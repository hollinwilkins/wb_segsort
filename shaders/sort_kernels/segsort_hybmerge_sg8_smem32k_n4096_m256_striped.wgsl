...
fn segsort_hybmerge_sg8_smem32k_n4096_m256_striped(
    ...
    workgroupBarrier();
    // merge pass 3: two sorted runs of 1024 -> 2048 (register-staged)
    {
    ...
    workgroupBarrier();
    // merge pass 4: two sorted runs of 2048 -> 4096 (register-staged)
    {
