...
fn segsort_hybrid_sg32_n2048_m128_striped(
    ...
    if keys[0] > keys[8] || (keys[0] == keys[8] && values[0] > values[8]) {
    // swap(0,8) 
    { let tmp_1151 = keys[0]; keys[0] = keys[8]; keys[8] = tmp_1151;let tmp_1152 = values[0]; values[0] = values[8]; values[8] = tmp_1152; }
    }
    // cmp_swap(1,9)
    if keys[1] > keys[9] || (keys[1] == keys[9] && values[1] > values[9]) {
    // swap(1,9) 
    { let tmp_1153 = keys[1]; keys[1] = keys[9]; keys[9] = tmp_1153;let tmp_1154 = values[1]; values[1] = values[9]; values[9] = tmp_1154; }
    }
    // cmp_swap(2,10)
    if keys[2] > keys[10] || (keys[2] == keys[10] && values[2] > values[10]) {
    // swap(2,10) 
    { let tmp_1155 = keys[2]; keys[2] = keys[10]; keys[10] = tmp_1155;let tmp_1156 = values[2]; values[2] = values[10]; values[10] = tmp_1156; }
    }
    // cmp_swap(3,11)
    if keys[3] > keys[11] || (keys[3] == keys[11] && values[3] > values[11]) {
    // swap(3,11) 
    { let tmp_1157 = keys[3]; keys[3] = keys[11]; keys[11] = tmp_1157;let tmp_1158 = values[3]; values[3] = values[11]; values[11] = tmp_1158; }
    }
    // cmp_swap(4,12)
    if keys[4] > keys[12] || (keys[4] == keys[12] && values[4] > values[12]) {
    // swap(4,12) 
    { let tmp_1159 = keys[4]; keys[4] = keys[12]; keys[12] = tmp_1159;let tmp_1160 = values[4]; values[4] = values[12]; values[12] = tmp_1160; }
    }
    // cmp_swap(5,13)
    if keys[5] > keys[13] || (keys[5] == keys[13] && values[5] > values[13]) {
    // swap(5,13) 
    { let tmp_1161 = keys[5]; keys[5] = keys[13]; keys[13] = tmp_1161;let tmp_1162 = values[5]; values[5] = values[13]; values[13] = tmp_1162; }
    }
    // cmp_swap(6,14)
    if keys[6] > keys[14] || (keys[6] == keys[14] && values[6] > values[14]) {
    // swap(6,14) 
    { let tmp_1163 = keys[6]; keys[6] = keys[14]; keys[14] = tmp_1163;let tmp_1164 = values[6]; values[6] = values[14]; values[14] = tmp_1164; }
    }
    // cmp_swap(7,15)
    if keys[7] > keys[15] || (keys[7] == keys[15] && values[7] > values[15]) {
    // swap(7,15) 
    { let tmp_1165 = keys[7]; keys[7] = keys[15]; keys[15] = tmp_1165;let tmp_1166 = values[7]; values[7] = values[15]; values[15] = tmp_1166; }
    }
    // exch_local(4,16) 
    // cmp_swap(0,4)
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_1167 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_1167;let tmp_1168 = values[0]; values[0] = values[4]; values[4] = tmp_1168; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_1169 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_1169;let tmp_1170 = values[1]; values[1] = values[5]; values[5] = tmp_1170; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_1171 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_1171;let tmp_1172 = values[2]; values[2] = values[6]; values[6] = tmp_1172; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_1173 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_1173;let tmp_1174 = values[3]; values[3] = values[7]; values[7] = tmp_1174; }
    }
    // cmp_swap(8,12)
    if keys[8] > keys[12] || (keys[8] == keys[12] && values[8] > values[12]) {
    // swap(8,12) 
    { let tmp_1175 = keys[8]; keys[8] = keys[12]; keys[12] = tmp_1175;let tmp_1176 = values[8]; values[8] = values[12]; values[12] = tmp_1176; }
    }
    // cmp_swap(9,13)
    if keys[9] > keys[13] || (keys[9] == keys[13] && values[9] > values[13]) {
    // swap(9,13) 
    { let tmp_1177 = keys[9]; keys[9] = keys[13]; keys[13] = tmp_1177;let tmp_1178 = values[9]; values[9] = values[13]; values[13] = tmp_1178; }
    }
    // cmp_swap(10,14)
    if keys[10] > keys[14] || (keys[10] == keys[14] && values[10] > values[14]) {
    // swap(10,14) 
    { let tmp_1179 = keys[10]; keys[10] = keys[14]; keys[14] = tmp_1179;let tmp_1180 = values[10]; values[10] = values[14]; values[14] = tmp_1180; }
    }
    // cmp_swap(11,15)
    if keys[11] > keys[15] || (keys[11] == keys[15] && values[11] > values[15]) {
    // swap(11,15) 
    { let tmp_1181 = keys[11]; keys[11] = keys[15]; keys[15] = tmp_1181;let tmp_1182 = values[11]; values[11] = values[15]; values[15] = tmp_1182; }
    }
    // exch_local(2,16) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_1183 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_1183;let tmp_1184 = values[0]; values[0] = values[2]; values[2] = tmp_1184; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_1185 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_1185;let tmp_1186 = values[1]; values[1] = values[3]; values[3] = tmp_1186; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_1187 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_1187;let tmp_1188 = values[4]; values[4] = values[6]; values[6] = tmp_1188; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_1189 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_1189;let tmp_1190 = values[5]; values[5] = values[7]; values[7] = tmp_1190; }
    }
    // cmp_swap(8,10)
    if keys[8] > keys[10] || (keys[8] == keys[10] && values[8] > values[10]) {
    // swap(8,10) 
    { let tmp_1191 = keys[8]; keys[8] = keys[10]; keys[10] = tmp_1191;let tmp_1192 = values[8]; values[8] = values[10]; values[10] = tmp_1192; }
    }
    // cmp_swap(9,11)
    if keys[9] > keys[11] || (keys[9] == keys[11] && values[9] > values[11]) {
    // swap(9,11) 
    { let tmp_1193 = keys[9]; keys[9] = keys[11]; keys[11] = tmp_1193;let tmp_1194 = values[9]; values[9] = values[11]; values[11] = tmp_1194; }
    }
    // cmp_swap(12,14)
    if keys[12] > keys[14] || (keys[12] == keys[14] && values[12] > values[14]) {
    // swap(12,14) 
    { let tmp_1195 = keys[12]; keys[12] = keys[14]; keys[14] = tmp_1195;let tmp_1196 = values[12]; values[12] = values[14]; values[14] = tmp_1196; }
    }
    // cmp_swap(13,15)
    if keys[13] > keys[15] || (keys[13] == keys[15] && values[13] > values[15]) {
    // swap(13,15) 
    { let tmp_1197 = keys[13]; keys[13] = keys[15]; keys[15] = tmp_1197;let tmp_1198 = values[13]; values[13] = values[15]; values[15] = tmp_1198; }
    }
    // exch_local(1,16) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_1199 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_1199;let tmp_1200 = values[0]; values[0] = values[1]; values[1] = tmp_1200; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_1201 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_1201;let tmp_1202 = values[2]; values[2] = values[3]; values[3] = tmp_1202; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_1203 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_1203;let tmp_1204 = values[4]; values[4] = values[5]; values[5] = tmp_1204; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_1205 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_1205;let tmp_1206 = values[6]; values[6] = values[7]; values[7] = tmp_1206; }
    }
    // cmp_swap(8,9)
    if keys[8] > keys[9] || (keys[8] == keys[9] && values[8] > values[9]) {
    // swap(8,9) 
    { let tmp_1207 = keys[8]; keys[8] = keys[9]; keys[9] = tmp_1207;let tmp_1208 = values[8]; values[8] = values[9]; values[9] = tmp_1208; }
    }
    // cmp_swap(10,11)
    if keys[10] > keys[11] || (keys[10] == keys[11] && values[10] > values[11]) {
    // swap(10,11) 
    { let tmp_1209 = keys[10]; keys[10] = keys[11]; keys[11] = tmp_1209;let tmp_1210 = values[10]; values[10] = values[11]; values[11] = tmp_1210; }
    }
    // cmp_swap(12,13)
    if keys[12] > keys[13] || (keys[12] == keys[13] && values[12] > values[13]) {
    // swap(12,13) 
    { let tmp_1211 = keys[12]; keys[12] = keys[13]; keys[13] = tmp_1211;let tmp_1212 = values[12]; values[12] = values[13]; values[13] = tmp_1212; }
    }
    // cmp_swap(14,15)
    if keys[14] > keys[15] || (keys[14] == keys[15] && values[14] > values[15]) {
    // swap(14,15) 
    { let tmp_1213 = keys[14]; keys[14] = keys[15]; keys[15] = tmp_1213;let tmp_1214 = values[14]; values[14] = values[15]; values[15] = tmp_1214; }
    }
    // exch_intxn(tmask:63,swbit:5,wpt:16)
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; smem_keys[tid_g * WPT + 8u] = keys[8]; smem_vals[tid_g * WPT + 8u] = values[8]; smem_keys[tid_g * WPT + 9u] = keys[9]; smem_vals[tid_g * WPT + 9u] = values[9]; smem_keys[tid_g * WPT + 10u] = keys[10]; smem_vals[tid_g * WPT + 10u] = values[10]; smem_keys[tid_g * WPT + 11u] = keys[11]; smem_vals[tid_g * WPT + 11u] = values[11]; smem_keys[tid_g * WPT + 12u] = keys[12]; smem_vals[tid_g * WPT + 12u] = values[12]; smem_keys[tid_g * WPT + 13u] = keys[13]; smem_vals[tid_g * WPT + 13u] = values[13]; smem_keys[tid_g * WPT + 14u] = keys[14]; smem_vals[tid_g * WPT + 14u] = values[14]; smem_keys[tid_g * WPT + 15u] = keys[15]; smem_vals[tid_g * WPT + 15u] = values[15]; workgroupBarrier(); let tmp_1215 = extractBits(local_tid, 5u, 1u) != 0u; let tmp_1216 = seg_base + (local_tid ^ 63u); let tmp_1217 = smem_keys[tmp_1216 * WPT + 15u]; let tmp_1218 = smem_vals[tmp_1216 * WPT + 15u]; let tmp_1219 = keys[0] < tmp_1217 || (keys[0] == tmp_1217 && values[0] < tmp_1218); if tmp_1215 == tmp_1219 { keys[0] = tmp_1217; values[0] = tmp_1218; } let tmp_1220 = smem_keys[tmp_1216 * WPT + 14u]; let tmp_1221 = smem_vals[tmp_1216 * WPT + 14u]; let tmp_1222 = keys[1] < tmp_1220 || (keys[1] == tmp_1220 && values[1] < tmp_1221); if tmp_1215 == tmp_1222 { keys[1] = tmp_1220; values[1] = tmp_1221; } let tmp_1223 = smem_keys[tmp_1216 * WPT + 13u]; let tmp_1224 = smem_vals[tmp_1216 * WPT + 13u]; let tmp_1225 = keys[2] < tmp_1223 || (keys[2] == tmp_1223 && values[2] < tmp_1224); if tmp_1215 == tmp_1225 { keys[2] = tmp_1223; values[2] = tmp_1224; } let tmp_1226 = smem_keys[tmp_1216 * WPT + 12u]; let tmp_1227 = smem_vals[tmp_1216 * WPT + 12u]; let tmp_1228 = keys[3] < tmp_1226 || (keys[3] == tmp_1226 && values[3] < tmp_1227); if tmp_1215 == tmp_1228 { keys[3] = tmp_1226; values[3] = tmp_1227; } let tmp_1229 = smem_keys[tmp_1216 * WPT + 11u]; let tmp_1230 = smem_vals[tmp_1216 * WPT + 11u]; let tmp_1231 = keys[4] < tmp_1229 || (keys[4] == tmp_1229 && values[4] < tmp_1230); if tmp_1215 == tmp_1231 { keys[4] = tmp_1229; values[4] = tmp_1230; } let tmp_1232 = smem_keys[tmp_1216 * WPT + 10u]; let tmp_1233 = smem_vals[tmp_1216 * WPT + 10u]; let tmp_1234 = keys[5] < tmp_1232 || (keys[5] == tmp_1232 && values[5] < tmp_1233); if tmp_1215 == tmp_1234 { keys[5] = tmp_1232; values[5] = tmp_1233; } let tmp_1235 = smem_keys[tmp_1216 * WPT + 9u]; let tmp_1236 = smem_vals[tmp_1216 * WPT + 9u]; let tmp_1237 = keys[6] < tmp_1235 || (keys[6] == tmp_1235 && values[6] < tmp_1236); if tmp_1215 == tmp_1237 { keys[6] = tmp_1235; values[6] = tmp_1236; } let tmp_1238 = smem_keys[tmp_1216 * WPT + 8u]; let tmp_1239 = smem_vals[tmp_1216 * WPT + 8u]; let tmp_1240 = keys[7] < tmp_1238 || (keys[7] == tmp_1238 && values[7] < tmp_1239); if tmp_1215 == tmp_1240 { keys[7] = tmp_1238; values[7] = tmp_1239; } let tmp_1241 = smem_keys[tmp_1216 * WPT + 7u]; let tmp_1242 = smem_vals[tmp_1216 * WPT + 7u]; let tmp_1243 = keys[8] < tmp_1241 || (keys[8] == tmp_1241 && values[8] < tmp_1242); if tmp_1215 == tmp_1243 { keys[8] = tmp_1241; values[8] = tmp_1242; } let tmp_1244 = smem_keys[tmp_1216 * WPT + 6u]; let tmp_1245 = smem_vals[tmp_1216 * WPT + 6u]; let tmp_1246 = keys[9] < tmp_1244 || (keys[9] == tmp_1244 && values[9] < tmp_1245); if tmp_1215 == tmp_1246 { keys[9] = tmp_1244; values[9] = tmp_1245; } let tmp_1247 = smem_keys[tmp_1216 * WPT + 5u]; let tmp_1248 = smem_vals[tmp_1216 * WPT + 5u]; let tmp_1249 = keys[10] < tmp_1247 || (keys[10] == tmp_1247 && values[10] < tmp_1248); if tmp_1215 == tmp_1249 { keys[10] = tmp_1247; values[10] = tmp_1248; } let tmp_1250 = smem_keys[tmp_1216 * WPT + 4u]; let tmp_1251 = smem_vals[tmp_1216 * WPT + 4u]; let tmp_1252 = keys[11] < tmp_1250 || (keys[11] == tmp_1250 && values[11] < tmp_1251); if tmp_1215 == tmp_1252 { keys[11] = tmp_1250; values[11] = tmp_1251; } let tmp_1253 = smem_keys[tmp_1216 * WPT + 3u]; let tmp_1254 = smem_vals[tmp_1216 * WPT + 3u]; let tmp_1255 = keys[12] < tmp_1253 || (keys[12] == tmp_1253 && values[12] < tmp_1254); if tmp_1215 == tmp_1255 { keys[12] = tmp_1253; values[12] = tmp_1254; } let tmp_1256 = smem_keys[tmp_1216 * WPT + 2u]; let tmp_1257 = smem_vals[tmp_1216 * WPT + 2u]; let tmp_1258 = keys[13] < tmp_1256 || (keys[13] == tmp_1256 && values[13] < tmp_1257); if tmp_1215 == tmp_1258 { keys[13] = tmp_1256; values[13] = tmp_1257; } let tmp_1259 = smem_keys[tmp_1216 * WPT + 1u]; let tmp_1260 = smem_vals[tmp_1216 * WPT + 1u]; let tmp_1261 = keys[14] < tmp_1259 || (keys[14] == tmp_1259 && values[14] < tmp_1260); if tmp_1215 == tmp_1261 { keys[14] = tmp_1259; values[14] = tmp_1260; } let tmp_1262 = smem_keys[tmp_1216 * WPT + 0u]; let tmp_1263 = smem_vals[tmp_1216 * WPT + 0u]; let tmp_1264 = keys[15] < tmp_1262 || (keys[15] == tmp_1262 && values[15] < tmp_1263); if tmp_1215 == tmp_1264 { keys[15] = tmp_1262; values[15] = tmp_1263; } workgroupBarrier(); }
    // exch_paral(tmask:16,swbit:4,wpt:16) 
    {
    let tmp_1265 = subgroupShuffleXor(keys[0], 16u);
    let tmp_1266 = subgroupShuffleXor(values[0], 16u);
    let tmp_1267 = subgroupShuffleXor(keys[1], 16u);
    let tmp_1268 = subgroupShuffleXor(values[1], 16u);
    let tmp_1269 = subgroupShuffleXor(keys[2], 16u);
    let tmp_1270 = subgroupShuffleXor(values[2], 16u);
    let tmp_1271 = subgroupShuffleXor(keys[3], 16u);
    let tmp_1272 = subgroupShuffleXor(values[3], 16u);
    let tmp_1273 = subgroupShuffleXor(keys[4], 16u);
    let tmp_1274 = subgroupShuffleXor(values[4], 16u);
    let tmp_1275 = subgroupShuffleXor(keys[5], 16u);
    let tmp_1276 = subgroupShuffleXor(values[5], 16u);
    let tmp_1277 = subgroupShuffleXor(keys[6], 16u);
    let tmp_1278 = subgroupShuffleXor(values[6], 16u);
    let tmp_1279 = subgroupShuffleXor(keys[7], 16u);
    let tmp_1280 = subgroupShuffleXor(values[7], 16u);
    let tmp_1281 = subgroupShuffleXor(keys[8], 16u);
    let tmp_1282 = subgroupShuffleXor(values[8], 16u);
    let tmp_1283 = subgroupShuffleXor(keys[9], 16u);
    let tmp_1284 = subgroupShuffleXor(values[9], 16u);
    let tmp_1285 = subgroupShuffleXor(keys[10], 16u);
    let tmp_1286 = subgroupShuffleXor(values[10], 16u);
    let tmp_1287 = subgroupShuffleXor(keys[11], 16u);
    let tmp_1288 = subgroupShuffleXor(values[11], 16u);
    let tmp_1289 = subgroupShuffleXor(keys[12], 16u);
    let tmp_1290 = subgroupShuffleXor(values[12], 16u);
    let tmp_1291 = subgroupShuffleXor(keys[13], 16u);
    let tmp_1292 = subgroupShuffleXor(values[13], 16u);
    let tmp_1293 = subgroupShuffleXor(keys[14], 16u);
    let tmp_1294 = subgroupShuffleXor(values[14], 16u);
    let tmp_1295 = subgroupShuffleXor(keys[15], 16u);
    let tmp_1296 = subgroupShuffleXor(values[15], 16u);
    let tmp_1297 = extractBits(local_tid, 4u, 1u) != 0u;
    let tmp_1298 = keys[0] < tmp_1265 || (keys[0] == tmp_1265 && values[0] < tmp_1266);
    if tmp_1297 == tmp_1298 { keys[0] = tmp_1265; values[0] = tmp_1266; }
    let tmp_1299 = keys[1] < tmp_1267 || (keys[1] == tmp_1267 && values[1] < tmp_1268);
    if tmp_1297 == tmp_1299 { keys[1] = tmp_1267; values[1] = tmp_1268; }
    let tmp_1300 = keys[2] < tmp_1269 || (keys[2] == tmp_1269 && values[2] < tmp_1270);
    if tmp_1297 == tmp_1300 { keys[2] = tmp_1269; values[2] = tmp_1270; }
    let tmp_1301 = keys[3] < tmp_1271 || (keys[3] == tmp_1271 && values[3] < tmp_1272);
    if tmp_1297 == tmp_1301 { keys[3] = tmp_1271; values[3] = tmp_1272; }
    let tmp_1302 = keys[4] < tmp_1273 || (keys[4] == tmp_1273 && values[4] < tmp_1274);
    if tmp_1297 == tmp_1302 { keys[4] = tmp_1273; values[4] = tmp_1274; }
    let tmp_1303 = keys[5] < tmp_1275 || (keys[5] == tmp_1275 && values[5] < tmp_1276);
    if tmp_1297 == tmp_1303 { keys[5] = tmp_1275; values[5] = tmp_1276; }
    let tmp_1304 = keys[6] < tmp_1277 || (keys[6] == tmp_1277 && values[6] < tmp_1278);
    if tmp_1297 == tmp_1304 { keys[6] = tmp_1277; values[6] = tmp_1278; }
    let tmp_1305 = keys[7] < tmp_1279 || (keys[7] == tmp_1279 && values[7] < tmp_1280);
    if tmp_1297 == tmp_1305 { keys[7] = tmp_1279; values[7] = tmp_1280; }
    let tmp_1306 = keys[8] < tmp_1281 || (keys[8] == tmp_1281 && values[8] < tmp_1282);
    if tmp_1297 == tmp_1306 { keys[8] = tmp_1281; values[8] = tmp_1282; }
    let tmp_1307 = keys[9] < tmp_1283 || (keys[9] == tmp_1283 && values[9] < tmp_1284);
    if tmp_1297 == tmp_1307 { keys[9] = tmp_1283; values[9] = tmp_1284; }
    let tmp_1308 = keys[10] < tmp_1285 || (keys[10] == tmp_1285 && values[10] < tmp_1286);
    if tmp_1297 == tmp_1308 { keys[10] = tmp_1285; values[10] = tmp_1286; }
    let tmp_1309 = keys[11] < tmp_1287 || (keys[11] == tmp_1287 && values[11] < tmp_1288);
    if tmp_1297 == tmp_1309 { keys[11] = tmp_1287; values[11] = tmp_1288; }
    let tmp_1310 = keys[12] < tmp_1289 || (keys[12] == tmp_1289 && values[12] < tmp_1290);
    if tmp_1297 == tmp_1310 { keys[12] = tmp_1289; values[12] = tmp_1290; }
    let tmp_1311 = keys[13] < tmp_1291 || (keys[13] == tmp_1291 && values[13] < tmp_1292);
    if tmp_1297 == tmp_1311 { keys[13] = tmp_1291; values[13] = tmp_1292; }
    let tmp_1312 = keys[14] < tmp_1293 || (keys[14] == tmp_1293 && values[14] < tmp_1294);
    if tmp_1297 == tmp_1312 { keys[14] = tmp_1293; values[14] = tmp_1294; }
    let tmp_1313 = keys[15] < tmp_1295 || (keys[15] == tmp_1295 && values[15] < tmp_1296);
    if tmp_1297 == tmp_1313 { keys[15] = tmp_1295; values[15] = tmp_1296; }
    }
    // exch_paral(tmask:8,swbit:3,wpt:16) 
    {
    let tmp_1314 = subgroupShuffleXor(keys[0], 8u);
    let tmp_1315 = subgroupShuffleXor(values[0], 8u);
    let tmp_1316 = subgroupShuffleXor(keys[1], 8u);
    let tmp_1317 = subgroupShuffleXor(values[1], 8u);
    let tmp_1318 = subgroupShuffleXor(keys[2], 8u);
    let tmp_1319 = subgroupShuffleXor(values[2], 8u);
    let tmp_1320 = subgroupShuffleXor(keys[3], 8u);
    let tmp_1321 = subgroupShuffleXor(values[3], 8u);
    let tmp_1322 = subgroupShuffleXor(keys[4], 8u);
    let tmp_1323 = subgroupShuffleXor(values[4], 8u);
    let tmp_1324 = subgroupShuffleXor(keys[5], 8u);
    let tmp_1325 = subgroupShuffleXor(values[5], 8u);
    let tmp_1326 = subgroupShuffleXor(keys[6], 8u);
    let tmp_1327 = subgroupShuffleXor(values[6], 8u);
    let tmp_1328 = subgroupShuffleXor(keys[7], 8u);
    let tmp_1329 = subgroupShuffleXor(values[7], 8u);
    let tmp_1330 = subgroupShuffleXor(keys[8], 8u);
    let tmp_1331 = subgroupShuffleXor(values[8], 8u);
    let tmp_1332 = subgroupShuffleXor(keys[9], 8u);
    let tmp_1333 = subgroupShuffleXor(values[9], 8u);
    let tmp_1334 = subgroupShuffleXor(keys[10], 8u);
    let tmp_1335 = subgroupShuffleXor(values[10], 8u);
    let tmp_1336 = subgroupShuffleXor(keys[11], 8u);
    let tmp_1337 = subgroupShuffleXor(values[11], 8u);
    let tmp_1338 = subgroupShuffleXor(keys[12], 8u);
    let tmp_1339 = subgroupShuffleXor(values[12], 8u);
    let tmp_1340 = subgroupShuffleXor(keys[13], 8u);
    let tmp_1341 = subgroupShuffleXor(values[13], 8u);
    let tmp_1342 = subgroupShuffleXor(keys[14], 8u);
    let tmp_1343 = subgroupShuffleXor(values[14], 8u);
    let tmp_1344 = subgroupShuffleXor(keys[15], 8u);
    let tmp_1345 = subgroupShuffleXor(values[15], 8u);
    let tmp_1346 = extractBits(local_tid, 3u, 1u) != 0u;
    let tmp_1347 = keys[0] < tmp_1314 || (keys[0] == tmp_1314 && values[0] < tmp_1315);
    if tmp_1346 == tmp_1347 { keys[0] = tmp_1314; values[0] = tmp_1315; }
    let tmp_1348 = keys[1] < tmp_1316 || (keys[1] == tmp_1316 && values[1] < tmp_1317);
    if tmp_1346 == tmp_1348 { keys[1] = tmp_1316; values[1] = tmp_1317; }
    let tmp_1349 = keys[2] < tmp_1318 || (keys[2] == tmp_1318 && values[2] < tmp_1319);
    if tmp_1346 == tmp_1349 { keys[2] = tmp_1318; values[2] = tmp_1319; }
    let tmp_1350 = keys[3] < tmp_1320 || (keys[3] == tmp_1320 && values[3] < tmp_1321);
    if tmp_1346 == tmp_1350 { keys[3] = tmp_1320; values[3] = tmp_1321; }
    let tmp_1351 = keys[4] < tmp_1322 || (keys[4] == tmp_1322 && values[4] < tmp_1323);
    if tmp_1346 == tmp_1351 { keys[4] = tmp_1322; values[4] = tmp_1323; }
    let tmp_1352 = keys[5] < tmp_1324 || (keys[5] == tmp_1324 && values[5] < tmp_1325);
    if tmp_1346 == tmp_1352 { keys[5] = tmp_1324; values[5] = tmp_1325; }
    let tmp_1353 = keys[6] < tmp_1326 || (keys[6] == tmp_1326 && values[6] < tmp_1327);
    if tmp_1346 == tmp_1353 { keys[6] = tmp_1326; values[6] = tmp_1327; }
    let tmp_1354 = keys[7] < tmp_1328 || (keys[7] == tmp_1328 && values[7] < tmp_1329);
    if tmp_1346 == tmp_1354 { keys[7] = tmp_1328; values[7] = tmp_1329; }
    let tmp_1355 = keys[8] < tmp_1330 || (keys[8] == tmp_1330 && values[8] < tmp_1331);
    if tmp_1346 == tmp_1355 { keys[8] = tmp_1330; values[8] = tmp_1331; }
    let tmp_1356 = keys[9] < tmp_1332 || (keys[9] == tmp_1332 && values[9] < tmp_1333);
    if tmp_1346 == tmp_1356 { keys[9] = tmp_1332; values[9] = tmp_1333; }
    let tmp_1357 = keys[10] < tmp_1334 || (keys[10] == tmp_1334 && values[10] < tmp_1335);
    if tmp_1346 == tmp_1357 { keys[10] = tmp_1334; values[10] = tmp_1335; }
    let tmp_1358 = keys[11] < tmp_1336 || (keys[11] == tmp_1336 && values[11] < tmp_1337);
    if tmp_1346 == tmp_1358 { keys[11] = tmp_1336; values[11] = tmp_1337; }
    let tmp_1359 = keys[12] < tmp_1338 || (keys[12] == tmp_1338 && values[12] < tmp_1339);
    if tmp_1346 == tmp_1359 { keys[12] = tmp_1338; values[12] = tmp_1339; }
    let tmp_1360 = keys[13] < tmp_1340 || (keys[13] == tmp_1340 && values[13] < tmp_1341);
    if tmp_1346 == tmp_1360 { keys[13] = tmp_1340; values[13] = tmp_1341; }
    let tmp_1361 = keys[14] < tmp_1342 || (keys[14] == tmp_1342 && values[14] < tmp_1343);
    if tmp_1346 == tmp_1361 { keys[14] = tmp_1342; values[14] = tmp_1343; }
    let tmp_1362 = keys[15] < tmp_1344 || (keys[15] == tmp_1344 && values[15] < tmp_1345);
    if tmp_1346 == tmp_1362 { keys[15] = tmp_1344; values[15] = tmp_1345; }
    }
    // exch_paral(tmask:4,swbit:2,wpt:16) 
    {
    let tmp_1363 = subgroupShuffleXor(keys[0], 4u);
    let tmp_1364 = subgroupShuffleXor(values[0], 4u);
    let tmp_1365 = subgroupShuffleXor(keys[1], 4u);
    let tmp_1366 = subgroupShuffleXor(values[1], 4u);
    let tmp_1367 = subgroupShuffleXor(keys[2], 4u);
    let tmp_1368 = subgroupShuffleXor(values[2], 4u);
    let tmp_1369 = subgroupShuffleXor(keys[3], 4u);
    let tmp_1370 = subgroupShuffleXor(values[3], 4u);
    let tmp_1371 = subgroupShuffleXor(keys[4], 4u);
    let tmp_1372 = subgroupShuffleXor(values[4], 4u);
    let tmp_1373 = subgroupShuffleXor(keys[5], 4u);
    let tmp_1374 = subgroupShuffleXor(values[5], 4u);
    let tmp_1375 = subgroupShuffleXor(keys[6], 4u);
    let tmp_1376 = subgroupShuffleXor(values[6], 4u);
    let tmp_1377 = subgroupShuffleXor(keys[7], 4u);
    let tmp_1378 = subgroupShuffleXor(values[7], 4u);
    let tmp_1379 = subgroupShuffleXor(keys[8], 4u);
    let tmp_1380 = subgroupShuffleXor(values[8], 4u);
    let tmp_1381 = subgroupShuffleXor(keys[9], 4u);
    let tmp_1382 = subgroupShuffleXor(values[9], 4u);
    let tmp_1383 = subgroupShuffleXor(keys[10], 4u);
    let tmp_1384 = subgroupShuffleXor(values[10], 4u);
    let tmp_1385 = subgroupShuffleXor(keys[11], 4u);
    let tmp_1386 = subgroupShuffleXor(values[11], 4u);
    let tmp_1387 = subgroupShuffleXor(keys[12], 4u);
    let tmp_1388 = subgroupShuffleXor(values[12], 4u);
    let tmp_1389 = subgroupShuffleXor(keys[13], 4u);
    let tmp_1390 = subgroupShuffleXor(values[13], 4u);
    let tmp_1391 = subgroupShuffleXor(keys[14], 4u);
    let tmp_1392 = subgroupShuffleXor(values[14], 4u);
    let tmp_1393 = subgroupShuffleXor(keys[15], 4u);
    let tmp_1394 = subgroupShuffleXor(values[15], 4u);
    let tmp_1395 = extractBits(local_tid, 2u, 1u) != 0u;
    let tmp_1396 = keys[0] < tmp_1363 || (keys[0] == tmp_1363 && values[0] < tmp_1364);
    if tmp_1395 == tmp_1396 { keys[0] = tmp_1363; values[0] = tmp_1364; }
    let tmp_1397 = keys[1] < tmp_1365 || (keys[1] == tmp_1365 && values[1] < tmp_1366);
    if tmp_1395 == tmp_1397 { keys[1] = tmp_1365; values[1] = tmp_1366; }
    let tmp_1398 = keys[2] < tmp_1367 || (keys[2] == tmp_1367 && values[2] < tmp_1368);
    if tmp_1395 == tmp_1398 { keys[2] = tmp_1367; values[2] = tmp_1368; }
    let tmp_1399 = keys[3] < tmp_1369 || (keys[3] == tmp_1369 && values[3] < tmp_1370);
    if tmp_1395 == tmp_1399 { keys[3] = tmp_1369; values[3] = tmp_1370; }
    let tmp_1400 = keys[4] < tmp_1371 || (keys[4] == tmp_1371 && values[4] < tmp_1372);
    if tmp_1395 == tmp_1400 { keys[4] = tmp_1371; values[4] = tmp_1372; }
    let tmp_1401 = keys[5] < tmp_1373 || (keys[5] == tmp_1373 && values[5] < tmp_1374);
    if tmp_1395 == tmp_1401 { keys[5] = tmp_1373; values[5] = tmp_1374; }
    let tmp_1402 = keys[6] < tmp_1375 || (keys[6] == tmp_1375 && values[6] < tmp_1376);
    if tmp_1395 == tmp_1402 { keys[6] = tmp_1375; values[6] = tmp_1376; }
    let tmp_1403 = keys[7] < tmp_1377 || (keys[7] == tmp_1377 && values[7] < tmp_1378);
    if tmp_1395 == tmp_1403 { keys[7] = tmp_1377; values[7] = tmp_1378; }
    let tmp_1404 = keys[8] < tmp_1379 || (keys[8] == tmp_1379 && values[8] < tmp_1380);
    if tmp_1395 == tmp_1404 { keys[8] = tmp_1379; values[8] = tmp_1380; }
    let tmp_1405 = keys[9] < tmp_1381 || (keys[9] == tmp_1381 && values[9] < tmp_1382);
    if tmp_1395 == tmp_1405 { keys[9] = tmp_1381; values[9] = tmp_1382; }
    let tmp_1406 = keys[10] < tmp_1383 || (keys[10] == tmp_1383 && values[10] < tmp_1384);
    if tmp_1395 == tmp_1406 { keys[10] = tmp_1383; values[10] = tmp_1384; }
    let tmp_1407 = keys[11] < tmp_1385 || (keys[11] == tmp_1385 && values[11] < tmp_1386);
    if tmp_1395 == tmp_1407 { keys[11] = tmp_1385; values[11] = tmp_1386; }
    let tmp_1408 = keys[12] < tmp_1387 || (keys[12] == tmp_1387 && values[12] < tmp_1388);
    if tmp_1395 == tmp_1408 { keys[12] = tmp_1387; values[12] = tmp_1388; }
    let tmp_1409 = keys[13] < tmp_1389 || (keys[13] == tmp_1389 && values[13] < tmp_1390);
    if tmp_1395 == tmp_1409 { keys[13] = tmp_1389; values[13] = tmp_1390; }
    let tmp_1410 = keys[14] < tmp_1391 || (keys[14] == tmp_1391 && values[14] < tmp_1392);
    if tmp_1395 == tmp_1410 { keys[14] = tmp_1391; values[14] = tmp_1392; }
    let tmp_1411 = keys[15] < tmp_1393 || (keys[15] == tmp_1393 && values[15] < tmp_1394);
    if tmp_1395 == tmp_1411 { keys[15] = tmp_1393; values[15] = tmp_1394; }
    }
    // exch_paral(tmask:2,swbit:1,wpt:16) 
    {
    let tmp_1412 = subgroupShuffleXor(keys[0], 2u);
    let tmp_1413 = subgroupShuffleXor(values[0], 2u);
    let tmp_1414 = subgroupShuffleXor(keys[1], 2u);
    let tmp_1415 = subgroupShuffleXor(values[1], 2u);
    let tmp_1416 = subgroupShuffleXor(keys[2], 2u);
    let tmp_1417 = subgroupShuffleXor(values[2], 2u);
    let tmp_1418 = subgroupShuffleXor(keys[3], 2u);
    let tmp_1419 = subgroupShuffleXor(values[3], 2u);
    let tmp_1420 = subgroupShuffleXor(keys[4], 2u);
    let tmp_1421 = subgroupShuffleXor(values[4], 2u);
    let tmp_1422 = subgroupShuffleXor(keys[5], 2u);
    let tmp_1423 = subgroupShuffleXor(values[5], 2u);
    let tmp_1424 = subgroupShuffleXor(keys[6], 2u);
    let tmp_1425 = subgroupShuffleXor(values[6], 2u);
    let tmp_1426 = subgroupShuffleXor(keys[7], 2u);
    let tmp_1427 = subgroupShuffleXor(values[7], 2u);
    let tmp_1428 = subgroupShuffleXor(keys[8], 2u);
    let tmp_1429 = subgroupShuffleXor(values[8], 2u);
    let tmp_1430 = subgroupShuffleXor(keys[9], 2u);
    let tmp_1431 = subgroupShuffleXor(values[9], 2u);
    let tmp_1432 = subgroupShuffleXor(keys[10], 2u);
    let tmp_1433 = subgroupShuffleXor(values[10], 2u);
    let tmp_1434 = subgroupShuffleXor(keys[11], 2u);
    let tmp_1435 = subgroupShuffleXor(values[11], 2u);
    let tmp_1436 = subgroupShuffleXor(keys[12], 2u);
    let tmp_1437 = subgroupShuffleXor(values[12], 2u);
    let tmp_1438 = subgroupShuffleXor(keys[13], 2u);
    let tmp_1439 = subgroupShuffleXor(values[13], 2u);
    let tmp_1440 = subgroupShuffleXor(keys[14], 2u);
    let tmp_1441 = subgroupShuffleXor(values[14], 2u);
    let tmp_1442 = subgroupShuffleXor(keys[15], 2u);
    let tmp_1443 = subgroupShuffleXor(values[15], 2u);
    let tmp_1444 = extractBits(local_tid, 1u, 1u) != 0u;
    let tmp_1445 = keys[0] < tmp_1412 || (keys[0] == tmp_1412 && values[0] < tmp_1413);
    if tmp_1444 == tmp_1445 { keys[0] = tmp_1412; values[0] = tmp_1413; }
    let tmp_1446 = keys[1] < tmp_1414 || (keys[1] == tmp_1414 && values[1] < tmp_1415);
    if tmp_1444 == tmp_1446 { keys[1] = tmp_1414; values[1] = tmp_1415; }
    let tmp_1447 = keys[2] < tmp_1416 || (keys[2] == tmp_1416 && values[2] < tmp_1417);
    if tmp_1444 == tmp_1447 { keys[2] = tmp_1416; values[2] = tmp_1417; }
    let tmp_1448 = keys[3] < tmp_1418 || (keys[3] == tmp_1418 && values[3] < tmp_1419);
    if tmp_1444 == tmp_1448 { keys[3] = tmp_1418; values[3] = tmp_1419; }
    let tmp_1449 = keys[4] < tmp_1420 || (keys[4] == tmp_1420 && values[4] < tmp_1421);
    if tmp_1444 == tmp_1449 { keys[4] = tmp_1420; values[4] = tmp_1421; }
    let tmp_1450 = keys[5] < tmp_1422 || (keys[5] == tmp_1422 && values[5] < tmp_1423);
    if tmp_1444 == tmp_1450 { keys[5] = tmp_1422; values[5] = tmp_1423; }
    let tmp_1451 = keys[6] < tmp_1424 || (keys[6] == tmp_1424 && values[6] < tmp_1425);
    if tmp_1444 == tmp_1451 { keys[6] = tmp_1424; values[6] = tmp_1425; }
    let tmp_1452 = keys[7] < tmp_1426 || (keys[7] == tmp_1426 && values[7] < tmp_1427);
    if tmp_1444 == tmp_1452 { keys[7] = tmp_1426; values[7] = tmp_1427; }
    let tmp_1453 = keys[8] < tmp_1428 || (keys[8] == tmp_1428 && values[8] < tmp_1429);
    if tmp_1444 == tmp_1453 { keys[8] = tmp_1428; values[8] = tmp_1429; }
    let tmp_1454 = keys[9] < tmp_1430 || (keys[9] == tmp_1430 && values[9] < tmp_1431);
    if tmp_1444 == tmp_1454 { keys[9] = tmp_1430; values[9] = tmp_1431; }
    let tmp_1455 = keys[10] < tmp_1432 || (keys[10] == tmp_1432 && values[10] < tmp_1433);
    if tmp_1444 == tmp_1455 { keys[10] = tmp_1432; values[10] = tmp_1433; }
    let tmp_1456 = keys[11] < tmp_1434 || (keys[11] == tmp_1434 && values[11] < tmp_1435);
    if tmp_1444 == tmp_1456 { keys[11] = tmp_1434; values[11] = tmp_1435; }
    let tmp_1457 = keys[12] < tmp_1436 || (keys[12] == tmp_1436 && values[12] < tmp_1437);
    if tmp_1444 == tmp_1457 { keys[12] = tmp_1436; values[12] = tmp_1437; }
    let tmp_1458 = keys[13] < tmp_1438 || (keys[13] == tmp_1438 && values[13] < tmp_1439);
    if tmp_1444 == tmp_1458 { keys[13] = tmp_1438; values[13] = tmp_1439; }
    let tmp_1459 = keys[14] < tmp_1440 || (keys[14] == tmp_1440 && values[14] < tmp_1441);
    if tmp_1444 == tmp_1459 { keys[14] = tmp_1440; values[14] = tmp_1441; }
    let tmp_1460 = keys[15] < tmp_1442 || (keys[15] == tmp_1442 && values[15] < tmp_1443);
    if tmp_1444 == tmp_1460 { keys[15] = tmp_1442; values[15] = tmp_1443; }
    }
    // exch_paral(tmask:1,swbit:0,wpt:16) 
    {
    let tmp_1461 = subgroupShuffleXor(keys[0], 1u);
    let tmp_1462 = subgroupShuffleXor(values[0], 1u);
    let tmp_1463 = subgroupShuffleXor(keys[1], 1u);
    let tmp_1464 = subgroupShuffleXor(values[1], 1u);
    let tmp_1465 = subgroupShuffleXor(keys[2], 1u);
    let tmp_1466 = subgroupShuffleXor(values[2], 1u);
    let tmp_1467 = subgroupShuffleXor(keys[3], 1u);
    let tmp_1468 = subgroupShuffleXor(values[3], 1u);
    let tmp_1469 = subgroupShuffleXor(keys[4], 1u);
    let tmp_1470 = subgroupShuffleXor(values[4], 1u);
    let tmp_1471 = subgroupShuffleXor(keys[5], 1u);
    let tmp_1472 = subgroupShuffleXor(values[5], 1u);
    let tmp_1473 = subgroupShuffleXor(keys[6], 1u);
    let tmp_1474 = subgroupShuffleXor(values[6], 1u);
    let tmp_1475 = subgroupShuffleXor(keys[7], 1u);
    let tmp_1476 = subgroupShuffleXor(values[7], 1u);
    let tmp_1477 = subgroupShuffleXor(keys[8], 1u);
    let tmp_1478 = subgroupShuffleXor(values[8], 1u);
    let tmp_1479 = subgroupShuffleXor(keys[9], 1u);
    let tmp_1480 = subgroupShuffleXor(values[9], 1u);
    let tmp_1481 = subgroupShuffleXor(keys[10], 1u);
    let tmp_1482 = subgroupShuffleXor(values[10], 1u);
    let tmp_1483 = subgroupShuffleXor(keys[11], 1u);
    let tmp_1484 = subgroupShuffleXor(values[11], 1u);
    let tmp_1485 = subgroupShuffleXor(keys[12], 1u);
    let tmp_1486 = subgroupShuffleXor(values[12], 1u);
    let tmp_1487 = subgroupShuffleXor(keys[13], 1u);
    let tmp_1488 = subgroupShuffleXor(values[13], 1u);
    let tmp_1489 = subgroupShuffleXor(keys[14], 1u);
    let tmp_1490 = subgroupShuffleXor(values[14], 1u);
    let tmp_1491 = subgroupShuffleXor(keys[15], 1u);
    let tmp_1492 = subgroupShuffleXor(values[15], 1u);
    let tmp_1493 = extractBits(local_tid, 0u, 1u) != 0u;
    let tmp_1494 = keys[0] < tmp_1461 || (keys[0] == tmp_1461 && values[0] < tmp_1462);
    if tmp_1493 == tmp_1494 { keys[0] = tmp_1461; values[0] = tmp_1462; }
    let tmp_1495 = keys[1] < tmp_1463 || (keys[1] == tmp_1463 && values[1] < tmp_1464);
    if tmp_1493 == tmp_1495 { keys[1] = tmp_1463; values[1] = tmp_1464; }
    let tmp_1496 = keys[2] < tmp_1465 || (keys[2] == tmp_1465 && values[2] < tmp_1466);
    if tmp_1493 == tmp_1496 { keys[2] = tmp_1465; values[2] = tmp_1466; }
    let tmp_1497 = keys[3] < tmp_1467 || (keys[3] == tmp_1467 && values[3] < tmp_1468);
    if tmp_1493 == tmp_1497 { keys[3] = tmp_1467; values[3] = tmp_1468; }
    let tmp_1498 = keys[4] < tmp_1469 || (keys[4] == tmp_1469 && values[4] < tmp_1470);
    if tmp_1493 == tmp_1498 { keys[4] = tmp_1469; values[4] = tmp_1470; }
    let tmp_1499 = keys[5] < tmp_1471 || (keys[5] == tmp_1471 && values[5] < tmp_1472);
    if tmp_1493 == tmp_1499 { keys[5] = tmp_1471; values[5] = tmp_1472; }
    let tmp_1500 = keys[6] < tmp_1473 || (keys[6] == tmp_1473 && values[6] < tmp_1474);
    if tmp_1493 == tmp_1500 { keys[6] = tmp_1473; values[6] = tmp_1474; }
    let tmp_1501 = keys[7] < tmp_1475 || (keys[7] == tmp_1475 && values[7] < tmp_1476);
    if tmp_1493 == tmp_1501 { keys[7] = tmp_1475; values[7] = tmp_1476; }
    let tmp_1502 = keys[8] < tmp_1477 || (keys[8] == tmp_1477 && values[8] < tmp_1478);
    if tmp_1493 == tmp_1502 { keys[8] = tmp_1477; values[8] = tmp_1478; }
    let tmp_1503 = keys[9] < tmp_1479 || (keys[9] == tmp_1479 && values[9] < tmp_1480);
    if tmp_1493 == tmp_1503 { keys[9] = tmp_1479; values[9] = tmp_1480; }
    let tmp_1504 = keys[10] < tmp_1481 || (keys[10] == tmp_1481 && values[10] < tmp_1482);
    if tmp_1493 == tmp_1504 { keys[10] = tmp_1481; values[10] = tmp_1482; }
    let tmp_1505 = keys[11] < tmp_1483 || (keys[11] == tmp_1483 && values[11] < tmp_1484);
    if tmp_1493 == tmp_1505 { keys[11] = tmp_1483; values[11] = tmp_1484; }
    let tmp_1506 = keys[12] < tmp_1485 || (keys[12] == tmp_1485 && values[12] < tmp_1486);
    if tmp_1493 == tmp_1506 { keys[12] = tmp_1485; values[12] = tmp_1486; }
    let tmp_1507 = keys[13] < tmp_1487 || (keys[13] == tmp_1487 && values[13] < tmp_1488);
    if tmp_1493 == tmp_1507 { keys[13] = tmp_1487; values[13] = tmp_1488; }
    let tmp_1508 = keys[14] < tmp_1489 || (keys[14] == tmp_1489 && values[14] < tmp_1490);
    if tmp_1493 == tmp_1508 { keys[14] = tmp_1489; values[14] = tmp_1490; }
    let tmp_1509 = keys[15] < tmp_1491 || (keys[15] == tmp_1491 && values[15] < tmp_1492);
    if tmp_1493 == tmp_1509 { keys[15] = tmp_1491; values[15] = tmp_1492; }
    }
    // exch_local(8,16) 
    // cmp_swap(0,8)
    if keys[0] > keys[8] || (keys[0] == keys[8] && values[0] > values[8]) {
    // swap(0,8) 
    { let tmp_1510 = keys[0]; keys[0] = keys[8]; keys[8] = tmp_1510;let tmp_1511 = values[0]; values[0] = values[8]; values[8] = tmp_1511; }
    }
    // cmp_swap(1,9)
    if keys[1] > keys[9] || (keys[1] == keys[9] && values[1] > values[9]) {
    // swap(1,9) 
    { let tmp_1512 = keys[1]; keys[1] = keys[9]; keys[9] = tmp_1512;let tmp_1513 = values[1]; values[1] = values[9]; values[9] = tmp_1513; }
    }
    // cmp_swap(2,10)
    if keys[2] > keys[10] || (keys[2] == keys[10] && values[2] > values[10]) {
    // swap(2,10) 
    { let tmp_1514 = keys[2]; keys[2] = keys[10]; keys[10] = tmp_1514;let tmp_1515 = values[2]; values[2] = values[10]; values[10] = tmp_1515; }
    }
    // cmp_swap(3,11)
    if keys[3] > keys[11] || (keys[3] == keys[11] && values[3] > values[11]) {
    // swap(3,11) 
    { let tmp_1516 = keys[3]; keys[3] = keys[11]; keys[11] = tmp_1516;let tmp_1517 = values[3]; values[3] = values[11]; values[11] = tmp_1517; }
    }
    // cmp_swap(4,12)
    if keys[4] > keys[12] || (keys[4] == keys[12] && values[4] > values[12]) {
    // swap(4,12) 
    { let tmp_1518 = keys[4]; keys[4] = keys[12]; keys[12] = tmp_1518;let tmp_1519 = values[4]; values[4] = values[12]; values[12] = tmp_1519; }
    }
    // cmp_swap(5,13)
    if keys[5] > keys[13] || (keys[5] == keys[13] && values[5] > values[13]) {
    // swap(5,13) 
    { let tmp_1520 = keys[5]; keys[5] = keys[13]; keys[13] = tmp_1520;let tmp_1521 = values[5]; values[5] = values[13]; values[13] = tmp_1521; }
    }
    // cmp_swap(6,14)
    if keys[6] > keys[14] || (keys[6] == keys[14] && values[6] > values[14]) {
    // swap(6,14) 
    { let tmp_1522 = keys[6]; keys[6] = keys[14]; keys[14] = tmp_1522;let tmp_1523 = values[6]; values[6] = values[14]; values[14] = tmp_1523; }
    }
    // cmp_swap(7,15)
    if keys[7] > keys[15] || (keys[7] == keys[15] && values[7] > values[15]) {
    // swap(7,15) 
    { let tmp_1524 = keys[7]; keys[7] = keys[15]; keys[15] = tmp_1524;let tmp_1525 = values[7]; values[7] = values[15]; values[15] = tmp_1525; }
    }
    // exch_local(4,16) 
    // cmp_swap(0,4)
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_1526 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_1526;let tmp_1527 = values[0]; values[0] = values[4]; values[4] = tmp_1527; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_1528 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_1528;let tmp_1529 = values[1]; values[1] = values[5]; values[5] = tmp_1529; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_1530 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_1530;let tmp_1531 = values[2]; values[2] = values[6]; values[6] = tmp_1531; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_1532 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_1532;let tmp_1533 = values[3]; values[3] = values[7]; values[7] = tmp_1533; }
    }
    // cmp_swap(8,12)
    if keys[8] > keys[12] || (keys[8] == keys[12] && values[8] > values[12]) {
    // swap(8,12) 
    { let tmp_1534 = keys[8]; keys[8] = keys[12]; keys[12] = tmp_1534;let tmp_1535 = values[8]; values[8] = values[12]; values[12] = tmp_1535; }
    }
    // cmp_swap(9,13)
    if keys[9] > keys[13] || (keys[9] == keys[13] && values[9] > values[13]) {
    // swap(9,13) 
    { let tmp_1536 = keys[9]; keys[9] = keys[13]; keys[13] = tmp_1536;let tmp_1537 = values[9]; values[9] = values[13]; values[13] = tmp_1537; }
    }
    // cmp_swap(10,14)
    if keys[10] > keys[14] || (keys[10] == keys[14] && values[10] > values[14]) {
    // swap(10,14) 
    { let tmp_1538 = keys[10]; keys[10] = keys[14]; keys[14] = tmp_1538;let tmp_1539 = values[10]; values[10] = values[14]; values[14] = tmp_1539; }
    }
    // cmp_swap(11,15)
    if keys[11] > keys[15] || (keys[11] == keys[15] && values[11] > values[15]) {
    // swap(11,15) 
    { let tmp_1540 = keys[11]; keys[11] = keys[15]; keys[15] = tmp_1540;let tmp_1541 = values[11]; values[11] = values[15]; values[15] = tmp_1541; }
    }
    // exch_local(2,16) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_1542 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_1542;let tmp_1543 = values[0]; values[0] = values[2]; values[2] = tmp_1543; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_1544 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_1544;let tmp_1545 = values[1]; values[1] = values[3]; values[3] = tmp_1545; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_1546 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_1546;let tmp_1547 = values[4]; values[4] = values[6]; values[6] = tmp_1547; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_1548 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_1548;let tmp_1549 = values[5]; values[5] = values[7]; values[7] = tmp_1549; }
    }
    // cmp_swap(8,10)
    if keys[8] > keys[10] || (keys[8] == keys[10] && values[8] > values[10]) {
    // swap(8,10) 
    { let tmp_1550 = keys[8]; keys[8] = keys[10]; keys[10] = tmp_1550;let tmp_1551 = values[8]; values[8] = values[10]; values[10] = tmp_1551; }
    }
    // cmp_swap(9,11)
    if keys[9] > keys[11] || (keys[9] == keys[11] && values[9] > values[11]) {
    // swap(9,11) 
    { let tmp_1552 = keys[9]; keys[9] = keys[11]; keys[11] = tmp_1552;let tmp_1553 = values[9]; values[9] = values[11]; values[11] = tmp_1553; }
    }
    // cmp_swap(12,14)
    if keys[12] > keys[14] || (keys[12] == keys[14] && values[12] > values[14]) {
    // swap(12,14) 
    { let tmp_1554 = keys[12]; keys[12] = keys[14]; keys[14] = tmp_1554;let tmp_1555 = values[12]; values[12] = values[14]; values[14] = tmp_1555; }
    }
    // cmp_swap(13,15)
    if keys[13] > keys[15] || (keys[13] == keys[15] && values[13] > values[15]) {
    // swap(13,15) 
    { let tmp_1556 = keys[13]; keys[13] = keys[15]; keys[15] = tmp_1556;let tmp_1557 = values[13]; values[13] = values[15]; values[15] = tmp_1557; }
    }
    // exch_local(1,16) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_1558 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_1558;let tmp_1559 = values[0]; values[0] = values[1]; values[1] = tmp_1559; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_1560 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_1560;let tmp_1561 = values[2]; values[2] = values[3]; values[3] = tmp_1561; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_1562 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_1562;let tmp_1563 = values[4]; values[4] = values[5]; values[5] = tmp_1563; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_1564 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_1564;let tmp_1565 = values[6]; values[6] = values[7]; values[7] = tmp_1565; }
    }
    // cmp_swap(8,9)
    if keys[8] > keys[9] || (keys[8] == keys[9] && values[8] > values[9]) {
    // swap(8,9) 
    { let tmp_1566 = keys[8]; keys[8] = keys[9]; keys[9] = tmp_1566;let tmp_1567 = values[8]; values[8] = values[9]; values[9] = tmp_1567; }
    }
    // cmp_swap(10,11)
    if keys[10] > keys[11] || (keys[10] == keys[11] && values[10] > values[11]) {
    // swap(10,11) 
    { let tmp_1568 = keys[10]; keys[10] = keys[11]; keys[11] = tmp_1568;let tmp_1569 = values[10]; values[10] = values[11]; values[11] = tmp_1569; }
    }
    // cmp_swap(12,13)
    if keys[12] > keys[13] || (keys[12] == keys[13] && values[12] > values[13]) {
    // swap(12,13) 
    { let tmp_1570 = keys[12]; keys[12] = keys[13]; keys[13] = tmp_1570;let tmp_1571 = values[12]; values[12] = values[13]; values[13] = tmp_1571; }
    }
    // cmp_swap(14,15)
    if keys[14] > keys[15] || (keys[14] == keys[15] && values[14] > values[15]) {
    // swap(14,15) 
    { let tmp_1572 = keys[14]; keys[14] = keys[15]; keys[15] = tmp_1572;let tmp_1573 = values[14]; values[14] = values[15]; values[15] = tmp_1573; }
    }
    // exch_intxn(tmask:127,swbit:6,wpt:16)
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; smem_keys[tid_g * WPT + 8u] = keys[8]; smem_vals[tid_g * WPT + 8u] = values[8]; smem_keys[tid_g * WPT + 9u] = keys[9]; smem_vals[tid_g * WPT + 9u] = values[9]; smem_keys[tid_g * WPT + 10u] = keys[10]; smem_vals[tid_g * WPT + 10u] = values[10]; smem_keys[tid_g * WPT + 11u] = keys[11]; smem_vals[tid_g * WPT + 11u] = values[11]; smem_keys[tid_g * WPT + 12u] = keys[12]; smem_vals[tid_g * WPT + 12u] = values[12]; smem_keys[tid_g * WPT + 13u] = keys[13]; smem_vals[tid_g * WPT + 13u] = values[13]; smem_keys[tid_g * WPT + 14u] = keys[14]; smem_vals[tid_g * WPT + 14u] = values[14]; smem_keys[tid_g * WPT + 15u] = keys[15]; smem_vals[tid_g * WPT + 15u] = values[15]; workgroupBarrier(); let tmp_1574 = extractBits(local_tid, 6u, 1u) != 0u; let tmp_1575 = seg_base + (local_tid ^ 127u); let tmp_1576 = smem_keys[tmp_1575 * WPT + 15u]; let tmp_1577 = smem_vals[tmp_1575 * WPT + 15u]; let tmp_1578 = keys[0] < tmp_1576 || (keys[0] == tmp_1576 && values[0] < tmp_1577); if tmp_1574 == tmp_1578 { keys[0] = tmp_1576; values[0] = tmp_1577; } let tmp_1579 = smem_keys[tmp_1575 * WPT + 14u]; let tmp_1580 = smem_vals[tmp_1575 * WPT + 14u]; let tmp_1581 = keys[1] < tmp_1579 || (keys[1] == tmp_1579 && values[1] < tmp_1580); if tmp_1574 == tmp_1581 { keys[1] = tmp_1579; values[1] = tmp_1580; } let tmp_1582 = smem_keys[tmp_1575 * WPT + 13u]; let tmp_1583 = smem_vals[tmp_1575 * WPT + 13u]; let tmp_1584 = keys[2] < tmp_1582 || (keys[2] == tmp_1582 && values[2] < tmp_1583); if tmp_1574 == tmp_1584 { keys[2] = tmp_1582; values[2] = tmp_1583; } let tmp_1585 = smem_keys[tmp_1575 * WPT + 12u]; let tmp_1586 = smem_vals[tmp_1575 * WPT + 12u]; let tmp_1587 = keys[3] < tmp_1585 || (keys[3] == tmp_1585 && values[3] < tmp_1586); if tmp_1574 == tmp_1587 { keys[3] = tmp_1585; values[3] = tmp_1586; } let tmp_1588 = smem_keys[tmp_1575 * WPT + 11u]; let tmp_1589 = smem_vals[tmp_1575 * WPT + 11u]; let tmp_1590 = keys[4] < tmp_1588 || (keys[4] == tmp_1588 && values[4] < tmp_1589); if tmp_1574 == tmp_1590 { keys[4] = tmp_1588; values[4] = tmp_1589; } let tmp_1591 = smem_keys[tmp_1575 * WPT + 10u]; let tmp_1592 = smem_vals[tmp_1575 * WPT + 10u]; let tmp_1593 = keys[5] < tmp_1591 || (keys[5] == tmp_1591 && values[5] < tmp_1592); if tmp_1574 == tmp_1593 { keys[5] = tmp_1591; values[5] = tmp_1592; } let tmp_1594 = smem_keys[tmp_1575 * WPT + 9u]; let tmp_1595 = smem_vals[tmp_1575 * WPT + 9u]; let tmp_1596 = keys[6] < tmp_1594 || (keys[6] == tmp_1594 && values[6] < tmp_1595); if tmp_1574 == tmp_1596 { keys[6] = tmp_1594; values[6] = tmp_1595; } let tmp_1597 = smem_keys[tmp_1575 * WPT + 8u]; let tmp_1598 = smem_vals[tmp_1575 * WPT + 8u]; let tmp_1599 = keys[7] < tmp_1597 || (keys[7] == tmp_1597 && values[7] < tmp_1598); if tmp_1574 == tmp_1599 { keys[7] = tmp_1597; values[7] = tmp_1598; } let tmp_1600 = smem_keys[tmp_1575 * WPT + 7u]; let tmp_1601 = smem_vals[tmp_1575 * WPT + 7u]; let tmp_1602 = keys[8] < tmp_1600 || (keys[8] == tmp_1600 && values[8] < tmp_1601); if tmp_1574 == tmp_1602 { keys[8] = tmp_1600; values[8] = tmp_1601; } let tmp_1603 = smem_keys[tmp_1575 * WPT + 6u]; let tmp_1604 = smem_vals[tmp_1575 * WPT + 6u]; let tmp_1605 = keys[9] < tmp_1603 || (keys[9] == tmp_1603 && values[9] < tmp_1604); if tmp_1574 == tmp_1605 { keys[9] = tmp_1603; values[9] = tmp_1604; } let tmp_1606 = smem_keys[tmp_1575 * WPT + 5u]; let tmp_1607 = smem_vals[tmp_1575 * WPT + 5u]; let tmp_1608 = keys[10] < tmp_1606 || (keys[10] == tmp_1606 && values[10] < tmp_1607); if tmp_1574 == tmp_1608 { keys[10] = tmp_1606; values[10] = tmp_1607; } let tmp_1609 = smem_keys[tmp_1575 * WPT + 4u]; let tmp_1610 = smem_vals[tmp_1575 * WPT + 4u]; let tmp_1611 = keys[11] < tmp_1609 || (keys[11] == tmp_1609 && values[11] < tmp_1610); if tmp_1574 == tmp_1611 { keys[11] = tmp_1609; values[11] = tmp_1610; } let tmp_1612 = smem_keys[tmp_1575 * WPT + 3u]; let tmp_1613 = smem_vals[tmp_1575 * WPT + 3u]; let tmp_1614 = keys[12] < tmp_1612 || (keys[12] == tmp_1612 && values[12] < tmp_1613); if tmp_1574 == tmp_1614 { keys[12] = tmp_1612; values[12] = tmp_1613; } let tmp_1615 = smem_keys[tmp_1575 * WPT + 2u]; let tmp_1616 = smem_vals[tmp_1575 * WPT + 2u]; let tmp_1617 = keys[13] < tmp_1615 || (keys[13] == tmp_1615 && values[13] < tmp_1616); if tmp_1574 == tmp_1617 { keys[13] = tmp_1615; values[13] = tmp_1616; } let tmp_1618 = smem_keys[tmp_1575 * WPT + 1u]; let tmp_1619 = smem_vals[tmp_1575 * WPT + 1u]; let tmp_1620 = keys[14] < tmp_1618 || (keys[14] == tmp_1618 && values[14] < tmp_1619); if tmp_1574 == tmp_1620 { keys[14] = tmp_1618; values[14] = tmp_1619; } let tmp_1621 = smem_keys[tmp_1575 * WPT + 0u]; let tmp_1622 = smem_vals[tmp_1575 * WPT + 0u]; let tmp_1623 = keys[15] < tmp_1621 || (keys[15] == tmp_1621 && values[15] < tmp_1622); if tmp_1574 == tmp_1623 { keys[15] = tmp_1621; values[15] = tmp_1622; } workgroupBarrier(); }
    // exch_paral(tmask:32,swbit:5,wpt:16) 
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; smem_keys[tid_g * WPT + 8u] = keys[8]; smem_vals[tid_g * WPT + 8u] = values[8]; smem_keys[tid_g * WPT + 9u] = keys[9]; smem_vals[tid_g * WPT + 9u] = values[9]; smem_keys[tid_g * WPT + 10u] = keys[10]; smem_vals[tid_g * WPT + 10u] = values[10]; smem_keys[tid_g * WPT + 11u] = keys[11]; smem_vals[tid_g * WPT + 11u] = values[11]; smem_keys[tid_g * WPT + 12u] = keys[12]; smem_vals[tid_g * WPT + 12u] = values[12]; smem_keys[tid_g * WPT + 13u] = keys[13]; smem_vals[tid_g * WPT + 13u] = values[13]; smem_keys[tid_g * WPT + 14u] = keys[14]; smem_vals[tid_g * WPT + 14u] = values[14]; smem_keys[tid_g * WPT + 15u] = keys[15]; smem_vals[tid_g * WPT + 15u] = values[15]; workgroupBarrier(); let tmp_1624 = extractBits(local_tid, 5u, 1u) != 0u; let tmp_1625 = seg_base + (local_tid ^ 32u); let tmp_1626 = smem_keys[tmp_1625 * WPT + 0u]; let tmp_1627 = smem_vals[tmp_1625 * WPT + 0u]; let tmp_1628 = keys[0] < tmp_1626 || (keys[0] == tmp_1626 && values[0] < tmp_1627); if tmp_1624 == tmp_1628 { keys[0] = tmp_1626; values[0] = tmp_1627; } let tmp_1629 = smem_keys[tmp_1625 * WPT + 1u]; let tmp_1630 = smem_vals[tmp_1625 * WPT + 1u]; let tmp_1631 = keys[1] < tmp_1629 || (keys[1] == tmp_1629 && values[1] < tmp_1630); if tmp_1624 == tmp_1631 { keys[1] = tmp_1629; values[1] = tmp_1630; } let tmp_1632 = smem_keys[tmp_1625 * WPT + 2u]; let tmp_1633 = smem_vals[tmp_1625 * WPT + 2u]; let tmp_1634 = keys[2] < tmp_1632 || (keys[2] == tmp_1632 && values[2] < tmp_1633); if tmp_1624 == tmp_1634 { keys[2] = tmp_1632; values[2] = tmp_1633; } let tmp_1635 = smem_keys[tmp_1625 * WPT + 3u]; let tmp_1636 = smem_vals[tmp_1625 * WPT + 3u]; let tmp_1637 = keys[3] < tmp_1635 || (keys[3] == tmp_1635 && values[3] < tmp_1636); if tmp_1624 == tmp_1637 { keys[3] = tmp_1635; values[3] = tmp_1636; } let tmp_1638 = smem_keys[tmp_1625 * WPT + 4u]; let tmp_1639 = smem_vals[tmp_1625 * WPT + 4u]; let tmp_1640 = keys[4] < tmp_1638 || (keys[4] == tmp_1638 && values[4] < tmp_1639); if tmp_1624 == tmp_1640 { keys[4] = tmp_1638; values[4] = tmp_1639; } let tmp_1641 = smem_keys[tmp_1625 * WPT + 5u]; let tmp_1642 = smem_vals[tmp_1625 * WPT + 5u]; let tmp_1643 = keys[5] < tmp_1641 || (keys[5] == tmp_1641 && values[5] < tmp_1642); if tmp_1624 == tmp_1643 { keys[5] = tmp_1641; values[5] = tmp_1642; } let tmp_1644 = smem_keys[tmp_1625 * WPT + 6u]; let tmp_1645 = smem_vals[tmp_1625 * WPT + 6u]; let tmp_1646 = keys[6] < tmp_1644 || (keys[6] == tmp_1644 && values[6] < tmp_1645); if tmp_1624 == tmp_1646 { keys[6] = tmp_1644; values[6] = tmp_1645; } let tmp_1647 = smem_keys[tmp_1625 * WPT + 7u]; let tmp_1648 = smem_vals[tmp_1625 * WPT + 7u]; let tmp_1649 = keys[7] < tmp_1647 || (keys[7] == tmp_1647 && values[7] < tmp_1648); if tmp_1624 == tmp_1649 { keys[7] = tmp_1647; values[7] = tmp_1648; } let tmp_1650 = smem_keys[tmp_1625 * WPT + 8u]; let tmp_1651 = smem_vals[tmp_1625 * WPT + 8u]; let tmp_1652 = keys[8] < tmp_1650 || (keys[8] == tmp_1650 && values[8] < tmp_1651); if tmp_1624 == tmp_1652 { keys[8] = tmp_1650; values[8] = tmp_1651; } let tmp_1653 = smem_keys[tmp_1625 * WPT + 9u]; let tmp_1654 = smem_vals[tmp_1625 * WPT + 9u]; let tmp_1655 = keys[9] < tmp_1653 || (keys[9] == tmp_1653 && values[9] < tmp_1654); if tmp_1624 == tmp_1655 { keys[9] = tmp_1653; values[9] = tmp_1654; } let tmp_1656 = smem_keys[tmp_1625 * WPT + 10u]; let tmp_1657 = smem_vals[tmp_1625 * WPT + 10u]; let tmp_1658 = keys[10] < tmp_1656 || (keys[10] == tmp_1656 && values[10] < tmp_1657); if tmp_1624 == tmp_1658 { keys[10] = tmp_1656; values[10] = tmp_1657; } let tmp_1659 = smem_keys[tmp_1625 * WPT + 11u]; let tmp_1660 = smem_vals[tmp_1625 * WPT + 11u]; let tmp_1661 = keys[11] < tmp_1659 || (keys[11] == tmp_1659 && values[11] < tmp_1660); if tmp_1624 == tmp_1661 { keys[11] = tmp_1659; values[11] = tmp_1660; } let tmp_1662 = smem_keys[tmp_1625 * WPT + 12u]; let tmp_1663 = smem_vals[tmp_1625 * WPT + 12u]; let tmp_1664 = keys[12] < tmp_1662 || (keys[12] == tmp_1662 && values[12] < tmp_1663); if tmp_1624 == tmp_1664 { keys[12] = tmp_1662; values[12] = tmp_1663; } let tmp_1665 = smem_keys[tmp_1625 * WPT + 13u]; let tmp_1666 = smem_vals[tmp_1625 * WPT + 13u]; let tmp_1667 = keys[13] < tmp_1665 || (keys[13] == tmp_1665 && values[13] < tmp_1666); if tmp_1624 == tmp_1667 { keys[13] = tmp_1665; values[13] = tmp_1666; } let tmp_1668 = smem_keys[tmp_1625 * WPT + 14u]; let tmp_1669 = smem_vals[tmp_1625 * WPT + 14u]; let tmp_1670 = keys[14] < tmp_1668 || (keys[14] == tmp_1668 && values[14] < tmp_1669); if tmp_1624 == tmp_1670 { keys[14] = tmp_1668; values[14] = tmp_1669; } let tmp_1671 = smem_keys[tmp_1625 * WPT + 15u]; let tmp_1672 = smem_vals[tmp_1625 * WPT + 15u]; let tmp_1673 = keys[15] < tmp_1671 || (keys[15] == tmp_1671 && values[15] < tmp_1672); if tmp_1624 == tmp_1673 { keys[15] = tmp_1671; values[15] = tmp_1672; } workgroupBarrier(); }
    // exch_paral(tmask:16,swbit:4,wpt:16) 
    {
    let tmp_1674 = subgroupShuffleXor(keys[0], 16u);
    let tmp_1675 = subgroupShuffleXor(values[0], 16u);
    let tmp_1676 = subgroupShuffleXor(keys[1], 16u);
    let tmp_1677 = subgroupShuffleXor(values[1], 16u);
    let tmp_1678 = subgroupShuffleXor(keys[2], 16u);
    let tmp_1679 = subgroupShuffleXor(values[2], 16u);
    let tmp_1680 = subgroupShuffleXor(keys[3], 16u);
    let tmp_1681 = subgroupShuffleXor(values[3], 16u);
    let tmp_1682 = subgroupShuffleXor(keys[4], 16u);
    let tmp_1683 = subgroupShuffleXor(values[4], 16u);
    let tmp_1684 = subgroupShuffleXor(keys[5], 16u);
    let tmp_1685 = subgroupShuffleXor(values[5], 16u);
    let tmp_1686 = subgroupShuffleXor(keys[6], 16u);
    let tmp_1687 = subgroupShuffleXor(values[6], 16u);
    let tmp_1688 = subgroupShuffleXor(keys[7], 16u);
    let tmp_1689 = subgroupShuffleXor(values[7], 16u);
    let tmp_1690 = subgroupShuffleXor(keys[8], 16u);
    let tmp_1691 = subgroupShuffleXor(values[8], 16u);
    let tmp_1692 = subgroupShuffleXor(keys[9], 16u);
    let tmp_1693 = subgroupShuffleXor(values[9], 16u);
    let tmp_1694 = subgroupShuffleXor(keys[10], 16u);
    let tmp_1695 = subgroupShuffleXor(values[10], 16u);
    let tmp_1696 = subgroupShuffleXor(keys[11], 16u);
    let tmp_1697 = subgroupShuffleXor(values[11], 16u);
    let tmp_1698 = subgroupShuffleXor(keys[12], 16u);
    let tmp_1699 = subgroupShuffleXor(values[12], 16u);
    let tmp_1700 = subgroupShuffleXor(keys[13], 16u);
    let tmp_1701 = subgroupShuffleXor(values[13], 16u);
    let tmp_1702 = subgroupShuffleXor(keys[14], 16u);
    let tmp_1703 = subgroupShuffleXor(values[14], 16u);
    let tmp_1704 = subgroupShuffleXor(keys[15], 16u);
    let tmp_1705 = subgroupShuffleXor(values[15], 16u);
    let tmp_1706 = extractBits(local_tid, 4u, 1u) != 0u;
    let tmp_1707 = keys[0] < tmp_1674 || (keys[0] == tmp_1674 && values[0] < tmp_1675);
    if tmp_1706 == tmp_1707 { keys[0] = tmp_1674; values[0] = tmp_1675; }
    let tmp_1708 = keys[1] < tmp_1676 || (keys[1] == tmp_1676 && values[1] < tmp_1677);
    if tmp_1706 == tmp_1708 { keys[1] = tmp_1676; values[1] = tmp_1677; }
    let tmp_1709 = keys[2] < tmp_1678 || (keys[2] == tmp_1678 && values[2] < tmp_1679);
    if tmp_1706 == tmp_1709 { keys[2] = tmp_1678; values[2] = tmp_1679; }
    let tmp_1710 = keys[3] < tmp_1680 || (keys[3] == tmp_1680 && values[3] < tmp_1681);
    if tmp_1706 == tmp_1710 { keys[3] = tmp_1680; values[3] = tmp_1681; }
    let tmp_1711 = keys[4] < tmp_1682 || (keys[4] == tmp_1682 && values[4] < tmp_1683);
    if tmp_1706 == tmp_1711 { keys[4] = tmp_1682; values[4] = tmp_1683; }
    let tmp_1712 = keys[5] < tmp_1684 || (keys[5] == tmp_1684 && values[5] < tmp_1685);
    if tmp_1706 == tmp_1712 { keys[5] = tmp_1684; values[5] = tmp_1685; }
    let tmp_1713 = keys[6] < tmp_1686 || (keys[6] == tmp_1686 && values[6] < tmp_1687);
    if tmp_1706 == tmp_1713 { keys[6] = tmp_1686; values[6] = tmp_1687; }
    let tmp_1714 = keys[7] < tmp_1688 || (keys[7] == tmp_1688 && values[7] < tmp_1689);
    if tmp_1706 == tmp_1714 { keys[7] = tmp_1688; values[7] = tmp_1689; }
    let tmp_1715 = keys[8] < tmp_1690 || (keys[8] == tmp_1690 && values[8] < tmp_1691);
    if tmp_1706 == tmp_1715 { keys[8] = tmp_1690; values[8] = tmp_1691; }
    let tmp_1716 = keys[9] < tmp_1692 || (keys[9] == tmp_1692 && values[9] < tmp_1693);
    if tmp_1706 == tmp_1716 { keys[9] = tmp_1692; values[9] = tmp_1693; }
    let tmp_1717 = keys[10] < tmp_1694 || (keys[10] == tmp_1694 && values[10] < tmp_1695);
    if tmp_1706 == tmp_1717 { keys[10] = tmp_1694; values[10] = tmp_1695; }
    let tmp_1718 = keys[11] < tmp_1696 || (keys[11] == tmp_1696 && values[11] < tmp_1697);
    if tmp_1706 == tmp_1718 { keys[11] = tmp_1696; values[11] = tmp_1697; }
    let tmp_1719 = keys[12] < tmp_1698 || (keys[12] == tmp_1698 && values[12] < tmp_1699);
    if tmp_1706 == tmp_1719 { keys[12] = tmp_1698; values[12] = tmp_1699; }
    let tmp_1720 = keys[13] < tmp_1700 || (keys[13] == tmp_1700 && values[13] < tmp_1701);
    if tmp_1706 == tmp_1720 { keys[13] = tmp_1700; values[13] = tmp_1701; }
    let tmp_1721 = keys[14] < tmp_1702 || (keys[14] == tmp_1702 && values[14] < tmp_1703);
    if tmp_1706 == tmp_1721 { keys[14] = tmp_1702; values[14] = tmp_1703; }
    let tmp_1722 = keys[15] < tmp_1704 || (keys[15] == tmp_1704 && values[15] < tmp_1705);
    if tmp_1706 == tmp_1722 { keys[15] = tmp_1704; values[15] = tmp_1705; }
    }
    // exch_paral(tmask:8,swbit:3,wpt:16) 
    {
    let tmp_1723 = subgroupShuffleXor(keys[0], 8u);
    let tmp_1724 = subgroupShuffleXor(values[0], 8u);
    let tmp_1725 = subgroupShuffleXor(keys[1], 8u);
    let tmp_1726 = subgroupShuffleXor(values[1], 8u);
    let tmp_1727 = subgroupShuffleXor(keys[2], 8u);
    let tmp_1728 = subgroupShuffleXor(values[2], 8u);
    let tmp_1729 = subgroupShuffleXor(keys[3], 8u);
    let tmp_1730 = subgroupShuffleXor(values[3], 8u);
    let tmp_1731 = subgroupShuffleXor(keys[4], 8u);
    let tmp_1732 = subgroupShuffleXor(values[4], 8u);
    let tmp_1733 = subgroupShuffleXor(keys[5], 8u);
    let tmp_1734 = subgroupShuffleXor(values[5], 8u);
    let tmp_1735 = subgroupShuffleXor(keys[6], 8u);
    let tmp_1736 = subgroupShuffleXor(values[6], 8u);
    let tmp_1737 = subgroupShuffleXor(keys[7], 8u);
    let tmp_1738 = subgroupShuffleXor(values[7], 8u);
    let tmp_1739 = subgroupShuffleXor(keys[8], 8u);
    let tmp_1740 = subgroupShuffleXor(values[8], 8u);
    let tmp_1741 = subgroupShuffleXor(keys[9], 8u);
    let tmp_1742 = subgroupShuffleXor(values[9], 8u);
    let tmp_1743 = subgroupShuffleXor(keys[10], 8u);
    let tmp_1744 = subgroupShuffleXor(values[10], 8u);
    let tmp_1745 = subgroupShuffleXor(keys[11], 8u);
    let tmp_1746 = subgroupShuffleXor(values[11], 8u);
    let tmp_1747 = subgroupShuffleXor(keys[12], 8u);
    let tmp_1748 = subgroupShuffleXor(values[12], 8u);
    let tmp_1749 = subgroupShuffleXor(keys[13], 8u);
    let tmp_1750 = subgroupShuffleXor(values[13], 8u);
    let tmp_1751 = subgroupShuffleXor(keys[14], 8u);
    let tmp_1752 = subgroupShuffleXor(values[14], 8u);
    let tmp_1753 = subgroupShuffleXor(keys[15], 8u);
    let tmp_1754 = subgroupShuffleXor(values[15], 8u);
    let tmp_1755 = extractBits(local_tid, 3u, 1u) != 0u;
    let tmp_1756 = keys[0] < tmp_1723 || (keys[0] == tmp_1723 && values[0] < tmp_1724);
    if tmp_1755 == tmp_1756 { keys[0] = tmp_1723; values[0] = tmp_1724; }
    let tmp_1757 = keys[1] < tmp_1725 || (keys[1] == tmp_1725 && values[1] < tmp_1726);
    if tmp_1755 == tmp_1757 { keys[1] = tmp_1725; values[1] = tmp_1726; }
    let tmp_1758 = keys[2] < tmp_1727 || (keys[2] == tmp_1727 && values[2] < tmp_1728);
    if tmp_1755 == tmp_1758 { keys[2] = tmp_1727; values[2] = tmp_1728; }
    let tmp_1759 = keys[3] < tmp_1729 || (keys[3] == tmp_1729 && values[3] < tmp_1730);
    if tmp_1755 == tmp_1759 { keys[3] = tmp_1729; values[3] = tmp_1730; }
    let tmp_1760 = keys[4] < tmp_1731 || (keys[4] == tmp_1731 && values[4] < tmp_1732);
    if tmp_1755 == tmp_1760 { keys[4] = tmp_1731; values[4] = tmp_1732; }
    let tmp_1761 = keys[5] < tmp_1733 || (keys[5] == tmp_1733 && values[5] < tmp_1734);
    if tmp_1755 == tmp_1761 { keys[5] = tmp_1733; values[5] = tmp_1734; }
    let tmp_1762 = keys[6] < tmp_1735 || (keys[6] == tmp_1735 && values[6] < tmp_1736);
    if tmp_1755 == tmp_1762 { keys[6] = tmp_1735; values[6] = tmp_1736; }
    let tmp_1763 = keys[7] < tmp_1737 || (keys[7] == tmp_1737 && values[7] < tmp_1738);
    if tmp_1755 == tmp_1763 { keys[7] = tmp_1737; values[7] = tmp_1738; }
    let tmp_1764 = keys[8] < tmp_1739 || (keys[8] == tmp_1739 && values[8] < tmp_1740);
    if tmp_1755 == tmp_1764 { keys[8] = tmp_1739; values[8] = tmp_1740; }
    let tmp_1765 = keys[9] < tmp_1741 || (keys[9] == tmp_1741 && values[9] < tmp_1742);
    if tmp_1755 == tmp_1765 { keys[9] = tmp_1741; values[9] = tmp_1742; }
    let tmp_1766 = keys[10] < tmp_1743 || (keys[10] == tmp_1743 && values[10] < tmp_1744);
    if tmp_1755 == tmp_1766 { keys[10] = tmp_1743; values[10] = tmp_1744; }
    let tmp_1767 = keys[11] < tmp_1745 || (keys[11] == tmp_1745 && values[11] < tmp_1746);
    if tmp_1755 == tmp_1767 { keys[11] = tmp_1745; values[11] = tmp_1746; }
    let tmp_1768 = keys[12] < tmp_1747 || (keys[12] == tmp_1747 && values[12] < tmp_1748);
    if tmp_1755 == tmp_1768 { keys[12] = tmp_1747; values[12] = tmp_1748; }
    let tmp_1769 = keys[13] < tmp_1749 || (keys[13] == tmp_1749 && values[13] < tmp_1750);
    if tmp_1755 == tmp_1769 { keys[13] = tmp_1749; values[13] = tmp_1750; }
    let tmp_1770 = keys[14] < tmp_1751 || (keys[14] == tmp_1751 && values[14] < tmp_1752);
    if tmp_1755 == tmp_1770 { keys[14] = tmp_1751; values[14] = tmp_1752; }
    let tmp_1771 = keys[15] < tmp_1753 || (keys[15] == tmp_1753 && values[15] < tmp_1754);
    if tmp_1755 == tmp_1771 { keys[15] = tmp_1753; values[15] = tmp_1754; }
    }
    // exch_paral(tmask:4,swbit:2,wpt:16) 
    {
    let tmp_1772 = subgroupShuffleXor(keys[0], 4u);
    let tmp_1773 = subgroupShuffleXor(values[0], 4u);
    let tmp_1774 = subgroupShuffleXor(keys[1], 4u);
    let tmp_1775 = subgroupShuffleXor(values[1], 4u);
    let tmp_1776 = subgroupShuffleXor(keys[2], 4u);
    let tmp_1777 = subgroupShuffleXor(values[2], 4u);
    let tmp_1778 = subgroupShuffleXor(keys[3], 4u);
    let tmp_1779 = subgroupShuffleXor(values[3], 4u);
    let tmp_1780 = subgroupShuffleXor(keys[4], 4u);
    let tmp_1781 = subgroupShuffleXor(values[4], 4u);
    let tmp_1782 = subgroupShuffleXor(keys[5], 4u);
    let tmp_1783 = subgroupShuffleXor(values[5], 4u);
    let tmp_1784 = subgroupShuffleXor(keys[6], 4u);
    let tmp_1785 = subgroupShuffleXor(values[6], 4u);
    let tmp_1786 = subgroupShuffleXor(keys[7], 4u);
    let tmp_1787 = subgroupShuffleXor(values[7], 4u);
    let tmp_1788 = subgroupShuffleXor(keys[8], 4u);
    let tmp_1789 = subgroupShuffleXor(values[8], 4u);
    let tmp_1790 = subgroupShuffleXor(keys[9], 4u);
    let tmp_1791 = subgroupShuffleXor(values[9], 4u);
    let tmp_1792 = subgroupShuffleXor(keys[10], 4u);
    let tmp_1793 = subgroupShuffleXor(values[10], 4u);
    let tmp_1794 = subgroupShuffleXor(keys[11], 4u);
    let tmp_1795 = subgroupShuffleXor(values[11], 4u);
    let tmp_1796 = subgroupShuffleXor(keys[12], 4u);
    let tmp_1797 = subgroupShuffleXor(values[12], 4u);
    let tmp_1798 = subgroupShuffleXor(keys[13], 4u);
    let tmp_1799 = subgroupShuffleXor(values[13], 4u);
    let tmp_1800 = subgroupShuffleXor(keys[14], 4u);
    let tmp_1801 = subgroupShuffleXor(values[14], 4u);
    let tmp_1802 = subgroupShuffleXor(keys[15], 4u);
    let tmp_1803 = subgroupShuffleXor(values[15], 4u);
    let tmp_1804 = extractBits(local_tid, 2u, 1u) != 0u;
    let tmp_1805 = keys[0] < tmp_1772 || (keys[0] == tmp_1772 && values[0] < tmp_1773);
    if tmp_1804 == tmp_1805 { keys[0] = tmp_1772; values[0] = tmp_1773; }
    let tmp_1806 = keys[1] < tmp_1774 || (keys[1] == tmp_1774 && values[1] < tmp_1775);
    if tmp_1804 == tmp_1806 { keys[1] = tmp_1774; values[1] = tmp_1775; }
    let tmp_1807 = keys[2] < tmp_1776 || (keys[2] == tmp_1776 && values[2] < tmp_1777);
    if tmp_1804 == tmp_1807 { keys[2] = tmp_1776; values[2] = tmp_1777; }
    let tmp_1808 = keys[3] < tmp_1778 || (keys[3] == tmp_1778 && values[3] < tmp_1779);
    if tmp_1804 == tmp_1808 { keys[3] = tmp_1778; values[3] = tmp_1779; }
    let tmp_1809 = keys[4] < tmp_1780 || (keys[4] == tmp_1780 && values[4] < tmp_1781);
    if tmp_1804 == tmp_1809 { keys[4] = tmp_1780; values[4] = tmp_1781; }
    let tmp_1810 = keys[5] < tmp_1782 || (keys[5] == tmp_1782 && values[5] < tmp_1783);
    if tmp_1804 == tmp_1810 { keys[5] = tmp_1782; values[5] = tmp_1783; }
    let tmp_1811 = keys[6] < tmp_1784 || (keys[6] == tmp_1784 && values[6] < tmp_1785);
    if tmp_1804 == tmp_1811 { keys[6] = tmp_1784; values[6] = tmp_1785; }
    let tmp_1812 = keys[7] < tmp_1786 || (keys[7] == tmp_1786 && values[7] < tmp_1787);
    if tmp_1804 == tmp_1812 { keys[7] = tmp_1786; values[7] = tmp_1787; }
    let tmp_1813 = keys[8] < tmp_1788 || (keys[8] == tmp_1788 && values[8] < tmp_1789);
    if tmp_1804 == tmp_1813 { keys[8] = tmp_1788; values[8] = tmp_1789; }
    let tmp_1814 = keys[9] < tmp_1790 || (keys[9] == tmp_1790 && values[9] < tmp_1791);
    if tmp_1804 == tmp_1814 { keys[9] = tmp_1790; values[9] = tmp_1791; }
    let tmp_1815 = keys[10] < tmp_1792 || (keys[10] == tmp_1792 && values[10] < tmp_1793);
    if tmp_1804 == tmp_1815 { keys[10] = tmp_1792; values[10] = tmp_1793; }
    let tmp_1816 = keys[11] < tmp_1794 || (keys[11] == tmp_1794 && values[11] < tmp_1795);
    if tmp_1804 == tmp_1816 { keys[11] = tmp_1794; values[11] = tmp_1795; }
    let tmp_1817 = keys[12] < tmp_1796 || (keys[12] == tmp_1796 && values[12] < tmp_1797);
    if tmp_1804 == tmp_1817 { keys[12] = tmp_1796; values[12] = tmp_1797; }
    let tmp_1818 = keys[13] < tmp_1798 || (keys[13] == tmp_1798 && values[13] < tmp_1799);
    if tmp_1804 == tmp_1818 { keys[13] = tmp_1798; values[13] = tmp_1799; }
    let tmp_1819 = keys[14] < tmp_1800 || (keys[14] == tmp_1800 && values[14] < tmp_1801);
    if tmp_1804 == tmp_1819 { keys[14] = tmp_1800; values[14] = tmp_1801; }
    let tmp_1820 = keys[15] < tmp_1802 || (keys[15] == tmp_1802 && values[15] < tmp_1803);
    if tmp_1804 == tmp_1820 { keys[15] = tmp_1802; values[15] = tmp_1803; }
    }
    // exch_paral(tmask:2,swbit:1,wpt:16) 
    {
    let tmp_1821 = subgroupShuffleXor(keys[0], 2u);
    let tmp_1822 = subgroupShuffleXor(values[0], 2u);
    let tmp_1823 = subgroupShuffleXor(keys[1], 2u);
    let tmp_1824 = subgroupShuffleXor(values[1], 2u);
    let tmp_1825 = subgroupShuffleXor(keys[2], 2u);
    let tmp_1826 = subgroupShuffleXor(values[2], 2u);
    let tmp_1827 = subgroupShuffleXor(keys[3], 2u);
    let tmp_1828 = subgroupShuffleXor(values[3], 2u);
    let tmp_1829 = subgroupShuffleXor(keys[4], 2u);
    let tmp_1830 = subgroupShuffleXor(values[4], 2u);
    let tmp_1831 = subgroupShuffleXor(keys[5], 2u);
    let tmp_1832 = subgroupShuffleXor(values[5], 2u);
    let tmp_1833 = subgroupShuffleXor(keys[6], 2u);
    let tmp_1834 = subgroupShuffleXor(values[6], 2u);
    let tmp_1835 = subgroupShuffleXor(keys[7], 2u);
    let tmp_1836 = subgroupShuffleXor(values[7], 2u);
    let tmp_1837 = subgroupShuffleXor(keys[8], 2u);
    let tmp_1838 = subgroupShuffleXor(values[8], 2u);
    let tmp_1839 = subgroupShuffleXor(keys[9], 2u);
    let tmp_1840 = subgroupShuffleXor(values[9], 2u);
    let tmp_1841 = subgroupShuffleXor(keys[10], 2u);
    let tmp_1842 = subgroupShuffleXor(values[10], 2u);
    let tmp_1843 = subgroupShuffleXor(keys[11], 2u);
    let tmp_1844 = subgroupShuffleXor(values[11], 2u);
    let tmp_1845 = subgroupShuffleXor(keys[12], 2u);
    let tmp_1846 = subgroupShuffleXor(values[12], 2u);
    let tmp_1847 = subgroupShuffleXor(keys[13], 2u);
    let tmp_1848 = subgroupShuffleXor(values[13], 2u);
    let tmp_1849 = subgroupShuffleXor(keys[14], 2u);
    let tmp_1850 = subgroupShuffleXor(values[14], 2u);
    let tmp_1851 = subgroupShuffleXor(keys[15], 2u);
    let tmp_1852 = subgroupShuffleXor(values[15], 2u);
    let tmp_1853 = extractBits(local_tid, 1u, 1u) != 0u;
    let tmp_1854 = keys[0] < tmp_1821 || (keys[0] == tmp_1821 && values[0] < tmp_1822);
    if tmp_1853 == tmp_1854 { keys[0] = tmp_1821; values[0] = tmp_1822; }
    let tmp_1855 = keys[1] < tmp_1823 || (keys[1] == tmp_1823 && values[1] < tmp_1824);
    if tmp_1853 == tmp_1855 { keys[1] = tmp_1823; values[1] = tmp_1824; }
    let tmp_1856 = keys[2] < tmp_1825 || (keys[2] == tmp_1825 && values[2] < tmp_1826);
    if tmp_1853 == tmp_1856 { keys[2] = tmp_1825; values[2] = tmp_1826; }
    let tmp_1857 = keys[3] < tmp_1827 || (keys[3] == tmp_1827 && values[3] < tmp_1828);
    if tmp_1853 == tmp_1857 { keys[3] = tmp_1827; values[3] = tmp_1828; }
    let tmp_1858 = keys[4] < tmp_1829 || (keys[4] == tmp_1829 && values[4] < tmp_1830);
    if tmp_1853 == tmp_1858 { keys[4] = tmp_1829; values[4] = tmp_1830; }
    let tmp_1859 = keys[5] < tmp_1831 || (keys[5] == tmp_1831 && values[5] < tmp_1832);
    if tmp_1853 == tmp_1859 { keys[5] = tmp_1831; values[5] = tmp_1832; }
    let tmp_1860 = keys[6] < tmp_1833 || (keys[6] == tmp_1833 && values[6] < tmp_1834);
    if tmp_1853 == tmp_1860 { keys[6] = tmp_1833; values[6] = tmp_1834; }
    let tmp_1861 = keys[7] < tmp_1835 || (keys[7] == tmp_1835 && values[7] < tmp_1836);
    if tmp_1853 == tmp_1861 { keys[7] = tmp_1835; values[7] = tmp_1836; }
    let tmp_1862 = keys[8] < tmp_1837 || (keys[8] == tmp_1837 && values[8] < tmp_1838);
    if tmp_1853 == tmp_1862 { keys[8] = tmp_1837; values[8] = tmp_1838; }
    let tmp_1863 = keys[9] < tmp_1839 || (keys[9] == tmp_1839 && values[9] < tmp_1840);
    if tmp_1853 == tmp_1863 { keys[9] = tmp_1839; values[9] = tmp_1840; }
    let tmp_1864 = keys[10] < tmp_1841 || (keys[10] == tmp_1841 && values[10] < tmp_1842);
    if tmp_1853 == tmp_1864 { keys[10] = tmp_1841; values[10] = tmp_1842; }
    let tmp_1865 = keys[11] < tmp_1843 || (keys[11] == tmp_1843 && values[11] < tmp_1844);
    if tmp_1853 == tmp_1865 { keys[11] = tmp_1843; values[11] = tmp_1844; }
    let tmp_1866 = keys[12] < tmp_1845 || (keys[12] == tmp_1845 && values[12] < tmp_1846);
    if tmp_1853 == tmp_1866 { keys[12] = tmp_1845; values[12] = tmp_1846; }
    let tmp_1867 = keys[13] < tmp_1847 || (keys[13] == tmp_1847 && values[13] < tmp_1848);
    if tmp_1853 == tmp_1867 { keys[13] = tmp_1847; values[13] = tmp_1848; }
    let tmp_1868 = keys[14] < tmp_1849 || (keys[14] == tmp_1849 && values[14] < tmp_1850);
    if tmp_1853 == tmp_1868 { keys[14] = tmp_1849; values[14] = tmp_1850; }
    let tmp_1869 = keys[15] < tmp_1851 || (keys[15] == tmp_1851 && values[15] < tmp_1852);
    if tmp_1853 == tmp_1869 { keys[15] = tmp_1851; values[15] = tmp_1852; }
    }
    // exch_paral(tmask:1,swbit:0,wpt:16) 
    {
    let tmp_1870 = subgroupShuffleXor(keys[0], 1u);
    let tmp_1871 = subgroupShuffleXor(values[0], 1u);
    let tmp_1872 = subgroupShuffleXor(keys[1], 1u);
    let tmp_1873 = subgroupShuffleXor(values[1], 1u);
    let tmp_1874 = subgroupShuffleXor(keys[2], 1u);
    let tmp_1875 = subgroupShuffleXor(values[2], 1u);
    let tmp_1876 = subgroupShuffleXor(keys[3], 1u);
    let tmp_1877 = subgroupShuffleXor(values[3], 1u);
    let tmp_1878 = subgroupShuffleXor(keys[4], 1u);
    let tmp_1879 = subgroupShuffleXor(values[4], 1u);
    let tmp_1880 = subgroupShuffleXor(keys[5], 1u);
    let tmp_1881 = subgroupShuffleXor(values[5], 1u);
    let tmp_1882 = subgroupShuffleXor(keys[6], 1u);
    let tmp_1883 = subgroupShuffleXor(values[6], 1u);
    let tmp_1884 = subgroupShuffleXor(keys[7], 1u);
    let tmp_1885 = subgroupShuffleXor(values[7], 1u);
    let tmp_1886 = subgroupShuffleXor(keys[8], 1u);
    let tmp_1887 = subgroupShuffleXor(values[8], 1u);
    let tmp_1888 = subgroupShuffleXor(keys[9], 1u);
    let tmp_1889 = subgroupShuffleXor(values[9], 1u);
    let tmp_1890 = subgroupShuffleXor(keys[10], 1u);
    let tmp_1891 = subgroupShuffleXor(values[10], 1u);
    let tmp_1892 = subgroupShuffleXor(keys[11], 1u);
    let tmp_1893 = subgroupShuffleXor(values[11], 1u);
    let tmp_1894 = subgroupShuffleXor(keys[12], 1u);
    let tmp_1895 = subgroupShuffleXor(values[12], 1u);
    let tmp_1896 = subgroupShuffleXor(keys[13], 1u);
    let tmp_1897 = subgroupShuffleXor(values[13], 1u);
    let tmp_1898 = subgroupShuffleXor(keys[14], 1u);
    let tmp_1899 = subgroupShuffleXor(values[14], 1u);
    let tmp_1900 = subgroupShuffleXor(keys[15], 1u);
    let tmp_1901 = subgroupShuffleXor(values[15], 1u);
    let tmp_1902 = extractBits(local_tid, 0u, 1u) != 0u;
    let tmp_1903 = keys[0] < tmp_1870 || (keys[0] == tmp_1870 && values[0] < tmp_1871);
    if tmp_1902 == tmp_1903 { keys[0] = tmp_1870; values[0] = tmp_1871; }
    let tmp_1904 = keys[1] < tmp_1872 || (keys[1] == tmp_1872 && values[1] < tmp_1873);
    if tmp_1902 == tmp_1904 { keys[1] = tmp_1872; values[1] = tmp_1873; }
    let tmp_1905 = keys[2] < tmp_1874 || (keys[2] == tmp_1874 && values[2] < tmp_1875);
    if tmp_1902 == tmp_1905 { keys[2] = tmp_1874; values[2] = tmp_1875; }
    let tmp_1906 = keys[3] < tmp_1876 || (keys[3] == tmp_1876 && values[3] < tmp_1877);
    if tmp_1902 == tmp_1906 { keys[3] = tmp_1876; values[3] = tmp_1877; }
    let tmp_1907 = keys[4] < tmp_1878 || (keys[4] == tmp_1878 && values[4] < tmp_1879);
    if tmp_1902 == tmp_1907 { keys[4] = tmp_1878; values[4] = tmp_1879; }
    let tmp_1908 = keys[5] < tmp_1880 || (keys[5] == tmp_1880 && values[5] < tmp_1881);
    if tmp_1902 == tmp_1908 { keys[5] = tmp_1880; values[5] = tmp_1881; }
    let tmp_1909 = keys[6] < tmp_1882 || (keys[6] == tmp_1882 && values[6] < tmp_1883);
    if tmp_1902 == tmp_1909 { keys[6] = tmp_1882; values[6] = tmp_1883; }
    let tmp_1910 = keys[7] < tmp_1884 || (keys[7] == tmp_1884 && values[7] < tmp_1885);
    if tmp_1902 == tmp_1910 { keys[7] = tmp_1884; values[7] = tmp_1885; }
    let tmp_1911 = keys[8] < tmp_1886 || (keys[8] == tmp_1886 && values[8] < tmp_1887);
    if tmp_1902 == tmp_1911 { keys[8] = tmp_1886; values[8] = tmp_1887; }
    let tmp_1912 = keys[9] < tmp_1888 || (keys[9] == tmp_1888 && values[9] < tmp_1889);
    if tmp_1902 == tmp_1912 { keys[9] = tmp_1888; values[9] = tmp_1889; }
    let tmp_1913 = keys[10] < tmp_1890 || (keys[10] == tmp_1890 && values[10] < tmp_1891);
    if tmp_1902 == tmp_1913 { keys[10] = tmp_1890; values[10] = tmp_1891; }
    let tmp_1914 = keys[11] < tmp_1892 || (keys[11] == tmp_1892 && values[11] < tmp_1893);
    if tmp_1902 == tmp_1914 { keys[11] = tmp_1892; values[11] = tmp_1893; }
    let tmp_1915 = keys[12] < tmp_1894 || (keys[12] == tmp_1894 && values[12] < tmp_1895);
    if tmp_1902 == tmp_1915 { keys[12] = tmp_1894; values[12] = tmp_1895; }
    let tmp_1916 = keys[13] < tmp_1896 || (keys[13] == tmp_1896 && values[13] < tmp_1897);
    if tmp_1902 == tmp_1916 { keys[13] = tmp_1896; values[13] = tmp_1897; }
    let tmp_1917 = keys[14] < tmp_1898 || (keys[14] == tmp_1898 && values[14] < tmp_1899);
    if tmp_1902 == tmp_1917 { keys[14] = tmp_1898; values[14] = tmp_1899; }
    let tmp_1918 = keys[15] < tmp_1900 || (keys[15] == tmp_1900 && values[15] < tmp_1901);
    if tmp_1902 == tmp_1918 { keys[15] = tmp_1900; values[15] = tmp_1901; }
    }
    // exch_local(8,16) 
    // cmp_swap(0,8)
    if keys[0] > keys[8] || (keys[0] == keys[8] && values[0] > values[8]) {
    // swap(0,8) 
    { let tmp_1919 = keys[0]; keys[0] = keys[8]; keys[8] = tmp_1919;let tmp_1920 = values[0]; values[0] = values[8]; values[8] = tmp_1920; }
    }
    // cmp_swap(1,9)
    if keys[1] > keys[9] || (keys[1] == keys[9] && values[1] > values[9]) {
    // swap(1,9) 
    { let tmp_1921 = keys[1]; keys[1] = keys[9]; keys[9] = tmp_1921;let tmp_1922 = values[1]; values[1] = values[9]; values[9] = tmp_1922; }
    }
    // cmp_swap(2,10)
    if keys[2] > keys[10] || (keys[2] == keys[10] && values[2] > values[10]) {
    // swap(2,10) 
    { let tmp_1923 = keys[2]; keys[2] = keys[10]; keys[10] = tmp_1923;let tmp_1924 = values[2]; values[2] = values[10]; values[10] = tmp_1924; }
    }
    // cmp_swap(3,11)
    if keys[3] > keys[11] || (keys[3] == keys[11] && values[3] > values[11]) {
    // swap(3,11) 
    { let tmp_1925 = keys[3]; keys[3] = keys[11]; keys[11] = tmp_1925;let tmp_1926 = values[3]; values[3] = values[11]; values[11] = tmp_1926; }
    }
    // cmp_swap(4,12)
    if keys[4] > keys[12] || (keys[4] == keys[12] && values[4] > values[12]) {
    // swap(4,12) 
    { let tmp_1927 = keys[4]; keys[4] = keys[12]; keys[12] = tmp_1927;let tmp_1928 = values[4]; values[4] = values[12]; values[12] = tmp_1928; }
    }
    // cmp_swap(5,13)
    if keys[5] > keys[13] || (keys[5] == keys[13] && values[5] > values[13]) {
    // swap(5,13) 
    { let tmp_1929 = keys[5]; keys[5] = keys[13]; keys[13] = tmp_1929;let tmp_1930 = values[5]; values[5] = values[13]; values[13] = tmp_1930; }
    }
    // cmp_swap(6,14)
    if keys[6] > keys[14] || (keys[6] == keys[14] && values[6] > values[14]) {
    // swap(6,14) 
    { let tmp_1931 = keys[6]; keys[6] = keys[14]; keys[14] = tmp_1931;let tmp_1932 = values[6]; values[6] = values[14]; values[14] = tmp_1932; }
    }
    // cmp_swap(7,15)
    if keys[7] > keys[15] || (keys[7] == keys[15] && values[7] > values[15]) {
    // swap(7,15) 
    { let tmp_1933 = keys[7]; keys[7] = keys[15]; keys[15] = tmp_1933;let tmp_1934 = values[7]; values[7] = values[15]; values[15] = tmp_1934; }
    }
    // exch_local(4,16) 
    // cmp_swap(0,4)
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_1935 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_1935;let tmp_1936 = values[0]; values[0] = values[4]; values[4] = tmp_1936; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_1937 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_1937;let tmp_1938 = values[1]; values[1] = values[5]; values[5] = tmp_1938; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_1939 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_1939;let tmp_1940 = values[2]; values[2] = values[6]; values[6] = tmp_1940; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_1941 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_1941;let tmp_1942 = values[3]; values[3] = values[7]; values[7] = tmp_1942; }
    }
    // cmp_swap(8,12)
    if keys[8] > keys[12] || (keys[8] == keys[12] && values[8] > values[12]) {
    // swap(8,12) 
    { let tmp_1943 = keys[8]; keys[8] = keys[12]; keys[12] = tmp_1943;let tmp_1944 = values[8]; values[8] = values[12]; values[12] = tmp_1944; }
    }
    // cmp_swap(9,13)
    if keys[9] > keys[13] || (keys[9] == keys[13] && values[9] > values[13]) {
    // swap(9,13) 
    { let tmp_1945 = keys[9]; keys[9] = keys[13]; keys[13] = tmp_1945;let tmp_1946 = values[9]; values[9] = values[13]; values[13] = tmp_1946; }
    }
    // cmp_swap(10,14)
    if keys[10] > keys[14] || (keys[10] == keys[14] && values[10] > values[14]) {
    // swap(10,14) 
    { let tmp_1947 = keys[10]; keys[10] = keys[14]; keys[14] = tmp_1947;let tmp_1948 = values[10]; values[10] = values[14]; values[14] = tmp_1948; }
    }
    // cmp_swap(11,15)
    if keys[11] > keys[15] || (keys[11] == keys[15] && values[11] > values[15]) {
    // swap(11,15) 
    { let tmp_1949 = keys[11]; keys[11] = keys[15]; keys[15] = tmp_1949;let tmp_1950 = values[11]; values[11] = values[15]; values[15] = tmp_1950; }
    }
    // exch_local(2,16) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_1951 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_1951;let tmp_1952 = values[0]; values[0] = values[2]; values[2] = tmp_1952; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_1953 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_1953;let tmp_1954 = values[1]; values[1] = values[3]; values[3] = tmp_1954; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_1955 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_1955;let tmp_1956 = values[4]; values[4] = values[6]; values[6] = tmp_1956; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_1957 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_1957;let tmp_1958 = values[5]; values[5] = values[7]; values[7] = tmp_1958; }
    }
    // cmp_swap(8,10)
    if keys[8] > keys[10] || (keys[8] == keys[10] && values[8] > values[10]) {
    // swap(8,10) 
    { let tmp_1959 = keys[8]; keys[8] = keys[10]; keys[10] = tmp_1959;let tmp_1960 = values[8]; values[8] = values[10]; values[10] = tmp_1960; }
    }
    // cmp_swap(9,11)
    if keys[9] > keys[11] || (keys[9] == keys[11] && values[9] > values[11]) {
    // swap(9,11) 
    { let tmp_1961 = keys[9]; keys[9] = keys[11]; keys[11] = tmp_1961;let tmp_1962 = values[9]; values[9] = values[11]; values[11] = tmp_1962; }
    }
    // cmp_swap(12,14)
    if keys[12] > keys[14] || (keys[12] == keys[14] && values[12] > values[14]) {
    // swap(12,14) 
    { let tmp_1963 = keys[12]; keys[12] = keys[14]; keys[14] = tmp_1963;let tmp_1964 = values[12]; values[12] = values[14]; values[14] = tmp_1964; }
    }
    // cmp_swap(13,15)
    if keys[13] > keys[15] || (keys[13] == keys[15] && values[13] > values[15]) {
    // swap(13,15) 
    { let tmp_1965 = keys[13]; keys[13] = keys[15]; keys[15] = tmp_1965;let tmp_1966 = values[13]; values[13] = values[15]; values[15] = tmp_1966; }
    }
    // exch_local(1,16) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_1967 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_1967;let tmp_1968 = values[0]; values[0] = values[1]; values[1] = tmp_1968; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_1969 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_1969;let tmp_1970 = values[2]; values[2] = values[3]; values[3] = tmp_1970; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_1971 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_1971;let tmp_1972 = values[4]; values[4] = values[5]; values[5] = tmp_1972; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_1973 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_1973;let tmp_1974 = values[6]; values[6] = values[7]; values[7] = tmp_1974; }
    }
    // cmp_swap(8,9)
    if keys[8] > keys[9] || (keys[8] == keys[9] && values[8] > values[9]) {
    // swap(8,9) 
    { let tmp_1975 = keys[8]; keys[8] = keys[9]; keys[9] = tmp_1975;let tmp_1976 = values[8]; values[8] = values[9]; values[9] = tmp_1976; }
    }
    // cmp_swap(10,11)
    if keys[10] > keys[11] || (keys[10] == keys[11] && values[10] > values[11]) {
    // swap(10,11) 
    { let tmp_1977 = keys[10]; keys[10] = keys[11]; keys[11] = tmp_1977;let tmp_1978 = values[10]; values[10] = values[11]; values[11] = tmp_1978; }
    }
    // cmp_swap(12,13)
    if keys[12] > keys[13] || (keys[12] == keys[13] && values[12] > values[13]) {
    // swap(12,13) 
    { let tmp_1979 = keys[12]; keys[12] = keys[13]; keys[13] = tmp_1979;let tmp_1980 = values[12]; values[12] = values[13]; values[13] = tmp_1980; }
    }
    // cmp_swap(14,15)
    if keys[14] > keys[15] || (keys[14] == keys[15] && values[14] > values[15]) {
    // swap(14,15) 
    { let tmp_1981 = keys[14]; keys[14] = keys[15]; keys[15] = tmp_1981;let tmp_1982 = values[14]; values[14] = values[15]; values[15] = tmp_1982; }
    }
