...
fn segsort_hybrid_sg8_n512_m256_striped(
    ...
    // exch_intxn(tmask:15,swbit:3,wpt:2)
    {
        // _exch_workgroup([(0, 1), (1, 0)],15,3)
        {
            ...
            workgroupBarrier();
            let tmp_50 = extractBits(local_tid, 3u, 1u) != 0u;
            let tmp_51 = seg_base + (local_tid ^ 15u);
            let tmp_52 = smem_keys[tmp_51 * WPT + 1u];
            let tmp_53 = smem_vals[tmp_51 * WPT + 1u];
            let tmp_54 = keys[0] < tmp_52 || (keys[0] == tmp_52 && values[0] < tmp_53);
            if tmp_50 == tmp_54 { keys[0] = tmp_52; values[0] = tmp_53; }
            let tmp_55 = smem_keys[tmp_51 * WPT + 0u];
            let tmp_56 = smem_vals[tmp_51 * WPT + 0u];
            let tmp_57 = keys[1] < tmp_55 || (keys[1] == tmp_55 && values[1] < tmp_56);
            if tmp_50 == tmp_57 { keys[1] = tmp_55; values[1] = tmp_56; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_79 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_79;
                let tmp_80 = values[0]; values[0] = values[1]; values[1] = tmp_80;
            }
        }
    }
    ...
    // exch_intxn(tmask:31,swbit:4,wpt:2)
    {
        // _exch_workgroup([(0, 1), (1, 0)],31,4)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_81 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_82 = seg_base + (local_tid ^ 31u);
            let tmp_83 = smem_keys[tmp_82 * WPT + 1u];
            let tmp_84 = smem_vals[tmp_82 * WPT + 1u];
            let tmp_85 = keys[0] < tmp_83 || (keys[0] == tmp_83 && values[0] < tmp_84);
            if tmp_81 == tmp_85 { keys[0] = tmp_83; values[0] = tmp_84; }
            let tmp_86 = smem_keys[tmp_82 * WPT + 0u];
            let tmp_87 = smem_vals[tmp_82 * WPT + 0u];
            let tmp_88 = keys[1] < tmp_86 || (keys[1] == tmp_86 && values[1] < tmp_87);
            if tmp_81 == tmp_88 { keys[1] = tmp_86; values[1] = tmp_87; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:8,swbit:3,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],8,3)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_89 = extractBits(local_tid, 3u, 1u) != 0u;
            let tmp_90 = seg_base + (local_tid ^ 8u);
            let tmp_91 = smem_keys[tmp_90 * WPT + 0u];
            let tmp_92 = smem_vals[tmp_90 * WPT + 0u];
            let tmp_93 = keys[0] < tmp_91 || (keys[0] == tmp_91 && values[0] < tmp_92);
            if tmp_89 == tmp_93 { keys[0] = tmp_91; values[0] = tmp_92; }
            let tmp_94 = smem_keys[tmp_90 * WPT + 1u];
            let tmp_95 = smem_vals[tmp_90 * WPT + 1u];
            let tmp_96 = keys[1] < tmp_94 || (keys[1] == tmp_94 && values[1] < tmp_95);
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_118 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_118;
                let tmp_119 = values[0]; values[0] = values[1]; values[1] = tmp_119;
            }
        }
    }
    ...
    // exch_intxn(tmask:63,swbit:5,wpt:2)
    {
        // _exch_workgroup([(0, 1), (1, 0)],63,5)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_120 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_121 = seg_base + (local_tid ^ 63u);
            let tmp_122 = smem_keys[tmp_121 * WPT + 1u];
            let tmp_123 = smem_vals[tmp_121 * WPT + 1u];
            let tmp_124 = keys[0] < tmp_122 || (keys[0] == tmp_122 && values[0] < tmp_123);
            if tmp_120 == tmp_124 { keys[0] = tmp_122; values[0] = tmp_123; }
            let tmp_125 = smem_keys[tmp_121 * WPT + 0u];
            let tmp_126 = smem_vals[tmp_121 * WPT + 0u];
    ...
    // exch_paral(tmask:16,swbit:4,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],16,4)
        {
            ...
            let tmp_129 = seg_base + (local_tid ^ 16u);
            let tmp_130 = smem_keys[tmp_129 * WPT + 0u];
            let tmp_131 = smem_vals[tmp_129 * WPT + 0u];
            let tmp_132 = keys[0] < tmp_130 || (keys[0] == tmp_130 && values[0] < tmp_131);
            if tmp_128 == tmp_132 { keys[0] = tmp_130; values[0] = tmp_131; }
            let tmp_133 = smem_keys[tmp_129 * WPT + 1u];
            let tmp_134 = smem_vals[tmp_129 * WPT + 1u];
            let tmp_135 = keys[1] < tmp_133 || (keys[1] == tmp_133 && values[1] < tmp_134);
            if tmp_128 == tmp_135 { keys[1] = tmp_133; values[1] = tmp_134; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:8,swbit:3,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],8,3)
        {
            ...
            let tmp_137 = seg_base + (local_tid ^ 8u);
            let tmp_138 = smem_keys[tmp_137 * WPT + 0u];
            let tmp_139 = smem_vals[tmp_137 * WPT + 0u];
            let tmp_140 = keys[0] < tmp_138 || (keys[0] == tmp_138 && values[0] < tmp_139);
            if tmp_136 == tmp_140 { keys[0] = tmp_138; values[0] = tmp_139; }
            let tmp_141 = smem_keys[tmp_137 * WPT + 1u];
            let tmp_142 = smem_vals[tmp_137 * WPT + 1u];
            let tmp_143 = keys[1] < tmp_141 || (keys[1] == tmp_141 && values[1] < tmp_142);
            if tmp_136 == tmp_143 { keys[1] = tmp_141; values[1] = tmp_142; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_165 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_165;
                let tmp_166 = values[0]; values[0] = values[1]; values[1] = tmp_166;
            }
        }
    }
    ...
    // exch_intxn(tmask:127,swbit:6,wpt:2)
    {
        // _exch_workgroup([(0, 1), (1, 0)],127,6)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_167 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_168 = seg_base + (local_tid ^ 127u);
            let tmp_169 = smem_keys[tmp_168 * WPT + 1u];
            let tmp_170 = smem_vals[tmp_168 * WPT + 1u];
            let tmp_171 = keys[0] < tmp_169 || (keys[0] == tmp_169 && values[0] < tmp_170);
            if tmp_167 == tmp_171 { keys[0] = tmp_169; values[0] = tmp_170; }
            let tmp_172 = smem_keys[tmp_168 * WPT + 0u];
            let tmp_173 = smem_vals[tmp_168 * WPT + 0u];
            let tmp_174 = keys[1] < tmp_172 || (keys[1] == tmp_172 && values[1] < tmp_173);
            if tmp_167 == tmp_174 { keys[1] = tmp_172; values[1] = tmp_173; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:32,swbit:5,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],32,5)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_175 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_176 = seg_base + (local_tid ^ 32u);
            let tmp_177 = smem_keys[tmp_176 * WPT + 0u];
            let tmp_178 = smem_vals[tmp_176 * WPT + 0u];
            let tmp_179 = keys[0] < tmp_177 || (keys[0] == tmp_177 && values[0] < tmp_178);
            if tmp_175 == tmp_179 { keys[0] = tmp_177; values[0] = tmp_178; }
            let tmp_180 = smem_keys[tmp_176 * WPT + 1u];
            let tmp_181 = smem_vals[tmp_176 * WPT + 1u];
    ...
    // exch_paral(tmask:16,swbit:4,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],16,4)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_183 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_184 = seg_base + (local_tid ^ 16u);
            let tmp_185 = smem_keys[tmp_184 * WPT + 0u];
            let tmp_186 = smem_vals[tmp_184 * WPT + 0u];
            let tmp_187 = keys[0] < tmp_185 || (keys[0] == tmp_185 && values[0] < tmp_186);
            if tmp_183 == tmp_187 { keys[0] = tmp_185; values[0] = tmp_186; }
            let tmp_188 = smem_keys[tmp_184 * WPT + 1u];
            let tmp_189 = smem_vals[tmp_184 * WPT + 1u];
            let tmp_190 = keys[1] < tmp_188 || (keys[1] == tmp_188 && values[1] < tmp_189);
            if tmp_183 == tmp_190 { keys[1] = tmp_188; values[1] = tmp_189; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:8,swbit:3,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],8,3)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_191 = extractBits(local_tid, 3u, 1u) != 0u;
            let tmp_192 = seg_base + (local_tid ^ 8u);
            let tmp_193 = smem_keys[tmp_192 * WPT + 0u];
            let tmp_194 = smem_vals[tmp_192 * WPT + 0u];
            let tmp_195 = keys[0] < tmp_193 || (keys[0] == tmp_193 && values[0] < tmp_194);
            if tmp_191 == tmp_195 { keys[0] = tmp_193; values[0] = tmp_194; }
            let tmp_196 = smem_keys[tmp_192 * WPT + 1u];
            let tmp_197 = smem_vals[tmp_192 * WPT + 1u];
            let tmp_198 = keys[1] < tmp_196 || (keys[1] == tmp_196 && values[1] < tmp_197);
            if tmp_191 == tmp_198 { keys[1] = tmp_196; values[1] = tmp_197; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_220 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_220;
                let tmp_221 = values[0]; values[0] = values[1]; values[1] = tmp_221;
            }
        }
    }
    ...
    // exch_intxn(tmask:255,swbit:7,wpt:2)
    {
        // _exch_workgroup([(0, 1), (1, 0)],255,7)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_222 = extractBits(local_tid, 7u, 1u) != 0u;
            let tmp_223 = seg_base + (local_tid ^ 255u);
            let tmp_224 = smem_keys[tmp_223 * WPT + 1u];
            let tmp_225 = smem_vals[tmp_223 * WPT + 1u];
            let tmp_226 = keys[0] < tmp_224 || (keys[0] == tmp_224 && values[0] < tmp_225);
            if tmp_222 == tmp_226 { keys[0] = tmp_224; values[0] = tmp_225; }
            let tmp_227 = smem_keys[tmp_223 * WPT + 0u];
            let tmp_228 = smem_vals[tmp_223 * WPT + 0u];
    ...
    // exch_paral(tmask:64,swbit:6,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],64,6)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_230 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_231 = seg_base + (local_tid ^ 64u);
    ...
    // exch_paral(tmask:32,swbit:5,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],32,5)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_238 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_239 = seg_base + (local_tid ^ 32u);
            let tmp_240 = smem_keys[tmp_239 * WPT + 0u];
            let tmp_241 = smem_vals[tmp_239 * WPT + 0u];
            let tmp_242 = keys[0] < tmp_240 || (keys[0] == tmp_240 && values[0] < tmp_241);
            if tmp_238 == tmp_242 { keys[0] = tmp_240; values[0] = tmp_241; }
            let tmp_243 = smem_keys[tmp_239 * WPT + 1u];
            let tmp_244 = smem_vals[tmp_239 * WPT + 1u];
            let tmp_245 = keys[1] < tmp_243 || (keys[1] == tmp_243 && values[1] < tmp_244);
            if tmp_238 == tmp_245 { keys[1] = tmp_243; values[1] = tmp_244; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:16,swbit:4,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],16,4)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_246 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_247 = seg_base + (local_tid ^ 16u);
            let tmp_248 = smem_keys[tmp_247 * WPT + 0u];
            let tmp_249 = smem_vals[tmp_247 * WPT + 0u];
            let tmp_250 = keys[0] < tmp_248 || (keys[0] == tmp_248 && values[0] < tmp_249);
            if tmp_246 == tmp_250 { keys[0] = tmp_248; values[0] = tmp_249; }
            let tmp_251 = smem_keys[tmp_247 * WPT + 1u];
            let tmp_252 = smem_vals[tmp_247 * WPT + 1u];
            let tmp_253 = keys[1] < tmp_251 || (keys[1] == tmp_251 && values[1] < tmp_252);
            if tmp_246 == tmp_253 { keys[1] = tmp_251; values[1] = tmp_252; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:8,swbit:3,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],8,3)
        {
            ...
            let tmp_255 = seg_base + (local_tid ^ 8u);
            let tmp_256 = smem_keys[tmp_255 * WPT + 0u];
            let tmp_257 = smem_vals[tmp_255 * WPT + 0u];
            let tmp_258 = keys[0] < tmp_256 || (keys[0] == tmp_256 && values[0] < tmp_257);
            if tmp_254 == tmp_258 { keys[0] = tmp_256; values[0] = tmp_257; }
            let tmp_259 = smem_keys[tmp_255 * WPT + 1u];
            let tmp_260 = smem_vals[tmp_255 * WPT + 1u];
            let tmp_261 = keys[1] < tmp_259 || (keys[1] == tmp_259 && values[1] < tmp_260);
            if tmp_254 == tmp_261 { keys[1] = tmp_259; values[1] = tmp_260; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_283 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_283;
                let tmp_284 = values[0]; values[0] = values[1]; values[1] = tmp_284;
            }
        }
    }
