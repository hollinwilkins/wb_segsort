...
const M: u32 = 256u;
const WPT: u32 = 2u;
const SG: u32 = 8u;      // register run spans one subgroup: RUN = SG*WPT = 16

var<workgroup> smem_keys: array<u32, N>;
var<workgroup> smem_vals: array<u32, N>;

@compute @workgroup_size(WG, 1, 1)
fn segsort_hybmerge_sg8_smem16k_n512_m256_striped(
    ...
    // merge pass 0: two sorted runs of 16 -> 32 (register-staged)
    {
    ...
    workgroupBarrier();
    // merge pass 1: two sorted runs of 32 -> 64 (register-staged)
    {
    ...
    workgroupBarrier();
    // merge pass 2: two sorted runs of 64 -> 128 (register-staged)
    {
    ...
    workgroupBarrier();
    // merge pass 3: two sorted runs of 128 -> 256 (register-staged)
    {
    ...
    workgroupBarrier();
    // merge pass 4: two sorted runs of 256 -> 512 (register-staged)
    {
