...
fn segsort_hybrid_sg16_n512_m256_striped(
    ...
    // exch_intxn(tmask:31,swbit:4,wpt:2)
    {
        // _exch_workgroup([(0, 1), (1, 0)],31,4)
        {
            ...
            workgroupBarrier();
            let tmp_80 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_81 = seg_base + (local_tid ^ 31u);
            let tmp_82 = smem_keys[tmp_81 * WPT + 1u];
            let tmp_83 = smem_vals[tmp_81 * WPT + 1u];
            let tmp_84 = keys[0] < tmp_82 || (keys[0] == tmp_82 && values[0] < tmp_83);
            if tmp_80 == tmp_84 { keys[0] = tmp_82; values[0] = tmp_83; }
            let tmp_85 = smem_keys[tmp_81 * WPT + 0u];
            let tmp_86 = smem_vals[tmp_81 * WPT + 0u];
    ...
    // exch_intxn(tmask:63,swbit:5,wpt:2)
    {
        // _exch_workgroup([(0, 1), (1, 0)],63,5)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_118 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_119 = seg_base + (local_tid ^ 63u);
            let tmp_120 = smem_keys[tmp_119 * WPT + 1u];
            let tmp_121 = smem_vals[tmp_119 * WPT + 1u];
            let tmp_122 = keys[0] < tmp_120 || (keys[0] == tmp_120 && values[0] < tmp_121);
            if tmp_118 == tmp_122 { keys[0] = tmp_120; values[0] = tmp_121; }
            let tmp_123 = smem_keys[tmp_119 * WPT + 0u];
            let tmp_124 = smem_vals[tmp_119 * WPT + 0u];
            let tmp_125 = keys[1] < tmp_123 || (keys[1] == tmp_123 && values[1] < tmp_124);
            if tmp_118 == tmp_125 { keys[1] = tmp_123; values[1] = tmp_124; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:16,swbit:4,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],16,4)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_126 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_127 = seg_base + (local_tid ^ 16u);
            let tmp_128 = smem_keys[tmp_127 * WPT + 0u];
            let tmp_129 = smem_vals[tmp_127 * WPT + 0u];
            let tmp_130 = keys[0] < tmp_128 || (keys[0] == tmp_128 && values[0] < tmp_129);
            if tmp_126 == tmp_130 { keys[0] = tmp_128; values[0] = tmp_129; }
            let tmp_131 = smem_keys[tmp_127 * WPT + 1u];
            let tmp_132 = smem_vals[tmp_127 * WPT + 1u];
            let tmp_133 = keys[1] < tmp_131 || (keys[1] == tmp_131 && values[1] < tmp_132);
            if tmp_126 == tmp_133 { keys[1] = tmp_131; values[1] = tmp_132; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_162 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_162;
                let tmp_163 = values[0]; values[0] = values[1]; values[1] = tmp_163;
            }
        }
    }
    ...
    // exch_intxn(tmask:127,swbit:6,wpt:2)
    {
        // _exch_workgroup([(0, 1), (1, 0)],127,6)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_164 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_165 = seg_base + (local_tid ^ 127u);
            let tmp_166 = smem_keys[tmp_165 * WPT + 1u];
            let tmp_167 = smem_vals[tmp_165 * WPT + 1u];
            let tmp_168 = keys[0] < tmp_166 || (keys[0] == tmp_166 && values[0] < tmp_167);
            if tmp_164 == tmp_168 { keys[0] = tmp_166; values[0] = tmp_167; }
            let tmp_169 = smem_keys[tmp_165 * WPT + 0u];
            let tmp_170 = smem_vals[tmp_165 * WPT + 0u];
    ...
    // exch_paral(tmask:32,swbit:5,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],32,5)
        {
            ...
            let tmp_173 = seg_base + (local_tid ^ 32u);
    ...
    // exch_paral(tmask:16,swbit:4,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],16,4)
        {
            ...
            let tmp_181 = seg_base + (local_tid ^ 16u);
            let tmp_182 = smem_keys[tmp_181 * WPT + 0u];
            let tmp_183 = smem_vals[tmp_181 * WPT + 0u];
            let tmp_184 = keys[0] < tmp_182 || (keys[0] == tmp_182 && values[0] < tmp_183);
            if tmp_180 == tmp_184 { keys[0] = tmp_182; values[0] = tmp_183; }
            let tmp_185 = smem_keys[tmp_181 * WPT + 1u];
            let tmp_186 = smem_vals[tmp_181 * WPT + 1u];
            let tmp_187 = keys[1] < tmp_185 || (keys[1] == tmp_185 && values[1] < tmp_186);
            if tmp_180 == tmp_187 { keys[1] = tmp_185; values[1] = tmp_186; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_216 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_216;
                let tmp_217 = values[0]; values[0] = values[1]; values[1] = tmp_217;
            }
        }
    }
    ...
    // exch_intxn(tmask:255,swbit:7,wpt:2)
    {
        // _exch_workgroup([(0, 1), (1, 0)],255,7)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_218 = extractBits(local_tid, 7u, 1u) != 0u;
            let tmp_219 = seg_base + (local_tid ^ 255u);
            let tmp_220 = smem_keys[tmp_219 * WPT + 1u];
            let tmp_221 = smem_vals[tmp_219 * WPT + 1u];
            let tmp_222 = keys[0] < tmp_220 || (keys[0] == tmp_220 && values[0] < tmp_221);
            if tmp_218 == tmp_222 { keys[0] = tmp_220; values[0] = tmp_221; }
            let tmp_223 = smem_keys[tmp_219 * WPT + 0u];
            let tmp_224 = smem_vals[tmp_219 * WPT + 0u];
            let tmp_225 = keys[1] < tmp_223 || (keys[1] == tmp_223 && values[1] < tmp_224);
            if tmp_218 == tmp_225 { keys[1] = tmp_223; values[1] = tmp_224; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:64,swbit:6,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],64,6)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_226 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_227 = seg_base + (local_tid ^ 64u);
    ...
    // exch_paral(tmask:32,swbit:5,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],32,5)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_234 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_235 = seg_base + (local_tid ^ 32u);
            let tmp_236 = smem_keys[tmp_235 * WPT + 0u];
            let tmp_237 = smem_vals[tmp_235 * WPT + 0u];
            let tmp_238 = keys[0] < tmp_236 || (keys[0] == tmp_236 && values[0] < tmp_237);
            if tmp_234 == tmp_238 { keys[0] = tmp_236; values[0] = tmp_237; }
            let tmp_239 = smem_keys[tmp_235 * WPT + 1u];
            let tmp_240 = smem_vals[tmp_235 * WPT + 1u];
            let tmp_241 = keys[1] < tmp_239 || (keys[1] == tmp_239 && values[1] < tmp_240);
    ...
    // exch_paral(tmask:16,swbit:4,wpt:2)
    {
        // _exch_workgroup([(0, 0), (1, 1)],16,4)
        {
            ...
            smem_vals[tid_g * WPT + 1u] = values[1];
            workgroupBarrier();
            let tmp_242 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_243 = seg_base + (local_tid ^ 16u);
            let tmp_244 = smem_keys[tmp_243 * WPT + 0u];
            let tmp_245 = smem_vals[tmp_243 * WPT + 0u];
            let tmp_246 = keys[0] < tmp_244 || (keys[0] == tmp_244 && values[0] < tmp_245);
            if tmp_242 == tmp_246 { keys[0] = tmp_244; values[0] = tmp_245; }
            let tmp_247 = smem_keys[tmp_243 * WPT + 1u];
            let tmp_248 = smem_vals[tmp_243 * WPT + 1u];
            let tmp_249 = keys[1] < tmp_247 || (keys[1] == tmp_247 && values[1] < tmp_248);
            if tmp_242 == tmp_249 { keys[1] = tmp_247; values[1] = tmp_248; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_278 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_278;
                let tmp_279 = values[0]; values[0] = values[1]; values[1] = tmp_279;
            }
        }
    }
