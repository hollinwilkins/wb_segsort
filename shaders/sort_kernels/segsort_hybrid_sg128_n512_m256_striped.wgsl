...
fn segsort_hybrid_sg128_n512_m256_striped(
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_159 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_159;
                let tmp_160 = values[0]; values[0] = values[1]; values[1] = tmp_160;
            }
        }
    }
    ...
    {
        // _exch_subgroup([(0, 1), (1, 0)],127,6)
        {
            let tmp_161 = subgroupShuffleXor(keys[1], 127u);
            let tmp_162 = subgroupShuffleXor(values[1], 127u);
            let tmp_163 = subgroupShuffleXor(keys[0], 127u);
            let tmp_164 = subgroupShuffleXor(values[0], 127u);
            let tmp_165 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_166 = keys[0] < tmp_161 || (keys[0] == tmp_161 && values[0] < tmp_162);
            if tmp_165 == tmp_166 { keys[0] = tmp_161; values[0] = tmp_162; }
            let tmp_167 = keys[1] < tmp_163 || (keys[1] == tmp_163 && values[1] < tmp_164);
            if tmp_165 == tmp_167 { keys[1] = tmp_163; values[1] = tmp_164; }
        }
    }

    // exch_paral(tmask:32,swbit:5,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],32,5)
        {
            let tmp_168 = subgroupShuffleXor(keys[0], 32u);
            let tmp_169 = subgroupShuffleXor(values[0], 32u);
            let tmp_170 = subgroupShuffleXor(keys[1], 32u);
            let tmp_171 = subgroupShuffleXor(values[1], 32u);
            let tmp_172 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_173 = keys[0] < tmp_168 || (keys[0] == tmp_168 && values[0] < tmp_169);
            if tmp_172 == tmp_173 { keys[0] = tmp_168; values[0] = tmp_169; }
            let tmp_174 = keys[1] < tmp_170 || (keys[1] == tmp_170 && values[1] < tmp_171);
            if tmp_172 == tmp_174 { keys[1] = tmp_170; values[1] = tmp_171; }
        }
    }
    ...
    // exch_paral(tmask:16,swbit:4,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],16,4)
        {
            let tmp_175 = subgroupShuffleXor(keys[0], 16u);
            let tmp_176 = subgroupShuffleXor(values[0], 16u);
            let tmp_177 = subgroupShuffleXor(keys[1], 16u);
            let tmp_178 = subgroupShuffleXor(values[1], 16u);
            let tmp_179 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_180 = keys[0] < tmp_175 || (keys[0] == tmp_175 && values[0] < tmp_176);
            if tmp_179 == tmp_180 { keys[0] = tmp_175; values[0] = tmp_176; }
            let tmp_181 = keys[1] < tmp_177 || (keys[1] == tmp_177 && values[1] < tmp_178);
            if tmp_179 == tmp_181 { keys[1] = tmp_177; values[1] = tmp_178; }
        }
    }
    ...
    // exch_paral(tmask:8,swbit:3,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],8,3)
        {
            let tmp_182 = subgroupShuffleXor(keys[0], 8u);
            let tmp_183 = subgroupShuffleXor(values[0], 8u);
            let tmp_184 = subgroupShuffleXor(keys[1], 8u);
            let tmp_185 = subgroupShuffleXor(values[1], 8u);
            let tmp_186 = extractBits(local_tid, 3u, 1u) != 0u;
            let tmp_187 = keys[0] < tmp_182 || (keys[0] == tmp_182 && values[0] < tmp_183);
            if tmp_186 == tmp_187 { keys[0] = tmp_182; values[0] = tmp_183; }
            let tmp_188 = keys[1] < tmp_184 || (keys[1] == tmp_184 && values[1] < tmp_185);
            if tmp_186 == tmp_188 { keys[1] = tmp_184; values[1] = tmp_185; }
        }
    }
    ...
    // exch_paral(tmask:4,swbit:2,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],4,2)
        {
            let tmp_189 = subgroupShuffleXor(keys[0], 4u);
            let tmp_190 = subgroupShuffleXor(values[0], 4u);
            let tmp_191 = subgroupShuffleXor(keys[1], 4u);
            let tmp_192 = subgroupShuffleXor(values[1], 4u);
            let tmp_193 = extractBits(local_tid, 2u, 1u) != 0u;
            let tmp_194 = keys[0] < tmp_189 || (keys[0] == tmp_189 && values[0] < tmp_190);
            if tmp_193 == tmp_194 { keys[0] = tmp_189; values[0] = tmp_190; }
            let tmp_195 = keys[1] < tmp_191 || (keys[1] == tmp_191 && values[1] < tmp_192);
            if tmp_193 == tmp_195 { keys[1] = tmp_191; values[1] = tmp_192; }
        }
    }
    ...
    // exch_paral(tmask:2,swbit:1,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],2,1)
        {
            ...
            let tmp_201 = keys[0] < tmp_196 || (keys[0] == tmp_196 && values[0] < tmp_197);
            if tmp_200 == tmp_201 { keys[0] = tmp_196; values[0] = tmp_197; }
            let tmp_202 = keys[1] < tmp_198 || (keys[1] == tmp_198 && values[1] < tmp_199);
            if tmp_200 == tmp_202 { keys[1] = tmp_198; values[1] = tmp_199; }
        }
    }
    ...
    // exch_paral(tmask:1,swbit:0,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],1,0)
        {
            let tmp_203 = subgroupShuffleXor(keys[0], 1u);
            let tmp_204 = subgroupShuffleXor(values[0], 1u);
            let tmp_205 = subgroupShuffleXor(keys[1], 1u);
            let tmp_206 = subgroupShuffleXor(values[1], 1u);
            let tmp_207 = extractBits(local_tid, 0u, 1u) != 0u;
            let tmp_208 = keys[0] < tmp_203 || (keys[0] == tmp_203 && values[0] < tmp_204);
            if tmp_207 == tmp_208 { keys[0] = tmp_203; values[0] = tmp_204; }
            let tmp_209 = keys[1] < tmp_205 || (keys[1] == tmp_205 && values[1] < tmp_206);
            if tmp_207 == tmp_209 { keys[1] = tmp_205; values[1] = tmp_206; }
        }
    }
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_210 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_210;
                let tmp_211 = values[0]; values[0] = values[1]; values[1] = tmp_211;
            }
        }
    }
    ...
    // exch_intxn(tmask:255,swbit:7,wpt:2)
    {
        // _exch_workgroup([(0, 1), (1, 0)],255,7)
        {
            ...
            workgroupBarrier();
            let tmp_212 = extractBits(local_tid, 7u, 1u) != 0u;
            let tmp_213 = seg_base + (local_tid ^ 255u);
            let tmp_214 = smem_keys[tmp_213 * WPT + 1u];
            let tmp_215 = smem_vals[tmp_213 * WPT + 1u];
            let tmp_216 = keys[0] < tmp_214 || (keys[0] == tmp_214 && values[0] < tmp_215);
            if tmp_212 == tmp_216 { keys[0] = tmp_214; values[0] = tmp_215; }
            let tmp_217 = smem_keys[tmp_213 * WPT + 0u];
            let tmp_218 = smem_vals[tmp_213 * WPT + 0u];
    ...
    {
        // _exch_subgroup([(0, 0), (1, 1)],64,6)
        {
            let tmp_220 = subgroupShuffleXor(keys[0], 64u);
            let tmp_221 = subgroupShuffleXor(values[0], 64u);
            let tmp_222 = subgroupShuffleXor(keys[1], 64u);
            let tmp_223 = subgroupShuffleXor(values[1], 64u);
            let tmp_224 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_225 = keys[0] < tmp_220 || (keys[0] == tmp_220 && values[0] < tmp_221);
            if tmp_224 == tmp_225 { keys[0] = tmp_220; values[0] = tmp_221; }
            let tmp_226 = keys[1] < tmp_222 || (keys[1] == tmp_222 && values[1] < tmp_223);
            if tmp_224 == tmp_226 { keys[1] = tmp_222; values[1] = tmp_223; }
        }
    }
    ...
    // exch_paral(tmask:32,swbit:5,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],32,5)
        {
            let tmp_227 = subgroupShuffleXor(keys[0], 32u);
            let tmp_228 = subgroupShuffleXor(values[0], 32u);
            let tmp_229 = subgroupShuffleXor(keys[1], 32u);
            let tmp_230 = subgroupShuffleXor(values[1], 32u);
            let tmp_231 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_232 = keys[0] < tmp_227 || (keys[0] == tmp_227 && values[0] < tmp_228);
            if tmp_231 == tmp_232 { keys[0] = tmp_227; values[0] = tmp_228; }
            let tmp_233 = keys[1] < tmp_229 || (keys[1] == tmp_229 && values[1] < tmp_230);
            if tmp_231 == tmp_233 { keys[1] = tmp_229; values[1] = tmp_230; }
        }
    }
    ...
    // exch_paral(tmask:16,swbit:4,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],16,4)
        {
            let tmp_234 = subgroupShuffleXor(keys[0], 16u);
            let tmp_235 = subgroupShuffleXor(values[0], 16u);
            let tmp_236 = subgroupShuffleXor(keys[1], 16u);
            let tmp_237 = subgroupShuffleXor(values[1], 16u);
            let tmp_238 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_239 = keys[0] < tmp_234 || (keys[0] == tmp_234 && values[0] < tmp_235);
            if tmp_238 == tmp_239 { keys[0] = tmp_234; values[0] = tmp_235; }
            let tmp_240 = keys[1] < tmp_236 || (keys[1] == tmp_236 && values[1] < tmp_237);
            if tmp_238 == tmp_240 { keys[1] = tmp_236; values[1] = tmp_237; }
        }
    }
    ...
    // exch_paral(tmask:8,swbit:3,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],8,3)
        {
            let tmp_241 = subgroupShuffleXor(keys[0], 8u);
            let tmp_242 = subgroupShuffleXor(values[0], 8u);
            let tmp_243 = subgroupShuffleXor(keys[1], 8u);
            let tmp_244 = subgroupShuffleXor(values[1], 8u);
            let tmp_245 = extractBits(local_tid, 3u, 1u) != 0u;
            let tmp_246 = keys[0] < tmp_241 || (keys[0] == tmp_241 && values[0] < tmp_242);
            if tmp_245 == tmp_246 { keys[0] = tmp_241; values[0] = tmp_242; }
            let tmp_247 = keys[1] < tmp_243 || (keys[1] == tmp_243 && values[1] < tmp_244);
            if tmp_245 == tmp_247 { keys[1] = tmp_243; values[1] = tmp_244; }
        }
    }
    ...
    // exch_paral(tmask:4,swbit:2,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],4,2)
        {
            let tmp_248 = subgroupShuffleXor(keys[0], 4u);
            let tmp_249 = subgroupShuffleXor(values[0], 4u);
            let tmp_250 = subgroupShuffleXor(keys[1], 4u);
            let tmp_251 = subgroupShuffleXor(values[1], 4u);
            let tmp_252 = extractBits(local_tid, 2u, 1u) != 0u;
            let tmp_253 = keys[0] < tmp_248 || (keys[0] == tmp_248 && values[0] < tmp_249);
            if tmp_252 == tmp_253 { keys[0] = tmp_248; values[0] = tmp_249; }
            let tmp_254 = keys[1] < tmp_250 || (keys[1] == tmp_250 && values[1] < tmp_251);
            if tmp_252 == tmp_254 { keys[1] = tmp_250; values[1] = tmp_251; }
        }
    }
    ...
    // exch_paral(tmask:2,swbit:1,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],2,1)
        {
            let tmp_255 = subgroupShuffleXor(keys[0], 2u);
            let tmp_256 = subgroupShuffleXor(values[0], 2u);
            let tmp_257 = subgroupShuffleXor(keys[1], 2u);
            let tmp_258 = subgroupShuffleXor(values[1], 2u);
            let tmp_259 = extractBits(local_tid, 1u, 1u) != 0u;
            let tmp_260 = keys[0] < tmp_255 || (keys[0] == tmp_255 && values[0] < tmp_256);
            if tmp_259 == tmp_260 { keys[0] = tmp_255; values[0] = tmp_256; }
            let tmp_261 = keys[1] < tmp_257 || (keys[1] == tmp_257 && values[1] < tmp_258);
            if tmp_259 == tmp_261 { keys[1] = tmp_257; values[1] = tmp_258; }
        }
    }
    ...
    // exch_paral(tmask:1,swbit:0,wpt:2)
    {
        // _exch_subgroup([(0, 0), (1, 1)],1,0)
        {
            let tmp_262 = subgroupShuffleXor(keys[0], 1u);
            let tmp_263 = subgroupShuffleXor(values[0], 1u);
            let tmp_264 = subgroupShuffleXor(keys[1], 1u);
            let tmp_265 = subgroupShuffleXor(values[1], 1u);
            let tmp_266 = extractBits(local_tid, 0u, 1u) != 0u;
    ...
    // exch_local(1,2)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_269 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_269;
                let tmp_270 = values[0]; values[0] = values[1]; values[1] = tmp_270;
            }
        }
    }
