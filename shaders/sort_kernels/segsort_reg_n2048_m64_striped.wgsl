...
fn segsort_reg_n2048_m64_striped(
    ...
    if keys[0] > keys[16] || (keys[0] == keys[16] && values[0] > values[16]) {
    // swap(0,16) 
    { let tmp_2575 = keys[0]; keys[0] = keys[16]; keys[16] = tmp_2575;let tmp_2576 = values[0]; values[0] = values[16]; values[16] = tmp_2576; }
    }
    // cmp_swap(1,17)
    if keys[1] > keys[17] || (keys[1] == keys[17] && values[1] > values[17]) {
    // swap(1,17) 
    { let tmp_2577 = keys[1]; keys[1] = keys[17]; keys[17] = tmp_2577;let tmp_2578 = values[1]; values[1] = values[17]; values[17] = tmp_2578; }
    }
    // cmp_swap(2,18)
    if keys[2] > keys[18] || (keys[2] == keys[18] && values[2] > values[18]) {
    // swap(2,18) 
    { let tmp_2579 = keys[2]; keys[2] = keys[18]; keys[18] = tmp_2579;let tmp_2580 = values[2]; values[2] = values[18]; values[18] = tmp_2580; }
    }
    // cmp_swap(3,19)
    if keys[3] > keys[19] || (keys[3] == keys[19] && values[3] > values[19]) {
    // swap(3,19) 
    { let tmp_2581 = keys[3]; keys[3] = keys[19]; keys[19] = tmp_2581;let tmp_2582 = values[3]; values[3] = values[19]; values[19] = tmp_2582; }
    }
    // cmp_swap(4,20)
    if keys[4] > keys[20] || (keys[4] == keys[20] && values[4] > values[20]) {
    // swap(4,20) 
    { let tmp_2583 = keys[4]; keys[4] = keys[20]; keys[20] = tmp_2583;let tmp_2584 = values[4]; values[4] = values[20]; values[20] = tmp_2584; }
    }
    // cmp_swap(5,21)
    if keys[5] > keys[21] || (keys[5] == keys[21] && values[5] > values[21]) {
    // swap(5,21) 
    { let tmp_2585 = keys[5]; keys[5] = keys[21]; keys[21] = tmp_2585;let tmp_2586 = values[5]; values[5] = values[21]; values[21] = tmp_2586; }
    }
    // cmp_swap(6,22)
    if keys[6] > keys[22] || (keys[6] == keys[22] && values[6] > values[22]) {
    // swap(6,22) 
    { let tmp_2587 = keys[6]; keys[6] = keys[22]; keys[22] = tmp_2587;let tmp_2588 = values[6]; values[6] = values[22]; values[22] = tmp_2588; }
    }
    // cmp_swap(7,23)
    if keys[7] > keys[23] || (keys[7] == keys[23] && values[7] > values[23]) {
    // swap(7,23) 
    { let tmp_2589 = keys[7]; keys[7] = keys[23]; keys[23] = tmp_2589;let tmp_2590 = values[7]; values[7] = values[23]; values[23] = tmp_2590; }
    }
    // cmp_swap(8,24)
    if keys[8] > keys[24] || (keys[8] == keys[24] && values[8] > values[24]) {
    // swap(8,24) 
    { let tmp_2591 = keys[8]; keys[8] = keys[24]; keys[24] = tmp_2591;let tmp_2592 = values[8]; values[8] = values[24]; values[24] = tmp_2592; }
    }
    // cmp_swap(9,25)
    if keys[9] > keys[25] || (keys[9] == keys[25] && values[9] > values[25]) {
    // swap(9,25) 
    { let tmp_2593 = keys[9]; keys[9] = keys[25]; keys[25] = tmp_2593;let tmp_2594 = values[9]; values[9] = values[25]; values[25] = tmp_2594; }
    }
    // cmp_swap(10,26)
    if keys[10] > keys[26] || (keys[10] == keys[26] && values[10] > values[26]) {
    // swap(10,26) 
    { let tmp_2595 = keys[10]; keys[10] = keys[26]; keys[26] = tmp_2595;let tmp_2596 = values[10]; values[10] = values[26]; values[26] = tmp_2596; }
    }
    // cmp_swap(11,27)
    if keys[11] > keys[27] || (keys[11] == keys[27] && values[11] > values[27]) {
    // swap(11,27) 
    { let tmp_2597 = keys[11]; keys[11] = keys[27]; keys[27] = tmp_2597;let tmp_2598 = values[11]; values[11] = values[27]; values[27] = tmp_2598; }
    }
    // cmp_swap(12,28)
    if keys[12] > keys[28] || (keys[12] == keys[28] && values[12] > values[28]) {
    // swap(12,28) 
    { let tmp_2599 = keys[12]; keys[12] = keys[28]; keys[28] = tmp_2599;let tmp_2600 = values[12]; values[12] = values[28]; values[28] = tmp_2600; }
    }
    // cmp_swap(13,29)
    if keys[13] > keys[29] || (keys[13] == keys[29] && values[13] > values[29]) {
    // swap(13,29) 
    { let tmp_2601 = keys[13]; keys[13] = keys[29]; keys[29] = tmp_2601;let tmp_2602 = values[13]; values[13] = values[29]; values[29] = tmp_2602; }
    }
    // cmp_swap(14,30)
    if keys[14] > keys[30] || (keys[14] == keys[30] && values[14] > values[30]) {
    // swap(14,30) 
    { let tmp_2603 = keys[14]; keys[14] = keys[30]; keys[30] = tmp_2603;let tmp_2604 = values[14]; values[14] = values[30]; values[30] = tmp_2604; }
    }
    // cmp_swap(15,31)
    if keys[15] > keys[31] || (keys[15] == keys[31] && values[15] > values[31]) {
    // swap(15,31) 
    { let tmp_2605 = keys[15]; keys[15] = keys[31]; keys[31] = tmp_2605;let tmp_2606 = values[15]; values[15] = values[31]; values[31] = tmp_2606; }
    }
    // exch_local(8,32) 
    // cmp_swap(0,8)
    if keys[0] > keys[8] || (keys[0] == keys[8] && values[0] > values[8]) {
    // swap(0,8) 
    { let tmp_2607 = keys[0]; keys[0] = keys[8]; keys[8] = tmp_2607;let tmp_2608 = values[0]; values[0] = values[8]; values[8] = tmp_2608; }
    }
    // cmp_swap(1,9)
    if keys[1] > keys[9] || (keys[1] == keys[9] && values[1] > values[9]) {
    // swap(1,9) 
    { let tmp_2609 = keys[1]; keys[1] = keys[9]; keys[9] = tmp_2609;let tmp_2610 = values[1]; values[1] = values[9]; values[9] = tmp_2610; }
    }
    // cmp_swap(2,10)
    if keys[2] > keys[10] || (keys[2] == keys[10] && values[2] > values[10]) {
    // swap(2,10) 
    { let tmp_2611 = keys[2]; keys[2] = keys[10]; keys[10] = tmp_2611;let tmp_2612 = values[2]; values[2] = values[10]; values[10] = tmp_2612; }
    }
    // cmp_swap(3,11)
    if keys[3] > keys[11] || (keys[3] == keys[11] && values[3] > values[11]) {
    // swap(3,11) 
    { let tmp_2613 = keys[3]; keys[3] = keys[11]; keys[11] = tmp_2613;let tmp_2614 = values[3]; values[3] = values[11]; values[11] = tmp_2614; }
    }
    // cmp_swap(4,12)
    if keys[4] > keys[12] || (keys[4] == keys[12] && values[4] > values[12]) {
    // swap(4,12) 
    { let tmp_2615 = keys[4]; keys[4] = keys[12]; keys[12] = tmp_2615;let tmp_2616 = values[4]; values[4] = values[12]; values[12] = tmp_2616; }
    }
    // cmp_swap(5,13)
    if keys[5] > keys[13] || (keys[5] == keys[13] && values[5] > values[13]) {
    // swap(5,13) 
    { let tmp_2617 = keys[5]; keys[5] = keys[13]; keys[13] = tmp_2617;let tmp_2618 = values[5]; values[5] = values[13]; values[13] = tmp_2618; }
    }
    // cmp_swap(6,14)
    if keys[6] > keys[14] || (keys[6] == keys[14] && values[6] > values[14]) {
    // swap(6,14) 
    { let tmp_2619 = keys[6]; keys[6] = keys[14]; keys[14] = tmp_2619;let tmp_2620 = values[6]; values[6] = values[14]; values[14] = tmp_2620; }
    }
    // cmp_swap(7,15)
    if keys[7] > keys[15] || (keys[7] == keys[15] && values[7] > values[15]) {
    // swap(7,15) 
    { let tmp_2621 = keys[7]; keys[7] = keys[15]; keys[15] = tmp_2621;let tmp_2622 = values[7]; values[7] = values[15]; values[15] = tmp_2622; }
    }
    // cmp_swap(16,24)
    if keys[16] > keys[24] || (keys[16] == keys[24] && values[16] > values[24]) {
    // swap(16,24) 
    { let tmp_2623 = keys[16]; keys[16] = keys[24]; keys[24] = tmp_2623;let tmp_2624 = values[16]; values[16] = values[24]; values[24] = tmp_2624; }
    }
    // cmp_swap(17,25)
    if keys[17] > keys[25] || (keys[17] == keys[25] && values[17] > values[25]) {
    // swap(17,25) 
    { let tmp_2625 = keys[17]; keys[17] = keys[25]; keys[25] = tmp_2625;let tmp_2626 = values[17]; values[17] = values[25]; values[25] = tmp_2626; }
    }
    // cmp_swap(18,26)
    if keys[18] > keys[26] || (keys[18] == keys[26] && values[18] > values[26]) {
    // swap(18,26) 
    { let tmp_2627 = keys[18]; keys[18] = keys[26]; keys[26] = tmp_2627;let tmp_2628 = values[18]; values[18] = values[26]; values[26] = tmp_2628; }
    }
    // cmp_swap(19,27)
    if keys[19] > keys[27] || (keys[19] == keys[27] && values[19] > values[27]) {
    // swap(19,27) 
    { let tmp_2629 = keys[19]; keys[19] = keys[27]; keys[27] = tmp_2629;let tmp_2630 = values[19]; values[19] = values[27]; values[27] = tmp_2630; }
    }
    // cmp_swap(20,28)
    if keys[20] > keys[28] || (keys[20] == keys[28] && values[20] > values[28]) {
    // swap(20,28) 
    { let tmp_2631 = keys[20]; keys[20] = keys[28]; keys[28] = tmp_2631;let tmp_2632 = values[20]; values[20] = values[28]; values[28] = tmp_2632; }
    }
    // cmp_swap(21,29)
    if keys[21] > keys[29] || (keys[21] == keys[29] && values[21] > values[29]) {
    // swap(21,29) 
    { let tmp_2633 = keys[21]; keys[21] = keys[29]; keys[29] = tmp_2633;let tmp_2634 = values[21]; values[21] = values[29]; values[29] = tmp_2634; }
    }
    // cmp_swap(22,30)
    if keys[22] > keys[30] || (keys[22] == keys[30] && values[22] > values[30]) {
    // swap(22,30) 
    { let tmp_2635 = keys[22]; keys[22] = keys[30]; keys[30] = tmp_2635;let tmp_2636 = values[22]; values[22] = values[30]; values[30] = tmp_2636; }
    }
    // cmp_swap(23,31)
    if keys[23] > keys[31] || (keys[23] == keys[31] && values[23] > values[31]) {
    // swap(23,31) 
    { let tmp_2637 = keys[23]; keys[23] = keys[31]; keys[31] = tmp_2637;let tmp_2638 = values[23]; values[23] = values[31]; values[31] = tmp_2638; }
    }
    // exch_local(4,32) 
    // cmp_swap(0,4)
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_2639 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_2639;let tmp_2640 = values[0]; values[0] = values[4]; values[4] = tmp_2640; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_2641 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_2641;let tmp_2642 = values[1]; values[1] = values[5]; values[5] = tmp_2642; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_2643 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_2643;let tmp_2644 = values[2]; values[2] = values[6]; values[6] = tmp_2644; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_2645 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_2645;let tmp_2646 = values[3]; values[3] = values[7]; values[7] = tmp_2646; }
    }
    // cmp_swap(8,12)
    if keys[8] > keys[12] || (keys[8] == keys[12] && values[8] > values[12]) {
    // swap(8,12) 
    { let tmp_2647 = keys[8]; keys[8] = keys[12]; keys[12] = tmp_2647;let tmp_2648 = values[8]; values[8] = values[12]; values[12] = tmp_2648; }
    }
    // cmp_swap(9,13)
    if keys[9] > keys[13] || (keys[9] == keys[13] && values[9] > values[13]) {
    // swap(9,13) 
    { let tmp_2649 = keys[9]; keys[9] = keys[13]; keys[13] = tmp_2649;let tmp_2650 = values[9]; values[9] = values[13]; values[13] = tmp_2650; }
    }
    // cmp_swap(10,14)
    if keys[10] > keys[14] || (keys[10] == keys[14] && values[10] > values[14]) {
    // swap(10,14) 
    { let tmp_2651 = keys[10]; keys[10] = keys[14]; keys[14] = tmp_2651;let tmp_2652 = values[10]; values[10] = values[14]; values[14] = tmp_2652; }
    }
    // cmp_swap(11,15)
    if keys[11] > keys[15] || (keys[11] == keys[15] && values[11] > values[15]) {
    // swap(11,15) 
    { let tmp_2653 = keys[11]; keys[11] = keys[15]; keys[15] = tmp_2653;let tmp_2654 = values[11]; values[11] = values[15]; values[15] = tmp_2654; }
    }
    // cmp_swap(16,20)
    if keys[16] > keys[20] || (keys[16] == keys[20] && values[16] > values[20]) {
    // swap(16,20) 
    { let tmp_2655 = keys[16]; keys[16] = keys[20]; keys[20] = tmp_2655;let tmp_2656 = values[16]; values[16] = values[20]; values[20] = tmp_2656; }
    }
    // cmp_swap(17,21)
    if keys[17] > keys[21] || (keys[17] == keys[21] && values[17] > values[21]) {
    // swap(17,21) 
    { let tmp_2657 = keys[17]; keys[17] = keys[21]; keys[21] = tmp_2657;let tmp_2658 = values[17]; values[17] = values[21]; values[21] = tmp_2658; }
    }
    // cmp_swap(18,22)
    if keys[18] > keys[22] || (keys[18] == keys[22] && values[18] > values[22]) {
    // swap(18,22) 
    { let tmp_2659 = keys[18]; keys[18] = keys[22]; keys[22] = tmp_2659;let tmp_2660 = values[18]; values[18] = values[22]; values[22] = tmp_2660; }
    }
    // cmp_swap(19,23)
    if keys[19] > keys[23] || (keys[19] == keys[23] && values[19] > values[23]) {
    // swap(19,23) 
    { let tmp_2661 = keys[19]; keys[19] = keys[23]; keys[23] = tmp_2661;let tmp_2662 = values[19]; values[19] = values[23]; values[23] = tmp_2662; }
    }
    // cmp_swap(24,28)
    if keys[24] > keys[28] || (keys[24] == keys[28] && values[24] > values[28]) {
    // swap(24,28) 
    { let tmp_2663 = keys[24]; keys[24] = keys[28]; keys[28] = tmp_2663;let tmp_2664 = values[24]; values[24] = values[28]; values[28] = tmp_2664; }
    }
    // cmp_swap(25,29)
    if keys[25] > keys[29] || (keys[25] == keys[29] && values[25] > values[29]) {
    // swap(25,29) 
    { let tmp_2665 = keys[25]; keys[25] = keys[29]; keys[29] = tmp_2665;let tmp_2666 = values[25]; values[25] = values[29]; values[29] = tmp_2666; }
    }
    // cmp_swap(26,30)
    if keys[26] > keys[30] || (keys[26] == keys[30] && values[26] > values[30]) {
    // swap(26,30) 
    { let tmp_2667 = keys[26]; keys[26] = keys[30]; keys[30] = tmp_2667;let tmp_2668 = values[26]; values[26] = values[30]; values[30] = tmp_2668; }
    }
    // cmp_swap(27,31)
    if keys[27] > keys[31] || (keys[27] == keys[31] && values[27] > values[31]) {
    // swap(27,31) 
    { let tmp_2669 = keys[27]; keys[27] = keys[31]; keys[31] = tmp_2669;let tmp_2670 = values[27]; values[27] = values[31]; values[31] = tmp_2670; }
    }
    // exch_local(2,32) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_2671 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_2671;let tmp_2672 = values[0]; values[0] = values[2]; values[2] = tmp_2672; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_2673 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_2673;let tmp_2674 = values[1]; values[1] = values[3]; values[3] = tmp_2674; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_2675 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_2675;let tmp_2676 = values[4]; values[4] = values[6]; values[6] = tmp_2676; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_2677 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_2677;let tmp_2678 = values[5]; values[5] = values[7]; values[7] = tmp_2678; }
    }
    // cmp_swap(8,10)
    if keys[8] > keys[10] || (keys[8] == keys[10] && values[8] > values[10]) {
    // swap(8,10) 
    { let tmp_2679 = keys[8]; keys[8] = keys[10]; keys[10] = tmp_2679;let tmp_2680 = values[8]; values[8] = values[10]; values[10] = tmp_2680; }
    }
    // cmp_swap(9,11)
    if keys[9] > keys[11] || (keys[9] == keys[11] && values[9] > values[11]) {
    // swap(9,11) 
    { let tmp_2681 = keys[9]; keys[9] = keys[11]; keys[11] = tmp_2681;let tmp_2682 = values[9]; values[9] = values[11]; values[11] = tmp_2682; }
    }
    // cmp_swap(12,14)
    if keys[12] > keys[14] || (keys[12] == keys[14] && values[12] > values[14]) {
    // swap(12,14) 
    { let tmp_2683 = keys[12]; keys[12] = keys[14]; keys[14] = tmp_2683;let tmp_2684 = values[12]; values[12] = values[14]; values[14] = tmp_2684; }
    }
    // cmp_swap(13,15)
    if keys[13] > keys[15] || (keys[13] == keys[15] && values[13] > values[15]) {
    // swap(13,15) 
    { let tmp_2685 = keys[13]; keys[13] = keys[15]; keys[15] = tmp_2685;let tmp_2686 = values[13]; values[13] = values[15]; values[15] = tmp_2686; }
    }
    // cmp_swap(16,18)
    if keys[16] > keys[18] || (keys[16] == keys[18] && values[16] > values[18]) {
    // swap(16,18) 
    { let tmp_2687 = keys[16]; keys[16] = keys[18]; keys[18] = tmp_2687;let tmp_2688 = values[16]; values[16] = values[18]; values[18] = tmp_2688; }
    }
    // cmp_swap(17,19)
    if keys[17] > keys[19] || (keys[17] == keys[19] && values[17] > values[19]) {
    // swap(17,19) 
    { let tmp_2689 = keys[17]; keys[17] = keys[19]; keys[19] = tmp_2689;let tmp_2690 = values[17]; values[17] = values[19]; values[19] = tmp_2690; }
    }
    // cmp_swap(20,22)
    if keys[20] > keys[22] || (keys[20] == keys[22] && values[20] > values[22]) {
    // swap(20,22) 
    { let tmp_2691 = keys[20]; keys[20] = keys[22]; keys[22] = tmp_2691;let tmp_2692 = values[20]; values[20] = values[22]; values[22] = tmp_2692; }
    }
    // cmp_swap(21,23)
    if keys[21] > keys[23] || (keys[21] == keys[23] && values[21] > values[23]) {
    // swap(21,23) 
    { let tmp_2693 = keys[21]; keys[21] = keys[23]; keys[23] = tmp_2693;let tmp_2694 = values[21]; values[21] = values[23]; values[23] = tmp_2694; }
    }
    // cmp_swap(24,26)
    if keys[24] > keys[26] || (keys[24] == keys[26] && values[24] > values[26]) {
    // swap(24,26) 
    { let tmp_2695 = keys[24]; keys[24] = keys[26]; keys[26] = tmp_2695;let tmp_2696 = values[24]; values[24] = values[26]; values[26] = tmp_2696; }
    }
    // cmp_swap(25,27)
    if keys[25] > keys[27] || (keys[25] == keys[27] && values[25] > values[27]) {
    // swap(25,27) 
    { let tmp_2697 = keys[25]; keys[25] = keys[27]; keys[27] = tmp_2697;let tmp_2698 = values[25]; values[25] = values[27]; values[27] = tmp_2698; }
    }
    // cmp_swap(28,30)
    if keys[28] > keys[30] || (keys[28] == keys[30] && values[28] > values[30]) {
    // swap(28,30) 
    { let tmp_2699 = keys[28]; keys[28] = keys[30]; keys[30] = tmp_2699;let tmp_2700 = values[28]; values[28] = values[30]; values[30] = tmp_2700; }
    }
    // cmp_swap(29,31)
    if keys[29] > keys[31] || (keys[29] == keys[31] && values[29] > values[31]) {
    // swap(29,31) 
    { let tmp_2701 = keys[29]; keys[29] = keys[31]; keys[31] = tmp_2701;let tmp_2702 = values[29]; values[29] = values[31]; values[31] = tmp_2702; }
    }
    // exch_local(1,32) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_2703 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_2703;let tmp_2704 = values[0]; values[0] = values[1]; values[1] = tmp_2704; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_2705 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_2705;let tmp_2706 = values[2]; values[2] = values[3]; values[3] = tmp_2706; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_2707 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_2707;let tmp_2708 = values[4]; values[4] = values[5]; values[5] = tmp_2708; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_2709 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_2709;let tmp_2710 = values[6]; values[6] = values[7]; values[7] = tmp_2710; }
    }
    // cmp_swap(8,9)
    if keys[8] > keys[9] || (keys[8] == keys[9] && values[8] > values[9]) {
    // swap(8,9) 
    { let tmp_2711 = keys[8]; keys[8] = keys[9]; keys[9] = tmp_2711;let tmp_2712 = values[8]; values[8] = values[9]; values[9] = tmp_2712; }
    }
    // cmp_swap(10,11)
    if keys[10] > keys[11] || (keys[10] == keys[11] && values[10] > values[11]) {
    // swap(10,11) 
    { let tmp_2713 = keys[10]; keys[10] = keys[11]; keys[11] = tmp_2713;let tmp_2714 = values[10]; values[10] = values[11]; values[11] = tmp_2714; }
    }
    // cmp_swap(12,13)
    if keys[12] > keys[13] || (keys[12] == keys[13] && values[12] > values[13]) {
    // swap(12,13) 
    { let tmp_2715 = keys[12]; keys[12] = keys[13]; keys[13] = tmp_2715;let tmp_2716 = values[12]; values[12] = values[13]; values[13] = tmp_2716; }
    }
    // cmp_swap(14,15)
    if keys[14] > keys[15] || (keys[14] == keys[15] && values[14] > values[15]) {
    // swap(14,15) 
    { let tmp_2717 = keys[14]; keys[14] = keys[15]; keys[15] = tmp_2717;let tmp_2718 = values[14]; values[14] = values[15]; values[15] = tmp_2718; }
    }
    // cmp_swap(16,17)
    if keys[16] > keys[17] || (keys[16] == keys[17] && values[16] > values[17]) {
    // swap(16,17) 
    { let tmp_2719 = keys[16]; keys[16] = keys[17]; keys[17] = tmp_2719;let tmp_2720 = values[16]; values[16] = values[17]; values[17] = tmp_2720; }
    }
    // cmp_swap(18,19)
    if keys[18] > keys[19] || (keys[18] == keys[19] && values[18] > values[19]) {
    // swap(18,19) 
    { let tmp_2721 = keys[18]; keys[18] = keys[19]; keys[19] = tmp_2721;let tmp_2722 = values[18]; values[18] = values[19]; values[19] = tmp_2722; }
    }
    // cmp_swap(20,21)
    if keys[20] > keys[21] || (keys[20] == keys[21] && values[20] > values[21]) {
    // swap(20,21) 
    { let tmp_2723 = keys[20]; keys[20] = keys[21]; keys[21] = tmp_2723;let tmp_2724 = values[20]; values[20] = values[21]; values[21] = tmp_2724; }
    }
    // cmp_swap(22,23)
    if keys[22] > keys[23] || (keys[22] == keys[23] && values[22] > values[23]) {
    // swap(22,23) 
    { let tmp_2725 = keys[22]; keys[22] = keys[23]; keys[23] = tmp_2725;let tmp_2726 = values[22]; values[22] = values[23]; values[23] = tmp_2726; }
    }
    // cmp_swap(24,25)
    if keys[24] > keys[25] || (keys[24] == keys[25] && values[24] > values[25]) {
    // swap(24,25) 
    { let tmp_2727 = keys[24]; keys[24] = keys[25]; keys[25] = tmp_2727;let tmp_2728 = values[24]; values[24] = values[25]; values[25] = tmp_2728; }
    }
    // cmp_swap(26,27)
    if keys[26] > keys[27] || (keys[26] == keys[27] && values[26] > values[27]) {
    // swap(26,27) 
    { let tmp_2729 = keys[26]; keys[26] = keys[27]; keys[27] = tmp_2729;let tmp_2730 = values[26]; values[26] = values[27]; values[27] = tmp_2730; }
    }
    // cmp_swap(28,29)
    if keys[28] > keys[29] || (keys[28] == keys[29] && values[28] > values[29]) {
    // swap(28,29) 
    { let tmp_2731 = keys[28]; keys[28] = keys[29]; keys[29] = tmp_2731;let tmp_2732 = values[28]; values[28] = values[29]; values[29] = tmp_2732; }
    }
    // cmp_swap(30,31)
    if keys[30] > keys[31] || (keys[30] == keys[31] && values[30] > values[31]) {
    // swap(30,31) 
    { let tmp_2733 = keys[30]; keys[30] = keys[31]; keys[31] = tmp_2733;let tmp_2734 = values[30]; values[30] = values[31]; values[31] = tmp_2734; }
    }
    ...
    if keys[0] > keys[16] || (keys[0] == keys[16] && values[0] > values[16]) {
    // swap(0,16) 
    { let tmp_3317 = keys[0]; keys[0] = keys[16]; keys[16] = tmp_3317;let tmp_3318 = values[0]; values[0] = values[16]; values[16] = tmp_3318; }
    }
    // cmp_swap(1,17)
    if keys[1] > keys[17] || (keys[1] == keys[17] && values[1] > values[17]) {
    // swap(1,17) 
    { let tmp_3319 = keys[1]; keys[1] = keys[17]; keys[17] = tmp_3319;let tmp_3320 = values[1]; values[1] = values[17]; values[17] = tmp_3320; }
    }
    // cmp_swap(2,18)
    if keys[2] > keys[18] || (keys[2] == keys[18] && values[2] > values[18]) {
    // swap(2,18) 
    { let tmp_3321 = keys[2]; keys[2] = keys[18]; keys[18] = tmp_3321;let tmp_3322 = values[2]; values[2] = values[18]; values[18] = tmp_3322; }
    }
    // cmp_swap(3,19)
    if keys[3] > keys[19] || (keys[3] == keys[19] && values[3] > values[19]) {
    // swap(3,19) 
    { let tmp_3323 = keys[3]; keys[3] = keys[19]; keys[19] = tmp_3323;let tmp_3324 = values[3]; values[3] = values[19]; values[19] = tmp_3324; }
    }
    // cmp_swap(4,20)
    if keys[4] > keys[20] || (keys[4] == keys[20] && values[4] > values[20]) {
    // swap(4,20) 
    { let tmp_3325 = keys[4]; keys[4] = keys[20]; keys[20] = tmp_3325;let tmp_3326 = values[4]; values[4] = values[20]; values[20] = tmp_3326; }
    }
    // cmp_swap(5,21)
    if keys[5] > keys[21] || (keys[5] == keys[21] && values[5] > values[21]) {
    // swap(5,21) 
    { let tmp_3327 = keys[5]; keys[5] = keys[21]; keys[21] = tmp_3327;let tmp_3328 = values[5]; values[5] = values[21]; values[21] = tmp_3328; }
    }
    // cmp_swap(6,22)
    if keys[6] > keys[22] || (keys[6] == keys[22] && values[6] > values[22]) {
    // swap(6,22) 
    { let tmp_3329 = keys[6]; keys[6] = keys[22]; keys[22] = tmp_3329;let tmp_3330 = values[6]; values[6] = values[22]; values[22] = tmp_3330; }
    }
    // cmp_swap(7,23)
    if keys[7] > keys[23] || (keys[7] == keys[23] && values[7] > values[23]) {
    // swap(7,23) 
    { let tmp_3331 = keys[7]; keys[7] = keys[23]; keys[23] = tmp_3331;let tmp_3332 = values[7]; values[7] = values[23]; values[23] = tmp_3332; }
    }
    // cmp_swap(8,24)
    if keys[8] > keys[24] || (keys[8] == keys[24] && values[8] > values[24]) {
    // swap(8,24) 
    { let tmp_3333 = keys[8]; keys[8] = keys[24]; keys[24] = tmp_3333;let tmp_3334 = values[8]; values[8] = values[24]; values[24] = tmp_3334; }
    }
    // cmp_swap(9,25)
    if keys[9] > keys[25] || (keys[9] == keys[25] && values[9] > values[25]) {
    // swap(9,25) 
    { let tmp_3335 = keys[9]; keys[9] = keys[25]; keys[25] = tmp_3335;let tmp_3336 = values[9]; values[9] = values[25]; values[25] = tmp_3336; }
    }
    // cmp_swap(10,26)
    if keys[10] > keys[26] || (keys[10] == keys[26] && values[10] > values[26]) {
    // swap(10,26) 
    { let tmp_3337 = keys[10]; keys[10] = keys[26]; keys[26] = tmp_3337;let tmp_3338 = values[10]; values[10] = values[26]; values[26] = tmp_3338; }
    }
    // cmp_swap(11,27)
    if keys[11] > keys[27] || (keys[11] == keys[27] && values[11] > values[27]) {
    // swap(11,27) 
    { let tmp_3339 = keys[11]; keys[11] = keys[27]; keys[27] = tmp_3339;let tmp_3340 = values[11]; values[11] = values[27]; values[27] = tmp_3340; }
    }
    // cmp_swap(12,28)
    if keys[12] > keys[28] || (keys[12] == keys[28] && values[12] > values[28]) {
    // swap(12,28) 
    { let tmp_3341 = keys[12]; keys[12] = keys[28]; keys[28] = tmp_3341;let tmp_3342 = values[12]; values[12] = values[28]; values[28] = tmp_3342; }
    }
    // cmp_swap(13,29)
    if keys[13] > keys[29] || (keys[13] == keys[29] && values[13] > values[29]) {
    // swap(13,29) 
    { let tmp_3343 = keys[13]; keys[13] = keys[29]; keys[29] = tmp_3343;let tmp_3344 = values[13]; values[13] = values[29]; values[29] = tmp_3344; }
    }
    // cmp_swap(14,30)
    if keys[14] > keys[30] || (keys[14] == keys[30] && values[14] > values[30]) {
    // swap(14,30) 
    { let tmp_3345 = keys[14]; keys[14] = keys[30]; keys[30] = tmp_3345;let tmp_3346 = values[14]; values[14] = values[30]; values[30] = tmp_3346; }
    }
    // cmp_swap(15,31)
    if keys[15] > keys[31] || (keys[15] == keys[31] && values[15] > values[31]) {
    // swap(15,31) 
    { let tmp_3347 = keys[15]; keys[15] = keys[31]; keys[31] = tmp_3347;let tmp_3348 = values[15]; values[15] = values[31]; values[31] = tmp_3348; }
    }
    // exch_local(8,32) 
    // cmp_swap(0,8)
    if keys[0] > keys[8] || (keys[0] == keys[8] && values[0] > values[8]) {
    // swap(0,8) 
    { let tmp_3349 = keys[0]; keys[0] = keys[8]; keys[8] = tmp_3349;let tmp_3350 = values[0]; values[0] = values[8]; values[8] = tmp_3350; }
    }
    // cmp_swap(1,9)
    if keys[1] > keys[9] || (keys[1] == keys[9] && values[1] > values[9]) {
    // swap(1,9) 
    { let tmp_3351 = keys[1]; keys[1] = keys[9]; keys[9] = tmp_3351;let tmp_3352 = values[1]; values[1] = values[9]; values[9] = tmp_3352; }
    }
    // cmp_swap(2,10)
    if keys[2] > keys[10] || (keys[2] == keys[10] && values[2] > values[10]) {
    // swap(2,10) 
    { let tmp_3353 = keys[2]; keys[2] = keys[10]; keys[10] = tmp_3353;let tmp_3354 = values[2]; values[2] = values[10]; values[10] = tmp_3354; }
    }
    // cmp_swap(3,11)
    if keys[3] > keys[11] || (keys[3] == keys[11] && values[3] > values[11]) {
    // swap(3,11) 
    { let tmp_3355 = keys[3]; keys[3] = keys[11]; keys[11] = tmp_3355;let tmp_3356 = values[3]; values[3] = values[11]; values[11] = tmp_3356; }
    }
    // cmp_swap(4,12)
    if keys[4] > keys[12] || (keys[4] == keys[12] && values[4] > values[12]) {
    // swap(4,12) 
    { let tmp_3357 = keys[4]; keys[4] = keys[12]; keys[12] = tmp_3357;let tmp_3358 = values[4]; values[4] = values[12]; values[12] = tmp_3358; }
    }
    // cmp_swap(5,13)
    if keys[5] > keys[13] || (keys[5] == keys[13] && values[5] > values[13]) {
    // swap(5,13) 
    { let tmp_3359 = keys[5]; keys[5] = keys[13]; keys[13] = tmp_3359;let tmp_3360 = values[5]; values[5] = values[13]; values[13] = tmp_3360; }
    }
    // cmp_swap(6,14)
    if keys[6] > keys[14] || (keys[6] == keys[14] && values[6] > values[14]) {
    // swap(6,14) 
    { let tmp_3361 = keys[6]; keys[6] = keys[14]; keys[14] = tmp_3361;let tmp_3362 = values[6]; values[6] = values[14]; values[14] = tmp_3362; }
    }
    // cmp_swap(7,15)
    if keys[7] > keys[15] || (keys[7] == keys[15] && values[7] > values[15]) {
    // swap(7,15) 
    { let tmp_3363 = keys[7]; keys[7] = keys[15]; keys[15] = tmp_3363;let tmp_3364 = values[7]; values[7] = values[15]; values[15] = tmp_3364; }
    }
    // cmp_swap(16,24)
    if keys[16] > keys[24] || (keys[16] == keys[24] && values[16] > values[24]) {
    // swap(16,24) 
    { let tmp_3365 = keys[16]; keys[16] = keys[24]; keys[24] = tmp_3365;let tmp_3366 = values[16]; values[16] = values[24]; values[24] = tmp_3366; }
    }
    // cmp_swap(17,25)
    if keys[17] > keys[25] || (keys[17] == keys[25] && values[17] > values[25]) {
    // swap(17,25) 
    { let tmp_3367 = keys[17]; keys[17] = keys[25]; keys[25] = tmp_3367;let tmp_3368 = values[17]; values[17] = values[25]; values[25] = tmp_3368; }
    }
    // cmp_swap(18,26)
    if keys[18] > keys[26] || (keys[18] == keys[26] && values[18] > values[26]) {
    // swap(18,26) 
    { let tmp_3369 = keys[18]; keys[18] = keys[26]; keys[26] = tmp_3369;let tmp_3370 = values[18]; values[18] = values[26]; values[26] = tmp_3370; }
    }
    // cmp_swap(19,27)
    if keys[19] > keys[27] || (keys[19] == keys[27] && values[19] > values[27]) {
    // swap(19,27) 
    { let tmp_3371 = keys[19]; keys[19] = keys[27]; keys[27] = tmp_3371;let tmp_3372 = values[19]; values[19] = values[27]; values[27] = tmp_3372; }
    }
    // cmp_swap(20,28)
    if keys[20] > keys[28] || (keys[20] == keys[28] && values[20] > values[28]) {
    // swap(20,28) 
    { let tmp_3373 = keys[20]; keys[20] = keys[28]; keys[28] = tmp_3373;let tmp_3374 = values[20]; values[20] = values[28]; values[28] = tmp_3374; }
    }
    // cmp_swap(21,29)
    if keys[21] > keys[29] || (keys[21] == keys[29] && values[21] > values[29]) {
    // swap(21,29) 
    { let tmp_3375 = keys[21]; keys[21] = keys[29]; keys[29] = tmp_3375;let tmp_3376 = values[21]; values[21] = values[29]; values[29] = tmp_3376; }
    }
    // cmp_swap(22,30)
    if keys[22] > keys[30] || (keys[22] == keys[30] && values[22] > values[30]) {
    // swap(22,30) 
    { let tmp_3377 = keys[22]; keys[22] = keys[30]; keys[30] = tmp_3377;let tmp_3378 = values[22]; values[22] = values[30]; values[30] = tmp_3378; }
    }
    // cmp_swap(23,31)
    if keys[23] > keys[31] || (keys[23] == keys[31] && values[23] > values[31]) {
    // swap(23,31) 
    { let tmp_3379 = keys[23]; keys[23] = keys[31]; keys[31] = tmp_3379;let tmp_3380 = values[23]; values[23] = values[31]; values[31] = tmp_3380; }
    }
    // exch_local(4,32) 
    // cmp_swap(0,4)
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_3381 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_3381;let tmp_3382 = values[0]; values[0] = values[4]; values[4] = tmp_3382; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_3383 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_3383;let tmp_3384 = values[1]; values[1] = values[5]; values[5] = tmp_3384; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_3385 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_3385;let tmp_3386 = values[2]; values[2] = values[6]; values[6] = tmp_3386; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_3387 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_3387;let tmp_3388 = values[3]; values[3] = values[7]; values[7] = tmp_3388; }
    }
    // cmp_swap(8,12)
    if keys[8] > keys[12] || (keys[8] == keys[12] && values[8] > values[12]) {
    // swap(8,12) 
    { let tmp_3389 = keys[8]; keys[8] = keys[12]; keys[12] = tmp_3389;let tmp_3390 = values[8]; values[8] = values[12]; values[12] = tmp_3390; }
    }
    // cmp_swap(9,13)
    if keys[9] > keys[13] || (keys[9] == keys[13] && values[9] > values[13]) {
    // swap(9,13) 
    { let tmp_3391 = keys[9]; keys[9] = keys[13]; keys[13] = tmp_3391;let tmp_3392 = values[9]; values[9] = values[13]; values[13] = tmp_3392; }
    }
    // cmp_swap(10,14)
    if keys[10] > keys[14] || (keys[10] == keys[14] && values[10] > values[14]) {
    // swap(10,14) 
    { let tmp_3393 = keys[10]; keys[10] = keys[14]; keys[14] = tmp_3393;let tmp_3394 = values[10]; values[10] = values[14]; values[14] = tmp_3394; }
    }
    // cmp_swap(11,15)
    if keys[11] > keys[15] || (keys[11] == keys[15] && values[11] > values[15]) {
    // swap(11,15) 
    { let tmp_3395 = keys[11]; keys[11] = keys[15]; keys[15] = tmp_3395;let tmp_3396 = values[11]; values[11] = values[15]; values[15] = tmp_3396; }
    }
    // cmp_swap(16,20)
    if keys[16] > keys[20] || (keys[16] == keys[20] && values[16] > values[20]) {
    // swap(16,20) 
    { let tmp_3397 = keys[16]; keys[16] = keys[20]; keys[20] = tmp_3397;let tmp_3398 = values[16]; values[16] = values[20]; values[20] = tmp_3398; }
    }
    // cmp_swap(17,21)
    if keys[17] > keys[21] || (keys[17] == keys[21] && values[17] > values[21]) {
    // swap(17,21) 
    { let tmp_3399 = keys[17]; keys[17] = keys[21]; keys[21] = tmp_3399;let tmp_3400 = values[17]; values[17] = values[21]; values[21] = tmp_3400; }
    }
    // cmp_swap(18,22)
    if keys[18] > keys[22] || (keys[18] == keys[22] && values[18] > values[22]) {
    // swap(18,22) 
    { let tmp_3401 = keys[18]; keys[18] = keys[22]; keys[22] = tmp_3401;let tmp_3402 = values[18]; values[18] = values[22]; values[22] = tmp_3402; }
    }
    // cmp_swap(19,23)
    if keys[19] > keys[23] || (keys[19] == keys[23] && values[19] > values[23]) {
    // swap(19,23) 
    { let tmp_3403 = keys[19]; keys[19] = keys[23]; keys[23] = tmp_3403;let tmp_3404 = values[19]; values[19] = values[23]; values[23] = tmp_3404; }
    }
    // cmp_swap(24,28)
    if keys[24] > keys[28] || (keys[24] == keys[28] && values[24] > values[28]) {
    // swap(24,28) 
    { let tmp_3405 = keys[24]; keys[24] = keys[28]; keys[28] = tmp_3405;let tmp_3406 = values[24]; values[24] = values[28]; values[28] = tmp_3406; }
    }
    // cmp_swap(25,29)
    if keys[25] > keys[29] || (keys[25] == keys[29] && values[25] > values[29]) {
    // swap(25,29) 
    { let tmp_3407 = keys[25]; keys[25] = keys[29]; keys[29] = tmp_3407;let tmp_3408 = values[25]; values[25] = values[29]; values[29] = tmp_3408; }
    }
    // cmp_swap(26,30)
    if keys[26] > keys[30] || (keys[26] == keys[30] && values[26] > values[30]) {
    // swap(26,30) 
    { let tmp_3409 = keys[26]; keys[26] = keys[30]; keys[30] = tmp_3409;let tmp_3410 = values[26]; values[26] = values[30]; values[30] = tmp_3410; }
    }
    // cmp_swap(27,31)
    if keys[27] > keys[31] || (keys[27] == keys[31] && values[27] > values[31]) {
    // swap(27,31) 
    { let tmp_3411 = keys[27]; keys[27] = keys[31]; keys[31] = tmp_3411;let tmp_3412 = values[27]; values[27] = values[31]; values[31] = tmp_3412; }
    }
    // exch_local(2,32) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_3413 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_3413;let tmp_3414 = values[0]; values[0] = values[2]; values[2] = tmp_3414; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_3415 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_3415;let tmp_3416 = values[1]; values[1] = values[3]; values[3] = tmp_3416; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_3417 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_3417;let tmp_3418 = values[4]; values[4] = values[6]; values[6] = tmp_3418; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_3419 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_3419;let tmp_3420 = values[5]; values[5] = values[7]; values[7] = tmp_3420; }
    }
    // cmp_swap(8,10)
    if keys[8] > keys[10] || (keys[8] == keys[10] && values[8] > values[10]) {
    // swap(8,10) 
    { let tmp_3421 = keys[8]; keys[8] = keys[10]; keys[10] = tmp_3421;let tmp_3422 = values[8]; values[8] = values[10]; values[10] = tmp_3422; }
    }
    // cmp_swap(9,11)
    if keys[9] > keys[11] || (keys[9] == keys[11] && values[9] > values[11]) {
    // swap(9,11) 
    { let tmp_3423 = keys[9]; keys[9] = keys[11]; keys[11] = tmp_3423;let tmp_3424 = values[9]; values[9] = values[11]; values[11] = tmp_3424; }
    }
    // cmp_swap(12,14)
    if keys[12] > keys[14] || (keys[12] == keys[14] && values[12] > values[14]) {
    // swap(12,14) 
    { let tmp_3425 = keys[12]; keys[12] = keys[14]; keys[14] = tmp_3425;let tmp_3426 = values[12]; values[12] = values[14]; values[14] = tmp_3426; }
    }
    // cmp_swap(13,15)
    if keys[13] > keys[15] || (keys[13] == keys[15] && values[13] > values[15]) {
    // swap(13,15) 
    { let tmp_3427 = keys[13]; keys[13] = keys[15]; keys[15] = tmp_3427;let tmp_3428 = values[13]; values[13] = values[15]; values[15] = tmp_3428; }
    }
    // cmp_swap(16,18)
    if keys[16] > keys[18] || (keys[16] == keys[18] && values[16] > values[18]) {
    // swap(16,18) 
    { let tmp_3429 = keys[16]; keys[16] = keys[18]; keys[18] = tmp_3429;let tmp_3430 = values[16]; values[16] = values[18]; values[18] = tmp_3430; }
    }
    // cmp_swap(17,19)
    if keys[17] > keys[19] || (keys[17] == keys[19] && values[17] > values[19]) {
    // swap(17,19) 
    { let tmp_3431 = keys[17]; keys[17] = keys[19]; keys[19] = tmp_3431;let tmp_3432 = values[17]; values[17] = values[19]; values[19] = tmp_3432; }
    }
    // cmp_swap(20,22)
    if keys[20] > keys[22] || (keys[20] == keys[22] && values[20] > values[22]) {
    // swap(20,22) 
    { let tmp_3433 = keys[20]; keys[20] = keys[22]; keys[22] = tmp_3433;let tmp_3434 = values[20]; values[20] = values[22]; values[22] = tmp_3434; }
    }
    // cmp_swap(21,23)
    if keys[21] > keys[23] || (keys[21] == keys[23] && values[21] > values[23]) {
    // swap(21,23) 
    { let tmp_3435 = keys[21]; keys[21] = keys[23]; keys[23] = tmp_3435;let tmp_3436 = values[21]; values[21] = values[23]; values[23] = tmp_3436; }
    }
    // cmp_swap(24,26)
    if keys[24] > keys[26] || (keys[24] == keys[26] && values[24] > values[26]) {
    // swap(24,26) 
    { let tmp_3437 = keys[24]; keys[24] = keys[26]; keys[26] = tmp_3437;let tmp_3438 = values[24]; values[24] = values[26]; values[26] = tmp_3438; }
    }
    // cmp_swap(25,27)
    if keys[25] > keys[27] || (keys[25] == keys[27] && values[25] > values[27]) {
    // swap(25,27) 
    { let tmp_3439 = keys[25]; keys[25] = keys[27]; keys[27] = tmp_3439;let tmp_3440 = values[25]; values[25] = values[27]; values[27] = tmp_3440; }
    }
    // cmp_swap(28,30)
    if keys[28] > keys[30] || (keys[28] == keys[30] && values[28] > values[30]) {
    // swap(28,30) 
    { let tmp_3441 = keys[28]; keys[28] = keys[30]; keys[30] = tmp_3441;let tmp_3442 = values[28]; values[28] = values[30]; values[30] = tmp_3442; }
    }
    // cmp_swap(29,31)
    if keys[29] > keys[31] || (keys[29] == keys[31] && values[29] > values[31]) {
    // swap(29,31) 
    { let tmp_3443 = keys[29]; keys[29] = keys[31]; keys[31] = tmp_3443;let tmp_3444 = values[29]; values[29] = values[31]; values[31] = tmp_3444; }
    }
    // exch_local(1,32) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_3445 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_3445;let tmp_3446 = values[0]; values[0] = values[1]; values[1] = tmp_3446; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_3447 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_3447;let tmp_3448 = values[2]; values[2] = values[3]; values[3] = tmp_3448; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_3449 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_3449;let tmp_3450 = values[4]; values[4] = values[5]; values[5] = tmp_3450; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_3451 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_3451;let tmp_3452 = values[6]; values[6] = values[7]; values[7] = tmp_3452; }
    }
    // cmp_swap(8,9)
    if keys[8] > keys[9] || (keys[8] == keys[9] && values[8] > values[9]) {
    // swap(8,9) 
    { let tmp_3453 = keys[8]; keys[8] = keys[9]; keys[9] = tmp_3453;let tmp_3454 = values[8]; values[8] = values[9]; values[9] = tmp_3454; }
    }
    // cmp_swap(10,11)
    if keys[10] > keys[11] || (keys[10] == keys[11] && values[10] > values[11]) {
    // swap(10,11) 
    { let tmp_3455 = keys[10]; keys[10] = keys[11]; keys[11] = tmp_3455;let tmp_3456 = values[10]; values[10] = values[11]; values[11] = tmp_3456; }
    }
    // cmp_swap(12,13)
    if keys[12] > keys[13] || (keys[12] == keys[13] && values[12] > values[13]) {
    // swap(12,13) 
    { let tmp_3457 = keys[12]; keys[12] = keys[13]; keys[13] = tmp_3457;let tmp_3458 = values[12]; values[12] = values[13]; values[13] = tmp_3458; }
    }
    // cmp_swap(14,15)
    if keys[14] > keys[15] || (keys[14] == keys[15] && values[14] > values[15]) {
    // swap(14,15) 
    { let tmp_3459 = keys[14]; keys[14] = keys[15]; keys[15] = tmp_3459;let tmp_3460 = values[14]; values[14] = values[15]; values[15] = tmp_3460; }
    }
    // cmp_swap(16,17)
    if keys[16] > keys[17] || (keys[16] == keys[17] && values[16] > values[17]) {
    // swap(16,17) 
    { let tmp_3461 = keys[16]; keys[16] = keys[17]; keys[17] = tmp_3461;let tmp_3462 = values[16]; values[16] = values[17]; values[17] = tmp_3462; }
    }
    // cmp_swap(18,19)
    if keys[18] > keys[19] || (keys[18] == keys[19] && values[18] > values[19]) {
    // swap(18,19) 
    { let tmp_3463 = keys[18]; keys[18] = keys[19]; keys[19] = tmp_3463;let tmp_3464 = values[18]; values[18] = values[19]; values[19] = tmp_3464; }
    }
    // cmp_swap(20,21)
    if keys[20] > keys[21] || (keys[20] == keys[21] && values[20] > values[21]) {
    // swap(20,21) 
    { let tmp_3465 = keys[20]; keys[20] = keys[21]; keys[21] = tmp_3465;let tmp_3466 = values[20]; values[20] = values[21]; values[21] = tmp_3466; }
    }
    // cmp_swap(22,23)
    if keys[22] > keys[23] || (keys[22] == keys[23] && values[22] > values[23]) {
    // swap(22,23) 
    { let tmp_3467 = keys[22]; keys[22] = keys[23]; keys[23] = tmp_3467;let tmp_3468 = values[22]; values[22] = values[23]; values[23] = tmp_3468; }
    }
    // cmp_swap(24,25)
    if keys[24] > keys[25] || (keys[24] == keys[25] && values[24] > values[25]) {
    // swap(24,25) 
    { let tmp_3469 = keys[24]; keys[24] = keys[25]; keys[25] = tmp_3469;let tmp_3470 = values[24]; values[24] = values[25]; values[25] = tmp_3470; }
    }
    // cmp_swap(26,27)
    if keys[26] > keys[27] || (keys[26] == keys[27] && values[26] > values[27]) {
    // swap(26,27) 
    { let tmp_3471 = keys[26]; keys[26] = keys[27]; keys[27] = tmp_3471;let tmp_3472 = values[26]; values[26] = values[27]; values[27] = tmp_3472; }
    }
    // cmp_swap(28,29)
    if keys[28] > keys[29] || (keys[28] == keys[29] && values[28] > values[29]) {
    // swap(28,29) 
    { let tmp_3473 = keys[28]; keys[28] = keys[29]; keys[29] = tmp_3473;let tmp_3474 = values[28]; values[28] = values[29]; values[29] = tmp_3474; }
    }
    // cmp_swap(30,31)
    if keys[30] > keys[31] || (keys[30] == keys[31] && values[30] > values[31]) {
    // swap(30,31) 
    { let tmp_3475 = keys[30]; keys[30] = keys[31]; keys[31] = tmp_3475;let tmp_3476 = values[30]; values[30] = values[31]; values[31] = tmp_3476; }
    }
