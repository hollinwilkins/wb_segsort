...
fn segsort_hybrid_sg64_n2048_m256_striped(
    ...
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; workgroupBarrier(); let tmp_717 = extractBits(local_tid, 6u, 1u) != 0u; let tmp_718 = seg_base + (local_tid ^ 127u); let tmp_719 = smem_keys[tmp_718 * WPT + 7u]; let tmp_720 = smem_vals[tmp_718 * WPT + 7u]; let tmp_721 = keys[0] < tmp_719 || (keys[0] == tmp_719 && values[0] < tmp_720); if tmp_717 == tmp_721 { keys[0] = tmp_719; values[0] = tmp_720; } let tmp_722 = smem_keys[tmp_718 * WPT + 6u]; let tmp_723 = smem_vals[tmp_718 * WPT + 6u]; let tmp_724 = keys[1] < tmp_722 || (keys[1] == tmp_722 && values[1] < tmp_723); if tmp_717 == tmp_724 { keys[1] = tmp_722; values[1] = tmp_723; } let tmp_725 = smem_keys[tmp_718 * WPT + 5u]; let tmp_726 = smem_vals[tmp_718 * WPT + 5u]; let tmp_727 = keys[2] < tmp_725 || (keys[2] == tmp_725 && values[2] < tmp_726); if tmp_717 == tmp_727 { keys[2] = tmp_725; values[2] = tmp_726; } let tmp_728 = smem_keys[tmp_718 * WPT + 4u]; let tmp_729 = smem_vals[tmp_718 * WPT + 4u]; let tmp_730 = keys[3] < tmp_728 || (keys[3] == tmp_728 && values[3] < tmp_729); if tmp_717 == tmp_730 { keys[3] = tmp_728; values[3] = tmp_729; } let tmp_731 = smem_keys[tmp_718 * WPT + 3u]; let tmp_732 = smem_vals[tmp_718 * WPT + 3u]; let tmp_733 = keys[4] < tmp_731 || (keys[4] == tmp_731 && values[4] < tmp_732); if tmp_717 == tmp_733 { keys[4] = tmp_731; values[4] = tmp_732; } let tmp_734 = smem_keys[tmp_718 * WPT + 2u]; let tmp_735 = smem_vals[tmp_718 * WPT + 2u]; let tmp_736 = keys[5] < tmp_734 || (keys[5] == tmp_734 && values[5] < tmp_735); if tmp_717 == tmp_736 { keys[5] = tmp_734; values[5] = tmp_735; } let tmp_737 = smem_keys[tmp_718 * WPT + 1u]; let tmp_738 = smem_vals[tmp_718 * WPT + 1u]; let tmp_739 = keys[6] < tmp_737 || (keys[6] == tmp_737 && values[6] < tmp_738); if tmp_717 == tmp_739 { keys[6] = tmp_737; values[6] = tmp_738; } let tmp_740 = smem_keys[tmp_718 * WPT + 0u]; let tmp_741 = smem_vals[tmp_718 * WPT + 0u]; let tmp_742 = keys[7] < tmp_740 || (keys[7] == tmp_740 && values[7] < tmp_741); if tmp_717 == tmp_742 { keys[7] = tmp_740; values[7] = tmp_741; } workgroupBarrier(); }
    ...
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_893 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_893;let tmp_894 = values[0]; values[0] = values[4]; values[4] = tmp_894; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_895 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_895;let tmp_896 = values[1]; values[1] = values[5]; values[5] = tmp_896; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_897 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_897;let tmp_898 = values[2]; values[2] = values[6]; values[6] = tmp_898; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_899 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_899;let tmp_900 = values[3]; values[3] = values[7]; values[7] = tmp_900; }
    }
    // exch_local(2,8) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_901 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_901;let tmp_902 = values[0]; values[0] = values[2]; values[2] = tmp_902; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_903 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_903;let tmp_904 = values[1]; values[1] = values[3]; values[3] = tmp_904; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_905 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_905;let tmp_906 = values[4]; values[4] = values[6]; values[6] = tmp_906; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_907 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_907;let tmp_908 = values[5]; values[5] = values[7]; values[7] = tmp_908; }
    }
    // exch_local(1,8) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_909 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_909;let tmp_910 = values[0]; values[0] = values[1]; values[1] = tmp_910; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_911 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_911;let tmp_912 = values[2]; values[2] = values[3]; values[3] = tmp_912; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_913 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_913;let tmp_914 = values[4]; values[4] = values[5]; values[5] = tmp_914; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_915 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_915;let tmp_916 = values[6]; values[6] = values[7]; values[7] = tmp_916; }
    }
    // exch_intxn(tmask:255,swbit:7,wpt:8)
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; workgroupBarrier(); let tmp_917 = extractBits(local_tid, 7u, 1u) != 0u; let tmp_918 = seg_base + (local_tid ^ 255u); let tmp_919 = smem_keys[tmp_918 * WPT + 7u]; let tmp_920 = smem_vals[tmp_918 * WPT + 7u]; let tmp_921 = keys[0] < tmp_919 || (keys[0] == tmp_919 && values[0] < tmp_920); if tmp_917 == tmp_921 { keys[0] = tmp_919; values[0] = tmp_920; } let tmp_922 = smem_keys[tmp_918 * WPT + 6u]; let tmp_923 = smem_vals[tmp_918 * WPT + 6u]; let tmp_924 = keys[1] < tmp_922 || (keys[1] == tmp_922 && values[1] < tmp_923); if tmp_917 == tmp_924 { keys[1] = tmp_922; values[1] = tmp_923; } let tmp_925 = smem_keys[tmp_918 * WPT + 5u]; let tmp_926 = smem_vals[tmp_918 * WPT + 5u]; let tmp_927 = keys[2] < tmp_925 || (keys[2] == tmp_925 && values[2] < tmp_926); if tmp_917 == tmp_927 { keys[2] = tmp_925; values[2] = tmp_926; } let tmp_928 = smem_keys[tmp_918 * WPT + 4u]; let tmp_929 = smem_vals[tmp_918 * WPT + 4u]; let tmp_930 = keys[3] < tmp_928 || (keys[3] == tmp_928 && values[3] < tmp_929); if tmp_917 == tmp_930 { keys[3] = tmp_928; values[3] = tmp_929; } let tmp_931 = smem_keys[tmp_918 * WPT + 3u]; let tmp_932 = smem_vals[tmp_918 * WPT + 3u]; let tmp_933 = keys[4] < tmp_931 || (keys[4] == tmp_931 && values[4] < tmp_932); if tmp_917 == tmp_933 { keys[4] = tmp_931; values[4] = tmp_932; } let tmp_934 = smem_keys[tmp_918 * WPT + 2u]; let tmp_935 = smem_vals[tmp_918 * WPT + 2u]; let tmp_936 = keys[5] < tmp_934 || (keys[5] == tmp_934 && values[5] < tmp_935); if tmp_917 == tmp_936 { keys[5] = tmp_934; values[5] = tmp_935; } let tmp_937 = smem_keys[tmp_918 * WPT + 1u]; let tmp_938 = smem_vals[tmp_918 * WPT + 1u]; let tmp_939 = keys[6] < tmp_937 || (keys[6] == tmp_937 && values[6] < tmp_938); if tmp_917 == tmp_939 { keys[6] = tmp_937; values[6] = tmp_938; } let tmp_940 = smem_keys[tmp_918 * WPT + 0u]; let tmp_941 = smem_vals[tmp_918 * WPT + 0u]; let tmp_942 = keys[7] < tmp_940 || (keys[7] == tmp_940 && values[7] < tmp_941); if tmp_917 == tmp_942 { keys[7] = tmp_940; values[7] = tmp_941; } workgroupBarrier(); }
    // exch_paral(tmask:64,swbit:6,wpt:8) 
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; workgroupBarrier(); let tmp_943 = extractBits(local_tid, 6u, 1u) != 0u; let tmp_944 = seg_base + (local_tid ^ 64u); let tmp_945 = smem_keys[tmp_944 * WPT + 0u]; let tmp_946 = smem_vals[tmp_944 * WPT + 0u]; let tmp_947 = keys[0] < tmp_945 || (keys[0] == tmp_945 && values[0] < tmp_946); if tmp_943 == tmp_947 { keys[0] = tmp_945; values[0] = tmp_946; } let tmp_948 = smem_keys[tmp_944 * WPT + 1u]; let tmp_949 = smem_vals[tmp_944 * WPT + 1u]; let tmp_950 = keys[1] < tmp_948 || (keys[1] == tmp_948 && values[1] < tmp_949); if tmp_943 == tmp_950 { keys[1] = tmp_948; values[1] = tmp_949; } let tmp_951 = smem_keys[tmp_944 * WPT + 2u]; let tmp_952 = smem_vals[tmp_944 * WPT + 2u]; let tmp_953 = keys[2] < tmp_951 || (keys[2] == tmp_951 && values[2] < tmp_952); if tmp_943 == tmp_953 { keys[2] = tmp_951; values[2] = tmp_952; } let tmp_954 = smem_keys[tmp_944 * WPT + 3u]; let tmp_955 = smem_vals[tmp_944 * WPT + 3u]; let tmp_956 = keys[3] < tmp_954 || (keys[3] == tmp_954 && values[3] < tmp_955); if tmp_943 == tmp_956 { keys[3] = tmp_954; values[3] = tmp_955; } let tmp_957 = smem_keys[tmp_944 * WPT + 4u]; let tmp_958 = smem_vals[tmp_944 * WPT + 4u]; let tmp_959 = keys[4] < tmp_957 || (keys[4] == tmp_957 && values[4] < tmp_958); if tmp_943 == tmp_959 { keys[4] = tmp_957; values[4] = tmp_958; } let tmp_960 = smem_keys[tmp_944 * WPT + 5u]; let tmp_961 = smem_vals[tmp_944 * WPT + 5u]; let tmp_962 = keys[5] < tmp_960 || (keys[5] == tmp_960 && values[5] < tmp_961); if tmp_943 == tmp_962 { keys[5] = tmp_960; values[5] = tmp_961; } let tmp_963 = smem_keys[tmp_944 * WPT + 6u]; let tmp_964 = smem_vals[tmp_944 * WPT + 6u]; let tmp_965 = keys[6] < tmp_963 || (keys[6] == tmp_963 && values[6] < tmp_964); if tmp_943 == tmp_965 { keys[6] = tmp_963; values[6] = tmp_964; } let tmp_966 = smem_keys[tmp_944 * WPT + 7u]; let tmp_967 = smem_vals[tmp_944 * WPT + 7u]; let tmp_968 = keys[7] < tmp_966 || (keys[7] == tmp_966 && values[7] < tmp_967); if tmp_943 == tmp_968 { keys[7] = tmp_966; values[7] = tmp_967; } workgroupBarrier(); }
    // exch_paral(tmask:32,swbit:5,wpt:8) 
    {
    ...
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_1119 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_1119;let tmp_1120 = values[0]; values[0] = values[4]; values[4] = tmp_1120; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_1121 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_1121;let tmp_1122 = values[1]; values[1] = values[5]; values[5] = tmp_1122; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_1123 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_1123;let tmp_1124 = values[2]; values[2] = values[6]; values[6] = tmp_1124; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_1125 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_1125;let tmp_1126 = values[3]; values[3] = values[7]; values[7] = tmp_1126; }
    }
    // exch_local(2,8) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_1127 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_1127;let tmp_1128 = values[0]; values[0] = values[2]; values[2] = tmp_1128; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_1129 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_1129;let tmp_1130 = values[1]; values[1] = values[3]; values[3] = tmp_1130; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_1131 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_1131;let tmp_1132 = values[4]; values[4] = values[6]; values[6] = tmp_1132; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_1133 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_1133;let tmp_1134 = values[5]; values[5] = values[7]; values[7] = tmp_1134; }
    }
    // exch_local(1,8) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_1135 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_1135;let tmp_1136 = values[0]; values[0] = values[1]; values[1] = tmp_1136; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_1137 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_1137;let tmp_1138 = values[2]; values[2] = values[3]; values[3] = tmp_1138; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_1139 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_1139;let tmp_1140 = values[4]; values[4] = values[5]; values[5] = tmp_1140; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_1141 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_1141;let tmp_1142 = values[6]; values[6] = values[7]; values[7] = tmp_1142; }
    }
