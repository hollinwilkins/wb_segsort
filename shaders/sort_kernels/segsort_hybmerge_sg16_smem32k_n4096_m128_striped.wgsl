...
const M: u32 = 128u;
const WPT: u32 = 32u;
const SG: u32 = 16u;      // register run spans one subgroup: RUN = SG*WPT = 512

var<workgroup> smem_keys: array<u32, N>;
var<workgroup> smem_vals: array<u32, N>;

@compute @workgroup_size(WG, 1, 1)
fn segsort_hybmerge_sg16_smem32k_n4096_m128_striped(
    ...
    // merge pass 0: two sorted runs of 512 -> 1024 (register-staged)
    {
    ...
    workgroupBarrier();
    // merge pass 1: two sorted runs of 1024 -> 2048 (register-staged)
    {
    ...
    workgroupBarrier();
    // merge pass 2: two sorted runs of 2048 -> 4096 (register-staged)
    {
