...
fn segsort_reg_n2048_m128_striped(
    ...
    if keys[0] > keys[8] || (keys[0] == keys[8] && values[0] > values[8]) {
    // swap(0,8) 
    { let tmp_1509 = keys[0]; keys[0] = keys[8]; keys[8] = tmp_1509;let tmp_1510 = values[0]; values[0] = values[8]; values[8] = tmp_1510; }
    }
    // cmp_swap(1,9)
    if keys[1] > keys[9] || (keys[1] == keys[9] && values[1] > values[9]) {
    // swap(1,9) 
    { let tmp_1511 = keys[1]; keys[1] = keys[9]; keys[9] = tmp_1511;let tmp_1512 = values[1]; values[1] = values[9]; values[9] = tmp_1512; }
    }
    // cmp_swap(2,10)
    if keys[2] > keys[10] || (keys[2] == keys[10] && values[2] > values[10]) {
    // swap(2,10) 
    { let tmp_1513 = keys[2]; keys[2] = keys[10]; keys[10] = tmp_1513;let tmp_1514 = values[2]; values[2] = values[10]; values[10] = tmp_1514; }
    }
    // cmp_swap(3,11)
    if keys[3] > keys[11] || (keys[3] == keys[11] && values[3] > values[11]) {
    // swap(3,11) 
    { let tmp_1515 = keys[3]; keys[3] = keys[11]; keys[11] = tmp_1515;let tmp_1516 = values[3]; values[3] = values[11]; values[11] = tmp_1516; }
    }
    // cmp_swap(4,12)
    if keys[4] > keys[12] || (keys[4] == keys[12] && values[4] > values[12]) {
    // swap(4,12) 
    { let tmp_1517 = keys[4]; keys[4] = keys[12]; keys[12] = tmp_1517;let tmp_1518 = values[4]; values[4] = values[12]; values[12] = tmp_1518; }
    }
    // cmp_swap(5,13)
    if keys[5] > keys[13] || (keys[5] == keys[13] && values[5] > values[13]) {
    // swap(5,13) 
    { let tmp_1519 = keys[5]; keys[5] = keys[13]; keys[13] = tmp_1519;let tmp_1520 = values[5]; values[5] = values[13]; values[13] = tmp_1520; }
    }
    // cmp_swap(6,14)
    if keys[6] > keys[14] || (keys[6] == keys[14] && values[6] > values[14]) {
    // swap(6,14) 
    { let tmp_1521 = keys[6]; keys[6] = keys[14]; keys[14] = tmp_1521;let tmp_1522 = values[6]; values[6] = values[14]; values[14] = tmp_1522; }
    }
    // cmp_swap(7,15)
    if keys[7] > keys[15] || (keys[7] == keys[15] && values[7] > values[15]) {
    // swap(7,15) 
    { let tmp_1523 = keys[7]; keys[7] = keys[15]; keys[15] = tmp_1523;let tmp_1524 = values[7]; values[7] = values[15]; values[15] = tmp_1524; }
    }
    // exch_local(4,16) 
    // cmp_swap(0,4)
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_1525 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_1525;let tmp_1526 = values[0]; values[0] = values[4]; values[4] = tmp_1526; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_1527 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_1527;let tmp_1528 = values[1]; values[1] = values[5]; values[5] = tmp_1528; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_1529 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_1529;let tmp_1530 = values[2]; values[2] = values[6]; values[6] = tmp_1530; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_1531 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_1531;let tmp_1532 = values[3]; values[3] = values[7]; values[7] = tmp_1532; }
    }
    // cmp_swap(8,12)
    if keys[8] > keys[12] || (keys[8] == keys[12] && values[8] > values[12]) {
    // swap(8,12) 
    { let tmp_1533 = keys[8]; keys[8] = keys[12]; keys[12] = tmp_1533;let tmp_1534 = values[8]; values[8] = values[12]; values[12] = tmp_1534; }
    }
    // cmp_swap(9,13)
    if keys[9] > keys[13] || (keys[9] == keys[13] && values[9] > values[13]) {
    // swap(9,13) 
    { let tmp_1535 = keys[9]; keys[9] = keys[13]; keys[13] = tmp_1535;let tmp_1536 = values[9]; values[9] = values[13]; values[13] = tmp_1536; }
    }
    // cmp_swap(10,14)
    if keys[10] > keys[14] || (keys[10] == keys[14] && values[10] > values[14]) {
    // swap(10,14) 
    { let tmp_1537 = keys[10]; keys[10] = keys[14]; keys[14] = tmp_1537;let tmp_1538 = values[10]; values[10] = values[14]; values[14] = tmp_1538; }
    }
    // cmp_swap(11,15)
    if keys[11] > keys[15] || (keys[11] == keys[15] && values[11] > values[15]) {
    // swap(11,15) 
    { let tmp_1539 = keys[11]; keys[11] = keys[15]; keys[15] = tmp_1539;let tmp_1540 = values[11]; values[11] = values[15]; values[15] = tmp_1540; }
    }
    // exch_local(2,16) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_1541 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_1541;let tmp_1542 = values[0]; values[0] = values[2]; values[2] = tmp_1542; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_1543 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_1543;let tmp_1544 = values[1]; values[1] = values[3]; values[3] = tmp_1544; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_1545 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_1545;let tmp_1546 = values[4]; values[4] = values[6]; values[6] = tmp_1546; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_1547 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_1547;let tmp_1548 = values[5]; values[5] = values[7]; values[7] = tmp_1548; }
    }
    // cmp_swap(8,10)
    if keys[8] > keys[10] || (keys[8] == keys[10] && values[8] > values[10]) {
    // swap(8,10) 
    { let tmp_1549 = keys[8]; keys[8] = keys[10]; keys[10] = tmp_1549;let tmp_1550 = values[8]; values[8] = values[10]; values[10] = tmp_1550; }
    }
    // cmp_swap(9,11)
    if keys[9] > keys[11] || (keys[9] == keys[11] && values[9] > values[11]) {
    // swap(9,11) 
    { let tmp_1551 = keys[9]; keys[9] = keys[11]; keys[11] = tmp_1551;let tmp_1552 = values[9]; values[9] = values[11]; values[11] = tmp_1552; }
    }
    // cmp_swap(12,14)
    if keys[12] > keys[14] || (keys[12] == keys[14] && values[12] > values[14]) {
    // swap(12,14) 
    { let tmp_1553 = keys[12]; keys[12] = keys[14]; keys[14] = tmp_1553;let tmp_1554 = values[12]; values[12] = values[14]; values[14] = tmp_1554; }
    }
    // cmp_swap(13,15)
    if keys[13] > keys[15] || (keys[13] == keys[15] && values[13] > values[15]) {
    // swap(13,15) 
    { let tmp_1555 = keys[13]; keys[13] = keys[15]; keys[15] = tmp_1555;let tmp_1556 = values[13]; values[13] = values[15]; values[15] = tmp_1556; }
    }
    // exch_local(1,16) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_1557 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_1557;let tmp_1558 = values[0]; values[0] = values[1]; values[1] = tmp_1558; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_1559 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_1559;let tmp_1560 = values[2]; values[2] = values[3]; values[3] = tmp_1560; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_1561 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_1561;let tmp_1562 = values[4]; values[4] = values[5]; values[5] = tmp_1562; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_1563 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_1563;let tmp_1564 = values[6]; values[6] = values[7]; values[7] = tmp_1564; }
    }
    // cmp_swap(8,9)
    if keys[8] > keys[9] || (keys[8] == keys[9] && values[8] > values[9]) {
    // swap(8,9) 
    { let tmp_1565 = keys[8]; keys[8] = keys[9]; keys[9] = tmp_1565;let tmp_1566 = values[8]; values[8] = values[9]; values[9] = tmp_1566; }
    }
    // cmp_swap(10,11)
    if keys[10] > keys[11] || (keys[10] == keys[11] && values[10] > values[11]) {
    // swap(10,11) 
    { let tmp_1567 = keys[10]; keys[10] = keys[11]; keys[11] = tmp_1567;let tmp_1568 = values[10]; values[10] = values[11]; values[11] = tmp_1568; }
    }
    // cmp_swap(12,13)
    if keys[12] > keys[13] || (keys[12] == keys[13] && values[12] > values[13]) {
    // swap(12,13) 
    { let tmp_1569 = keys[12]; keys[12] = keys[13]; keys[13] = tmp_1569;let tmp_1570 = values[12]; values[12] = values[13]; values[13] = tmp_1570; }
    }
    // cmp_swap(14,15)
    if keys[14] > keys[15] || (keys[14] == keys[15] && values[14] > values[15]) {
    // swap(14,15) 
    { let tmp_1571 = keys[14]; keys[14] = keys[15]; keys[15] = tmp_1571;let tmp_1572 = values[14]; values[14] = values[15]; values[15] = tmp_1572; }
    }
    // exch_intxn(tmask:127,swbit:6,wpt:16)
    {
    let tmp_1573 = subgroupShuffleXor(keys[15], 127u);
    let tmp_1574 = subgroupShuffleXor(values[15], 127u);
    let tmp_1575 = subgroupShuffleXor(keys[14], 127u);
    let tmp_1576 = subgroupShuffleXor(values[14], 127u);
    let tmp_1577 = subgroupShuffleXor(keys[13], 127u);
    let tmp_1578 = subgroupShuffleXor(values[13], 127u);
    let tmp_1579 = subgroupShuffleXor(keys[12], 127u);
    let tmp_1580 = subgroupShuffleXor(values[12], 127u);
    let tmp_1581 = subgroupShuffleXor(keys[11], 127u);
    let tmp_1582 = subgroupShuffleXor(values[11], 127u);
    let tmp_1583 = subgroupShuffleXor(keys[10], 127u);
    let tmp_1584 = subgroupShuffleXor(values[10], 127u);
    let tmp_1585 = subgroupShuffleXor(keys[9], 127u);
    let tmp_1586 = subgroupShuffleXor(values[9], 127u);
    let tmp_1587 = subgroupShuffleXor(keys[8], 127u);
    let tmp_1588 = subgroupShuffleXor(values[8], 127u);
    let tmp_1589 = subgroupShuffleXor(keys[7], 127u);
    let tmp_1590 = subgroupShuffleXor(values[7], 127u);
    let tmp_1591 = subgroupShuffleXor(keys[6], 127u);
    let tmp_1592 = subgroupShuffleXor(values[6], 127u);
    let tmp_1593 = subgroupShuffleXor(keys[5], 127u);
    let tmp_1594 = subgroupShuffleXor(values[5], 127u);
    let tmp_1595 = subgroupShuffleXor(keys[4], 127u);
    let tmp_1596 = subgroupShuffleXor(values[4], 127u);
    let tmp_1597 = subgroupShuffleXor(keys[3], 127u);
    let tmp_1598 = subgroupShuffleXor(values[3], 127u);
    let tmp_1599 = subgroupShuffleXor(keys[2], 127u);
    let tmp_1600 = subgroupShuffleXor(values[2], 127u);
    let tmp_1601 = subgroupShuffleXor(keys[1], 127u);
    let tmp_1602 = subgroupShuffleXor(values[1], 127u);
    let tmp_1603 = subgroupShuffleXor(keys[0], 127u);
    let tmp_1604 = subgroupShuffleXor(values[0], 127u);
    let tmp_1605 = extractBits(local_tid, 6u, 1u) != 0u;
    let tmp_1606 = keys[0] < tmp_1573 || (keys[0] == tmp_1573 && values[0] < tmp_1574);
    if tmp_1605 == tmp_1606 { keys[0] = tmp_1573; values[0] = tmp_1574; }
    let tmp_1607 = keys[1] < tmp_1575 || (keys[1] == tmp_1575 && values[1] < tmp_1576);
    if tmp_1605 == tmp_1607 { keys[1] = tmp_1575; values[1] = tmp_1576; }
    let tmp_1608 = keys[2] < tmp_1577 || (keys[2] == tmp_1577 && values[2] < tmp_1578);
    if tmp_1605 == tmp_1608 { keys[2] = tmp_1577; values[2] = tmp_1578; }
    let tmp_1609 = keys[3] < tmp_1579 || (keys[3] == tmp_1579 && values[3] < tmp_1580);
    if tmp_1605 == tmp_1609 { keys[3] = tmp_1579; values[3] = tmp_1580; }
    let tmp_1610 = keys[4] < tmp_1581 || (keys[4] == tmp_1581 && values[4] < tmp_1582);
    if tmp_1605 == tmp_1610 { keys[4] = tmp_1581; values[4] = tmp_1582; }
    let tmp_1611 = keys[5] < tmp_1583 || (keys[5] == tmp_1583 && values[5] < tmp_1584);
    if tmp_1605 == tmp_1611 { keys[5] = tmp_1583; values[5] = tmp_1584; }
    let tmp_1612 = keys[6] < tmp_1585 || (keys[6] == tmp_1585 && values[6] < tmp_1586);
    if tmp_1605 == tmp_1612 { keys[6] = tmp_1585; values[6] = tmp_1586; }
    let tmp_1613 = keys[7] < tmp_1587 || (keys[7] == tmp_1587 && values[7] < tmp_1588);
    if tmp_1605 == tmp_1613 { keys[7] = tmp_1587; values[7] = tmp_1588; }
    let tmp_1614 = keys[8] < tmp_1589 || (keys[8] == tmp_1589 && values[8] < tmp_1590);
    if tmp_1605 == tmp_1614 { keys[8] = tmp_1589; values[8] = tmp_1590; }
    let tmp_1615 = keys[9] < tmp_1591 || (keys[9] == tmp_1591 && values[9] < tmp_1592);
    if tmp_1605 == tmp_1615 { keys[9] = tmp_1591; values[9] = tmp_1592; }
    let tmp_1616 = keys[10] < tmp_1593 || (keys[10] == tmp_1593 && values[10] < tmp_1594);
    if tmp_1605 == tmp_1616 { keys[10] = tmp_1593; values[10] = tmp_1594; }
    let tmp_1617 = keys[11] < tmp_1595 || (keys[11] == tmp_1595 && values[11] < tmp_1596);
    if tmp_1605 == tmp_1617 { keys[11] = tmp_1595; values[11] = tmp_1596; }
    let tmp_1618 = keys[12] < tmp_1597 || (keys[12] == tmp_1597 && values[12] < tmp_1598);
    if tmp_1605 == tmp_1618 { keys[12] = tmp_1597; values[12] = tmp_1598; }
    let tmp_1619 = keys[13] < tmp_1599 || (keys[13] == tmp_1599 && values[13] < tmp_1600);
    if tmp_1605 == tmp_1619 { keys[13] = tmp_1599; values[13] = tmp_1600; }
    let tmp_1620 = keys[14] < tmp_1601 || (keys[14] == tmp_1601 && values[14] < tmp_1602);
    if tmp_1605 == tmp_1620 { keys[14] = tmp_1601; values[14] = tmp_1602; }
    let tmp_1621 = keys[15] < tmp_1603 || (keys[15] == tmp_1603 && values[15] < tmp_1604);
    if tmp_1605 == tmp_1621 { keys[15] = tmp_1603; values[15] = tmp_1604; }
    }
    // exch_paral(tmask:32,swbit:5,wpt:16) 
    {
    let tmp_1622 = subgroupShuffleXor(keys[0], 32u);
    let tmp_1623 = subgroupShuffleXor(values[0], 32u);
    let tmp_1624 = subgroupShuffleXor(keys[1], 32u);
    let tmp_1625 = subgroupShuffleXor(values[1], 32u);
    let tmp_1626 = subgroupShuffleXor(keys[2], 32u);
    let tmp_1627 = subgroupShuffleXor(values[2], 32u);
    let tmp_1628 = subgroupShuffleXor(keys[3], 32u);
    let tmp_1629 = subgroupShuffleXor(values[3], 32u);
    let tmp_1630 = subgroupShuffleXor(keys[4], 32u);
    let tmp_1631 = subgroupShuffleXor(values[4], 32u);
    let tmp_1632 = subgroupShuffleXor(keys[5], 32u);
    let tmp_1633 = subgroupShuffleXor(values[5], 32u);
    let tmp_1634 = subgroupShuffleXor(keys[6], 32u);
    let tmp_1635 = subgroupShuffleXor(values[6], 32u);
    let tmp_1636 = subgroupShuffleXor(keys[7], 32u);
    let tmp_1637 = subgroupShuffleXor(values[7], 32u);
    let tmp_1638 = subgroupShuffleXor(keys[8], 32u);
    let tmp_1639 = subgroupShuffleXor(values[8], 32u);
    let tmp_1640 = subgroupShuffleXor(keys[9], 32u);
    let tmp_1641 = subgroupShuffleXor(values[9], 32u);
    let tmp_1642 = subgroupShuffleXor(keys[10], 32u);
    let tmp_1643 = subgroupShuffleXor(values[10], 32u);
    let tmp_1644 = subgroupShuffleXor(keys[11], 32u);
    let tmp_1645 = subgroupShuffleXor(values[11], 32u);
    let tmp_1646 = subgroupShuffleXor(keys[12], 32u);
    let tmp_1647 = subgroupShuffleXor(values[12], 32u);
    let tmp_1648 = subgroupShuffleXor(keys[13], 32u);
    let tmp_1649 = subgroupShuffleXor(values[13], 32u);
    let tmp_1650 = subgroupShuffleXor(keys[14], 32u);
    let tmp_1651 = subgroupShuffleXor(values[14], 32u);
    let tmp_1652 = subgroupShuffleXor(keys[15], 32u);
    let tmp_1653 = subgroupShuffleXor(values[15], 32u);
    let tmp_1654 = extractBits(local_tid, 5u, 1u) != 0u;
    let tmp_1655 = keys[0] < tmp_1622 || (keys[0] == tmp_1622 && values[0] < tmp_1623);
    if tmp_1654 == tmp_1655 { keys[0] = tmp_1622; values[0] = tmp_1623; }
    let tmp_1656 = keys[1] < tmp_1624 || (keys[1] == tmp_1624 && values[1] < tmp_1625);
    if tmp_1654 == tmp_1656 { keys[1] = tmp_1624; values[1] = tmp_1625; }
    let tmp_1657 = keys[2] < tmp_1626 || (keys[2] == tmp_1626 && values[2] < tmp_1627);
    if tmp_1654 == tmp_1657 { keys[2] = tmp_1626; values[2] = tmp_1627; }
    let tmp_1658 = keys[3] < tmp_1628 || (keys[3] == tmp_1628 && values[3] < tmp_1629);
    if tmp_1654 == tmp_1658 { keys[3] = tmp_1628; values[3] = tmp_1629; }
    let tmp_1659 = keys[4] < tmp_1630 || (keys[4] == tmp_1630 && values[4] < tmp_1631);
    if tmp_1654 == tmp_1659 { keys[4] = tmp_1630; values[4] = tmp_1631; }
    let tmp_1660 = keys[5] < tmp_1632 || (keys[5] == tmp_1632 && values[5] < tmp_1633);
    if tmp_1654 == tmp_1660 { keys[5] = tmp_1632; values[5] = tmp_1633; }
    let tmp_1661 = keys[6] < tmp_1634 || (keys[6] == tmp_1634 && values[6] < tmp_1635);
    if tmp_1654 == tmp_1661 { keys[6] = tmp_1634; values[6] = tmp_1635; }
    let tmp_1662 = keys[7] < tmp_1636 || (keys[7] == tmp_1636 && values[7] < tmp_1637);
    if tmp_1654 == tmp_1662 { keys[7] = tmp_1636; values[7] = tmp_1637; }
    let tmp_1663 = keys[8] < tmp_1638 || (keys[8] == tmp_1638 && values[8] < tmp_1639);
    if tmp_1654 == tmp_1663 { keys[8] = tmp_1638; values[8] = tmp_1639; }
    let tmp_1664 = keys[9] < tmp_1640 || (keys[9] == tmp_1640 && values[9] < tmp_1641);
    if tmp_1654 == tmp_1664 { keys[9] = tmp_1640; values[9] = tmp_1641; }
    let tmp_1665 = keys[10] < tmp_1642 || (keys[10] == tmp_1642 && values[10] < tmp_1643);
    if tmp_1654 == tmp_1665 { keys[10] = tmp_1642; values[10] = tmp_1643; }
    let tmp_1666 = keys[11] < tmp_1644 || (keys[11] == tmp_1644 && values[11] < tmp_1645);
    if tmp_1654 == tmp_1666 { keys[11] = tmp_1644; values[11] = tmp_1645; }
    let tmp_1667 = keys[12] < tmp_1646 || (keys[12] == tmp_1646 && values[12] < tmp_1647);
    if tmp_1654 == tmp_1667 { keys[12] = tmp_1646; values[12] = tmp_1647; }
    let tmp_1668 = keys[13] < tmp_1648 || (keys[13] == tmp_1648 && values[13] < tmp_1649);
    if tmp_1654 == tmp_1668 { keys[13] = tmp_1648; values[13] = tmp_1649; }
    let tmp_1669 = keys[14] < tmp_1650 || (keys[14] == tmp_1650 && values[14] < tmp_1651);
    if tmp_1654 == tmp_1669 { keys[14] = tmp_1650; values[14] = tmp_1651; }
    let tmp_1670 = keys[15] < tmp_1652 || (keys[15] == tmp_1652 && values[15] < tmp_1653);
    if tmp_1654 == tmp_1670 { keys[15] = tmp_1652; values[15] = tmp_1653; }
    }
    // exch_paral(tmask:16,swbit:4,wpt:16) 
    {
    let tmp_1671 = subgroupShuffleXor(keys[0], 16u);
    let tmp_1672 = subgroupShuffleXor(values[0], 16u);
    let tmp_1673 = subgroupShuffleXor(keys[1], 16u);
    let tmp_1674 = subgroupShuffleXor(values[1], 16u);
    let tmp_1675 = subgroupShuffleXor(keys[2], 16u);
    let tmp_1676 = subgroupShuffleXor(values[2], 16u);
    let tmp_1677 = subgroupShuffleXor(keys[3], 16u);
    let tmp_1678 = subgroupShuffleXor(values[3], 16u);
    let tmp_1679 = subgroupShuffleXor(keys[4], 16u);
    let tmp_1680 = subgroupShuffleXor(values[4], 16u);
    let tmp_1681 = subgroupShuffleXor(keys[5], 16u);
    let tmp_1682 = subgroupShuffleXor(values[5], 16u);
    let tmp_1683 = subgroupShuffleXor(keys[6], 16u);
    let tmp_1684 = subgroupShuffleXor(values[6], 16u);
    let tmp_1685 = subgroupShuffleXor(keys[7], 16u);
    let tmp_1686 = subgroupShuffleXor(values[7], 16u);
    let tmp_1687 = subgroupShuffleXor(keys[8], 16u);
    let tmp_1688 = subgroupShuffleXor(values[8], 16u);
    let tmp_1689 = subgroupShuffleXor(keys[9], 16u);
    let tmp_1690 = subgroupShuffleXor(values[9], 16u);
    let tmp_1691 = subgroupShuffleXor(keys[10], 16u);
    let tmp_1692 = subgroupShuffleXor(values[10], 16u);
    let tmp_1693 = subgroupShuffleXor(keys[11], 16u);
    let tmp_1694 = subgroupShuffleXor(values[11], 16u);
    let tmp_1695 = subgroupShuffleXor(keys[12], 16u);
    let tmp_1696 = subgroupShuffleXor(values[12], 16u);
    let tmp_1697 = subgroupShuffleXor(keys[13], 16u);
    let tmp_1698 = subgroupShuffleXor(values[13], 16u);
    let tmp_1699 = subgroupShuffleXor(keys[14], 16u);
    let tmp_1700 = subgroupShuffleXor(values[14], 16u);
    let tmp_1701 = subgroupShuffleXor(keys[15], 16u);
    let tmp_1702 = subgroupShuffleXor(values[15], 16u);
    let tmp_1703 = extractBits(local_tid, 4u, 1u) != 0u;
    let tmp_1704 = keys[0] < tmp_1671 || (keys[0] == tmp_1671 && values[0] < tmp_1672);
    if tmp_1703 == tmp_1704 { keys[0] = tmp_1671; values[0] = tmp_1672; }
    let tmp_1705 = keys[1] < tmp_1673 || (keys[1] == tmp_1673 && values[1] < tmp_1674);
    if tmp_1703 == tmp_1705 { keys[1] = tmp_1673; values[1] = tmp_1674; }
    let tmp_1706 = keys[2] < tmp_1675 || (keys[2] == tmp_1675 && values[2] < tmp_1676);
    if tmp_1703 == tmp_1706 { keys[2] = tmp_1675; values[2] = tmp_1676; }
    let tmp_1707 = keys[3] < tmp_1677 || (keys[3] == tmp_1677 && values[3] < tmp_1678);
    if tmp_1703 == tmp_1707 { keys[3] = tmp_1677; values[3] = tmp_1678; }
    let tmp_1708 = keys[4] < tmp_1679 || (keys[4] == tmp_1679 && values[4] < tmp_1680);
    if tmp_1703 == tmp_1708 { keys[4] = tmp_1679; values[4] = tmp_1680; }
    let tmp_1709 = keys[5] < tmp_1681 || (keys[5] == tmp_1681 && values[5] < tmp_1682);
    if tmp_1703 == tmp_1709 { keys[5] = tmp_1681; values[5] = tmp_1682; }
    let tmp_1710 = keys[6] < tmp_1683 || (keys[6] == tmp_1683 && values[6] < tmp_1684);
    if tmp_1703 == tmp_1710 { keys[6] = tmp_1683; values[6] = tmp_1684; }
    let tmp_1711 = keys[7] < tmp_1685 || (keys[7] == tmp_1685 && values[7] < tmp_1686);
    if tmp_1703 == tmp_1711 { keys[7] = tmp_1685; values[7] = tmp_1686; }
    let tmp_1712 = keys[8] < tmp_1687 || (keys[8] == tmp_1687 && values[8] < tmp_1688);
    if tmp_1703 == tmp_1712 { keys[8] = tmp_1687; values[8] = tmp_1688; }
    let tmp_1713 = keys[9] < tmp_1689 || (keys[9] == tmp_1689 && values[9] < tmp_1690);
    if tmp_1703 == tmp_1713 { keys[9] = tmp_1689; values[9] = tmp_1690; }
    let tmp_1714 = keys[10] < tmp_1691 || (keys[10] == tmp_1691 && values[10] < tmp_1692);
    if tmp_1703 == tmp_1714 { keys[10] = tmp_1691; values[10] = tmp_1692; }
    let tmp_1715 = keys[11] < tmp_1693 || (keys[11] == tmp_1693 && values[11] < tmp_1694);
    if tmp_1703 == tmp_1715 { keys[11] = tmp_1693; values[11] = tmp_1694; }
    let tmp_1716 = keys[12] < tmp_1695 || (keys[12] == tmp_1695 && values[12] < tmp_1696);
    if tmp_1703 == tmp_1716 { keys[12] = tmp_1695; values[12] = tmp_1696; }
    let tmp_1717 = keys[13] < tmp_1697 || (keys[13] == tmp_1697 && values[13] < tmp_1698);
    if tmp_1703 == tmp_1717 { keys[13] = tmp_1697; values[13] = tmp_1698; }
    let tmp_1718 = keys[14] < tmp_1699 || (keys[14] == tmp_1699 && values[14] < tmp_1700);
    if tmp_1703 == tmp_1718 { keys[14] = tmp_1699; values[14] = tmp_1700; }
    let tmp_1719 = keys[15] < tmp_1701 || (keys[15] == tmp_1701 && values[15] < tmp_1702);
    if tmp_1703 == tmp_1719 { keys[15] = tmp_1701; values[15] = tmp_1702; }
    }
    // exch_paral(tmask:8,swbit:3,wpt:16) 
    {
    let tmp_1720 = subgroupShuffleXor(keys[0], 8u);
    let tmp_1721 = subgroupShuffleXor(values[0], 8u);
    let tmp_1722 = subgroupShuffleXor(keys[1], 8u);
    let tmp_1723 = subgroupShuffleXor(values[1], 8u);
    let tmp_1724 = subgroupShuffleXor(keys[2], 8u);
    let tmp_1725 = subgroupShuffleXor(values[2], 8u);
    let tmp_1726 = subgroupShuffleXor(keys[3], 8u);
    let tmp_1727 = subgroupShuffleXor(values[3], 8u);
    let tmp_1728 = subgroupShuffleXor(keys[4], 8u);
    let tmp_1729 = subgroupShuffleXor(values[4], 8u);
    let tmp_1730 = subgroupShuffleXor(keys[5], 8u);
    let tmp_1731 = subgroupShuffleXor(values[5], 8u);
    let tmp_1732 = subgroupShuffleXor(keys[6], 8u);
    let tmp_1733 = subgroupShuffleXor(values[6], 8u);
    let tmp_1734 = subgroupShuffleXor(keys[7], 8u);
    let tmp_1735 = subgroupShuffleXor(values[7], 8u);
    let tmp_1736 = subgroupShuffleXor(keys[8], 8u);
    let tmp_1737 = subgroupShuffleXor(values[8], 8u);
    let tmp_1738 = subgroupShuffleXor(keys[9], 8u);
    let tmp_1739 = subgroupShuffleXor(values[9], 8u);
    let tmp_1740 = subgroupShuffleXor(keys[10], 8u);
    let tmp_1741 = subgroupShuffleXor(values[10], 8u);
    let tmp_1742 = subgroupShuffleXor(keys[11], 8u);
    let tmp_1743 = subgroupShuffleXor(values[11], 8u);
    let tmp_1744 = subgroupShuffleXor(keys[12], 8u);
    let tmp_1745 = subgroupShuffleXor(values[12], 8u);
    let tmp_1746 = subgroupShuffleXor(keys[13], 8u);
    let tmp_1747 = subgroupShuffleXor(values[13], 8u);
    let tmp_1748 = subgroupShuffleXor(keys[14], 8u);
    let tmp_1749 = subgroupShuffleXor(values[14], 8u);
    let tmp_1750 = subgroupShuffleXor(keys[15], 8u);
    let tmp_1751 = subgroupShuffleXor(values[15], 8u);
    let tmp_1752 = extractBits(local_tid, 3u, 1u) != 0u;
    let tmp_1753 = keys[0] < tmp_1720 || (keys[0] == tmp_1720 && values[0] < tmp_1721);
    if tmp_1752 == tmp_1753 { keys[0] = tmp_1720; values[0] = tmp_1721; }
    let tmp_1754 = keys[1] < tmp_1722 || (keys[1] == tmp_1722 && values[1] < tmp_1723);
    if tmp_1752 == tmp_1754 { keys[1] = tmp_1722; values[1] = tmp_1723; }
    let tmp_1755 = keys[2] < tmp_1724 || (keys[2] == tmp_1724 && values[2] < tmp_1725);
    if tmp_1752 == tmp_1755 { keys[2] = tmp_1724; values[2] = tmp_1725; }
    let tmp_1756 = keys[3] < tmp_1726 || (keys[3] == tmp_1726 && values[3] < tmp_1727);
    if tmp_1752 == tmp_1756 { keys[3] = tmp_1726; values[3] = tmp_1727; }
    let tmp_1757 = keys[4] < tmp_1728 || (keys[4] == tmp_1728 && values[4] < tmp_1729);
    if tmp_1752 == tmp_1757 { keys[4] = tmp_1728; values[4] = tmp_1729; }
    let tmp_1758 = keys[5] < tmp_1730 || (keys[5] == tmp_1730 && values[5] < tmp_1731);
    if tmp_1752 == tmp_1758 { keys[5] = tmp_1730; values[5] = tmp_1731; }
    let tmp_1759 = keys[6] < tmp_1732 || (keys[6] == tmp_1732 && values[6] < tmp_1733);
    if tmp_1752 == tmp_1759 { keys[6] = tmp_1732; values[6] = tmp_1733; }
    let tmp_1760 = keys[7] < tmp_1734 || (keys[7] == tmp_1734 && values[7] < tmp_1735);
    if tmp_1752 == tmp_1760 { keys[7] = tmp_1734; values[7] = tmp_1735; }
    let tmp_1761 = keys[8] < tmp_1736 || (keys[8] == tmp_1736 && values[8] < tmp_1737);
    if tmp_1752 == tmp_1761 { keys[8] = tmp_1736; values[8] = tmp_1737; }
    let tmp_1762 = keys[9] < tmp_1738 || (keys[9] == tmp_1738 && values[9] < tmp_1739);
    if tmp_1752 == tmp_1762 { keys[9] = tmp_1738; values[9] = tmp_1739; }
    let tmp_1763 = keys[10] < tmp_1740 || (keys[10] == tmp_1740 && values[10] < tmp_1741);
    if tmp_1752 == tmp_1763 { keys[10] = tmp_1740; values[10] = tmp_1741; }
    let tmp_1764 = keys[11] < tmp_1742 || (keys[11] == tmp_1742 && values[11] < tmp_1743);
    if tmp_1752 == tmp_1764 { keys[11] = tmp_1742; values[11] = tmp_1743; }
    let tmp_1765 = keys[12] < tmp_1744 || (keys[12] == tmp_1744 && values[12] < tmp_1745);
    if tmp_1752 == tmp_1765 { keys[12] = tmp_1744; values[12] = tmp_1745; }
    let tmp_1766 = keys[13] < tmp_1746 || (keys[13] == tmp_1746 && values[13] < tmp_1747);
    if tmp_1752 == tmp_1766 { keys[13] = tmp_1746; values[13] = tmp_1747; }
    let tmp_1767 = keys[14] < tmp_1748 || (keys[14] == tmp_1748 && values[14] < tmp_1749);
    if tmp_1752 == tmp_1767 { keys[14] = tmp_1748; values[14] = tmp_1749; }
    let tmp_1768 = keys[15] < tmp_1750 || (keys[15] == tmp_1750 && values[15] < tmp_1751);
    if tmp_1752 == tmp_1768 { keys[15] = tmp_1750; values[15] = tmp_1751; }
    }
    // exch_paral(tmask:4,swbit:2,wpt:16) 
    {
    let tmp_1769 = subgroupShuffleXor(keys[0], 4u);
    let tmp_1770 = subgroupShuffleXor(values[0], 4u);
    let tmp_1771 = subgroupShuffleXor(keys[1], 4u);
    let tmp_1772 = subgroupShuffleXor(values[1], 4u);
    let tmp_1773 = subgroupShuffleXor(keys[2], 4u);
    let tmp_1774 = subgroupShuffleXor(values[2], 4u);
    let tmp_1775 = subgroupShuffleXor(keys[3], 4u);
    let tmp_1776 = subgroupShuffleXor(values[3], 4u);
    let tmp_1777 = subgroupShuffleXor(keys[4], 4u);
    let tmp_1778 = subgroupShuffleXor(values[4], 4u);
    let tmp_1779 = subgroupShuffleXor(keys[5], 4u);
    let tmp_1780 = subgroupShuffleXor(values[5], 4u);
    let tmp_1781 = subgroupShuffleXor(keys[6], 4u);
    let tmp_1782 = subgroupShuffleXor(values[6], 4u);
    let tmp_1783 = subgroupShuffleXor(keys[7], 4u);
    let tmp_1784 = subgroupShuffleXor(values[7], 4u);
    let tmp_1785 = subgroupShuffleXor(keys[8], 4u);
    let tmp_1786 = subgroupShuffleXor(values[8], 4u);
    let tmp_1787 = subgroupShuffleXor(keys[9], 4u);
    let tmp_1788 = subgroupShuffleXor(values[9], 4u);
    let tmp_1789 = subgroupShuffleXor(keys[10], 4u);
    let tmp_1790 = subgroupShuffleXor(values[10], 4u);
    let tmp_1791 = subgroupShuffleXor(keys[11], 4u);
    let tmp_1792 = subgroupShuffleXor(values[11], 4u);
    let tmp_1793 = subgroupShuffleXor(keys[12], 4u);
    let tmp_1794 = subgroupShuffleXor(values[12], 4u);
    let tmp_1795 = subgroupShuffleXor(keys[13], 4u);
    let tmp_1796 = subgroupShuffleXor(values[13], 4u);
    let tmp_1797 = subgroupShuffleXor(keys[14], 4u);
    let tmp_1798 = subgroupShuffleXor(values[14], 4u);
    let tmp_1799 = subgroupShuffleXor(keys[15], 4u);
    let tmp_1800 = subgroupShuffleXor(values[15], 4u);
    let tmp_1801 = extractBits(local_tid, 2u, 1u) != 0u;
    let tmp_1802 = keys[0] < tmp_1769 || (keys[0] == tmp_1769 && values[0] < tmp_1770);
    if tmp_1801 == tmp_1802 { keys[0] = tmp_1769; values[0] = tmp_1770; }
    let tmp_1803 = keys[1] < tmp_1771 || (keys[1] == tmp_1771 && values[1] < tmp_1772);
    if tmp_1801 == tmp_1803 { keys[1] = tmp_1771; values[1] = tmp_1772; }
    let tmp_1804 = keys[2] < tmp_1773 || (keys[2] == tmp_1773 && values[2] < tmp_1774);
    if tmp_1801 == tmp_1804 { keys[2] = tmp_1773; values[2] = tmp_1774; }
    let tmp_1805 = keys[3] < tmp_1775 || (keys[3] == tmp_1775 && values[3] < tmp_1776);
    if tmp_1801 == tmp_1805 { keys[3] = tmp_1775; values[3] = tmp_1776; }
    let tmp_1806 = keys[4] < tmp_1777 || (keys[4] == tmp_1777 && values[4] < tmp_1778);
    if tmp_1801 == tmp_1806 { keys[4] = tmp_1777; values[4] = tmp_1778; }
    let tmp_1807 = keys[5] < tmp_1779 || (keys[5] == tmp_1779 && values[5] < tmp_1780);
    if tmp_1801 == tmp_1807 { keys[5] = tmp_1779; values[5] = tmp_1780; }
    let tmp_1808 = keys[6] < tmp_1781 || (keys[6] == tmp_1781 && values[6] < tmp_1782);
    if tmp_1801 == tmp_1808 { keys[6] = tmp_1781; values[6] = tmp_1782; }
    let tmp_1809 = keys[7] < tmp_1783 || (keys[7] == tmp_1783 && values[7] < tmp_1784);
    if tmp_1801 == tmp_1809 { keys[7] = tmp_1783; values[7] = tmp_1784; }
    let tmp_1810 = keys[8] < tmp_1785 || (keys[8] == tmp_1785 && values[8] < tmp_1786);
    if tmp_1801 == tmp_1810 { keys[8] = tmp_1785; values[8] = tmp_1786; }
    let tmp_1811 = keys[9] < tmp_1787 || (keys[9] == tmp_1787 && values[9] < tmp_1788);
    if tmp_1801 == tmp_1811 { keys[9] = tmp_1787; values[9] = tmp_1788; }
    let tmp_1812 = keys[10] < tmp_1789 || (keys[10] == tmp_1789 && values[10] < tmp_1790);
    if tmp_1801 == tmp_1812 { keys[10] = tmp_1789; values[10] = tmp_1790; }
    let tmp_1813 = keys[11] < tmp_1791 || (keys[11] == tmp_1791 && values[11] < tmp_1792);
    if tmp_1801 == tmp_1813 { keys[11] = tmp_1791; values[11] = tmp_1792; }
    let tmp_1814 = keys[12] < tmp_1793 || (keys[12] == tmp_1793 && values[12] < tmp_1794);
    if tmp_1801 == tmp_1814 { keys[12] = tmp_1793; values[12] = tmp_1794; }
    let tmp_1815 = keys[13] < tmp_1795 || (keys[13] == tmp_1795 && values[13] < tmp_1796);
    if tmp_1801 == tmp_1815 { keys[13] = tmp_1795; values[13] = tmp_1796; }
    let tmp_1816 = keys[14] < tmp_1797 || (keys[14] == tmp_1797 && values[14] < tmp_1798);
    if tmp_1801 == tmp_1816 { keys[14] = tmp_1797; values[14] = tmp_1798; }
    let tmp_1817 = keys[15] < tmp_1799 || (keys[15] == tmp_1799 && values[15] < tmp_1800);
    if tmp_1801 == tmp_1817 { keys[15] = tmp_1799; values[15] = tmp_1800; }
    }
    // exch_paral(tmask:2,swbit:1,wpt:16) 
    {
    let tmp_1818 = subgroupShuffleXor(keys[0], 2u);
    let tmp_1819 = subgroupShuffleXor(values[0], 2u);
    let tmp_1820 = subgroupShuffleXor(keys[1], 2u);
    let tmp_1821 = subgroupShuffleXor(values[1], 2u);
    let tmp_1822 = subgroupShuffleXor(keys[2], 2u);
    let tmp_1823 = subgroupShuffleXor(values[2], 2u);
    let tmp_1824 = subgroupShuffleXor(keys[3], 2u);
    let tmp_1825 = subgroupShuffleXor(values[3], 2u);
    let tmp_1826 = subgroupShuffleXor(keys[4], 2u);
    let tmp_1827 = subgroupShuffleXor(values[4], 2u);
    let tmp_1828 = subgroupShuffleXor(keys[5], 2u);
    let tmp_1829 = subgroupShuffleXor(values[5], 2u);
    let tmp_1830 = subgroupShuffleXor(keys[6], 2u);
    let tmp_1831 = subgroupShuffleXor(values[6], 2u);
    let tmp_1832 = subgroupShuffleXor(keys[7], 2u);
    let tmp_1833 = subgroupShuffleXor(values[7], 2u);
    let tmp_1834 = subgroupShuffleXor(keys[8], 2u);
    let tmp_1835 = subgroupShuffleXor(values[8], 2u);
    let tmp_1836 = subgroupShuffleXor(keys[9], 2u);
    let tmp_1837 = subgroupShuffleXor(values[9], 2u);
    let tmp_1838 = subgroupShuffleXor(keys[10], 2u);
    let tmp_1839 = subgroupShuffleXor(values[10], 2u);
    let tmp_1840 = subgroupShuffleXor(keys[11], 2u);
    let tmp_1841 = subgroupShuffleXor(values[11], 2u);
    let tmp_1842 = subgroupShuffleXor(keys[12], 2u);
    let tmp_1843 = subgroupShuffleXor(values[12], 2u);
    let tmp_1844 = subgroupShuffleXor(keys[13], 2u);
    let tmp_1845 = subgroupShuffleXor(values[13], 2u);
    let tmp_1846 = subgroupShuffleXor(keys[14], 2u);
    let tmp_1847 = subgroupShuffleXor(values[14], 2u);
    let tmp_1848 = subgroupShuffleXor(keys[15], 2u);
    let tmp_1849 = subgroupShuffleXor(values[15], 2u);
    let tmp_1850 = extractBits(local_tid, 1u, 1u) != 0u;
    let tmp_1851 = keys[0] < tmp_1818 || (keys[0] == tmp_1818 && values[0] < tmp_1819);
    if tmp_1850 == tmp_1851 { keys[0] = tmp_1818; values[0] = tmp_1819; }
    let tmp_1852 = keys[1] < tmp_1820 || (keys[1] == tmp_1820 && values[1] < tmp_1821);
    if tmp_1850 == tmp_1852 { keys[1] = tmp_1820; values[1] = tmp_1821; }
    let tmp_1853 = keys[2] < tmp_1822 || (keys[2] == tmp_1822 && values[2] < tmp_1823);
    if tmp_1850 == tmp_1853 { keys[2] = tmp_1822; values[2] = tmp_1823; }
    let tmp_1854 = keys[3] < tmp_1824 || (keys[3] == tmp_1824 && values[3] < tmp_1825);
    if tmp_1850 == tmp_1854 { keys[3] = tmp_1824; values[3] = tmp_1825; }
    let tmp_1855 = keys[4] < tmp_1826 || (keys[4] == tmp_1826 && values[4] < tmp_1827);
    if tmp_1850 == tmp_1855 { keys[4] = tmp_1826; values[4] = tmp_1827; }
    let tmp_1856 = keys[5] < tmp_1828 || (keys[5] == tmp_1828 && values[5] < tmp_1829);
    if tmp_1850 == tmp_1856 { keys[5] = tmp_1828; values[5] = tmp_1829; }
    let tmp_1857 = keys[6] < tmp_1830 || (keys[6] == tmp_1830 && values[6] < tmp_1831);
    if tmp_1850 == tmp_1857 { keys[6] = tmp_1830; values[6] = tmp_1831; }
    let tmp_1858 = keys[7] < tmp_1832 || (keys[7] == tmp_1832 && values[7] < tmp_1833);
    if tmp_1850 == tmp_1858 { keys[7] = tmp_1832; values[7] = tmp_1833; }
    let tmp_1859 = keys[8] < tmp_1834 || (keys[8] == tmp_1834 && values[8] < tmp_1835);
    if tmp_1850 == tmp_1859 { keys[8] = tmp_1834; values[8] = tmp_1835; }
    let tmp_1860 = keys[9] < tmp_1836 || (keys[9] == tmp_1836 && values[9] < tmp_1837);
    if tmp_1850 == tmp_1860 { keys[9] = tmp_1836; values[9] = tmp_1837; }
    let tmp_1861 = keys[10] < tmp_1838 || (keys[10] == tmp_1838 && values[10] < tmp_1839);
    if tmp_1850 == tmp_1861 { keys[10] = tmp_1838; values[10] = tmp_1839; }
    let tmp_1862 = keys[11] < tmp_1840 || (keys[11] == tmp_1840 && values[11] < tmp_1841);
    if tmp_1850 == tmp_1862 { keys[11] = tmp_1840; values[11] = tmp_1841; }
    let tmp_1863 = keys[12] < tmp_1842 || (keys[12] == tmp_1842 && values[12] < tmp_1843);
    if tmp_1850 == tmp_1863 { keys[12] = tmp_1842; values[12] = tmp_1843; }
    let tmp_1864 = keys[13] < tmp_1844 || (keys[13] == tmp_1844 && values[13] < tmp_1845);
    if tmp_1850 == tmp_1864 { keys[13] = tmp_1844; values[13] = tmp_1845; }
    let tmp_1865 = keys[14] < tmp_1846 || (keys[14] == tmp_1846 && values[14] < tmp_1847);
    if tmp_1850 == tmp_1865 { keys[14] = tmp_1846; values[14] = tmp_1847; }
    let tmp_1866 = keys[15] < tmp_1848 || (keys[15] == tmp_1848 && values[15] < tmp_1849);
    if tmp_1850 == tmp_1866 { keys[15] = tmp_1848; values[15] = tmp_1849; }
    }
    // exch_paral(tmask:1,swbit:0,wpt:16) 
    {
    let tmp_1867 = subgroupShuffleXor(keys[0], 1u);
    let tmp_1868 = subgroupShuffleXor(values[0], 1u);
    let tmp_1869 = subgroupShuffleXor(keys[1], 1u);
    let tmp_1870 = subgroupShuffleXor(values[1], 1u);
    let tmp_1871 = subgroupShuffleXor(keys[2], 1u);
    let tmp_1872 = subgroupShuffleXor(values[2], 1u);
    let tmp_1873 = subgroupShuffleXor(keys[3], 1u);
    let tmp_1874 = subgroupShuffleXor(values[3], 1u);
    let tmp_1875 = subgroupShuffleXor(keys[4], 1u);
    let tmp_1876 = subgroupShuffleXor(values[4], 1u);
    let tmp_1877 = subgroupShuffleXor(keys[5], 1u);
    let tmp_1878 = subgroupShuffleXor(values[5], 1u);
    let tmp_1879 = subgroupShuffleXor(keys[6], 1u);
    let tmp_1880 = subgroupShuffleXor(values[6], 1u);
    let tmp_1881 = subgroupShuffleXor(keys[7], 1u);
    let tmp_1882 = subgroupShuffleXor(values[7], 1u);
    let tmp_1883 = subgroupShuffleXor(keys[8], 1u);
    let tmp_1884 = subgroupShuffleXor(values[8], 1u);
    let tmp_1885 = subgroupShuffleXor(keys[9], 1u);
    let tmp_1886 = subgroupShuffleXor(values[9], 1u);
    let tmp_1887 = subgroupShuffleXor(keys[10], 1u);
    let tmp_1888 = subgroupShuffleXor(values[10], 1u);
    let tmp_1889 = subgroupShuffleXor(keys[11], 1u);
    let tmp_1890 = subgroupShuffleXor(values[11], 1u);
    let tmp_1891 = subgroupShuffleXor(keys[12], 1u);
    let tmp_1892 = subgroupShuffleXor(values[12], 1u);
    let tmp_1893 = subgroupShuffleXor(keys[13], 1u);
    let tmp_1894 = subgroupShuffleXor(values[13], 1u);
    let tmp_1895 = subgroupShuffleXor(keys[14], 1u);
    let tmp_1896 = subgroupShuffleXor(values[14], 1u);
    let tmp_1897 = subgroupShuffleXor(keys[15], 1u);
    let tmp_1898 = subgroupShuffleXor(values[15], 1u);
    let tmp_1899 = extractBits(local_tid, 0u, 1u) != 0u;
    let tmp_1900 = keys[0] < tmp_1867 || (keys[0] == tmp_1867 && values[0] < tmp_1868);
    if tmp_1899 == tmp_1900 { keys[0] = tmp_1867; values[0] = tmp_1868; }
    let tmp_1901 = keys[1] < tmp_1869 || (keys[1] == tmp_1869 && values[1] < tmp_1870);
    if tmp_1899 == tmp_1901 { keys[1] = tmp_1869; values[1] = tmp_1870; }
    let tmp_1902 = keys[2] < tmp_1871 || (keys[2] == tmp_1871 && values[2] < tmp_1872);
    if tmp_1899 == tmp_1902 { keys[2] = tmp_1871; values[2] = tmp_1872; }
    let tmp_1903 = keys[3] < tmp_1873 || (keys[3] == tmp_1873 && values[3] < tmp_1874);
    if tmp_1899 == tmp_1903 { keys[3] = tmp_1873; values[3] = tmp_1874; }
    let tmp_1904 = keys[4] < tmp_1875 || (keys[4] == tmp_1875 && values[4] < tmp_1876);
    if tmp_1899 == tmp_1904 { keys[4] = tmp_1875; values[4] = tmp_1876; }
    let tmp_1905 = keys[5] < tmp_1877 || (keys[5] == tmp_1877 && values[5] < tmp_1878);
    if tmp_1899 == tmp_1905 { keys[5] = tmp_1877; values[5] = tmp_1878; }
    let tmp_1906 = keys[6] < tmp_1879 || (keys[6] == tmp_1879 && values[6] < tmp_1880);
    if tmp_1899 == tmp_1906 { keys[6] = tmp_1879; values[6] = tmp_1880; }
    let tmp_1907 = keys[7] < tmp_1881 || (keys[7] == tmp_1881 && values[7] < tmp_1882);
    if tmp_1899 == tmp_1907 { keys[7] = tmp_1881; values[7] = tmp_1882; }
    let tmp_1908 = keys[8] < tmp_1883 || (keys[8] == tmp_1883 && values[8] < tmp_1884);
    if tmp_1899 == tmp_1908 { keys[8] = tmp_1883; values[8] = tmp_1884; }
    let tmp_1909 = keys[9] < tmp_1885 || (keys[9] == tmp_1885 && values[9] < tmp_1886);
    if tmp_1899 == tmp_1909 { keys[9] = tmp_1885; values[9] = tmp_1886; }
    let tmp_1910 = keys[10] < tmp_1887 || (keys[10] == tmp_1887 && values[10] < tmp_1888);
    if tmp_1899 == tmp_1910 { keys[10] = tmp_1887; values[10] = tmp_1888; }
    let tmp_1911 = keys[11] < tmp_1889 || (keys[11] == tmp_1889 && values[11] < tmp_1890);
    if tmp_1899 == tmp_1911 { keys[11] = tmp_1889; values[11] = tmp_1890; }
    let tmp_1912 = keys[12] < tmp_1891 || (keys[12] == tmp_1891 && values[12] < tmp_1892);
    if tmp_1899 == tmp_1912 { keys[12] = tmp_1891; values[12] = tmp_1892; }
    let tmp_1913 = keys[13] < tmp_1893 || (keys[13] == tmp_1893 && values[13] < tmp_1894);
    if tmp_1899 == tmp_1913 { keys[13] = tmp_1893; values[13] = tmp_1894; }
    let tmp_1914 = keys[14] < tmp_1895 || (keys[14] == tmp_1895 && values[14] < tmp_1896);
    if tmp_1899 == tmp_1914 { keys[14] = tmp_1895; values[14] = tmp_1896; }
    let tmp_1915 = keys[15] < tmp_1897 || (keys[15] == tmp_1897 && values[15] < tmp_1898);
    if tmp_1899 == tmp_1915 { keys[15] = tmp_1897; values[15] = tmp_1898; }
    }
    // exch_local(8,16) 
    // cmp_swap(0,8)
    if keys[0] > keys[8] || (keys[0] == keys[8] && values[0] > values[8]) {
    // swap(0,8) 
    { let tmp_1916 = keys[0]; keys[0] = keys[8]; keys[8] = tmp_1916;let tmp_1917 = values[0]; values[0] = values[8]; values[8] = tmp_1917; }
    }
    // cmp_swap(1,9)
    if keys[1] > keys[9] || (keys[1] == keys[9] && values[1] > values[9]) {
    // swap(1,9) 
    { let tmp_1918 = keys[1]; keys[1] = keys[9]; keys[9] = tmp_1918;let tmp_1919 = values[1]; values[1] = values[9]; values[9] = tmp_1919; }
    }
    // cmp_swap(2,10)
    if keys[2] > keys[10] || (keys[2] == keys[10] && values[2] > values[10]) {
    // swap(2,10) 
    { let tmp_1920 = keys[2]; keys[2] = keys[10]; keys[10] = tmp_1920;let tmp_1921 = values[2]; values[2] = values[10]; values[10] = tmp_1921; }
    }
    // cmp_swap(3,11)
    if keys[3] > keys[11] || (keys[3] == keys[11] && values[3] > values[11]) {
    // swap(3,11) 
    { let tmp_1922 = keys[3]; keys[3] = keys[11]; keys[11] = tmp_1922;let tmp_1923 = values[3]; values[3] = values[11]; values[11] = tmp_1923; }
    }
    // cmp_swap(4,12)
    if keys[4] > keys[12] || (keys[4] == keys[12] && values[4] > values[12]) {
    // swap(4,12) 
    { let tmp_1924 = keys[4]; keys[4] = keys[12]; keys[12] = tmp_1924;let tmp_1925 = values[4]; values[4] = values[12]; values[12] = tmp_1925; }
    }
    // cmp_swap(5,13)
    if keys[5] > keys[13] || (keys[5] == keys[13] && values[5] > values[13]) {
    // swap(5,13) 
    { let tmp_1926 = keys[5]; keys[5] = keys[13]; keys[13] = tmp_1926;let tmp_1927 = values[5]; values[5] = values[13]; values[13] = tmp_1927; }
    }
    // cmp_swap(6,14)
    if keys[6] > keys[14] || (keys[6] == keys[14] && values[6] > values[14]) {
    // swap(6,14) 
    { let tmp_1928 = keys[6]; keys[6] = keys[14]; keys[14] = tmp_1928;let tmp_1929 = values[6]; values[6] = values[14]; values[14] = tmp_1929; }
    }
    // cmp_swap(7,15)
    if keys[7] > keys[15] || (keys[7] == keys[15] && values[7] > values[15]) {
    // swap(7,15) 
    { let tmp_1930 = keys[7]; keys[7] = keys[15]; keys[15] = tmp_1930;let tmp_1931 = values[7]; values[7] = values[15]; values[15] = tmp_1931; }
    }
    // exch_local(4,16) 
    // cmp_swap(0,4)
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_1932 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_1932;let tmp_1933 = values[0]; values[0] = values[4]; values[4] = tmp_1933; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_1934 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_1934;let tmp_1935 = values[1]; values[1] = values[5]; values[5] = tmp_1935; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_1936 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_1936;let tmp_1937 = values[2]; values[2] = values[6]; values[6] = tmp_1937; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_1938 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_1938;let tmp_1939 = values[3]; values[3] = values[7]; values[7] = tmp_1939; }
    }
    // cmp_swap(8,12)
    if keys[8] > keys[12] || (keys[8] == keys[12] && values[8] > values[12]) {
    // swap(8,12) 
    { let tmp_1940 = keys[8]; keys[8] = keys[12]; keys[12] = tmp_1940;let tmp_1941 = values[8]; values[8] = values[12]; values[12] = tmp_1941; }
    }
    // cmp_swap(9,13)
    if keys[9] > keys[13] || (keys[9] == keys[13] && values[9] > values[13]) {
    // swap(9,13) 
    { let tmp_1942 = keys[9]; keys[9] = keys[13]; keys[13] = tmp_1942;let tmp_1943 = values[9]; values[9] = values[13]; values[13] = tmp_1943; }
    }
    // cmp_swap(10,14)
    if keys[10] > keys[14] || (keys[10] == keys[14] && values[10] > values[14]) {
    // swap(10,14) 
    { let tmp_1944 = keys[10]; keys[10] = keys[14]; keys[14] = tmp_1944;let tmp_1945 = values[10]; values[10] = values[14]; values[14] = tmp_1945; }
    }
    // cmp_swap(11,15)
    if keys[11] > keys[15] || (keys[11] == keys[15] && values[11] > values[15]) {
    // swap(11,15) 
    { let tmp_1946 = keys[11]; keys[11] = keys[15]; keys[15] = tmp_1946;let tmp_1947 = values[11]; values[11] = values[15]; values[15] = tmp_1947; }
    }
    // exch_local(2,16) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_1948 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_1948;let tmp_1949 = values[0]; values[0] = values[2]; values[2] = tmp_1949; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_1950 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_1950;let tmp_1951 = values[1]; values[1] = values[3]; values[3] = tmp_1951; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_1952 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_1952;let tmp_1953 = values[4]; values[4] = values[6]; values[6] = tmp_1953; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_1954 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_1954;let tmp_1955 = values[5]; values[5] = values[7]; values[7] = tmp_1955; }
    }
    // cmp_swap(8,10)
    if keys[8] > keys[10] || (keys[8] == keys[10] && values[8] > values[10]) {
    // swap(8,10) 
    { let tmp_1956 = keys[8]; keys[8] = keys[10]; keys[10] = tmp_1956;let tmp_1957 = values[8]; values[8] = values[10]; values[10] = tmp_1957; }
    }
    // cmp_swap(9,11)
    if keys[9] > keys[11] || (keys[9] == keys[11] && values[9] > values[11]) {
    // swap(9,11) 
    { let tmp_1958 = keys[9]; keys[9] = keys[11]; keys[11] = tmp_1958;let tmp_1959 = values[9]; values[9] = values[11]; values[11] = tmp_1959; }
    }
    // cmp_swap(12,14)
    if keys[12] > keys[14] || (keys[12] == keys[14] && values[12] > values[14]) {
    // swap(12,14) 
    { let tmp_1960 = keys[12]; keys[12] = keys[14]; keys[14] = tmp_1960;let tmp_1961 = values[12]; values[12] = values[14]; values[14] = tmp_1961; }
    }
    // cmp_swap(13,15)
    if keys[13] > keys[15] || (keys[13] == keys[15] && values[13] > values[15]) {
    // swap(13,15) 
    { let tmp_1962 = keys[13]; keys[13] = keys[15]; keys[15] = tmp_1962;let tmp_1963 = values[13]; values[13] = values[15]; values[15] = tmp_1963; }
    }
    // exch_local(1,16) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_1964 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_1964;let tmp_1965 = values[0]; values[0] = values[1]; values[1] = tmp_1965; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_1966 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_1966;let tmp_1967 = values[2]; values[2] = values[3]; values[3] = tmp_1967; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_1968 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_1968;let tmp_1969 = values[4]; values[4] = values[5]; values[5] = tmp_1969; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_1970 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_1970;let tmp_1971 = values[6]; values[6] = values[7]; values[7] = tmp_1971; }
    }
    // cmp_swap(8,9)
    if keys[8] > keys[9] || (keys[8] == keys[9] && values[8] > values[9]) {
    // swap(8,9) 
    { let tmp_1972 = keys[8]; keys[8] = keys[9]; keys[9] = tmp_1972;let tmp_1973 = values[8]; values[8] = values[9]; values[9] = tmp_1973; }
    }
    // cmp_swap(10,11)
    if keys[10] > keys[11] || (keys[10] == keys[11] && values[10] > values[11]) {
    // swap(10,11) 
    { let tmp_1974 = keys[10]; keys[10] = keys[11]; keys[11] = tmp_1974;let tmp_1975 = values[10]; values[10] = values[11]; values[11] = tmp_1975; }
    }
    // cmp_swap(12,13)
    if keys[12] > keys[13] || (keys[12] == keys[13] && values[12] > values[13]) {
    // swap(12,13) 
    { let tmp_1976 = keys[12]; keys[12] = keys[13]; keys[13] = tmp_1976;let tmp_1977 = values[12]; values[12] = values[13]; values[13] = tmp_1977; }
    }
    // cmp_swap(14,15)
    if keys[14] > keys[15] || (keys[14] == keys[15] && values[14] > values[15]) {
    // swap(14,15) 
    { let tmp_1978 = keys[14]; keys[14] = keys[15]; keys[15] = tmp_1978;let tmp_1979 = values[14]; values[14] = values[15]; values[15] = tmp_1979; }
    }
    ...
    // striped (coalesced) store via subgroup shuffle transpose
    {
        ...
        { let src = grp_base + ((0u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((1u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((2u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((3u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((4u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((5u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((6u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((7u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((8u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((9u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((10u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((11u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((12u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((13u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((14u * M + local_tid) >> 4u);
        ...
        { let src = grp_base + ((15u * M + local_tid) >> 4u);
