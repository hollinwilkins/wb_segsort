...
fn segsort_hybrid_sg64_n2048_m128_striped(
    ...
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; smem_keys[tid_g * WPT + 8u] = keys[8]; smem_vals[tid_g * WPT + 8u] = values[8]; smem_keys[tid_g * WPT + 9u] = keys[9]; smem_vals[tid_g * WPT + 9u] = values[9]; smem_keys[tid_g * WPT + 10u] = keys[10]; smem_vals[tid_g * WPT + 10u] = values[10]; smem_keys[tid_g * WPT + 11u] = keys[11]; smem_vals[tid_g * WPT + 11u] = values[11]; smem_keys[tid_g * WPT + 12u] = keys[12]; smem_vals[tid_g * WPT + 12u] = values[12]; smem_keys[tid_g * WPT + 13u] = keys[13]; smem_vals[tid_g * WPT + 13u] = values[13]; smem_keys[tid_g * WPT + 14u] = keys[14]; smem_vals[tid_g * WPT + 14u] = values[14]; smem_keys[tid_g * WPT + 15u] = keys[15]; smem_vals[tid_g * WPT + 15u] = values[15]; workgroupBarrier(); let tmp_1573 = extractBits(local_tid, 6u, 1u) != 0u; let tmp_1574 = seg_base + (local_tid ^ 127u); let tmp_1575 = smem_keys[tmp_1574 * WPT + 15u]; let tmp_1576 = smem_vals[tmp_1574 * WPT + 15u]; let tmp_1577 = keys[0] < tmp_1575 || (keys[0] == tmp_1575 && values[0] < tmp_1576); if tmp_1573 == tmp_1577 { keys[0] = tmp_1575; values[0] = tmp_1576; } let tmp_1578 = smem_keys[tmp_1574 * WPT + 14u]; let tmp_1579 = smem_vals[tmp_1574 * WPT + 14u]; let tmp_1580 = keys[1] < tmp_1578 || (keys[1] == tmp_1578 && values[1] < tmp_1579); if tmp_1573 == tmp_1580 { keys[1] = tmp_1578; values[1] = tmp_1579; } let tmp_1581 = smem_keys[tmp_1574 * WPT + 13u]; let tmp_1582 = smem_vals[tmp_1574 * WPT + 13u]; let tmp_1583 = keys[2] < tmp_1581 || (keys[2] == tmp_1581 && values[2] < tmp_1582); if tmp_1573 == tmp_1583 { keys[2] = tmp_1581; values[2] = tmp_1582; } let tmp_1584 = smem_keys[tmp_1574 * WPT + 12u]; let tmp_1585 = smem_vals[tmp_1574 * WPT + 12u]; let tmp_1586 = keys[3] < tmp_1584 || (keys[3] == tmp_1584 && values[3] < tmp_1585); if tmp_1573 == tmp_1586 { keys[3] = tmp_1584; values[3] = tmp_1585; } let tmp_1587 = smem_keys[tmp_1574 * WPT + 11u]; let tmp_1588 = smem_vals[tmp_1574 * WPT + 11u]; let tmp_1589 = keys[4] < tmp_1587 || (keys[4] == tmp_1587 && values[4] < tmp_1588); if tmp_1573 == tmp_1589 { keys[4] = tmp_1587; values[4] = tmp_1588; } let tmp_1590 = smem_keys[tmp_1574 * WPT + 10u]; let tmp_1591 = smem_vals[tmp_1574 * WPT + 10u]; let tmp_1592 = keys[5] < tmp_1590 || (keys[5] == tmp_1590 && values[5] < tmp_1591); if tmp_1573 == tmp_1592 { keys[5] = tmp_1590; values[5] = tmp_1591; } let tmp_1593 = smem_keys[tmp_1574 * WPT + 9u]; let tmp_1594 = smem_vals[tmp_1574 * WPT + 9u]; let tmp_1595 = keys[6] < tmp_1593 || (keys[6] == tmp_1593 && values[6] < tmp_1594); if tmp_1573 == tmp_1595 { keys[6] = tmp_1593; values[6] = tmp_1594; } let tmp_1596 = smem_keys[tmp_1574 * WPT + 8u]; let tmp_1597 = smem_vals[tmp_1574 * WPT + 8u]; let tmp_1598 = keys[7] < tmp_1596 || (keys[7] == tmp_1596 && values[7] < tmp_1597); if tmp_1573 == tmp_1598 { keys[7] = tmp_1596; values[7] = tmp_1597; } let tmp_1599 = smem_keys[tmp_1574 * WPT + 7u]; let tmp_1600 = smem_vals[tmp_1574 * WPT + 7u]; let tmp_1601 = keys[8] < tmp_1599 || (keys[8] == tmp_1599 && values[8] < tmp_1600); if tmp_1573 == tmp_1601 { keys[8] = tmp_1599; values[8] = tmp_1600; } let tmp_1602 = smem_keys[tmp_1574 * WPT + 6u]; let tmp_1603 = smem_vals[tmp_1574 * WPT + 6u]; let tmp_1604 = keys[9] < tmp_1602 || (keys[9] == tmp_1602 && values[9] < tmp_1603); if tmp_1573 == tmp_1604 { keys[9] = tmp_1602; values[9] = tmp_1603; } let tmp_1605 = smem_keys[tmp_1574 * WPT + 5u]; let tmp_1606 = smem_vals[tmp_1574 * WPT + 5u]; let tmp_1607 = keys[10] < tmp_1605 || (keys[10] == tmp_1605 && values[10] < tmp_1606); if tmp_1573 == tmp_1607 { keys[10] = tmp_1605; values[10] = tmp_1606; } let tmp_1608 = smem_keys[tmp_1574 * WPT + 4u]; let tmp_1609 = smem_vals[tmp_1574 * WPT + 4u]; let tmp_1610 = keys[11] < tmp_1608 || (keys[11] == tmp_1608 && values[11] < tmp_1609); if tmp_1573 == tmp_1610 { keys[11] = tmp_1608; values[11] = tmp_1609; } let tmp_1611 = smem_keys[tmp_1574 * WPT + 3u]; let tmp_1612 = smem_vals[tmp_1574 * WPT + 3u]; let tmp_1613 = keys[12] < tmp_1611 || (keys[12] == tmp_1611 && values[12] < tmp_1612); if tmp_1573 == tmp_1613 { keys[12] = tmp_1611; values[12] = tmp_1612; } let tmp_1614 = smem_keys[tmp_1574 * WPT + 2u]; let tmp_1615 = smem_vals[tmp_1574 * WPT + 2u]; let tmp_1616 = keys[13] < tmp_1614 || (keys[13] == tmp_1614 && values[13] < tmp_1615); if tmp_1573 == tmp_1616 { keys[13] = tmp_1614; values[13] = tmp_1615; } let tmp_1617 = smem_keys[tmp_1574 * WPT + 1u]; let tmp_1618 = smem_vals[tmp_1574 * WPT + 1u]; let tmp_1619 = keys[14] < tmp_1617 || (keys[14] == tmp_1617 && values[14] < tmp_1618); if tmp_1573 == tmp_1619 { keys[14] = tmp_1617; values[14] = tmp_1618; } let tmp_1620 = smem_keys[tmp_1574 * WPT + 0u]; let tmp_1621 = smem_vals[tmp_1574 * WPT + 0u]; let tmp_1622 = keys[15] < tmp_1620 || (keys[15] == tmp_1620 && values[15] < tmp_1621); if tmp_1573 == tmp_1622 { keys[15] = tmp_1620; values[15] = tmp_1621; } workgroupBarrier(); }
    // exch_paral(tmask:32,swbit:5,wpt:16) 
    {
    let tmp_1623 = subgroupShuffleXor(keys[0], 32u);
    let tmp_1624 = subgroupShuffleXor(values[0], 32u);
    let tmp_1625 = subgroupShuffleXor(keys[1], 32u);
    let tmp_1626 = subgroupShuffleXor(values[1], 32u);
    let tmp_1627 = subgroupShuffleXor(keys[2], 32u);
    let tmp_1628 = subgroupShuffleXor(values[2], 32u);
    let tmp_1629 = subgroupShuffleXor(keys[3], 32u);
    let tmp_1630 = subgroupShuffleXor(values[3], 32u);
    let tmp_1631 = subgroupShuffleXor(keys[4], 32u);
    let tmp_1632 = subgroupShuffleXor(values[4], 32u);
    let tmp_1633 = subgroupShuffleXor(keys[5], 32u);
    let tmp_1634 = subgroupShuffleXor(values[5], 32u);
    let tmp_1635 = subgroupShuffleXor(keys[6], 32u);
    let tmp_1636 = subgroupShuffleXor(values[6], 32u);
    let tmp_1637 = subgroupShuffleXor(keys[7], 32u);
    let tmp_1638 = subgroupShuffleXor(values[7], 32u);
    let tmp_1639 = subgroupShuffleXor(keys[8], 32u);
    let tmp_1640 = subgroupShuffleXor(values[8], 32u);
    let tmp_1641 = subgroupShuffleXor(keys[9], 32u);
    let tmp_1642 = subgroupShuffleXor(values[9], 32u);
    let tmp_1643 = subgroupShuffleXor(keys[10], 32u);
    let tmp_1644 = subgroupShuffleXor(values[10], 32u);
    let tmp_1645 = subgroupShuffleXor(keys[11], 32u);
    let tmp_1646 = subgroupShuffleXor(values[11], 32u);
    let tmp_1647 = subgroupShuffleXor(keys[12], 32u);
    let tmp_1648 = subgroupShuffleXor(values[12], 32u);
    let tmp_1649 = subgroupShuffleXor(keys[13], 32u);
    let tmp_1650 = subgroupShuffleXor(values[13], 32u);
    let tmp_1651 = subgroupShuffleXor(keys[14], 32u);
    let tmp_1652 = subgroupShuffleXor(values[14], 32u);
    let tmp_1653 = subgroupShuffleXor(keys[15], 32u);
    let tmp_1654 = subgroupShuffleXor(values[15], 32u);
    let tmp_1655 = extractBits(local_tid, 5u, 1u) != 0u;
    let tmp_1656 = keys[0] < tmp_1623 || (keys[0] == tmp_1623 && values[0] < tmp_1624);
    if tmp_1655 == tmp_1656 { keys[0] = tmp_1623; values[0] = tmp_1624; }
    let tmp_1657 = keys[1] < tmp_1625 || (keys[1] == tmp_1625 && values[1] < tmp_1626);
    if tmp_1655 == tmp_1657 { keys[1] = tmp_1625; values[1] = tmp_1626; }
    let tmp_1658 = keys[2] < tmp_1627 || (keys[2] == tmp_1627 && values[2] < tmp_1628);
    if tmp_1655 == tmp_1658 { keys[2] = tmp_1627; values[2] = tmp_1628; }
    let tmp_1659 = keys[3] < tmp_1629 || (keys[3] == tmp_1629 && values[3] < tmp_1630);
    if tmp_1655 == tmp_1659 { keys[3] = tmp_1629; values[3] = tmp_1630; }
    let tmp_1660 = keys[4] < tmp_1631 || (keys[4] == tmp_1631 && values[4] < tmp_1632);
    if tmp_1655 == tmp_1660 { keys[4] = tmp_1631; values[4] = tmp_1632; }
    let tmp_1661 = keys[5] < tmp_1633 || (keys[5] == tmp_1633 && values[5] < tmp_1634);
    if tmp_1655 == tmp_1661 { keys[5] = tmp_1633; values[5] = tmp_1634; }
    let tmp_1662 = keys[6] < tmp_1635 || (keys[6] == tmp_1635 && values[6] < tmp_1636);
    if tmp_1655 == tmp_1662 { keys[6] = tmp_1635; values[6] = tmp_1636; }
    let tmp_1663 = keys[7] < tmp_1637 || (keys[7] == tmp_1637 && values[7] < tmp_1638);
    if tmp_1655 == tmp_1663 { keys[7] = tmp_1637; values[7] = tmp_1638; }
    let tmp_1664 = keys[8] < tmp_1639 || (keys[8] == tmp_1639 && values[8] < tmp_1640);
    if tmp_1655 == tmp_1664 { keys[8] = tmp_1639; values[8] = tmp_1640; }
    let tmp_1665 = keys[9] < tmp_1641 || (keys[9] == tmp_1641 && values[9] < tmp_1642);
    if tmp_1655 == tmp_1665 { keys[9] = tmp_1641; values[9] = tmp_1642; }
    let tmp_1666 = keys[10] < tmp_1643 || (keys[10] == tmp_1643 && values[10] < tmp_1644);
    if tmp_1655 == tmp_1666 { keys[10] = tmp_1643; values[10] = tmp_1644; }
    let tmp_1667 = keys[11] < tmp_1645 || (keys[11] == tmp_1645 && values[11] < tmp_1646);
    if tmp_1655 == tmp_1667 { keys[11] = tmp_1645; values[11] = tmp_1646; }
    let tmp_1668 = keys[12] < tmp_1647 || (keys[12] == tmp_1647 && values[12] < tmp_1648);
    if tmp_1655 == tmp_1668 { keys[12] = tmp_1647; values[12] = tmp_1648; }
    let tmp_1669 = keys[13] < tmp_1649 || (keys[13] == tmp_1649 && values[13] < tmp_1650);
    if tmp_1655 == tmp_1669 { keys[13] = tmp_1649; values[13] = tmp_1650; }
    let tmp_1670 = keys[14] < tmp_1651 || (keys[14] == tmp_1651 && values[14] < tmp_1652);
    if tmp_1655 == tmp_1670 { keys[14] = tmp_1651; values[14] = tmp_1652; }
    let tmp_1671 = keys[15] < tmp_1653 || (keys[15] == tmp_1653 && values[15] < tmp_1654);
    if tmp_1655 == tmp_1671 { keys[15] = tmp_1653; values[15] = tmp_1654; }
    }
    // exch_paral(tmask:16,swbit:4,wpt:16) 
    {
    let tmp_1672 = subgroupShuffleXor(keys[0], 16u);
    let tmp_1673 = subgroupShuffleXor(values[0], 16u);
    let tmp_1674 = subgroupShuffleXor(keys[1], 16u);
    let tmp_1675 = subgroupShuffleXor(values[1], 16u);
    let tmp_1676 = subgroupShuffleXor(keys[2], 16u);
    let tmp_1677 = subgroupShuffleXor(values[2], 16u);
    let tmp_1678 = subgroupShuffleXor(keys[3], 16u);
    let tmp_1679 = subgroupShuffleXor(values[3], 16u);
    let tmp_1680 = subgroupShuffleXor(keys[4], 16u);
    let tmp_1681 = subgroupShuffleXor(values[4], 16u);
    let tmp_1682 = subgroupShuffleXor(keys[5], 16u);
    let tmp_1683 = subgroupShuffleXor(values[5], 16u);
    let tmp_1684 = subgroupShuffleXor(keys[6], 16u);
    let tmp_1685 = subgroupShuffleXor(values[6], 16u);
    let tmp_1686 = subgroupShuffleXor(keys[7], 16u);
    let tmp_1687 = subgroupShuffleXor(values[7], 16u);
    let tmp_1688 = subgroupShuffleXor(keys[8], 16u);
    let tmp_1689 = subgroupShuffleXor(values[8], 16u);
    let tmp_1690 = subgroupShuffleXor(keys[9], 16u);
    let tmp_1691 = subgroupShuffleXor(values[9], 16u);
    let tmp_1692 = subgroupShuffleXor(keys[10], 16u);
    let tmp_1693 = subgroupShuffleXor(values[10], 16u);
    let tmp_1694 = subgroupShuffleXor(keys[11], 16u);
    let tmp_1695 = subgroupShuffleXor(values[11], 16u);
    let tmp_1696 = subgroupShuffleXor(keys[12], 16u);
    let tmp_1697 = subgroupShuffleXor(values[12], 16u);
    let tmp_1698 = subgroupShuffleXor(keys[13], 16u);
    let tmp_1699 = subgroupShuffleXor(values[13], 16u);
    let tmp_1700 = subgroupShuffleXor(keys[14], 16u);
    let tmp_1701 = subgroupShuffleXor(values[14], 16u);
    let tmp_1702 = subgroupShuffleXor(keys[15], 16u);
    let tmp_1703 = subgroupShuffleXor(values[15], 16u);
    let tmp_1704 = extractBits(local_tid, 4u, 1u) != 0u;
    let tmp_1705 = keys[0] < tmp_1672 || (keys[0] == tmp_1672 && values[0] < tmp_1673);
    if tmp_1704 == tmp_1705 { keys[0] = tmp_1672; values[0] = tmp_1673; }
    let tmp_1706 = keys[1] < tmp_1674 || (keys[1] == tmp_1674 && values[1] < tmp_1675);
    if tmp_1704 == tmp_1706 { keys[1] = tmp_1674; values[1] = tmp_1675; }
    let tmp_1707 = keys[2] < tmp_1676 || (keys[2] == tmp_1676 && values[2] < tmp_1677);
    if tmp_1704 == tmp_1707 { keys[2] = tmp_1676; values[2] = tmp_1677; }
    let tmp_1708 = keys[3] < tmp_1678 || (keys[3] == tmp_1678 && values[3] < tmp_1679);
    if tmp_1704 == tmp_1708 { keys[3] = tmp_1678; values[3] = tmp_1679; }
    let tmp_1709 = keys[4] < tmp_1680 || (keys[4] == tmp_1680 && values[4] < tmp_1681);
    if tmp_1704 == tmp_1709 { keys[4] = tmp_1680; values[4] = tmp_1681; }
    let tmp_1710 = keys[5] < tmp_1682 || (keys[5] == tmp_1682 && values[5] < tmp_1683);
    if tmp_1704 == tmp_1710 { keys[5] = tmp_1682; values[5] = tmp_1683; }
    let tmp_1711 = keys[6] < tmp_1684 || (keys[6] == tmp_1684 && values[6] < tmp_1685);
    if tmp_1704 == tmp_1711 { keys[6] = tmp_1684; values[6] = tmp_1685; }
    let tmp_1712 = keys[7] < tmp_1686 || (keys[7] == tmp_1686 && values[7] < tmp_1687);
    if tmp_1704 == tmp_1712 { keys[7] = tmp_1686; values[7] = tmp_1687; }
    let tmp_1713 = keys[8] < tmp_1688 || (keys[8] == tmp_1688 && values[8] < tmp_1689);
    if tmp_1704 == tmp_1713 { keys[8] = tmp_1688; values[8] = tmp_1689; }
    let tmp_1714 = keys[9] < tmp_1690 || (keys[9] == tmp_1690 && values[9] < tmp_1691);
    if tmp_1704 == tmp_1714 { keys[9] = tmp_1690; values[9] = tmp_1691; }
    let tmp_1715 = keys[10] < tmp_1692 || (keys[10] == tmp_1692 && values[10] < tmp_1693);
    if tmp_1704 == tmp_1715 { keys[10] = tmp_1692; values[10] = tmp_1693; }
    let tmp_1716 = keys[11] < tmp_1694 || (keys[11] == tmp_1694 && values[11] < tmp_1695);
    if tmp_1704 == tmp_1716 { keys[11] = tmp_1694; values[11] = tmp_1695; }
    let tmp_1717 = keys[12] < tmp_1696 || (keys[12] == tmp_1696 && values[12] < tmp_1697);
    if tmp_1704 == tmp_1717 { keys[12] = tmp_1696; values[12] = tmp_1697; }
    let tmp_1718 = keys[13] < tmp_1698 || (keys[13] == tmp_1698 && values[13] < tmp_1699);
    if tmp_1704 == tmp_1718 { keys[13] = tmp_1698; values[13] = tmp_1699; }
    let tmp_1719 = keys[14] < tmp_1700 || (keys[14] == tmp_1700 && values[14] < tmp_1701);
    if tmp_1704 == tmp_1719 { keys[14] = tmp_1700; values[14] = tmp_1701; }
    let tmp_1720 = keys[15] < tmp_1702 || (keys[15] == tmp_1702 && values[15] < tmp_1703);
    if tmp_1704 == tmp_1720 { keys[15] = tmp_1702; values[15] = tmp_1703; }
    }
    // exch_paral(tmask:8,swbit:3,wpt:16) 
    {
    let tmp_1721 = subgroupShuffleXor(keys[0], 8u);
    let tmp_1722 = subgroupShuffleXor(values[0], 8u);
    let tmp_1723 = subgroupShuffleXor(keys[1], 8u);
    let tmp_1724 = subgroupShuffleXor(values[1], 8u);
    let tmp_1725 = subgroupShuffleXor(keys[2], 8u);
    let tmp_1726 = subgroupShuffleXor(values[2], 8u);
    let tmp_1727 = subgroupShuffleXor(keys[3], 8u);
    let tmp_1728 = subgroupShuffleXor(values[3], 8u);
    let tmp_1729 = subgroupShuffleXor(keys[4], 8u);
    let tmp_1730 = subgroupShuffleXor(values[4], 8u);
    let tmp_1731 = subgroupShuffleXor(keys[5], 8u);
    let tmp_1732 = subgroupShuffleXor(values[5], 8u);
    let tmp_1733 = subgroupShuffleXor(keys[6], 8u);
    let tmp_1734 = subgroupShuffleXor(values[6], 8u);
    let tmp_1735 = subgroupShuffleXor(keys[7], 8u);
    let tmp_1736 = subgroupShuffleXor(values[7], 8u);
    let tmp_1737 = subgroupShuffleXor(keys[8], 8u);
    let tmp_1738 = subgroupShuffleXor(values[8], 8u);
    let tmp_1739 = subgroupShuffleXor(keys[9], 8u);
    let tmp_1740 = subgroupShuffleXor(values[9], 8u);
    let tmp_1741 = subgroupShuffleXor(keys[10], 8u);
    let tmp_1742 = subgroupShuffleXor(values[10], 8u);
    let tmp_1743 = subgroupShuffleXor(keys[11], 8u);
    let tmp_1744 = subgroupShuffleXor(values[11], 8u);
    let tmp_1745 = subgroupShuffleXor(keys[12], 8u);
    let tmp_1746 = subgroupShuffleXor(values[12], 8u);
    let tmp_1747 = subgroupShuffleXor(keys[13], 8u);
    let tmp_1748 = subgroupShuffleXor(values[13], 8u);
    let tmp_1749 = subgroupShuffleXor(keys[14], 8u);
    let tmp_1750 = subgroupShuffleXor(values[14], 8u);
    let tmp_1751 = subgroupShuffleXor(keys[15], 8u);
    let tmp_1752 = subgroupShuffleXor(values[15], 8u);
    let tmp_1753 = extractBits(local_tid, 3u, 1u) != 0u;
    let tmp_1754 = keys[0] < tmp_1721 || (keys[0] == tmp_1721 && values[0] < tmp_1722);
    if tmp_1753 == tmp_1754 { keys[0] = tmp_1721; values[0] = tmp_1722; }
    let tmp_1755 = keys[1] < tmp_1723 || (keys[1] == tmp_1723 && values[1] < tmp_1724);
    if tmp_1753 == tmp_1755 { keys[1] = tmp_1723; values[1] = tmp_1724; }
    let tmp_1756 = keys[2] < tmp_1725 || (keys[2] == tmp_1725 && values[2] < tmp_1726);
    if tmp_1753 == tmp_1756 { keys[2] = tmp_1725; values[2] = tmp_1726; }
    let tmp_1757 = keys[3] < tmp_1727 || (keys[3] == tmp_1727 && values[3] < tmp_1728);
    if tmp_1753 == tmp_1757 { keys[3] = tmp_1727; values[3] = tmp_1728; }
    let tmp_1758 = keys[4] < tmp_1729 || (keys[4] == tmp_1729 && values[4] < tmp_1730);
    if tmp_1753 == tmp_1758 { keys[4] = tmp_1729; values[4] = tmp_1730; }
    let tmp_1759 = keys[5] < tmp_1731 || (keys[5] == tmp_1731 && values[5] < tmp_1732);
    if tmp_1753 == tmp_1759 { keys[5] = tmp_1731; values[5] = tmp_1732; }
    let tmp_1760 = keys[6] < tmp_1733 || (keys[6] == tmp_1733 && values[6] < tmp_1734);
    if tmp_1753 == tmp_1760 { keys[6] = tmp_1733; values[6] = tmp_1734; }
    let tmp_1761 = keys[7] < tmp_1735 || (keys[7] == tmp_1735 && values[7] < tmp_1736);
    if tmp_1753 == tmp_1761 { keys[7] = tmp_1735; values[7] = tmp_1736; }
    let tmp_1762 = keys[8] < tmp_1737 || (keys[8] == tmp_1737 && values[8] < tmp_1738);
    if tmp_1753 == tmp_1762 { keys[8] = tmp_1737; values[8] = tmp_1738; }
    let tmp_1763 = keys[9] < tmp_1739 || (keys[9] == tmp_1739 && values[9] < tmp_1740);
    if tmp_1753 == tmp_1763 { keys[9] = tmp_1739; values[9] = tmp_1740; }
    let tmp_1764 = keys[10] < tmp_1741 || (keys[10] == tmp_1741 && values[10] < tmp_1742);
    if tmp_1753 == tmp_1764 { keys[10] = tmp_1741; values[10] = tmp_1742; }
    let tmp_1765 = keys[11] < tmp_1743 || (keys[11] == tmp_1743 && values[11] < tmp_1744);
    if tmp_1753 == tmp_1765 { keys[11] = tmp_1743; values[11] = tmp_1744; }
    let tmp_1766 = keys[12] < tmp_1745 || (keys[12] == tmp_1745 && values[12] < tmp_1746);
    if tmp_1753 == tmp_1766 { keys[12] = tmp_1745; values[12] = tmp_1746; }
    let tmp_1767 = keys[13] < tmp_1747 || (keys[13] == tmp_1747 && values[13] < tmp_1748);
    if tmp_1753 == tmp_1767 { keys[13] = tmp_1747; values[13] = tmp_1748; }
    let tmp_1768 = keys[14] < tmp_1749 || (keys[14] == tmp_1749 && values[14] < tmp_1750);
    if tmp_1753 == tmp_1768 { keys[14] = tmp_1749; values[14] = tmp_1750; }
    let tmp_1769 = keys[15] < tmp_1751 || (keys[15] == tmp_1751 && values[15] < tmp_1752);
    if tmp_1753 == tmp_1769 { keys[15] = tmp_1751; values[15] = tmp_1752; }
    }
    // exch_paral(tmask:4,swbit:2,wpt:16) 
    {
    let tmp_1770 = subgroupShuffleXor(keys[0], 4u);
    let tmp_1771 = subgroupShuffleXor(values[0], 4u);
    let tmp_1772 = subgroupShuffleXor(keys[1], 4u);
    let tmp_1773 = subgroupShuffleXor(values[1], 4u);
    let tmp_1774 = subgroupShuffleXor(keys[2], 4u);
    let tmp_1775 = subgroupShuffleXor(values[2], 4u);
    let tmp_1776 = subgroupShuffleXor(keys[3], 4u);
    let tmp_1777 = subgroupShuffleXor(values[3], 4u);
    let tmp_1778 = subgroupShuffleXor(keys[4], 4u);
    let tmp_1779 = subgroupShuffleXor(values[4], 4u);
    let tmp_1780 = subgroupShuffleXor(keys[5], 4u);
    let tmp_1781 = subgroupShuffleXor(values[5], 4u);
    let tmp_1782 = subgroupShuffleXor(keys[6], 4u);
    let tmp_1783 = subgroupShuffleXor(values[6], 4u);
    let tmp_1784 = subgroupShuffleXor(keys[7], 4u);
    let tmp_1785 = subgroupShuffleXor(values[7], 4u);
    let tmp_1786 = subgroupShuffleXor(keys[8], 4u);
    let tmp_1787 = subgroupShuffleXor(values[8], 4u);
    let tmp_1788 = subgroupShuffleXor(keys[9], 4u);
    let tmp_1789 = subgroupShuffleXor(values[9], 4u);
    let tmp_1790 = subgroupShuffleXor(keys[10], 4u);
    let tmp_1791 = subgroupShuffleXor(values[10], 4u);
    let tmp_1792 = subgroupShuffleXor(keys[11], 4u);
    let tmp_1793 = subgroupShuffleXor(values[11], 4u);
    let tmp_1794 = subgroupShuffleXor(keys[12], 4u);
    let tmp_1795 = subgroupShuffleXor(values[12], 4u);
    let tmp_1796 = subgroupShuffleXor(keys[13], 4u);
    let tmp_1797 = subgroupShuffleXor(values[13], 4u);
    let tmp_1798 = subgroupShuffleXor(keys[14], 4u);
    let tmp_1799 = subgroupShuffleXor(values[14], 4u);
    let tmp_1800 = subgroupShuffleXor(keys[15], 4u);
    let tmp_1801 = subgroupShuffleXor(values[15], 4u);
    let tmp_1802 = extractBits(local_tid, 2u, 1u) != 0u;
    let tmp_1803 = keys[0] < tmp_1770 || (keys[0] == tmp_1770 && values[0] < tmp_1771);
    if tmp_1802 == tmp_1803 { keys[0] = tmp_1770; values[0] = tmp_1771; }
    let tmp_1804 = keys[1] < tmp_1772 || (keys[1] == tmp_1772 && values[1] < tmp_1773);
    if tmp_1802 == tmp_1804 { keys[1] = tmp_1772; values[1] = tmp_1773; }
    let tmp_1805 = keys[2] < tmp_1774 || (keys[2] == tmp_1774 && values[2] < tmp_1775);
    if tmp_1802 == tmp_1805 { keys[2] = tmp_1774; values[2] = tmp_1775; }
    let tmp_1806 = keys[3] < tmp_1776 || (keys[3] == tmp_1776 && values[3] < tmp_1777);
    if tmp_1802 == tmp_1806 { keys[3] = tmp_1776; values[3] = tmp_1777; }
    let tmp_1807 = keys[4] < tmp_1778 || (keys[4] == tmp_1778 && values[4] < tmp_1779);
    if tmp_1802 == tmp_1807 { keys[4] = tmp_1778; values[4] = tmp_1779; }
    let tmp_1808 = keys[5] < tmp_1780 || (keys[5] == tmp_1780 && values[5] < tmp_1781);
    if tmp_1802 == tmp_1808 { keys[5] = tmp_1780; values[5] = tmp_1781; }
    let tmp_1809 = keys[6] < tmp_1782 || (keys[6] == tmp_1782 && values[6] < tmp_1783);
    if tmp_1802 == tmp_1809 { keys[6] = tmp_1782; values[6] = tmp_1783; }
    let tmp_1810 = keys[7] < tmp_1784 || (keys[7] == tmp_1784 && values[7] < tmp_1785);
    if tmp_1802 == tmp_1810 { keys[7] = tmp_1784; values[7] = tmp_1785; }
    let tmp_1811 = keys[8] < tmp_1786 || (keys[8] == tmp_1786 && values[8] < tmp_1787);
    if tmp_1802 == tmp_1811 { keys[8] = tmp_1786; values[8] = tmp_1787; }
    let tmp_1812 = keys[9] < tmp_1788 || (keys[9] == tmp_1788 && values[9] < tmp_1789);
    if tmp_1802 == tmp_1812 { keys[9] = tmp_1788; values[9] = tmp_1789; }
    let tmp_1813 = keys[10] < tmp_1790 || (keys[10] == tmp_1790 && values[10] < tmp_1791);
    if tmp_1802 == tmp_1813 { keys[10] = tmp_1790; values[10] = tmp_1791; }
    let tmp_1814 = keys[11] < tmp_1792 || (keys[11] == tmp_1792 && values[11] < tmp_1793);
    if tmp_1802 == tmp_1814 { keys[11] = tmp_1792; values[11] = tmp_1793; }
    let tmp_1815 = keys[12] < tmp_1794 || (keys[12] == tmp_1794 && values[12] < tmp_1795);
    if tmp_1802 == tmp_1815 { keys[12] = tmp_1794; values[12] = tmp_1795; }
    let tmp_1816 = keys[13] < tmp_1796 || (keys[13] == tmp_1796 && values[13] < tmp_1797);
    if tmp_1802 == tmp_1816 { keys[13] = tmp_1796; values[13] = tmp_1797; }
    let tmp_1817 = keys[14] < tmp_1798 || (keys[14] == tmp_1798 && values[14] < tmp_1799);
    if tmp_1802 == tmp_1817 { keys[14] = tmp_1798; values[14] = tmp_1799; }
    let tmp_1818 = keys[15] < tmp_1800 || (keys[15] == tmp_1800 && values[15] < tmp_1801);
    if tmp_1802 == tmp_1818 { keys[15] = tmp_1800; values[15] = tmp_1801; }
    }
    // exch_paral(tmask:2,swbit:1,wpt:16) 
    {
    let tmp_1819 = subgroupShuffleXor(keys[0], 2u);
    let tmp_1820 = subgroupShuffleXor(values[0], 2u);
    let tmp_1821 = subgroupShuffleXor(keys[1], 2u);
    let tmp_1822 = subgroupShuffleXor(values[1], 2u);
    let tmp_1823 = subgroupShuffleXor(keys[2], 2u);
    let tmp_1824 = subgroupShuffleXor(values[2], 2u);
    let tmp_1825 = subgroupShuffleXor(keys[3], 2u);
    let tmp_1826 = subgroupShuffleXor(values[3], 2u);
    let tmp_1827 = subgroupShuffleXor(keys[4], 2u);
    let tmp_1828 = subgroupShuffleXor(values[4], 2u);
    let tmp_1829 = subgroupShuffleXor(keys[5], 2u);
    let tmp_1830 = subgroupShuffleXor(values[5], 2u);
    let tmp_1831 = subgroupShuffleXor(keys[6], 2u);
    let tmp_1832 = subgroupShuffleXor(values[6], 2u);
    let tmp_1833 = subgroupShuffleXor(keys[7], 2u);
    let tmp_1834 = subgroupShuffleXor(values[7], 2u);
    let tmp_1835 = subgroupShuffleXor(keys[8], 2u);
    let tmp_1836 = subgroupShuffleXor(values[8], 2u);
    let tmp_1837 = subgroupShuffleXor(keys[9], 2u);
    let tmp_1838 = subgroupShuffleXor(values[9], 2u);
    let tmp_1839 = subgroupShuffleXor(keys[10], 2u);
    let tmp_1840 = subgroupShuffleXor(values[10], 2u);
    let tmp_1841 = subgroupShuffleXor(keys[11], 2u);
    let tmp_1842 = subgroupShuffleXor(values[11], 2u);
    let tmp_1843 = subgroupShuffleXor(keys[12], 2u);
    let tmp_1844 = subgroupShuffleXor(values[12], 2u);
    let tmp_1845 = subgroupShuffleXor(keys[13], 2u);
    let tmp_1846 = subgroupShuffleXor(values[13], 2u);
    let tmp_1847 = subgroupShuffleXor(keys[14], 2u);
    let tmp_1848 = subgroupShuffleXor(values[14], 2u);
    let tmp_1849 = subgroupShuffleXor(keys[15], 2u);
    let tmp_1850 = subgroupShuffleXor(values[15], 2u);
    let tmp_1851 = extractBits(local_tid, 1u, 1u) != 0u;
    let tmp_1852 = keys[0] < tmp_1819 || (keys[0] == tmp_1819 && values[0] < tmp_1820);
    if tmp_1851 == tmp_1852 { keys[0] = tmp_1819; values[0] = tmp_1820; }
    let tmp_1853 = keys[1] < tmp_1821 || (keys[1] == tmp_1821 && values[1] < tmp_1822);
    if tmp_1851 == tmp_1853 { keys[1] = tmp_1821; values[1] = tmp_1822; }
    let tmp_1854 = keys[2] < tmp_1823 || (keys[2] == tmp_1823 && values[2] < tmp_1824);
    if tmp_1851 == tmp_1854 { keys[2] = tmp_1823; values[2] = tmp_1824; }
    let tmp_1855 = keys[3] < tmp_1825 || (keys[3] == tmp_1825 && values[3] < tmp_1826);
    if tmp_1851 == tmp_1855 { keys[3] = tmp_1825; values[3] = tmp_1826; }
    let tmp_1856 = keys[4] < tmp_1827 || (keys[4] == tmp_1827 && values[4] < tmp_1828);
    if tmp_1851 == tmp_1856 { keys[4] = tmp_1827; values[4] = tmp_1828; }
    let tmp_1857 = keys[5] < tmp_1829 || (keys[5] == tmp_1829 && values[5] < tmp_1830);
    if tmp_1851 == tmp_1857 { keys[5] = tmp_1829; values[5] = tmp_1830; }
    let tmp_1858 = keys[6] < tmp_1831 || (keys[6] == tmp_1831 && values[6] < tmp_1832);
    if tmp_1851 == tmp_1858 { keys[6] = tmp_1831; values[6] = tmp_1832; }
    let tmp_1859 = keys[7] < tmp_1833 || (keys[7] == tmp_1833 && values[7] < tmp_1834);
    if tmp_1851 == tmp_1859 { keys[7] = tmp_1833; values[7] = tmp_1834; }
    let tmp_1860 = keys[8] < tmp_1835 || (keys[8] == tmp_1835 && values[8] < tmp_1836);
    if tmp_1851 == tmp_1860 { keys[8] = tmp_1835; values[8] = tmp_1836; }
    let tmp_1861 = keys[9] < tmp_1837 || (keys[9] == tmp_1837 && values[9] < tmp_1838);
    if tmp_1851 == tmp_1861 { keys[9] = tmp_1837; values[9] = tmp_1838; }
    let tmp_1862 = keys[10] < tmp_1839 || (keys[10] == tmp_1839 && values[10] < tmp_1840);
    if tmp_1851 == tmp_1862 { keys[10] = tmp_1839; values[10] = tmp_1840; }
    let tmp_1863 = keys[11] < tmp_1841 || (keys[11] == tmp_1841 && values[11] < tmp_1842);
    if tmp_1851 == tmp_1863 { keys[11] = tmp_1841; values[11] = tmp_1842; }
    let tmp_1864 = keys[12] < tmp_1843 || (keys[12] == tmp_1843 && values[12] < tmp_1844);
    if tmp_1851 == tmp_1864 { keys[12] = tmp_1843; values[12] = tmp_1844; }
    let tmp_1865 = keys[13] < tmp_1845 || (keys[13] == tmp_1845 && values[13] < tmp_1846);
    if tmp_1851 == tmp_1865 { keys[13] = tmp_1845; values[13] = tmp_1846; }
    let tmp_1866 = keys[14] < tmp_1847 || (keys[14] == tmp_1847 && values[14] < tmp_1848);
    if tmp_1851 == tmp_1866 { keys[14] = tmp_1847; values[14] = tmp_1848; }
    let tmp_1867 = keys[15] < tmp_1849 || (keys[15] == tmp_1849 && values[15] < tmp_1850);
    if tmp_1851 == tmp_1867 { keys[15] = tmp_1849; values[15] = tmp_1850; }
    }
    // exch_paral(tmask:1,swbit:0,wpt:16) 
    {
    let tmp_1868 = subgroupShuffleXor(keys[0], 1u);
    let tmp_1869 = subgroupShuffleXor(values[0], 1u);
    let tmp_1870 = subgroupShuffleXor(keys[1], 1u);
    let tmp_1871 = subgroupShuffleXor(values[1], 1u);
    let tmp_1872 = subgroupShuffleXor(keys[2], 1u);
    let tmp_1873 = subgroupShuffleXor(values[2], 1u);
    let tmp_1874 = subgroupShuffleXor(keys[3], 1u);
    let tmp_1875 = subgroupShuffleXor(values[3], 1u);
    let tmp_1876 = subgroupShuffleXor(keys[4], 1u);
    let tmp_1877 = subgroupShuffleXor(values[4], 1u);
    let tmp_1878 = subgroupShuffleXor(keys[5], 1u);
    let tmp_1879 = subgroupShuffleXor(values[5], 1u);
    let tmp_1880 = subgroupShuffleXor(keys[6], 1u);
    let tmp_1881 = subgroupShuffleXor(values[6], 1u);
    let tmp_1882 = subgroupShuffleXor(keys[7], 1u);
    let tmp_1883 = subgroupShuffleXor(values[7], 1u);
    let tmp_1884 = subgroupShuffleXor(keys[8], 1u);
    let tmp_1885 = subgroupShuffleXor(values[8], 1u);
    let tmp_1886 = subgroupShuffleXor(keys[9], 1u);
    let tmp_1887 = subgroupShuffleXor(values[9], 1u);
    let tmp_1888 = subgroupShuffleXor(keys[10], 1u);
    let tmp_1889 = subgroupShuffleXor(values[10], 1u);
    let tmp_1890 = subgroupShuffleXor(keys[11], 1u);
    let tmp_1891 = subgroupShuffleXor(values[11], 1u);
    let tmp_1892 = subgroupShuffleXor(keys[12], 1u);
    let tmp_1893 = subgroupShuffleXor(values[12], 1u);
    let tmp_1894 = subgroupShuffleXor(keys[13], 1u);
    let tmp_1895 = subgroupShuffleXor(values[13], 1u);
    let tmp_1896 = subgroupShuffleXor(keys[14], 1u);
    let tmp_1897 = subgroupShuffleXor(values[14], 1u);
    let tmp_1898 = subgroupShuffleXor(keys[15], 1u);
    let tmp_1899 = subgroupShuffleXor(values[15], 1u);
    let tmp_1900 = extractBits(local_tid, 0u, 1u) != 0u;
    let tmp_1901 = keys[0] < tmp_1868 || (keys[0] == tmp_1868 && values[0] < tmp_1869);
    if tmp_1900 == tmp_1901 { keys[0] = tmp_1868; values[0] = tmp_1869; }
    let tmp_1902 = keys[1] < tmp_1870 || (keys[1] == tmp_1870 && values[1] < tmp_1871);
    if tmp_1900 == tmp_1902 { keys[1] = tmp_1870; values[1] = tmp_1871; }
    let tmp_1903 = keys[2] < tmp_1872 || (keys[2] == tmp_1872 && values[2] < tmp_1873);
    if tmp_1900 == tmp_1903 { keys[2] = tmp_1872; values[2] = tmp_1873; }
    let tmp_1904 = keys[3] < tmp_1874 || (keys[3] == tmp_1874 && values[3] < tmp_1875);
    if tmp_1900 == tmp_1904 { keys[3] = tmp_1874; values[3] = tmp_1875; }
    let tmp_1905 = keys[4] < tmp_1876 || (keys[4] == tmp_1876 && values[4] < tmp_1877);
    if tmp_1900 == tmp_1905 { keys[4] = tmp_1876; values[4] = tmp_1877; }
    let tmp_1906 = keys[5] < tmp_1878 || (keys[5] == tmp_1878 && values[5] < tmp_1879);
    if tmp_1900 == tmp_1906 { keys[5] = tmp_1878; values[5] = tmp_1879; }
    let tmp_1907 = keys[6] < tmp_1880 || (keys[6] == tmp_1880 && values[6] < tmp_1881);
    if tmp_1900 == tmp_1907 { keys[6] = tmp_1880; values[6] = tmp_1881; }
    let tmp_1908 = keys[7] < tmp_1882 || (keys[7] == tmp_1882 && values[7] < tmp_1883);
    if tmp_1900 == tmp_1908 { keys[7] = tmp_1882; values[7] = tmp_1883; }
    let tmp_1909 = keys[8] < tmp_1884 || (keys[8] == tmp_1884 && values[8] < tmp_1885);
    if tmp_1900 == tmp_1909 { keys[8] = tmp_1884; values[8] = tmp_1885; }
    let tmp_1910 = keys[9] < tmp_1886 || (keys[9] == tmp_1886 && values[9] < tmp_1887);
    if tmp_1900 == tmp_1910 { keys[9] = tmp_1886; values[9] = tmp_1887; }
    let tmp_1911 = keys[10] < tmp_1888 || (keys[10] == tmp_1888 && values[10] < tmp_1889);
    if tmp_1900 == tmp_1911 { keys[10] = tmp_1888; values[10] = tmp_1889; }
    let tmp_1912 = keys[11] < tmp_1890 || (keys[11] == tmp_1890 && values[11] < tmp_1891);
    if tmp_1900 == tmp_1912 { keys[11] = tmp_1890; values[11] = tmp_1891; }
    let tmp_1913 = keys[12] < tmp_1892 || (keys[12] == tmp_1892 && values[12] < tmp_1893);
    if tmp_1900 == tmp_1913 { keys[12] = tmp_1892; values[12] = tmp_1893; }
    let tmp_1914 = keys[13] < tmp_1894 || (keys[13] == tmp_1894 && values[13] < tmp_1895);
    if tmp_1900 == tmp_1914 { keys[13] = tmp_1894; values[13] = tmp_1895; }
    let tmp_1915 = keys[14] < tmp_1896 || (keys[14] == tmp_1896 && values[14] < tmp_1897);
    if tmp_1900 == tmp_1915 { keys[14] = tmp_1896; values[14] = tmp_1897; }
    let tmp_1916 = keys[15] < tmp_1898 || (keys[15] == tmp_1898 && values[15] < tmp_1899);
    if tmp_1900 == tmp_1916 { keys[15] = tmp_1898; values[15] = tmp_1899; }
    }
    // exch_local(8,16) 
    // cmp_swap(0,8)
    if keys[0] > keys[8] || (keys[0] == keys[8] && values[0] > values[8]) {
    // swap(0,8) 
    { let tmp_1917 = keys[0]; keys[0] = keys[8]; keys[8] = tmp_1917;let tmp_1918 = values[0]; values[0] = values[8]; values[8] = tmp_1918; }
    }
    // cmp_swap(1,9)
    if keys[1] > keys[9] || (keys[1] == keys[9] && values[1] > values[9]) {
    // swap(1,9) 
    { let tmp_1919 = keys[1]; keys[1] = keys[9]; keys[9] = tmp_1919;let tmp_1920 = values[1]; values[1] = values[9]; values[9] = tmp_1920; }
    }
    // cmp_swap(2,10)
    if keys[2] > keys[10] || (keys[2] == keys[10] && values[2] > values[10]) {
    // swap(2,10) 
    { let tmp_1921 = keys[2]; keys[2] = keys[10]; keys[10] = tmp_1921;let tmp_1922 = values[2]; values[2] = values[10]; values[10] = tmp_1922; }
    }
    // cmp_swap(3,11)
    if keys[3] > keys[11] || (keys[3] == keys[11] && values[3] > values[11]) {
    // swap(3,11) 
    { let tmp_1923 = keys[3]; keys[3] = keys[11]; keys[11] = tmp_1923;let tmp_1924 = values[3]; values[3] = values[11]; values[11] = tmp_1924; }
    }
    // cmp_swap(4,12)
    if keys[4] > keys[12] || (keys[4] == keys[12] && values[4] > values[12]) {
    // swap(4,12) 
    { let tmp_1925 = keys[4]; keys[4] = keys[12]; keys[12] = tmp_1925;let tmp_1926 = values[4]; values[4] = values[12]; values[12] = tmp_1926; }
    }
    // cmp_swap(5,13)
    if keys[5] > keys[13] || (keys[5] == keys[13] && values[5] > values[13]) {
    // swap(5,13) 
    { let tmp_1927 = keys[5]; keys[5] = keys[13]; keys[13] = tmp_1927;let tmp_1928 = values[5]; values[5] = values[13]; values[13] = tmp_1928; }
    }
    // cmp_swap(6,14)
    if keys[6] > keys[14] || (keys[6] == keys[14] && values[6] > values[14]) {
    // swap(6,14) 
    { let tmp_1929 = keys[6]; keys[6] = keys[14]; keys[14] = tmp_1929;let tmp_1930 = values[6]; values[6] = values[14]; values[14] = tmp_1930; }
    }
    // cmp_swap(7,15)
    if keys[7] > keys[15] || (keys[7] == keys[15] && values[7] > values[15]) {
    // swap(7,15) 
    { let tmp_1931 = keys[7]; keys[7] = keys[15]; keys[15] = tmp_1931;let tmp_1932 = values[7]; values[7] = values[15]; values[15] = tmp_1932; }
    }
    // exch_local(4,16) 
    // cmp_swap(0,4)
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_1933 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_1933;let tmp_1934 = values[0]; values[0] = values[4]; values[4] = tmp_1934; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_1935 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_1935;let tmp_1936 = values[1]; values[1] = values[5]; values[5] = tmp_1936; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_1937 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_1937;let tmp_1938 = values[2]; values[2] = values[6]; values[6] = tmp_1938; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_1939 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_1939;let tmp_1940 = values[3]; values[3] = values[7]; values[7] = tmp_1940; }
    }
    // cmp_swap(8,12)
    if keys[8] > keys[12] || (keys[8] == keys[12] && values[8] > values[12]) {
    // swap(8,12) 
    { let tmp_1941 = keys[8]; keys[8] = keys[12]; keys[12] = tmp_1941;let tmp_1942 = values[8]; values[8] = values[12]; values[12] = tmp_1942; }
    }
    // cmp_swap(9,13)
    if keys[9] > keys[13] || (keys[9] == keys[13] && values[9] > values[13]) {
    // swap(9,13) 
    { let tmp_1943 = keys[9]; keys[9] = keys[13]; keys[13] = tmp_1943;let tmp_1944 = values[9]; values[9] = values[13]; values[13] = tmp_1944; }
    }
    // cmp_swap(10,14)
    if keys[10] > keys[14] || (keys[10] == keys[14] && values[10] > values[14]) {
    // swap(10,14) 
    { let tmp_1945 = keys[10]; keys[10] = keys[14]; keys[14] = tmp_1945;let tmp_1946 = values[10]; values[10] = values[14]; values[14] = tmp_1946; }
    }
    // cmp_swap(11,15)
    if keys[11] > keys[15] || (keys[11] == keys[15] && values[11] > values[15]) {
    // swap(11,15) 
    { let tmp_1947 = keys[11]; keys[11] = keys[15]; keys[15] = tmp_1947;let tmp_1948 = values[11]; values[11] = values[15]; values[15] = tmp_1948; }
    }
    // exch_local(2,16) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_1949 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_1949;let tmp_1950 = values[0]; values[0] = values[2]; values[2] = tmp_1950; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_1951 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_1951;let tmp_1952 = values[1]; values[1] = values[3]; values[3] = tmp_1952; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_1953 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_1953;let tmp_1954 = values[4]; values[4] = values[6]; values[6] = tmp_1954; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_1955 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_1955;let tmp_1956 = values[5]; values[5] = values[7]; values[7] = tmp_1956; }
    }
    // cmp_swap(8,10)
    if keys[8] > keys[10] || (keys[8] == keys[10] && values[8] > values[10]) {
    // swap(8,10) 
    { let tmp_1957 = keys[8]; keys[8] = keys[10]; keys[10] = tmp_1957;let tmp_1958 = values[8]; values[8] = values[10]; values[10] = tmp_1958; }
    }
    // cmp_swap(9,11)
    if keys[9] > keys[11] || (keys[9] == keys[11] && values[9] > values[11]) {
    // swap(9,11) 
    { let tmp_1959 = keys[9]; keys[9] = keys[11]; keys[11] = tmp_1959;let tmp_1960 = values[9]; values[9] = values[11]; values[11] = tmp_1960; }
    }
    // cmp_swap(12,14)
    if keys[12] > keys[14] || (keys[12] == keys[14] && values[12] > values[14]) {
    // swap(12,14) 
    { let tmp_1961 = keys[12]; keys[12] = keys[14]; keys[14] = tmp_1961;let tmp_1962 = values[12]; values[12] = values[14]; values[14] = tmp_1962; }
    }
    // cmp_swap(13,15)
    if keys[13] > keys[15] || (keys[13] == keys[15] && values[13] > values[15]) {
    // swap(13,15) 
    { let tmp_1963 = keys[13]; keys[13] = keys[15]; keys[15] = tmp_1963;let tmp_1964 = values[13]; values[13] = values[15]; values[15] = tmp_1964; }
    }
    // exch_local(1,16) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_1965 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_1965;let tmp_1966 = values[0]; values[0] = values[1]; values[1] = tmp_1966; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_1967 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_1967;let tmp_1968 = values[2]; values[2] = values[3]; values[3] = tmp_1968; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_1969 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_1969;let tmp_1970 = values[4]; values[4] = values[5]; values[5] = tmp_1970; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_1971 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_1971;let tmp_1972 = values[6]; values[6] = values[7]; values[7] = tmp_1972; }
    }
    // cmp_swap(8,9)
    if keys[8] > keys[9] || (keys[8] == keys[9] && values[8] > values[9]) {
    // swap(8,9) 
    { let tmp_1973 = keys[8]; keys[8] = keys[9]; keys[9] = tmp_1973;let tmp_1974 = values[8]; values[8] = values[9]; values[9] = tmp_1974; }
    }
    // cmp_swap(10,11)
    if keys[10] > keys[11] || (keys[10] == keys[11] && values[10] > values[11]) {
    // swap(10,11) 
    { let tmp_1975 = keys[10]; keys[10] = keys[11]; keys[11] = tmp_1975;let tmp_1976 = values[10]; values[10] = values[11]; values[11] = tmp_1976; }
    }
    // cmp_swap(12,13)
    if keys[12] > keys[13] || (keys[12] == keys[13] && values[12] > values[13]) {
    // swap(12,13) 
    { let tmp_1977 = keys[12]; keys[12] = keys[13]; keys[13] = tmp_1977;let tmp_1978 = values[12]; values[12] = values[13]; values[13] = tmp_1978; }
    }
    // cmp_swap(14,15)
    if keys[14] > keys[15] || (keys[14] == keys[15] && values[14] > values[15]) {
    // swap(14,15) 
    { let tmp_1979 = keys[14]; keys[14] = keys[15]; keys[15] = tmp_1979;let tmp_1980 = values[14]; values[14] = values[15]; values[15] = tmp_1980; }
    }
