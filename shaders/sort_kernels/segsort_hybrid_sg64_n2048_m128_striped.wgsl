...
fn segsort_hybrid_sg64_n2048_m128_striped(
    ...
    // exch_intxn(tmask:127,swbit:6,wpt:16)
    {
        // _exch_workgroup([(0, 15), (1, 14), (2, 13), (3, 12), (4, 11), (5, 10), (6, 9), (7, 8), (8, 7), (9, 6), (10, 5), (11, 4), (12, 3), (13, 2), (14, 1), (15, 0)],127,6)
        {
            ...
            workgroupBarrier();
            let tmp_1573 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_1574 = seg_base + (local_tid ^ 127u);
            let tmp_1575 = smem_keys[tmp_1574 * WPT + 15u];
            let tmp_1576 = smem_vals[tmp_1574 * WPT + 15u];
            let tmp_1577 = keys[0] < tmp_1575 || (keys[0] == tmp_1575 && values[0] < tmp_1576);
            if tmp_1573 == tmp_1577 { keys[0] = tmp_1575; values[0] = tmp_1576; }
            let tmp_1578 = smem_keys[tmp_1574 * WPT + 14u];
            let tmp_1579 = smem_vals[tmp_1574 * WPT + 14u];
            let tmp_1580 = keys[1] < tmp_1578 || (keys[1] == tmp_1578 && values[1] < tmp_1579);
            if tmp_1573 == tmp_1580 { keys[1] = tmp_1578; values[1] = tmp_1579; }
            let tmp_1581 = smem_keys[tmp_1574 * WPT + 13u];
            let tmp_1582 = smem_vals[tmp_1574 * WPT + 13u];
            let tmp_1583 = keys[2] < tmp_1581 || (keys[2] == tmp_1581 && values[2] < tmp_1582);
            if tmp_1573 == tmp_1583 { keys[2] = tmp_1581; values[2] = tmp_1582; }
            let tmp_1584 = smem_keys[tmp_1574 * WPT + 12u];
            let tmp_1585 = smem_vals[tmp_1574 * WPT + 12u];
            let tmp_1586 = keys[3] < tmp_1584 || (keys[3] == tmp_1584 && values[3] < tmp_1585);
            if tmp_1573 == tmp_1586 { keys[3] = tmp_1584; values[3] = tmp_1585; }
            let tmp_1587 = smem_keys[tmp_1574 * WPT + 11u];
            let tmp_1588 = smem_vals[tmp_1574 * WPT + 11u];
            let tmp_1589 = keys[4] < tmp_1587 || (keys[4] == tmp_1587 && values[4] < tmp_1588);
            if tmp_1573 == tmp_1589 { keys[4] = tmp_1587; values[4] = tmp_1588; }
            let tmp_1590 = smem_keys[tmp_1574 * WPT + 10u];
            let tmp_1591 = smem_vals[tmp_1574 * WPT + 10u];
            let tmp_1592 = keys[5] < tmp_1590 || (keys[5] == tmp_1590 && values[5] < tmp_1591);
            if tmp_1573 == tmp_1592 { keys[5] = tmp_1590; values[5] = tmp_1591; }
            let tmp_1593 = smem_keys[tmp_1574 * WPT + 9u];
            let tmp_1594 = smem_vals[tmp_1574 * WPT + 9u];
            let tmp_1595 = keys[6] < tmp_1593 || (keys[6] == tmp_1593 && values[6] < tmp_1594);
            if tmp_1573 == tmp_1595 { keys[6] = tmp_1593; values[6] = tmp_1594; }
            let tmp_1596 = smem_keys[tmp_1574 * WPT + 8u];
            let tmp_1597 = smem_vals[tmp_1574 * WPT + 8u];
            let tmp_1598 = keys[7] < tmp_1596 || (keys[7] == tmp_1596 && values[7] < tmp_1597);
            if tmp_1573 == tmp_1598 { keys[7] = tmp_1596; values[7] = tmp_1597; }
            let tmp_1599 = smem_keys[tmp_1574 * WPT + 7u];
            let tmp_1600 = smem_vals[tmp_1574 * WPT + 7u];
            let tmp_1601 = keys[8] < tmp_1599 || (keys[8] == tmp_1599 && values[8] < tmp_1600);
            if tmp_1573 == tmp_1601 { keys[8] = tmp_1599; values[8] = tmp_1600; }
            let tmp_1602 = smem_keys[tmp_1574 * WPT + 6u];
            let tmp_1603 = smem_vals[tmp_1574 * WPT + 6u];
            let tmp_1604 = keys[9] < tmp_1602 || (keys[9] == tmp_1602 && values[9] < tmp_1603);
            if tmp_1573 == tmp_1604 { keys[9] = tmp_1602; values[9] = tmp_1603; }
            let tmp_1605 = smem_keys[tmp_1574 * WPT + 5u];
            let tmp_1606 = smem_vals[tmp_1574 * WPT + 5u];
            let tmp_1607 = keys[10] < tmp_1605 || (keys[10] == tmp_1605 && values[10] < tmp_1606);
            if tmp_1573 == tmp_1607 { keys[10] = tmp_1605; values[10] = tmp_1606; }
            let tmp_1608 = smem_keys[tmp_1574 * WPT + 4u];
            let tmp_1609 = smem_vals[tmp_1574 * WPT + 4u];
            let tmp_1610 = keys[11] < tmp_1608 || (keys[11] == tmp_1608 && values[11] < tmp_1609);
            if tmp_1573 == tmp_1610 { keys[11] = tmp_1608; values[11] = tmp_1609; }
            let tmp_1611 = smem_keys[tmp_1574 * WPT + 3u];
            let tmp_1612 = smem_vals[tmp_1574 * WPT + 3u];
            let tmp_1613 = keys[12] < tmp_1611 || (keys[12] == tmp_1611 && values[12] < tmp_1612);
            if tmp_1573 == tmp_1613 { keys[12] = tmp_1611; values[12] = tmp_1612; }
            let tmp_1614 = smem_keys[tmp_1574 * WPT + 2u];
            let tmp_1615 = smem_vals[tmp_1574 * WPT + 2u];
            let tmp_1616 = keys[13] < tmp_1614 || (keys[13] == tmp_1614 && values[13] < tmp_1615);
            if tmp_1573 == tmp_1616 { keys[13] = tmp_1614; values[13] = tmp_1615; }
            let tmp_1617 = smem_keys[tmp_1574 * WPT + 1u];
            let tmp_1618 = smem_vals[tmp_1574 * WPT + 1u];
            let tmp_1619 = keys[14] < tmp_1617 || (keys[14] == tmp_1617 && values[14] < tmp_1618);
            if tmp_1573 == tmp_1619 { keys[14] = tmp_1617; values[14] = tmp_1618; }
            let tmp_1620 = smem_keys[tmp_1574 * WPT + 0u];
            let tmp_1621 = smem_vals[tmp_1574 * WPT + 0u];
            let tmp_1622 = keys[15] < tmp_1620 || (keys[15] == tmp_1620 && values[15] < tmp_1621);
            if tmp_1573 == tmp_1622 { keys[15] = tmp_1620; values[15] = tmp_1621; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(8,16)
    {
        ...
        if keys[0] > keys[8] || (keys[0] == keys[8] && values[0] > values[8]) {
            // swap(0,8)
            {
                let tmp_1917 = keys[0]; keys[0] = keys[8]; keys[8] = tmp_1917;
                let tmp_1918 = values[0]; values[0] = values[8]; values[8] = tmp_1918;
            }
        }
        // cmp_swap(1,9)
        if keys[1] > keys[9] || (keys[1] == keys[9] && values[1] > values[9]) {
            // swap(1,9)
            {
                let tmp_1919 = keys[1]; keys[1] = keys[9]; keys[9] = tmp_1919;
                let tmp_1920 = values[1]; values[1] = values[9]; values[9] = tmp_1920;
            }
        }
        // cmp_swap(2,10)
        if keys[2] > keys[10] || (keys[2] == keys[10] && values[2] > values[10]) {
            // swap(2,10)
            {
                let tmp_1921 = keys[2]; keys[2] = keys[10]; keys[10] = tmp_1921;
                let tmp_1922 = values[2]; values[2] = values[10]; values[10] = tmp_1922;
            }
        }
        // cmp_swap(3,11)
        if keys[3] > keys[11] || (keys[3] == keys[11] && values[3] > values[11]) {
            // swap(3,11)
            {
                let tmp_1923 = keys[3]; keys[3] = keys[11]; keys[11] = tmp_1923;
                let tmp_1924 = values[3]; values[3] = values[11]; values[11] = tmp_1924;
            }
        }
        // cmp_swap(4,12)
        if keys[4] > keys[12] || (keys[4] == keys[12] && values[4] > values[12]) {
            // swap(4,12)
            {
                let tmp_1925 = keys[4]; keys[4] = keys[12]; keys[12] = tmp_1925;
                let tmp_1926 = values[4]; values[4] = values[12]; values[12] = tmp_1926;
            }
        }
        // cmp_swap(5,13)
        if keys[5] > keys[13] || (keys[5] == keys[13] && values[5] > values[13]) {
            // swap(5,13)
            {
                let tmp_1927 = keys[5]; keys[5] = keys[13]; keys[13] = tmp_1927;
                let tmp_1928 = values[5]; values[5] = values[13]; values[13] = tmp_1928;
            }
        }
        // cmp_swap(6,14)
        if keys[6] > keys[14] || (keys[6] == keys[14] && values[6] > values[14]) {
            // swap(6,14)
            {
                let tmp_1929 = keys[6]; keys[6] = keys[14]; keys[14] = tmp_1929;
                let tmp_1930 = values[6]; values[6] = values[14]; values[14] = tmp_1930;
            }
        }
        // cmp_swap(7,15)
        if keys[7] > keys[15] || (keys[7] == keys[15] && values[7] > values[15]) {
            // swap(7,15)
            {
                let tmp_1931 = keys[7]; keys[7] = keys[15]; keys[15] = tmp_1931;
                let tmp_1932 = values[7]; values[7] = values[15]; values[15] = tmp_1932;
            }
        }
    }
    ...
    // exch_local(4,16)
    {
        ...
        if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
            // swap(0,4)
            {
                let tmp_1933 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_1933;
                let tmp_1934 = values[0]; values[0] = values[4]; values[4] = tmp_1934;
            }
        }
        // cmp_swap(1,5)
        if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
            // swap(1,5)
            {
                let tmp_1935 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_1935;
                let tmp_1936 = values[1]; values[1] = values[5]; values[5] = tmp_1936;
            }
        }
        // cmp_swap(2,6)
        if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
            // swap(2,6)
            {
                let tmp_1937 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_1937;
                let tmp_1938 = values[2]; values[2] = values[6]; values[6] = tmp_1938;
            }
        }
        // cmp_swap(3,7)
        if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
            // swap(3,7)
            {
                let tmp_1939 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_1939;
                let tmp_1940 = values[3]; values[3] = values[7]; values[7] = tmp_1940;
            }
        }
        // cmp_swap(8,12)
        if keys[8] > keys[12] || (keys[8] == keys[12] && values[8] > values[12]) {
            // swap(8,12)
            {
                let tmp_1941 = keys[8]; keys[8] = keys[12]; keys[12] = tmp_1941;
                let tmp_1942 = values[8]; values[8] = values[12]; values[12] = tmp_1942;
            }
        }
        // cmp_swap(9,13)
        if keys[9] > keys[13] || (keys[9] == keys[13] && values[9] > values[13]) {
            // swap(9,13)
            {
                let tmp_1943 = keys[9]; keys[9] = keys[13]; keys[13] = tmp_1943;
                let tmp_1944 = values[9]; values[9] = values[13]; values[13] = tmp_1944;
            }
        }
        // cmp_swap(10,14)
        if keys[10] > keys[14] || (keys[10] == keys[14] && values[10] > values[14]) {
            // swap(10,14)
            {
                let tmp_1945 = keys[10]; keys[10] = keys[14]; keys[14] = tmp_1945;
                let tmp_1946 = values[10]; values[10] = values[14]; values[14] = tmp_1946;
            }
        }
        // cmp_swap(11,15)
        if keys[11] > keys[15] || (keys[11] == keys[15] && values[11] > values[15]) {
            // swap(11,15)
            {
                let tmp_1947 = keys[11]; keys[11] = keys[15]; keys[15] = tmp_1947;
                let tmp_1948 = values[11]; values[11] = values[15]; values[15] = tmp_1948;
            }
        }
    }
    ...
    // exch_local(2,16)
    {
        ...
        if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
            // swap(0,2)
            {
                let tmp_1949 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_1949;
                let tmp_1950 = values[0]; values[0] = values[2]; values[2] = tmp_1950;
            }
        }
        // cmp_swap(1,3)
        if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
            // swap(1,3)
            {
                let tmp_1951 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_1951;
                let tmp_1952 = values[1]; values[1] = values[3]; values[3] = tmp_1952;
            }
        }
        // cmp_swap(4,6)
        if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
            // swap(4,6)
            {
                let tmp_1953 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_1953;
                let tmp_1954 = values[4]; values[4] = values[6]; values[6] = tmp_1954;
            }
        }
        // cmp_swap(5,7)
        if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
            // swap(5,7)
            {
                let tmp_1955 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_1955;
                let tmp_1956 = values[5]; values[5] = values[7]; values[7] = tmp_1956;
            }
        }
        // cmp_swap(8,10)
        if keys[8] > keys[10] || (keys[8] == keys[10] && values[8] > values[10]) {
            // swap(8,10)
            {
                let tmp_1957 = keys[8]; keys[8] = keys[10]; keys[10] = tmp_1957;
                let tmp_1958 = values[8]; values[8] = values[10]; values[10] = tmp_1958;
            }
        }
        // cmp_swap(9,11)
        if keys[9] > keys[11] || (keys[9] == keys[11] && values[9] > values[11]) {
            // swap(9,11)
            {
                let tmp_1959 = keys[9]; keys[9] = keys[11]; keys[11] = tmp_1959;
                let tmp_1960 = values[9]; values[9] = values[11]; values[11] = tmp_1960;
            }
        }
        // cmp_swap(12,14)
        if keys[12] > keys[14] || (keys[12] == keys[14] && values[12] > values[14]) {
            // swap(12,14)
            {
                let tmp_1961 = keys[12]; keys[12] = keys[14]; keys[14] = tmp_1961;
                let tmp_1962 = values[12]; values[12] = values[14]; values[14] = tmp_1962;
            }
        }
        // cmp_swap(13,15)
        if keys[13] > keys[15] || (keys[13] == keys[15] && values[13] > values[15]) {
            // swap(13,15)
            {
                let tmp_1963 = keys[13]; keys[13] = keys[15]; keys[15] = tmp_1963;
                let tmp_1964 = values[13]; values[13] = values[15]; values[15] = tmp_1964;
            }
        }
    }
    ...
    // exch_local(1,16)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_1965 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_1965;
                let tmp_1966 = values[0]; values[0] = values[1]; values[1] = tmp_1966;
            }
        }
        // cmp_swap(2,3)
        if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
            // swap(2,3)
            {
                let tmp_1967 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_1967;
                let tmp_1968 = values[2]; values[2] = values[3]; values[3] = tmp_1968;
            }
        }
        // cmp_swap(4,5)
        if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
            // swap(4,5)
            {
                let tmp_1969 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_1969;
                let tmp_1970 = values[4]; values[4] = values[5]; values[5] = tmp_1970;
            }
        }
        // cmp_swap(6,7)
        if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
            // swap(6,7)
            {
                let tmp_1971 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_1971;
                let tmp_1972 = values[6]; values[6] = values[7]; values[7] = tmp_1972;
            }
        }
        // cmp_swap(8,9)
        if keys[8] > keys[9] || (keys[8] == keys[9] && values[8] > values[9]) {
            // swap(8,9)
            {
                let tmp_1973 = keys[8]; keys[8] = keys[9]; keys[9] = tmp_1973;
                let tmp_1974 = values[8]; values[8] = values[9]; values[9] = tmp_1974;
            }
        }
        // cmp_swap(10,11)
        if keys[10] > keys[11] || (keys[10] == keys[11] && values[10] > values[11]) {
            // swap(10,11)
            {
                let tmp_1975 = keys[10]; keys[10] = keys[11]; keys[11] = tmp_1975;
                let tmp_1976 = values[10]; values[10] = values[11]; values[11] = tmp_1976;
            }
        }
        // cmp_swap(12,13)
        if keys[12] > keys[13] || (keys[12] == keys[13] && values[12] > values[13]) {
            // swap(12,13)
            {
                let tmp_1977 = keys[12]; keys[12] = keys[13]; keys[13] = tmp_1977;
                let tmp_1978 = values[12]; values[12] = values[13]; values[13] = tmp_1978;
            }
        }
        // cmp_swap(14,15)
        if keys[14] > keys[15] || (keys[14] == keys[15] && values[14] > values[15]) {
            // swap(14,15)
            {
                let tmp_1979 = keys[14]; keys[14] = keys[15]; keys[15] = tmp_1979;
                let tmp_1980 = values[14]; values[14] = values[15]; values[15] = tmp_1980;
            }
        }
    }
