...
fn segsort_hybrid_sg64_n1024_m256_striped(
    ...
    // exch_intxn(tmask:127,swbit:6,wpt:4)
    {
        // _exch_workgroup([(0, 3), (1, 2), (2, 1), (3, 0)],127,6)
        {
            ...
            workgroupBarrier();
            let tmp_333 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_334 = seg_base + (local_tid ^ 127u);
            let tmp_335 = smem_keys[tmp_334 * WPT + 3u];
            let tmp_336 = smem_vals[tmp_334 * WPT + 3u];
            let tmp_337 = keys[0] < tmp_335 || (keys[0] == tmp_335 && values[0] < tmp_336);
            if tmp_333 == tmp_337 { keys[0] = tmp_335; values[0] = tmp_336; }
            let tmp_338 = smem_keys[tmp_334 * WPT + 2u];
            let tmp_339 = smem_vals[tmp_334 * WPT + 2u];
            let tmp_340 = keys[1] < tmp_338 || (keys[1] == tmp_338 && values[1] < tmp_339);
            if tmp_333 == tmp_340 { keys[1] = tmp_338; values[1] = tmp_339; }
            let tmp_341 = smem_keys[tmp_334 * WPT + 1u];
            let tmp_342 = smem_vals[tmp_334 * WPT + 1u];
            let tmp_343 = keys[2] < tmp_341 || (keys[2] == tmp_341 && values[2] < tmp_342);
            if tmp_333 == tmp_343 { keys[2] = tmp_341; values[2] = tmp_342; }
            let tmp_344 = smem_keys[tmp_334 * WPT + 0u];
            let tmp_345 = smem_vals[tmp_334 * WPT + 0u];
            let tmp_346 = keys[3] < tmp_344 || (keys[3] == tmp_344 && values[3] < tmp_345);
            if tmp_333 == tmp_346 { keys[3] = tmp_344; values[3] = tmp_345; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(2,4)
    {
        ...
        if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
            // swap(0,2)
            {
                let tmp_425 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_425;
                let tmp_426 = values[0]; values[0] = values[2]; values[2] = tmp_426;
            }
        }
        // cmp_swap(1,3)
        if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
            // swap(1,3)
            {
                let tmp_427 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_427;
                let tmp_428 = values[1]; values[1] = values[3]; values[3] = tmp_428;
            }
        }
    }
    ...
    // exch_local(1,4)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_429 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_429;
                let tmp_430 = values[0]; values[0] = values[1]; values[1] = tmp_430;
            }
        }
        // cmp_swap(2,3)
        if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
            // swap(2,3)
            {
                let tmp_431 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_431;
                let tmp_432 = values[2]; values[2] = values[3]; values[3] = tmp_432;
            }
        }
    }
    ...
    // exch_intxn(tmask:255,swbit:7,wpt:4)
    {
        // _exch_workgroup([(0, 3), (1, 2), (2, 1), (3, 0)],255,7)
        {
            ...
            smem_vals[tid_g * WPT + 3u] = values[3];
            workgroupBarrier();
            let tmp_433 = extractBits(local_tid, 7u, 1u) != 0u;
            let tmp_434 = seg_base + (local_tid ^ 255u);
            let tmp_435 = smem_keys[tmp_434 * WPT + 3u];
            let tmp_436 = smem_vals[tmp_434 * WPT + 3u];
            let tmp_437 = keys[0] < tmp_435 || (keys[0] == tmp_435 && values[0] < tmp_436);
            if tmp_433 == tmp_437 { keys[0] = tmp_435; values[0] = tmp_436; }
            let tmp_438 = smem_keys[tmp_434 * WPT + 2u];
            let tmp_439 = smem_vals[tmp_434 * WPT + 2u];
            let tmp_440 = keys[1] < tmp_438 || (keys[1] == tmp_438 && values[1] < tmp_439);
            if tmp_433 == tmp_440 { keys[1] = tmp_438; values[1] = tmp_439; }
            let tmp_441 = smem_keys[tmp_434 * WPT + 1u];
            let tmp_442 = smem_vals[tmp_434 * WPT + 1u];
            let tmp_443 = keys[2] < tmp_441 || (keys[2] == tmp_441 && values[2] < tmp_442);
            if tmp_433 == tmp_443 { keys[2] = tmp_441; values[2] = tmp_442; }
            let tmp_444 = smem_keys[tmp_434 * WPT + 0u];
            let tmp_445 = smem_vals[tmp_434 * WPT + 0u];
            let tmp_446 = keys[3] < tmp_444 || (keys[3] == tmp_444 && values[3] < tmp_445);
            if tmp_433 == tmp_446 { keys[3] = tmp_444; values[3] = tmp_445; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:64,swbit:6,wpt:4)
    {
        // _exch_workgroup([(0, 0), (1, 1), (2, 2), (3, 3)],64,6)
        {
            ...
            smem_vals[tid_g * WPT + 3u] = values[3];
            workgroupBarrier();
            let tmp_447 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_448 = seg_base + (local_tid ^ 64u);
            let tmp_449 = smem_keys[tmp_448 * WPT + 0u];
            let tmp_450 = smem_vals[tmp_448 * WPT + 0u];
            let tmp_451 = keys[0] < tmp_449 || (keys[0] == tmp_449 && values[0] < tmp_450);
            if tmp_447 == tmp_451 { keys[0] = tmp_449; values[0] = tmp_450; }
            let tmp_452 = smem_keys[tmp_448 * WPT + 1u];
            let tmp_453 = smem_vals[tmp_448 * WPT + 1u];
            let tmp_454 = keys[1] < tmp_452 || (keys[1] == tmp_452 && values[1] < tmp_453);
            if tmp_447 == tmp_454 { keys[1] = tmp_452; values[1] = tmp_453; }
            let tmp_455 = smem_keys[tmp_448 * WPT + 2u];
            let tmp_456 = smem_vals[tmp_448 * WPT + 2u];
            let tmp_457 = keys[2] < tmp_455 || (keys[2] == tmp_455 && values[2] < tmp_456);
            if tmp_447 == tmp_457 { keys[2] = tmp_455; values[2] = tmp_456; }
            let tmp_458 = smem_keys[tmp_448 * WPT + 3u];
            let tmp_459 = smem_vals[tmp_448 * WPT + 3u];
            let tmp_460 = keys[3] < tmp_458 || (keys[3] == tmp_458 && values[3] < tmp_459);
            if tmp_447 == tmp_460 { keys[3] = tmp_458; values[3] = tmp_459; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:32,swbit:5,wpt:4)
    {
        // _exch_subgroup([(0, 0), (1, 1), (2, 2), (3, 3)],32,5)
        {
            let tmp_461 = subgroupShuffleXor(keys[0], 32u);
            let tmp_462 = subgroupShuffleXor(values[0], 32u);
            let tmp_463 = subgroupShuffleXor(keys[1], 32u);
            let tmp_464 = subgroupShuffleXor(values[1], 32u);
            let tmp_465 = subgroupShuffleXor(keys[2], 32u);
            let tmp_466 = subgroupShuffleXor(values[2], 32u);
            let tmp_467 = subgroupShuffleXor(keys[3], 32u);
            let tmp_468 = subgroupShuffleXor(values[3], 32u);
            let tmp_469 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_470 = keys[0] < tmp_461 || (keys[0] == tmp_461 && values[0] < tmp_462);
            if tmp_469 == tmp_470 { keys[0] = tmp_461; values[0] = tmp_462; }
            let tmp_471 = keys[1] < tmp_463 || (keys[1] == tmp_463 && values[1] < tmp_464);
            if tmp_469 == tmp_471 { keys[1] = tmp_463; values[1] = tmp_464; }
            let tmp_472 = keys[2] < tmp_465 || (keys[2] == tmp_465 && values[2] < tmp_466);
            if tmp_469 == tmp_472 { keys[2] = tmp_465; values[2] = tmp_466; }
            let tmp_473 = keys[3] < tmp_467 || (keys[3] == tmp_467 && values[3] < tmp_468);
            if tmp_469 == tmp_473 { keys[3] = tmp_467; values[3] = tmp_468; }
        }
    }
    ...
    // exch_paral(tmask:16,swbit:4,wpt:4)
    {
        // _exch_subgroup([(0, 0), (1, 1), (2, 2), (3, 3)],16,4)
        {
            let tmp_474 = subgroupShuffleXor(keys[0], 16u);
            let tmp_475 = subgroupShuffleXor(values[0], 16u);
            let tmp_476 = subgroupShuffleXor(keys[1], 16u);
            let tmp_477 = subgroupShuffleXor(values[1], 16u);
            let tmp_478 = subgroupShuffleXor(keys[2], 16u);
            let tmp_479 = subgroupShuffleXor(values[2], 16u);
            let tmp_480 = subgroupShuffleXor(keys[3], 16u);
            let tmp_481 = subgroupShuffleXor(values[3], 16u);
            let tmp_482 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_483 = keys[0] < tmp_474 || (keys[0] == tmp_474 && values[0] < tmp_475);
            if tmp_482 == tmp_483 { keys[0] = tmp_474; values[0] = tmp_475; }
            let tmp_484 = keys[1] < tmp_476 || (keys[1] == tmp_476 && values[1] < tmp_477);
            if tmp_482 == tmp_484 { keys[1] = tmp_476; values[1] = tmp_477; }
            let tmp_485 = keys[2] < tmp_478 || (keys[2] == tmp_478 && values[2] < tmp_479);
            if tmp_482 == tmp_485 { keys[2] = tmp_478; values[2] = tmp_479; }
            let tmp_486 = keys[3] < tmp_480 || (keys[3] == tmp_480 && values[3] < tmp_481);
            if tmp_482 == tmp_486 { keys[3] = tmp_480; values[3] = tmp_481; }
        }
    }
    ...
    // exch_paral(tmask:8,swbit:3,wpt:4)
    {
        // _exch_subgroup([(0, 0), (1, 1), (2, 2), (3, 3)],8,3)
        {
            let tmp_487 = subgroupShuffleXor(keys[0], 8u);
            let tmp_488 = subgroupShuffleXor(values[0], 8u);
            let tmp_489 = subgroupShuffleXor(keys[1], 8u);
            let tmp_490 = subgroupShuffleXor(values[1], 8u);
            let tmp_491 = subgroupShuffleXor(keys[2], 8u);
            let tmp_492 = subgroupShuffleXor(values[2], 8u);
            let tmp_493 = subgroupShuffleXor(keys[3], 8u);
            let tmp_494 = subgroupShuffleXor(values[3], 8u);
            let tmp_495 = extractBits(local_tid, 3u, 1u) != 0u;
            let tmp_496 = keys[0] < tmp_487 || (keys[0] == tmp_487 && values[0] < tmp_488);
            if tmp_495 == tmp_496 { keys[0] = tmp_487; values[0] = tmp_488; }
            let tmp_497 = keys[1] < tmp_489 || (keys[1] == tmp_489 && values[1] < tmp_490);
            if tmp_495 == tmp_497 { keys[1] = tmp_489; values[1] = tmp_490; }
            let tmp_498 = keys[2] < tmp_491 || (keys[2] == tmp_491 && values[2] < tmp_492);
            if tmp_495 == tmp_498 { keys[2] = tmp_491; values[2] = tmp_492; }
            let tmp_499 = keys[3] < tmp_493 || (keys[3] == tmp_493 && values[3] < tmp_494);
            if tmp_495 == tmp_499 { keys[3] = tmp_493; values[3] = tmp_494; }
        }
    }
    ...
    // exch_paral(tmask:4,swbit:2,wpt:4)
    {
        // _exch_subgroup([(0, 0), (1, 1), (2, 2), (3, 3)],4,2)
        {
            let tmp_500 = subgroupShuffleXor(keys[0], 4u);
            let tmp_501 = subgroupShuffleXor(values[0], 4u);
            let tmp_502 = subgroupShuffleXor(keys[1], 4u);
            let tmp_503 = subgroupShuffleXor(values[1], 4u);
            let tmp_504 = subgroupShuffleXor(keys[2], 4u);
            let tmp_505 = subgroupShuffleXor(values[2], 4u);
            let tmp_506 = subgroupShuffleXor(keys[3], 4u);
            let tmp_507 = subgroupShuffleXor(values[3], 4u);
            let tmp_508 = extractBits(local_tid, 2u, 1u) != 0u;
            let tmp_509 = keys[0] < tmp_500 || (keys[0] == tmp_500 && values[0] < tmp_501);
            if tmp_508 == tmp_509 { keys[0] = tmp_500; values[0] = tmp_501; }
            let tmp_510 = keys[1] < tmp_502 || (keys[1] == tmp_502 && values[1] < tmp_503);
            if tmp_508 == tmp_510 { keys[1] = tmp_502; values[1] = tmp_503; }
            let tmp_511 = keys[2] < tmp_504 || (keys[2] == tmp_504 && values[2] < tmp_505);
            if tmp_508 == tmp_511 { keys[2] = tmp_504; values[2] = tmp_505; }
            let tmp_512 = keys[3] < tmp_506 || (keys[3] == tmp_506 && values[3] < tmp_507);
            if tmp_508 == tmp_512 { keys[3] = tmp_506; values[3] = tmp_507; }
        }
    }
    ...
    // exch_paral(tmask:2,swbit:1,wpt:4)
    {
        // _exch_subgroup([(0, 0), (1, 1), (2, 2), (3, 3)],2,1)
        {
            let tmp_513 = subgroupShuffleXor(keys[0], 2u);
            let tmp_514 = subgroupShuffleXor(values[0], 2u);
            let tmp_515 = subgroupShuffleXor(keys[1], 2u);
            let tmp_516 = subgroupShuffleXor(values[1], 2u);
            let tmp_517 = subgroupShuffleXor(keys[2], 2u);
            let tmp_518 = subgroupShuffleXor(values[2], 2u);
            let tmp_519 = subgroupShuffleXor(keys[3], 2u);
            let tmp_520 = subgroupShuffleXor(values[3], 2u);
            let tmp_521 = extractBits(local_tid, 1u, 1u) != 0u;
            let tmp_522 = keys[0] < tmp_513 || (keys[0] == tmp_513 && values[0] < tmp_514);
            if tmp_521 == tmp_522 { keys[0] = tmp_513; values[0] = tmp_514; }
            let tmp_523 = keys[1] < tmp_515 || (keys[1] == tmp_515 && values[1] < tmp_516);
            if tmp_521 == tmp_523 { keys[1] = tmp_515; values[1] = tmp_516; }
            let tmp_524 = keys[2] < tmp_517 || (keys[2] == tmp_517 && values[2] < tmp_518);
            if tmp_521 == tmp_524 { keys[2] = tmp_517; values[2] = tmp_518; }
            let tmp_525 = keys[3] < tmp_519 || (keys[3] == tmp_519 && values[3] < tmp_520);
            if tmp_521 == tmp_525 { keys[3] = tmp_519; values[3] = tmp_520; }
        }
    }
    ...
    // exch_paral(tmask:1,swbit:0,wpt:4)
    {
        // _exch_subgroup([(0, 0), (1, 1), (2, 2), (3, 3)],1,0)
        {
            let tmp_526 = subgroupShuffleXor(keys[0], 1u);
            let tmp_527 = subgroupShuffleXor(values[0], 1u);
            let tmp_528 = subgroupShuffleXor(keys[1], 1u);
            let tmp_529 = subgroupShuffleXor(values[1], 1u);
            let tmp_530 = subgroupShuffleXor(keys[2], 1u);
            let tmp_531 = subgroupShuffleXor(values[2], 1u);
            let tmp_532 = subgroupShuffleXor(keys[3], 1u);
            let tmp_533 = subgroupShuffleXor(values[3], 1u);
            let tmp_534 = extractBits(local_tid, 0u, 1u) != 0u;
            let tmp_535 = keys[0] < tmp_526 || (keys[0] == tmp_526 && values[0] < tmp_527);
            if tmp_534 == tmp_535 { keys[0] = tmp_526; values[0] = tmp_527; }
            let tmp_536 = keys[1] < tmp_528 || (keys[1] == tmp_528 && values[1] < tmp_529);
            if tmp_534 == tmp_536 { keys[1] = tmp_528; values[1] = tmp_529; }
            let tmp_537 = keys[2] < tmp_530 || (keys[2] == tmp_530 && values[2] < tmp_531);
            if tmp_534 == tmp_537 { keys[2] = tmp_530; values[2] = tmp_531; }
            let tmp_538 = keys[3] < tmp_532 || (keys[3] == tmp_532 && values[3] < tmp_533);
            if tmp_534 == tmp_538 { keys[3] = tmp_532; values[3] = tmp_533; }
        }
    }
    ...
    // exch_local(2,4)
    {
        ...
        if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
            // swap(0,2)
            {
                let tmp_539 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_539;
                let tmp_540 = values[0]; values[0] = values[2]; values[2] = tmp_540;
            }
        }
        // cmp_swap(1,3)
        if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
            // swap(1,3)
            {
                let tmp_541 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_541;
                let tmp_542 = values[1]; values[1] = values[3]; values[3] = tmp_542;
            }
        }
    }
    ...
    // exch_local(1,4)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_543 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_543;
                let tmp_544 = values[0]; values[0] = values[1]; values[1] = tmp_544;
            }
        }
        // cmp_swap(2,3)
        if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
            // swap(2,3)
            {
                let tmp_545 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_545;
                let tmp_546 = values[2]; values[2] = values[3]; values[3] = tmp_546;
            }
        }
    }
