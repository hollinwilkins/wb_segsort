...
fn segsort_hybrid_sg32_n1024_m256_striped(
    ...
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; workgroupBarrier(); let tmp_247 = extractBits(local_tid, 5u, 1u) != 0u; let tmp_248 = seg_base + (local_tid ^ 63u); let tmp_249 = smem_keys[tmp_248 * WPT + 3u]; let tmp_250 = smem_vals[tmp_248 * WPT + 3u]; let tmp_251 = keys[0] < tmp_249 || (keys[0] == tmp_249 && values[0] < tmp_250); if tmp_247 == tmp_251 { keys[0] = tmp_249; values[0] = tmp_250; } let tmp_252 = smem_keys[tmp_248 * WPT + 2u]; let tmp_253 = smem_vals[tmp_248 * WPT + 2u]; let tmp_254 = keys[1] < tmp_252 || (keys[1] == tmp_252 && values[1] < tmp_253); if tmp_247 == tmp_254 { keys[1] = tmp_252; values[1] = tmp_253; } let tmp_255 = smem_keys[tmp_248 * WPT + 1u]; let tmp_256 = smem_vals[tmp_248 * WPT + 1u]; let tmp_257 = keys[2] < tmp_255 || (keys[2] == tmp_255 && values[2] < tmp_256); if tmp_247 == tmp_257 { keys[2] = tmp_255; values[2] = tmp_256; } let tmp_258 = smem_keys[tmp_248 * WPT + 0u]; let tmp_259 = smem_vals[tmp_248 * WPT + 0u]; let tmp_260 = keys[3] < tmp_258 || (keys[3] == tmp_258 && values[3] < tmp_259); if tmp_247 == tmp_260 { keys[3] = tmp_258; values[3] = tmp_259; } workgroupBarrier(); }
    ...
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_326 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_326;let tmp_327 = values[0]; values[0] = values[2]; values[2] = tmp_327; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_328 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_328;let tmp_329 = values[1]; values[1] = values[3]; values[3] = tmp_329; }
    }
    // exch_local(1,4) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_330 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_330;let tmp_331 = values[0]; values[0] = values[1]; values[1] = tmp_331; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_332 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_332;let tmp_333 = values[2]; values[2] = values[3]; values[3] = tmp_333; }
    }
    // exch_intxn(tmask:127,swbit:6,wpt:4)
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; workgroupBarrier(); let tmp_334 = extractBits(local_tid, 6u, 1u) != 0u; let tmp_335 = seg_base + (local_tid ^ 127u); let tmp_336 = smem_keys[tmp_335 * WPT + 3u]; let tmp_337 = smem_vals[tmp_335 * WPT + 3u]; let tmp_338 = keys[0] < tmp_336 || (keys[0] == tmp_336 && values[0] < tmp_337); if tmp_334 == tmp_338 { keys[0] = tmp_336; values[0] = tmp_337; } let tmp_339 = smem_keys[tmp_335 * WPT + 2u]; let tmp_340 = smem_vals[tmp_335 * WPT + 2u]; let tmp_341 = keys[1] < tmp_339 || (keys[1] == tmp_339 && values[1] < tmp_340); if tmp_334 == tmp_341 { keys[1] = tmp_339; values[1] = tmp_340; } let tmp_342 = smem_keys[tmp_335 * WPT + 1u]; let tmp_343 = smem_vals[tmp_335 * WPT + 1u]; let tmp_344 = keys[2] < tmp_342 || (keys[2] == tmp_342 && values[2] < tmp_343); if tmp_334 == tmp_344 { keys[2] = tmp_342; values[2] = tmp_343; } let tmp_345 = smem_keys[tmp_335 * WPT + 0u]; let tmp_346 = smem_vals[tmp_335 * WPT + 0u]; let tmp_347 = keys[3] < tmp_345 || (keys[3] == tmp_345 && values[3] < tmp_346); if tmp_334 == tmp_347 { keys[3] = tmp_345; values[3] = tmp_346; } workgroupBarrier(); }
    // exch_paral(tmask:32,swbit:5,wpt:4) 
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; workgroupBarrier(); let tmp_348 = extractBits(local_tid, 5u, 1u) != 0u; let tmp_349 = seg_base + (local_tid ^ 32u); let tmp_350 = smem_keys[tmp_349 * WPT + 0u]; let tmp_351 = smem_vals[tmp_349 * WPT + 0u]; let tmp_352 = keys[0] < tmp_350 || (keys[0] == tmp_350 && values[0] < tmp_351); if tmp_348 == tmp_352 { keys[0] = tmp_350; values[0] = tmp_351; } let tmp_353 = smem_keys[tmp_349 * WPT + 1u]; let tmp_354 = smem_vals[tmp_349 * WPT + 1u]; let tmp_355 = keys[1] < tmp_353 || (keys[1] == tmp_353 && values[1] < tmp_354); if tmp_348 == tmp_355 { keys[1] = tmp_353; values[1] = tmp_354; } let tmp_356 = smem_keys[tmp_349 * WPT + 2u]; let tmp_357 = smem_vals[tmp_349 * WPT + 2u]; let tmp_358 = keys[2] < tmp_356 || (keys[2] == tmp_356 && values[2] < tmp_357); if tmp_348 == tmp_358 { keys[2] = tmp_356; values[2] = tmp_357; } let tmp_359 = smem_keys[tmp_349 * WPT + 3u]; let tmp_360 = smem_vals[tmp_349 * WPT + 3u]; let tmp_361 = keys[3] < tmp_359 || (keys[3] == tmp_359 && values[3] < tmp_360); if tmp_348 == tmp_361 { keys[3] = tmp_359; values[3] = tmp_360; } workgroupBarrier(); }
    // exch_paral(tmask:16,swbit:4,wpt:4) 
    {
    let tmp_362 = subgroupShuffleXor(keys[0], 16u);
    let tmp_363 = subgroupShuffleXor(values[0], 16u);
    let tmp_364 = subgroupShuffleXor(keys[1], 16u);
    let tmp_365 = subgroupShuffleXor(values[1], 16u);
    let tmp_366 = subgroupShuffleXor(keys[2], 16u);
    let tmp_367 = subgroupShuffleXor(values[2], 16u);
    let tmp_368 = subgroupShuffleXor(keys[3], 16u);
    let tmp_369 = subgroupShuffleXor(values[3], 16u);
    let tmp_370 = extractBits(local_tid, 4u, 1u) != 0u;
    let tmp_371 = keys[0] < tmp_362 || (keys[0] == tmp_362 && values[0] < tmp_363);
    if tmp_370 == tmp_371 { keys[0] = tmp_362; values[0] = tmp_363; }
    let tmp_372 = keys[1] < tmp_364 || (keys[1] == tmp_364 && values[1] < tmp_365);
    if tmp_370 == tmp_372 { keys[1] = tmp_364; values[1] = tmp_365; }
    let tmp_373 = keys[2] < tmp_366 || (keys[2] == tmp_366 && values[2] < tmp_367);
    if tmp_370 == tmp_373 { keys[2] = tmp_366; values[2] = tmp_367; }
    let tmp_374 = keys[3] < tmp_368 || (keys[3] == tmp_368 && values[3] < tmp_369);
    if tmp_370 == tmp_374 { keys[3] = tmp_368; values[3] = tmp_369; }
    }
    // exch_paral(tmask:8,swbit:3,wpt:4) 
    {
    let tmp_375 = subgroupShuffleXor(keys[0], 8u);
    let tmp_376 = subgroupShuffleXor(values[0], 8u);
    let tmp_377 = subgroupShuffleXor(keys[1], 8u);
    let tmp_378 = subgroupShuffleXor(values[1], 8u);
    let tmp_379 = subgroupShuffleXor(keys[2], 8u);
    let tmp_380 = subgroupShuffleXor(values[2], 8u);
    let tmp_381 = subgroupShuffleXor(keys[3], 8u);
    let tmp_382 = subgroupShuffleXor(values[3], 8u);
    let tmp_383 = extractBits(local_tid, 3u, 1u) != 0u;
    let tmp_384 = keys[0] < tmp_375 || (keys[0] == tmp_375 && values[0] < tmp_376);
    if tmp_383 == tmp_384 { keys[0] = tmp_375; values[0] = tmp_376; }
    let tmp_385 = keys[1] < tmp_377 || (keys[1] == tmp_377 && values[1] < tmp_378);
    if tmp_383 == tmp_385 { keys[1] = tmp_377; values[1] = tmp_378; }
    let tmp_386 = keys[2] < tmp_379 || (keys[2] == tmp_379 && values[2] < tmp_380);
    if tmp_383 == tmp_386 { keys[2] = tmp_379; values[2] = tmp_380; }
    let tmp_387 = keys[3] < tmp_381 || (keys[3] == tmp_381 && values[3] < tmp_382);
    if tmp_383 == tmp_387 { keys[3] = tmp_381; values[3] = tmp_382; }
    }
    // exch_paral(tmask:4,swbit:2,wpt:4) 
    {
    let tmp_388 = subgroupShuffleXor(keys[0], 4u);
    let tmp_389 = subgroupShuffleXor(values[0], 4u);
    let tmp_390 = subgroupShuffleXor(keys[1], 4u);
    let tmp_391 = subgroupShuffleXor(values[1], 4u);
    let tmp_392 = subgroupShuffleXor(keys[2], 4u);
    let tmp_393 = subgroupShuffleXor(values[2], 4u);
    let tmp_394 = subgroupShuffleXor(keys[3], 4u);
    let tmp_395 = subgroupShuffleXor(values[3], 4u);
    let tmp_396 = extractBits(local_tid, 2u, 1u) != 0u;
    let tmp_397 = keys[0] < tmp_388 || (keys[0] == tmp_388 && values[0] < tmp_389);
    if tmp_396 == tmp_397 { keys[0] = tmp_388; values[0] = tmp_389; }
    let tmp_398 = keys[1] < tmp_390 || (keys[1] == tmp_390 && values[1] < tmp_391);
    if tmp_396 == tmp_398 { keys[1] = tmp_390; values[1] = tmp_391; }
    let tmp_399 = keys[2] < tmp_392 || (keys[2] == tmp_392 && values[2] < tmp_393);
    if tmp_396 == tmp_399 { keys[2] = tmp_392; values[2] = tmp_393; }
    let tmp_400 = keys[3] < tmp_394 || (keys[3] == tmp_394 && values[3] < tmp_395);
    if tmp_396 == tmp_400 { keys[3] = tmp_394; values[3] = tmp_395; }
    }
    // exch_paral(tmask:2,swbit:1,wpt:4) 
    {
    let tmp_401 = subgroupShuffleXor(keys[0], 2u);
    let tmp_402 = subgroupShuffleXor(values[0], 2u);
    let tmp_403 = subgroupShuffleXor(keys[1], 2u);
    let tmp_404 = subgroupShuffleXor(values[1], 2u);
    let tmp_405 = subgroupShuffleXor(keys[2], 2u);
    let tmp_406 = subgroupShuffleXor(values[2], 2u);
    let tmp_407 = subgroupShuffleXor(keys[3], 2u);
    let tmp_408 = subgroupShuffleXor(values[3], 2u);
    let tmp_409 = extractBits(local_tid, 1u, 1u) != 0u;
    let tmp_410 = keys[0] < tmp_401 || (keys[0] == tmp_401 && values[0] < tmp_402);
    if tmp_409 == tmp_410 { keys[0] = tmp_401; values[0] = tmp_402; }
    let tmp_411 = keys[1] < tmp_403 || (keys[1] == tmp_403 && values[1] < tmp_404);
    if tmp_409 == tmp_411 { keys[1] = tmp_403; values[1] = tmp_404; }
    let tmp_412 = keys[2] < tmp_405 || (keys[2] == tmp_405 && values[2] < tmp_406);
    if tmp_409 == tmp_412 { keys[2] = tmp_405; values[2] = tmp_406; }
    let tmp_413 = keys[3] < tmp_407 || (keys[3] == tmp_407 && values[3] < tmp_408);
    if tmp_409 == tmp_413 { keys[3] = tmp_407; values[3] = tmp_408; }
    }
    // exch_paral(tmask:1,swbit:0,wpt:4) 
    {
    let tmp_414 = subgroupShuffleXor(keys[0], 1u);
    let tmp_415 = subgroupShuffleXor(values[0], 1u);
    let tmp_416 = subgroupShuffleXor(keys[1], 1u);
    let tmp_417 = subgroupShuffleXor(values[1], 1u);
    let tmp_418 = subgroupShuffleXor(keys[2], 1u);
    let tmp_419 = subgroupShuffleXor(values[2], 1u);
    let tmp_420 = subgroupShuffleXor(keys[3], 1u);
    let tmp_421 = subgroupShuffleXor(values[3], 1u);
    let tmp_422 = extractBits(local_tid, 0u, 1u) != 0u;
    let tmp_423 = keys[0] < tmp_414 || (keys[0] == tmp_414 && values[0] < tmp_415);
    if tmp_422 == tmp_423 { keys[0] = tmp_414; values[0] = tmp_415; }
    let tmp_424 = keys[1] < tmp_416 || (keys[1] == tmp_416 && values[1] < tmp_417);
    if tmp_422 == tmp_424 { keys[1] = tmp_416; values[1] = tmp_417; }
    let tmp_425 = keys[2] < tmp_418 || (keys[2] == tmp_418 && values[2] < tmp_419);
    if tmp_422 == tmp_425 { keys[2] = tmp_418; values[2] = tmp_419; }
    let tmp_426 = keys[3] < tmp_420 || (keys[3] == tmp_420 && values[3] < tmp_421);
    if tmp_422 == tmp_426 { keys[3] = tmp_420; values[3] = tmp_421; }
    }
    // exch_local(2,4) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_427 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_427;let tmp_428 = values[0]; values[0] = values[2]; values[2] = tmp_428; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_429 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_429;let tmp_430 = values[1]; values[1] = values[3]; values[3] = tmp_430; }
    }
    // exch_local(1,4) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_431 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_431;let tmp_432 = values[0]; values[0] = values[1]; values[1] = tmp_432; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_433 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_433;let tmp_434 = values[2]; values[2] = values[3]; values[3] = tmp_434; }
    }
    // exch_intxn(tmask:255,swbit:7,wpt:4)
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; workgroupBarrier(); let tmp_435 = extractBits(local_tid, 7u, 1u) != 0u; let tmp_436 = seg_base + (local_tid ^ 255u); let tmp_437 = smem_keys[tmp_436 * WPT + 3u]; let tmp_438 = smem_vals[tmp_436 * WPT + 3u]; let tmp_439 = keys[0] < tmp_437 || (keys[0] == tmp_437 && values[0] < tmp_438); if tmp_435 == tmp_439 { keys[0] = tmp_437; values[0] = tmp_438; } let tmp_440 = smem_keys[tmp_436 * WPT + 2u]; let tmp_441 = smem_vals[tmp_436 * WPT + 2u]; let tmp_442 = keys[1] < tmp_440 || (keys[1] == tmp_440 && values[1] < tmp_441); if tmp_435 == tmp_442 { keys[1] = tmp_440; values[1] = tmp_441; } let tmp_443 = smem_keys[tmp_436 * WPT + 1u]; let tmp_444 = smem_vals[tmp_436 * WPT + 1u]; let tmp_445 = keys[2] < tmp_443 || (keys[2] == tmp_443 && values[2] < tmp_444); if tmp_435 == tmp_445 { keys[2] = tmp_443; values[2] = tmp_444; } let tmp_446 = smem_keys[tmp_436 * WPT + 0u]; let tmp_447 = smem_vals[tmp_436 * WPT + 0u]; let tmp_448 = keys[3] < tmp_446 || (keys[3] == tmp_446 && values[3] < tmp_447); if tmp_435 == tmp_448 { keys[3] = tmp_446; values[3] = tmp_447; } workgroupBarrier(); }
    // exch_paral(tmask:64,swbit:6,wpt:4) 
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; workgroupBarrier(); let tmp_449 = extractBits(local_tid, 6u, 1u) != 0u; let tmp_450 = seg_base + (local_tid ^ 64u); let tmp_451 = smem_keys[tmp_450 * WPT + 0u]; let tmp_452 = smem_vals[tmp_450 * WPT + 0u]; let tmp_453 = keys[0] < tmp_451 || (keys[0] == tmp_451 && values[0] < tmp_452); if tmp_449 == tmp_453 { keys[0] = tmp_451; values[0] = tmp_452; } let tmp_454 = smem_keys[tmp_450 * WPT + 1u]; let tmp_455 = smem_vals[tmp_450 * WPT + 1u]; let tmp_456 = keys[1] < tmp_454 || (keys[1] == tmp_454 && values[1] < tmp_455); if tmp_449 == tmp_456 { keys[1] = tmp_454; values[1] = tmp_455; } let tmp_457 = smem_keys[tmp_450 * WPT + 2u]; let tmp_458 = smem_vals[tmp_450 * WPT + 2u]; let tmp_459 = keys[2] < tmp_457 || (keys[2] == tmp_457 && values[2] < tmp_458); if tmp_449 == tmp_459 { keys[2] = tmp_457; values[2] = tmp_458; } let tmp_460 = smem_keys[tmp_450 * WPT + 3u]; let tmp_461 = smem_vals[tmp_450 * WPT + 3u]; let tmp_462 = keys[3] < tmp_460 || (keys[3] == tmp_460 && values[3] < tmp_461); if tmp_449 == tmp_462 { keys[3] = tmp_460; values[3] = tmp_461; } workgroupBarrier(); }
    // exch_paral(tmask:32,swbit:5,wpt:4) 
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; workgroupBarrier(); let tmp_463 = extractBits(local_tid, 5u, 1u) != 0u; let tmp_464 = seg_base + (local_tid ^ 32u); let tmp_465 = smem_keys[tmp_464 * WPT + 0u]; let tmp_466 = smem_vals[tmp_464 * WPT + 0u]; let tmp_467 = keys[0] < tmp_465 || (keys[0] == tmp_465 && values[0] < tmp_466); if tmp_463 == tmp_467 { keys[0] = tmp_465; values[0] = tmp_466; } let tmp_468 = smem_keys[tmp_464 * WPT + 1u]; let tmp_469 = smem_vals[tmp_464 * WPT + 1u]; let tmp_470 = keys[1] < tmp_468 || (keys[1] == tmp_468 && values[1] < tmp_469); if tmp_463 == tmp_470 { keys[1] = tmp_468; values[1] = tmp_469; } let tmp_471 = smem_keys[tmp_464 * WPT + 2u]; let tmp_472 = smem_vals[tmp_464 * WPT + 2u]; let tmp_473 = keys[2] < tmp_471 || (keys[2] == tmp_471 && values[2] < tmp_472); if tmp_463 == tmp_473 { keys[2] = tmp_471; values[2] = tmp_472; } let tmp_474 = smem_keys[tmp_464 * WPT + 3u]; let tmp_475 = smem_vals[tmp_464 * WPT + 3u]; let tmp_476 = keys[3] < tmp_474 || (keys[3] == tmp_474 && values[3] < tmp_475); if tmp_463 == tmp_476 { keys[3] = tmp_474; values[3] = tmp_475; } workgroupBarrier(); }
    // exch_paral(tmask:16,swbit:4,wpt:4) 
    {
    let tmp_477 = subgroupShuffleXor(keys[0], 16u);
    let tmp_478 = subgroupShuffleXor(values[0], 16u);
    let tmp_479 = subgroupShuffleXor(keys[1], 16u);
    let tmp_480 = subgroupShuffleXor(values[1], 16u);
    let tmp_481 = subgroupShuffleXor(keys[2], 16u);
    let tmp_482 = subgroupShuffleXor(values[2], 16u);
    let tmp_483 = subgroupShuffleXor(keys[3], 16u);
    let tmp_484 = subgroupShuffleXor(values[3], 16u);
    let tmp_485 = extractBits(local_tid, 4u, 1u) != 0u;
    let tmp_486 = keys[0] < tmp_477 || (keys[0] == tmp_477 && values[0] < tmp_478);
    if tmp_485 == tmp_486 { keys[0] = tmp_477; values[0] = tmp_478; }
    let tmp_487 = keys[1] < tmp_479 || (keys[1] == tmp_479 && values[1] < tmp_480);
    if tmp_485 == tmp_487 { keys[1] = tmp_479; values[1] = tmp_480; }
    let tmp_488 = keys[2] < tmp_481 || (keys[2] == tmp_481 && values[2] < tmp_482);
    if tmp_485 == tmp_488 { keys[2] = tmp_481; values[2] = tmp_482; }
    let tmp_489 = keys[3] < tmp_483 || (keys[3] == tmp_483 && values[3] < tmp_484);
    if tmp_485 == tmp_489 { keys[3] = tmp_483; values[3] = tmp_484; }
    }
    // exch_paral(tmask:8,swbit:3,wpt:4) 
    {
    let tmp_490 = subgroupShuffleXor(keys[0], 8u);
    let tmp_491 = subgroupShuffleXor(values[0], 8u);
    let tmp_492 = subgroupShuffleXor(keys[1], 8u);
    let tmp_493 = subgroupShuffleXor(values[1], 8u);
    let tmp_494 = subgroupShuffleXor(keys[2], 8u);
    let tmp_495 = subgroupShuffleXor(values[2], 8u);
    let tmp_496 = subgroupShuffleXor(keys[3], 8u);
    let tmp_497 = subgroupShuffleXor(values[3], 8u);
    let tmp_498 = extractBits(local_tid, 3u, 1u) != 0u;
    let tmp_499 = keys[0] < tmp_490 || (keys[0] == tmp_490 && values[0] < tmp_491);
    if tmp_498 == tmp_499 { keys[0] = tmp_490; values[0] = tmp_491; }
    let tmp_500 = keys[1] < tmp_492 || (keys[1] == tmp_492 && values[1] < tmp_493);
    if tmp_498 == tmp_500 { keys[1] = tmp_492; values[1] = tmp_493; }
    let tmp_501 = keys[2] < tmp_494 || (keys[2] == tmp_494 && values[2] < tmp_495);
    if tmp_498 == tmp_501 { keys[2] = tmp_494; values[2] = tmp_495; }
    let tmp_502 = keys[3] < tmp_496 || (keys[3] == tmp_496 && values[3] < tmp_497);
    if tmp_498 == tmp_502 { keys[3] = tmp_496; values[3] = tmp_497; }
    }
    // exch_paral(tmask:4,swbit:2,wpt:4) 
    {
    let tmp_503 = subgroupShuffleXor(keys[0], 4u);
    let tmp_504 = subgroupShuffleXor(values[0], 4u);
    let tmp_505 = subgroupShuffleXor(keys[1], 4u);
    let tmp_506 = subgroupShuffleXor(values[1], 4u);
    let tmp_507 = subgroupShuffleXor(keys[2], 4u);
    let tmp_508 = subgroupShuffleXor(values[2], 4u);
    let tmp_509 = subgroupShuffleXor(keys[3], 4u);
    let tmp_510 = subgroupShuffleXor(values[3], 4u);
    let tmp_511 = extractBits(local_tid, 2u, 1u) != 0u;
    let tmp_512 = keys[0] < tmp_503 || (keys[0] == tmp_503 && values[0] < tmp_504);
    if tmp_511 == tmp_512 { keys[0] = tmp_503; values[0] = tmp_504; }
    let tmp_513 = keys[1] < tmp_505 || (keys[1] == tmp_505 && values[1] < tmp_506);
    if tmp_511 == tmp_513 { keys[1] = tmp_505; values[1] = tmp_506; }
    let tmp_514 = keys[2] < tmp_507 || (keys[2] == tmp_507 && values[2] < tmp_508);
    if tmp_511 == tmp_514 { keys[2] = tmp_507; values[2] = tmp_508; }
    let tmp_515 = keys[3] < tmp_509 || (keys[3] == tmp_509 && values[3] < tmp_510);
    if tmp_511 == tmp_515 { keys[3] = tmp_509; values[3] = tmp_510; }
    }
    // exch_paral(tmask:2,swbit:1,wpt:4) 
    {
    let tmp_516 = subgroupShuffleXor(keys[0], 2u);
    let tmp_517 = subgroupShuffleXor(values[0], 2u);
    let tmp_518 = subgroupShuffleXor(keys[1], 2u);
    let tmp_519 = subgroupShuffleXor(values[1], 2u);
    let tmp_520 = subgroupShuffleXor(keys[2], 2u);
    let tmp_521 = subgroupShuffleXor(values[2], 2u);
    let tmp_522 = subgroupShuffleXor(keys[3], 2u);
    let tmp_523 = subgroupShuffleXor(values[3], 2u);
    let tmp_524 = extractBits(local_tid, 1u, 1u) != 0u;
    let tmp_525 = keys[0] < tmp_516 || (keys[0] == tmp_516 && values[0] < tmp_517);
    if tmp_524 == tmp_525 { keys[0] = tmp_516; values[0] = tmp_517; }
    let tmp_526 = keys[1] < tmp_518 || (keys[1] == tmp_518 && values[1] < tmp_519);
    if tmp_524 == tmp_526 { keys[1] = tmp_518; values[1] = tmp_519; }
    let tmp_527 = keys[2] < tmp_520 || (keys[2] == tmp_520 && values[2] < tmp_521);
    if tmp_524 == tmp_527 { keys[2] = tmp_520; values[2] = tmp_521; }
    let tmp_528 = keys[3] < tmp_522 || (keys[3] == tmp_522 && values[3] < tmp_523);
    if tmp_524 == tmp_528 { keys[3] = tmp_522; values[3] = tmp_523; }
    }
    // exch_paral(tmask:1,swbit:0,wpt:4) 
    {
    let tmp_529 = subgroupShuffleXor(keys[0], 1u);
    let tmp_530 = subgroupShuffleXor(values[0], 1u);
    let tmp_531 = subgroupShuffleXor(keys[1], 1u);
    let tmp_532 = subgroupShuffleXor(values[1], 1u);
    let tmp_533 = subgroupShuffleXor(keys[2], 1u);
    let tmp_534 = subgroupShuffleXor(values[2], 1u);
    let tmp_535 = subgroupShuffleXor(keys[3], 1u);
    let tmp_536 = subgroupShuffleXor(values[3], 1u);
    let tmp_537 = extractBits(local_tid, 0u, 1u) != 0u;
    let tmp_538 = keys[0] < tmp_529 || (keys[0] == tmp_529 && values[0] < tmp_530);
    if tmp_537 == tmp_538 { keys[0] = tmp_529; values[0] = tmp_530; }
    let tmp_539 = keys[1] < tmp_531 || (keys[1] == tmp_531 && values[1] < tmp_532);
    if tmp_537 == tmp_539 { keys[1] = tmp_531; values[1] = tmp_532; }
    let tmp_540 = keys[2] < tmp_533 || (keys[2] == tmp_533 && values[2] < tmp_534);
    if tmp_537 == tmp_540 { keys[2] = tmp_533; values[2] = tmp_534; }
    let tmp_541 = keys[3] < tmp_535 || (keys[3] == tmp_535 && values[3] < tmp_536);
    if tmp_537 == tmp_541 { keys[3] = tmp_535; values[3] = tmp_536; }
    }
    // exch_local(2,4) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    ...
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_546 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_546;let tmp_547 = values[0]; values[0] = values[1]; values[1] = tmp_547; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_548 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_548;let tmp_549 = values[2]; values[2] = values[3]; values[3] = tmp_549; }
    }
