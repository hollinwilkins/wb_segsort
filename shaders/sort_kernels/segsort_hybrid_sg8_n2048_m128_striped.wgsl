...
fn segsort_hybrid_sg8_n2048_m128_striped(
    ...
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; smem_keys[tid_g * WPT + 8u] = keys[8]; smem_vals[tid_g * WPT + 8u] = values[8]; smem_keys[tid_g * WPT + 9u] = keys[9]; smem_vals[tid_g * WPT + 9u] = values[9]; smem_keys[tid_g * WPT + 10u] = keys[10]; smem_vals[tid_g * WPT + 10u] = values[10]; smem_keys[tid_g * WPT + 11u] = keys[11]; smem_vals[tid_g * WPT + 11u] = values[11]; smem_keys[tid_g * WPT + 12u] = keys[12]; smem_vals[tid_g * WPT + 12u] = values[12]; smem_keys[tid_g * WPT + 13u] = keys[13]; smem_vals[tid_g * WPT + 13u] = values[13]; smem_keys[tid_g * WPT + 14u] = keys[14]; smem_vals[tid_g * WPT + 14u] = values[14]; smem_keys[tid_g * WPT + 15u] = keys[15]; smem_vals[tid_g * WPT + 15u] = values[15]; workgroupBarrier(); let tmp_1579 = extractBits(local_tid, 6u, 1u) != 0u; let tmp_1580 = seg_base + (local_tid ^ 127u); let tmp_1581 = smem_keys[tmp_1580 * WPT + 15u]; let tmp_1582 = smem_vals[tmp_1580 * WPT + 15u]; let tmp_1583 = keys[0] < tmp_1581 || (keys[0] == tmp_1581 && values[0] < tmp_1582); if tmp_1579 == tmp_1583 { keys[0] = tmp_1581; values[0] = tmp_1582; } let tmp_1584 = smem_keys[tmp_1580 * WPT + 14u]; let tmp_1585 = smem_vals[tmp_1580 * WPT + 14u]; let tmp_1586 = keys[1] < tmp_1584 || (keys[1] == tmp_1584 && values[1] < tmp_1585); if tmp_1579 == tmp_1586 { keys[1] = tmp_1584; values[1] = tmp_1585; } let tmp_1587 = smem_keys[tmp_1580 * WPT + 13u]; let tmp_1588 = smem_vals[tmp_1580 * WPT + 13u]; let tmp_1589 = keys[2] < tmp_1587 || (keys[2] == tmp_1587 && values[2] < tmp_1588); if tmp_1579 == tmp_1589 { keys[2] = tmp_1587; values[2] = tmp_1588; } let tmp_1590 = smem_keys[tmp_1580 * WPT + 12u]; let tmp_1591 = smem_vals[tmp_1580 * WPT + 12u]; let tmp_1592 = keys[3] < tmp_1590 || (keys[3] == tmp_1590 && values[3] < tmp_1591); if tmp_1579 == tmp_1592 { keys[3] = tmp_1590; values[3] = tmp_1591; } let tmp_1593 = smem_keys[tmp_1580 * WPT + 11u]; let tmp_1594 = smem_vals[tmp_1580 * WPT + 11u]; let tmp_1595 = keys[4] < tmp_1593 || (keys[4] == tmp_1593 && values[4] < tmp_1594); if tmp_1579 == tmp_1595 { keys[4] = tmp_1593; values[4] = tmp_1594; } let tmp_1596 = smem_keys[tmp_1580 * WPT + 10u]; let tmp_1597 = smem_vals[tmp_1580 * WPT + 10u]; let tmp_1598 = keys[5] < tmp_1596 || (keys[5] == tmp_1596 && values[5] < tmp_1597); if tmp_1579 == tmp_1598 { keys[5] = tmp_1596; values[5] = tmp_1597; } let tmp_1599 = smem_keys[tmp_1580 * WPT + 9u]; let tmp_1600 = smem_vals[tmp_1580 * WPT + 9u]; let tmp_1601 = keys[6] < tmp_1599 || (keys[6] == tmp_1599 && values[6] < tmp_1600); if tmp_1579 == tmp_1601 { keys[6] = tmp_1599; values[6] = tmp_1600; } let tmp_1602 = smem_keys[tmp_1580 * WPT + 8u]; let tmp_1603 = smem_vals[tmp_1580 * WPT + 8u]; let tmp_1604 = keys[7] < tmp_1602 || (keys[7] == tmp_1602 && values[7] < tmp_1603); if tmp_1579 == tmp_1604 { keys[7] = tmp_1602; values[7] = tmp_1603; } let tmp_1605 = smem_keys[tmp_1580 * WPT + 7u]; let tmp_1606 = smem_vals[tmp_1580 * WPT + 7u]; let tmp_1607 = keys[8] < tmp_1605 || (keys[8] == tmp_1605 && values[8] < tmp_1606); if tmp_1579 == tmp_1607 { keys[8] = tmp_1605; values[8] = tmp_1606; } let tmp_1608 = smem_keys[tmp_1580 * WPT + 6u]; let tmp_1609 = smem_vals[tmp_1580 * WPT + 6u]; let tmp_1610 = keys[9] < tmp_1608 || (keys[9] == tmp_1608 && values[9] < tmp_1609); if tmp_1579 == tmp_1610 { keys[9] = tmp_1608; values[9] = tmp_1609; } let tmp_1611 = smem_keys[tmp_1580 * WPT + 5u]; let tmp_1612 = smem_vals[tmp_1580 * WPT + 5u]; let tmp_1613 = keys[10] < tmp_1611 || (keys[10] == tmp_1611 && values[10] < tmp_1612); if tmp_1579 == tmp_1613 { keys[10] = tmp_1611; values[10] = tmp_1612; } let tmp_1614 = smem_keys[tmp_1580 * WPT + 4u]; let tmp_1615 = smem_vals[tmp_1580 * WPT + 4u]; let tmp_1616 = keys[11] < tmp_1614 || (keys[11] == tmp_1614 && values[11] < tmp_1615); if tmp_1579 == tmp_1616 { keys[11] = tmp_1614; values[11] = tmp_1615; } let tmp_1617 = smem_keys[tmp_1580 * WPT + 3u]; let tmp_1618 = smem_vals[tmp_1580 * WPT + 3u]; let tmp_1619 = keys[12] < tmp_1617 || (keys[12] == tmp_1617 && values[12] < tmp_1618); if tmp_1579 == tmp_1619 { keys[12] = tmp_1617; values[12] = tmp_1618; } let tmp_1620 = smem_keys[tmp_1580 * WPT + 2u]; let tmp_1621 = smem_vals[tmp_1580 * WPT + 2u]; let tmp_1622 = keys[13] < tmp_1620 || (keys[13] == tmp_1620 && values[13] < tmp_1621); if tmp_1579 == tmp_1622 { keys[13] = tmp_1620; values[13] = tmp_1621; } let tmp_1623 = smem_keys[tmp_1580 * WPT + 1u]; let tmp_1624 = smem_vals[tmp_1580 * WPT + 1u]; let tmp_1625 = keys[14] < tmp_1623 || (keys[14] == tmp_1623 && values[14] < tmp_1624); if tmp_1579 == tmp_1625 { keys[14] = tmp_1623; values[14] = tmp_1624; } let tmp_1626 = smem_keys[tmp_1580 * WPT + 0u]; let tmp_1627 = smem_vals[tmp_1580 * WPT + 0u]; let tmp_1628 = keys[15] < tmp_1626 || (keys[15] == tmp_1626 && values[15] < tmp_1627); if tmp_1579 == tmp_1628 { keys[15] = tmp_1626; values[15] = tmp_1627; } workgroupBarrier(); }
    // exch_paral(tmask:32,swbit:5,wpt:16) 
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; smem_keys[tid_g * WPT + 8u] = keys[8]; smem_vals[tid_g * WPT + 8u] = values[8]; smem_keys[tid_g * WPT + 9u] = keys[9]; smem_vals[tid_g * WPT + 9u] = values[9]; smem_keys[tid_g * WPT + 10u] = keys[10]; smem_vals[tid_g * WPT + 10u] = values[10]; smem_keys[tid_g * WPT + 11u] = keys[11]; smem_vals[tid_g * WPT + 11u] = values[11]; smem_keys[tid_g * WPT + 12u] = keys[12]; smem_vals[tid_g * WPT + 12u] = values[12]; smem_keys[tid_g * WPT + 13u] = keys[13]; smem_vals[tid_g * WPT + 13u] = values[13]; smem_keys[tid_g * WPT + 14u] = keys[14]; smem_vals[tid_g * WPT + 14u] = values[14]; smem_keys[tid_g * WPT + 15u] = keys[15]; smem_vals[tid_g * WPT + 15u] = values[15]; workgroupBarrier(); let tmp_1629 = extractBits(local_tid, 5u, 1u) != 0u; let tmp_1630 = seg_base + (local_tid ^ 32u); let tmp_1631 = smem_keys[tmp_1630 * WPT + 0u]; let tmp_1632 = smem_vals[tmp_1630 * WPT + 0u]; let tmp_1633 = keys[0] < tmp_1631 || (keys[0] == tmp_1631 && values[0] < tmp_1632); if tmp_1629 == tmp_1633 { keys[0] = tmp_1631; values[0] = tmp_1632; } let tmp_1634 = smem_keys[tmp_1630 * WPT + 1u]; let tmp_1635 = smem_vals[tmp_1630 * WPT + 1u]; let tmp_1636 = keys[1] < tmp_1634 || (keys[1] == tmp_1634 && values[1] < tmp_1635); if tmp_1629 == tmp_1636 { keys[1] = tmp_1634; values[1] = tmp_1635; } let tmp_1637 = smem_keys[tmp_1630 * WPT + 2u]; let tmp_1638 = smem_vals[tmp_1630 * WPT + 2u]; let tmp_1639 = keys[2] < tmp_1637 || (keys[2] == tmp_1637 && values[2] < tmp_1638); if tmp_1629 == tmp_1639 { keys[2] = tmp_1637; values[2] = tmp_1638; } let tmp_1640 = smem_keys[tmp_1630 * WPT + 3u]; let tmp_1641 = smem_vals[tmp_1630 * WPT + 3u]; let tmp_1642 = keys[3] < tmp_1640 || (keys[3] == tmp_1640 && values[3] < tmp_1641); if tmp_1629 == tmp_1642 { keys[3] = tmp_1640; values[3] = tmp_1641; } let tmp_1643 = smem_keys[tmp_1630 * WPT + 4u]; let tmp_1644 = smem_vals[tmp_1630 * WPT + 4u]; let tmp_1645 = keys[4] < tmp_1643 || (keys[4] == tmp_1643 && values[4] < tmp_1644); if tmp_1629 == tmp_1645 { keys[4] = tmp_1643; values[4] = tmp_1644; } let tmp_1646 = smem_keys[tmp_1630 * WPT + 5u]; let tmp_1647 = smem_vals[tmp_1630 * WPT + 5u]; let tmp_1648 = keys[5] < tmp_1646 || (keys[5] == tmp_1646 && values[5] < tmp_1647); if tmp_1629 == tmp_1648 { keys[5] = tmp_1646; values[5] = tmp_1647; } let tmp_1649 = smem_keys[tmp_1630 * WPT + 6u]; let tmp_1650 = smem_vals[tmp_1630 * WPT + 6u]; let tmp_1651 = keys[6] < tmp_1649 || (keys[6] == tmp_1649 && values[6] < tmp_1650); if tmp_1629 == tmp_1651 { keys[6] = tmp_1649; values[6] = tmp_1650; } let tmp_1652 = smem_keys[tmp_1630 * WPT + 7u]; let tmp_1653 = smem_vals[tmp_1630 * WPT + 7u]; let tmp_1654 = keys[7] < tmp_1652 || (keys[7] == tmp_1652 && values[7] < tmp_1653); if tmp_1629 == tmp_1654 { keys[7] = tmp_1652; values[7] = tmp_1653; } let tmp_1655 = smem_keys[tmp_1630 * WPT + 8u]; let tmp_1656 = smem_vals[tmp_1630 * WPT + 8u]; let tmp_1657 = keys[8] < tmp_1655 || (keys[8] == tmp_1655 && values[8] < tmp_1656); if tmp_1629 == tmp_1657 { keys[8] = tmp_1655; values[8] = tmp_1656; } let tmp_1658 = smem_keys[tmp_1630 * WPT + 9u]; let tmp_1659 = smem_vals[tmp_1630 * WPT + 9u]; let tmp_1660 = keys[9] < tmp_1658 || (keys[9] == tmp_1658 && values[9] < tmp_1659); if tmp_1629 == tmp_1660 { keys[9] = tmp_1658; values[9] = tmp_1659; } let tmp_1661 = smem_keys[tmp_1630 * WPT + 10u]; let tmp_1662 = smem_vals[tmp_1630 * WPT + 10u]; let tmp_1663 = keys[10] < tmp_1661 || (keys[10] == tmp_1661 && values[10] < tmp_1662); if tmp_1629 == tmp_1663 { keys[10] = tmp_1661; values[10] = tmp_1662; } let tmp_1664 = smem_keys[tmp_1630 * WPT + 11u]; let tmp_1665 = smem_vals[tmp_1630 * WPT + 11u]; let tmp_1666 = keys[11] < tmp_1664 || (keys[11] == tmp_1664 && values[11] < tmp_1665); if tmp_1629 == tmp_1666 { keys[11] = tmp_1664; values[11] = tmp_1665; } let tmp_1667 = smem_keys[tmp_1630 * WPT + 12u]; let tmp_1668 = smem_vals[tmp_1630 * WPT + 12u]; let tmp_1669 = keys[12] < tmp_1667 || (keys[12] == tmp_1667 && values[12] < tmp_1668); if tmp_1629 == tmp_1669 { keys[12] = tmp_1667; values[12] = tmp_1668; } let tmp_1670 = smem_keys[tmp_1630 * WPT + 13u]; let tmp_1671 = smem_vals[tmp_1630 * WPT + 13u]; let tmp_1672 = keys[13] < tmp_1670 || (keys[13] == tmp_1670 && values[13] < tmp_1671); if tmp_1629 == tmp_1672 { keys[13] = tmp_1670; values[13] = tmp_1671; } let tmp_1673 = smem_keys[tmp_1630 * WPT + 14u]; let tmp_1674 = smem_vals[tmp_1630 * WPT + 14u]; let tmp_1675 = keys[14] < tmp_1673 || (keys[14] == tmp_1673 && values[14] < tmp_1674); if tmp_1629 == tmp_1675 { keys[14] = tmp_1673; values[14] = tmp_1674; } let tmp_1676 = smem_keys[tmp_1630 * WPT + 15u]; let tmp_1677 = smem_vals[tmp_1630 * WPT + 15u]; let tmp_1678 = keys[15] < tmp_1676 || (keys[15] == tmp_1676 && values[15] < tmp_1677); if tmp_1629 == tmp_1678 { keys[15] = tmp_1676; values[15] = tmp_1677; } workgroupBarrier(); }
    // exch_paral(tmask:16,swbit:4,wpt:16) 
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; smem_keys[tid_g * WPT + 8u] = keys[8]; smem_vals[tid_g * WPT + 8u] = values[8]; smem_keys[tid_g * WPT + 9u] = keys[9]; smem_vals[tid_g * WPT + 9u] = values[9]; smem_keys[tid_g * WPT + 10u] = keys[10]; smem_vals[tid_g * WPT + 10u] = values[10]; smem_keys[tid_g * WPT + 11u] = keys[11]; smem_vals[tid_g * WPT + 11u] = values[11]; smem_keys[tid_g * WPT + 12u] = keys[12]; smem_vals[tid_g * WPT + 12u] = values[12]; smem_keys[tid_g * WPT + 13u] = keys[13]; smem_vals[tid_g * WPT + 13u] = values[13]; smem_keys[tid_g * WPT + 14u] = keys[14]; smem_vals[tid_g * WPT + 14u] = values[14]; smem_keys[tid_g * WPT + 15u] = keys[15]; smem_vals[tid_g * WPT + 15u] = values[15]; workgroupBarrier(); let tmp_1679 = extractBits(local_tid, 4u, 1u) != 0u; let tmp_1680 = seg_base + (local_tid ^ 16u); let tmp_1681 = smem_keys[tmp_1680 * WPT + 0u]; let tmp_1682 = smem_vals[tmp_1680 * WPT + 0u]; let tmp_1683 = keys[0] < tmp_1681 || (keys[0] == tmp_1681 && values[0] < tmp_1682); if tmp_1679 == tmp_1683 { keys[0] = tmp_1681; values[0] = tmp_1682; } let tmp_1684 = smem_keys[tmp_1680 * WPT + 1u]; let tmp_1685 = smem_vals[tmp_1680 * WPT + 1u]; let tmp_1686 = keys[1] < tmp_1684 || (keys[1] == tmp_1684 && values[1] < tmp_1685); if tmp_1679 == tmp_1686 { keys[1] = tmp_1684; values[1] = tmp_1685; } let tmp_1687 = smem_keys[tmp_1680 * WPT + 2u]; let tmp_1688 = smem_vals[tmp_1680 * WPT + 2u]; let tmp_1689 = keys[2] < tmp_1687 || (keys[2] == tmp_1687 && values[2] < tmp_1688); if tmp_1679 == tmp_1689 { keys[2] = tmp_1687; values[2] = tmp_1688; } let tmp_1690 = smem_keys[tmp_1680 * WPT + 3u]; let tmp_1691 = smem_vals[tmp_1680 * WPT + 3u]; let tmp_1692 = keys[3] < tmp_1690 || (keys[3] == tmp_1690 && values[3] < tmp_1691); if tmp_1679 == tmp_1692 { keys[3] = tmp_1690; values[3] = tmp_1691; } let tmp_1693 = smem_keys[tmp_1680 * WPT + 4u]; let tmp_1694 = smem_vals[tmp_1680 * WPT + 4u]; let tmp_1695 = keys[4] < tmp_1693 || (keys[4] == tmp_1693 && values[4] < tmp_1694); if tmp_1679 == tmp_1695 { keys[4] = tmp_1693; values[4] = tmp_1694; } let tmp_1696 = smem_keys[tmp_1680 * WPT + 5u]; let tmp_1697 = smem_vals[tmp_1680 * WPT + 5u]; let tmp_1698 = keys[5] < tmp_1696 || (keys[5] == tmp_1696 && values[5] < tmp_1697); if tmp_1679 == tmp_1698 { keys[5] = tmp_1696; values[5] = tmp_1697; } let tmp_1699 = smem_keys[tmp_1680 * WPT + 6u]; let tmp_1700 = smem_vals[tmp_1680 * WPT + 6u]; let tmp_1701 = keys[6] < tmp_1699 || (keys[6] == tmp_1699 && values[6] < tmp_1700); if tmp_1679 == tmp_1701 { keys[6] = tmp_1699; values[6] = tmp_1700; } let tmp_1702 = smem_keys[tmp_1680 * WPT + 7u]; let tmp_1703 = smem_vals[tmp_1680 * WPT + 7u]; let tmp_1704 = keys[7] < tmp_1702 || (keys[7] == tmp_1702 && values[7] < tmp_1703); if tmp_1679 == tmp_1704 { keys[7] = tmp_1702; values[7] = tmp_1703; } let tmp_1705 = smem_keys[tmp_1680 * WPT + 8u]; let tmp_1706 = smem_vals[tmp_1680 * WPT + 8u]; let tmp_1707 = keys[8] < tmp_1705 || (keys[8] == tmp_1705 && values[8] < tmp_1706); if tmp_1679 == tmp_1707 { keys[8] = tmp_1705; values[8] = tmp_1706; } let tmp_1708 = smem_keys[tmp_1680 * WPT + 9u]; let tmp_1709 = smem_vals[tmp_1680 * WPT + 9u]; let tmp_1710 = keys[9] < tmp_1708 || (keys[9] == tmp_1708 && values[9] < tmp_1709); if tmp_1679 == tmp_1710 { keys[9] = tmp_1708; values[9] = tmp_1709; } let tmp_1711 = smem_keys[tmp_1680 * WPT + 10u]; let tmp_1712 = smem_vals[tmp_1680 * WPT + 10u]; let tmp_1713 = keys[10] < tmp_1711 || (keys[10] == tmp_1711 && values[10] < tmp_1712); if tmp_1679 == tmp_1713 { keys[10] = tmp_1711; values[10] = tmp_1712; } let tmp_1714 = smem_keys[tmp_1680 * WPT + 11u]; let tmp_1715 = smem_vals[tmp_1680 * WPT + 11u]; let tmp_1716 = keys[11] < tmp_1714 || (keys[11] == tmp_1714 && values[11] < tmp_1715); if tmp_1679 == tmp_1716 { keys[11] = tmp_1714; values[11] = tmp_1715; } let tmp_1717 = smem_keys[tmp_1680 * WPT + 12u]; let tmp_1718 = smem_vals[tmp_1680 * WPT + 12u]; let tmp_1719 = keys[12] < tmp_1717 || (keys[12] == tmp_1717 && values[12] < tmp_1718); if tmp_1679 == tmp_1719 { keys[12] = tmp_1717; values[12] = tmp_1718; } let tmp_1720 = smem_keys[tmp_1680 * WPT + 13u]; let tmp_1721 = smem_vals[tmp_1680 * WPT + 13u]; let tmp_1722 = keys[13] < tmp_1720 || (keys[13] == tmp_1720 && values[13] < tmp_1721); if tmp_1679 == tmp_1722 { keys[13] = tmp_1720; values[13] = tmp_1721; } let tmp_1723 = smem_keys[tmp_1680 * WPT + 14u]; let tmp_1724 = smem_vals[tmp_1680 * WPT + 14u]; let tmp_1725 = keys[14] < tmp_1723 || (keys[14] == tmp_1723 && values[14] < tmp_1724); if tmp_1679 == tmp_1725 { keys[14] = tmp_1723; values[14] = tmp_1724; } let tmp_1726 = smem_keys[tmp_1680 * WPT + 15u]; let tmp_1727 = smem_vals[tmp_1680 * WPT + 15u]; let tmp_1728 = keys[15] < tmp_1726 || (keys[15] == tmp_1726 && values[15] < tmp_1727); if tmp_1679 == tmp_1728 { keys[15] = tmp_1726; values[15] = tmp_1727; } workgroupBarrier(); }
    // exch_paral(tmask:8,swbit:3,wpt:16) 
    { smem_keys[tid_g * WPT + 0u] = keys[0]; smem_vals[tid_g * WPT + 0u] = values[0]; smem_keys[tid_g * WPT + 1u] = keys[1]; smem_vals[tid_g * WPT + 1u] = values[1]; smem_keys[tid_g * WPT + 2u] = keys[2]; smem_vals[tid_g * WPT + 2u] = values[2]; smem_keys[tid_g * WPT + 3u] = keys[3]; smem_vals[tid_g * WPT + 3u] = values[3]; smem_keys[tid_g * WPT + 4u] = keys[4]; smem_vals[tid_g * WPT + 4u] = values[4]; smem_keys[tid_g * WPT + 5u] = keys[5]; smem_vals[tid_g * WPT + 5u] = values[5]; smem_keys[tid_g * WPT + 6u] = keys[6]; smem_vals[tid_g * WPT + 6u] = values[6]; smem_keys[tid_g * WPT + 7u] = keys[7]; smem_vals[tid_g * WPT + 7u] = values[7]; smem_keys[tid_g * WPT + 8u] = keys[8]; smem_vals[tid_g * WPT + 8u] = values[8]; smem_keys[tid_g * WPT + 9u] = keys[9]; smem_vals[tid_g * WPT + 9u] = values[9]; smem_keys[tid_g * WPT + 10u] = keys[10]; smem_vals[tid_g * WPT + 10u] = values[10]; smem_keys[tid_g * WPT + 11u] = keys[11]; smem_vals[tid_g * WPT + 11u] = values[11]; smem_keys[tid_g * WPT + 12u] = keys[12]; smem_vals[tid_g * WPT + 12u] = values[12]; smem_keys[tid_g * WPT + 13u] = keys[13]; smem_vals[tid_g * WPT + 13u] = values[13]; smem_keys[tid_g * WPT + 14u] = keys[14]; smem_vals[tid_g * WPT + 14u] = values[14]; smem_keys[tid_g * WPT + 15u] = keys[15]; smem_vals[tid_g * WPT + 15u] = values[15]; workgroupBarrier(); let tmp_1729 = extractBits(local_tid, 3u, 1u) != 0u; let tmp_1730 = seg_base + (local_tid ^ 8u); let tmp_1731 = smem_keys[tmp_1730 * WPT + 0u]; let tmp_1732 = smem_vals[tmp_1730 * WPT + 0u]; let tmp_1733 = keys[0] < tmp_1731 || (keys[0] == tmp_1731 && values[0] < tmp_1732); if tmp_1729 == tmp_1733 { keys[0] = tmp_1731; values[0] = tmp_1732; } let tmp_1734 = smem_keys[tmp_1730 * WPT + 1u]; let tmp_1735 = smem_vals[tmp_1730 * WPT + 1u]; let tmp_1736 = keys[1] < tmp_1734 || (keys[1] == tmp_1734 && values[1] < tmp_1735); if tmp_1729 == tmp_1736 { keys[1] = tmp_1734; values[1] = tmp_1735; } let tmp_1737 = smem_keys[tmp_1730 * WPT + 2u]; let tmp_1738 = smem_vals[tmp_1730 * WPT + 2u]; let tmp_1739 = keys[2] < tmp_1737 || (keys[2] == tmp_1737 && values[2] < tmp_1738); if tmp_1729 == tmp_1739 { keys[2] = tmp_1737; values[2] = tmp_1738; } let tmp_1740 = smem_keys[tmp_1730 * WPT + 3u]; let tmp_1741 = smem_vals[tmp_1730 * WPT + 3u]; let tmp_1742 = keys[3] < tmp_1740 || (keys[3] == tmp_1740 && values[3] < tmp_1741); if tmp_1729 == tmp_1742 { keys[3] = tmp_1740; values[3] = tmp_1741; } let tmp_1743 = smem_keys[tmp_1730 * WPT + 4u]; let tmp_1744 = smem_vals[tmp_1730 * WPT + 4u]; let tmp_1745 = keys[4] < tmp_1743 || (keys[4] == tmp_1743 && values[4] < tmp_1744); if tmp_1729 == tmp_1745 { keys[4] = tmp_1743; values[4] = tmp_1744; } let tmp_1746 = smem_keys[tmp_1730 * WPT + 5u]; let tmp_1747 = smem_vals[tmp_1730 * WPT + 5u]; let tmp_1748 = keys[5] < tmp_1746 || (keys[5] == tmp_1746 && values[5] < tmp_1747); if tmp_1729 == tmp_1748 { keys[5] = tmp_1746; values[5] = tmp_1747; } let tmp_1749 = smem_keys[tmp_1730 * WPT + 6u]; let tmp_1750 = smem_vals[tmp_1730 * WPT + 6u]; let tmp_1751 = keys[6] < tmp_1749 || (keys[6] == tmp_1749 && values[6] < tmp_1750); if tmp_1729 == tmp_1751 { keys[6] = tmp_1749; values[6] = tmp_1750; } let tmp_1752 = smem_keys[tmp_1730 * WPT + 7u]; let tmp_1753 = smem_vals[tmp_1730 * WPT + 7u]; let tmp_1754 = keys[7] < tmp_1752 || (keys[7] == tmp_1752 && values[7] < tmp_1753); if tmp_1729 == tmp_1754 { keys[7] = tmp_1752; values[7] = tmp_1753; } let tmp_1755 = smem_keys[tmp_1730 * WPT + 8u]; let tmp_1756 = smem_vals[tmp_1730 * WPT + 8u]; let tmp_1757 = keys[8] < tmp_1755 || (keys[8] == tmp_1755 && values[8] < tmp_1756); if tmp_1729 == tmp_1757 { keys[8] = tmp_1755; values[8] = tmp_1756; } let tmp_1758 = smem_keys[tmp_1730 * WPT + 9u]; let tmp_1759 = smem_vals[tmp_1730 * WPT + 9u]; let tmp_1760 = keys[9] < tmp_1758 || (keys[9] == tmp_1758 && values[9] < tmp_1759); if tmp_1729 == tmp_1760 { keys[9] = tmp_1758; values[9] = tmp_1759; } let tmp_1761 = smem_keys[tmp_1730 * WPT + 10u]; let tmp_1762 = smem_vals[tmp_1730 * WPT + 10u]; let tmp_1763 = keys[10] < tmp_1761 || (keys[10] == tmp_1761 && values[10] < tmp_1762); if tmp_1729 == tmp_1763 { keys[10] = tmp_1761; values[10] = tmp_1762; } let tmp_1764 = smem_keys[tmp_1730 * WPT + 11u]; let tmp_1765 = smem_vals[tmp_1730 * WPT + 11u]; let tmp_1766 = keys[11] < tmp_1764 || (keys[11] == tmp_1764 && values[11] < tmp_1765); if tmp_1729 == tmp_1766 { keys[11] = tmp_1764; values[11] = tmp_1765; } let tmp_1767 = smem_keys[tmp_1730 * WPT + 12u]; let tmp_1768 = smem_vals[tmp_1730 * WPT + 12u]; let tmp_1769 = keys[12] < tmp_1767 || (keys[12] == tmp_1767 && values[12] < tmp_1768); if tmp_1729 == tmp_1769 { keys[12] = tmp_1767; values[12] = tmp_1768; } let tmp_1770 = smem_keys[tmp_1730 * WPT + 13u]; let tmp_1771 = smem_vals[tmp_1730 * WPT + 13u]; let tmp_1772 = keys[13] < tmp_1770 || (keys[13] == tmp_1770 && values[13] < tmp_1771); if tmp_1729 == tmp_1772 { keys[13] = tmp_1770; values[13] = tmp_1771; } let tmp_1773 = smem_keys[tmp_1730 * WPT + 14u]; let tmp_1774 = smem_vals[tmp_1730 * WPT + 14u]; let tmp_1775 = keys[14] < tmp_1773 || (keys[14] == tmp_1773 && values[14] < tmp_1774); if tmp_1729 == tmp_1775 { keys[14] = tmp_1773; values[14] = tmp_1774; } let tmp_1776 = smem_keys[tmp_1730 * WPT + 15u]; let tmp_1777 = smem_vals[tmp_1730 * WPT + 15u]; let tmp_1778 = keys[15] < tmp_1776 || (keys[15] == tmp_1776 && values[15] < tmp_1777); if tmp_1729 == tmp_1778 { keys[15] = tmp_1776; values[15] = tmp_1777; } workgroupBarrier(); }
    // exch_paral(tmask:4,swbit:2,wpt:16) 
    {
    ...
    if keys[0] > keys[8] || (keys[0] == keys[8] && values[0] > values[8]) {
    // swap(0,8) 
    { let tmp_1926 = keys[0]; keys[0] = keys[8]; keys[8] = tmp_1926;let tmp_1927 = values[0]; values[0] = values[8]; values[8] = tmp_1927; }
    }
    // cmp_swap(1,9)
    if keys[1] > keys[9] || (keys[1] == keys[9] && values[1] > values[9]) {
    // swap(1,9) 
    { let tmp_1928 = keys[1]; keys[1] = keys[9]; keys[9] = tmp_1928;let tmp_1929 = values[1]; values[1] = values[9]; values[9] = tmp_1929; }
    }
    // cmp_swap(2,10)
    if keys[2] > keys[10] || (keys[2] == keys[10] && values[2] > values[10]) {
    // swap(2,10) 
    { let tmp_1930 = keys[2]; keys[2] = keys[10]; keys[10] = tmp_1930;let tmp_1931 = values[2]; values[2] = values[10]; values[10] = tmp_1931; }
    }
    // cmp_swap(3,11)
    if keys[3] > keys[11] || (keys[3] == keys[11] && values[3] > values[11]) {
    // swap(3,11) 
    { let tmp_1932 = keys[3]; keys[3] = keys[11]; keys[11] = tmp_1932;let tmp_1933 = values[3]; values[3] = values[11]; values[11] = tmp_1933; }
    }
    // cmp_swap(4,12)
    if keys[4] > keys[12] || (keys[4] == keys[12] && values[4] > values[12]) {
    // swap(4,12) 
    { let tmp_1934 = keys[4]; keys[4] = keys[12]; keys[12] = tmp_1934;let tmp_1935 = values[4]; values[4] = values[12]; values[12] = tmp_1935; }
    }
    // cmp_swap(5,13)
    if keys[5] > keys[13] || (keys[5] == keys[13] && values[5] > values[13]) {
    // swap(5,13) 
    { let tmp_1936 = keys[5]; keys[5] = keys[13]; keys[13] = tmp_1936;let tmp_1937 = values[5]; values[5] = values[13]; values[13] = tmp_1937; }
    }
    // cmp_swap(6,14)
    if keys[6] > keys[14] || (keys[6] == keys[14] && values[6] > values[14]) {
    // swap(6,14) 
    { let tmp_1938 = keys[6]; keys[6] = keys[14]; keys[14] = tmp_1938;let tmp_1939 = values[6]; values[6] = values[14]; values[14] = tmp_1939; }
    }
    // cmp_swap(7,15)
    if keys[7] > keys[15] || (keys[7] == keys[15] && values[7] > values[15]) {
    // swap(7,15) 
    { let tmp_1940 = keys[7]; keys[7] = keys[15]; keys[15] = tmp_1940;let tmp_1941 = values[7]; values[7] = values[15]; values[15] = tmp_1941; }
    }
    // exch_local(4,16) 
    // cmp_swap(0,4)
    if keys[0] > keys[4] || (keys[0] == keys[4] && values[0] > values[4]) {
    // swap(0,4) 
    { let tmp_1942 = keys[0]; keys[0] = keys[4]; keys[4] = tmp_1942;let tmp_1943 = values[0]; values[0] = values[4]; values[4] = tmp_1943; }
    }
    // cmp_swap(1,5)
    if keys[1] > keys[5] || (keys[1] == keys[5] && values[1] > values[5]) {
    // swap(1,5) 
    { let tmp_1944 = keys[1]; keys[1] = keys[5]; keys[5] = tmp_1944;let tmp_1945 = values[1]; values[1] = values[5]; values[5] = tmp_1945; }
    }
    // cmp_swap(2,6)
    if keys[2] > keys[6] || (keys[2] == keys[6] && values[2] > values[6]) {
    // swap(2,6) 
    { let tmp_1946 = keys[2]; keys[2] = keys[6]; keys[6] = tmp_1946;let tmp_1947 = values[2]; values[2] = values[6]; values[6] = tmp_1947; }
    }
    // cmp_swap(3,7)
    if keys[3] > keys[7] || (keys[3] == keys[7] && values[3] > values[7]) {
    // swap(3,7) 
    { let tmp_1948 = keys[3]; keys[3] = keys[7]; keys[7] = tmp_1948;let tmp_1949 = values[3]; values[3] = values[7]; values[7] = tmp_1949; }
    }
    // cmp_swap(8,12)
    if keys[8] > keys[12] || (keys[8] == keys[12] && values[8] > values[12]) {
    // swap(8,12) 
    { let tmp_1950 = keys[8]; keys[8] = keys[12]; keys[12] = tmp_1950;let tmp_1951 = values[8]; values[8] = values[12]; values[12] = tmp_1951; }
    }
    // cmp_swap(9,13)
    if keys[9] > keys[13] || (keys[9] == keys[13] && values[9] > values[13]) {
    // swap(9,13) 
    { let tmp_1952 = keys[9]; keys[9] = keys[13]; keys[13] = tmp_1952;let tmp_1953 = values[9]; values[9] = values[13]; values[13] = tmp_1953; }
    }
    // cmp_swap(10,14)
    if keys[10] > keys[14] || (keys[10] == keys[14] && values[10] > values[14]) {
    // swap(10,14) 
    { let tmp_1954 = keys[10]; keys[10] = keys[14]; keys[14] = tmp_1954;let tmp_1955 = values[10]; values[10] = values[14]; values[14] = tmp_1955; }
    }
    // cmp_swap(11,15)
    if keys[11] > keys[15] || (keys[11] == keys[15] && values[11] > values[15]) {
    // swap(11,15) 
    { let tmp_1956 = keys[11]; keys[11] = keys[15]; keys[15] = tmp_1956;let tmp_1957 = values[11]; values[11] = values[15]; values[15] = tmp_1957; }
    }
    // exch_local(2,16) 
    // cmp_swap(0,2)
    if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
    // swap(0,2) 
    { let tmp_1958 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_1958;let tmp_1959 = values[0]; values[0] = values[2]; values[2] = tmp_1959; }
    }
    // cmp_swap(1,3)
    if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
    // swap(1,3) 
    { let tmp_1960 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_1960;let tmp_1961 = values[1]; values[1] = values[3]; values[3] = tmp_1961; }
    }
    // cmp_swap(4,6)
    if keys[4] > keys[6] || (keys[4] == keys[6] && values[4] > values[6]) {
    // swap(4,6) 
    { let tmp_1962 = keys[4]; keys[4] = keys[6]; keys[6] = tmp_1962;let tmp_1963 = values[4]; values[4] = values[6]; values[6] = tmp_1963; }
    }
    // cmp_swap(5,7)
    if keys[5] > keys[7] || (keys[5] == keys[7] && values[5] > values[7]) {
    // swap(5,7) 
    { let tmp_1964 = keys[5]; keys[5] = keys[7]; keys[7] = tmp_1964;let tmp_1965 = values[5]; values[5] = values[7]; values[7] = tmp_1965; }
    }
    // cmp_swap(8,10)
    if keys[8] > keys[10] || (keys[8] == keys[10] && values[8] > values[10]) {
    // swap(8,10) 
    { let tmp_1966 = keys[8]; keys[8] = keys[10]; keys[10] = tmp_1966;let tmp_1967 = values[8]; values[8] = values[10]; values[10] = tmp_1967; }
    }
    // cmp_swap(9,11)
    if keys[9] > keys[11] || (keys[9] == keys[11] && values[9] > values[11]) {
    // swap(9,11) 
    { let tmp_1968 = keys[9]; keys[9] = keys[11]; keys[11] = tmp_1968;let tmp_1969 = values[9]; values[9] = values[11]; values[11] = tmp_1969; }
    }
    // cmp_swap(12,14)
    if keys[12] > keys[14] || (keys[12] == keys[14] && values[12] > values[14]) {
    // swap(12,14) 
    { let tmp_1970 = keys[12]; keys[12] = keys[14]; keys[14] = tmp_1970;let tmp_1971 = values[12]; values[12] = values[14]; values[14] = tmp_1971; }
    }
    // cmp_swap(13,15)
    if keys[13] > keys[15] || (keys[13] == keys[15] && values[13] > values[15]) {
    // swap(13,15) 
    { let tmp_1972 = keys[13]; keys[13] = keys[15]; keys[15] = tmp_1972;let tmp_1973 = values[13]; values[13] = values[15]; values[15] = tmp_1973; }
    }
    // exch_local(1,16) 
    // cmp_swap(0,1)
    if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
    // swap(0,1) 
    { let tmp_1974 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_1974;let tmp_1975 = values[0]; values[0] = values[1]; values[1] = tmp_1975; }
    }
    // cmp_swap(2,3)
    if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
    // swap(2,3) 
    { let tmp_1976 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_1976;let tmp_1977 = values[2]; values[2] = values[3]; values[3] = tmp_1977; }
    }
    // cmp_swap(4,5)
    if keys[4] > keys[5] || (keys[4] == keys[5] && values[4] > values[5]) {
    // swap(4,5) 
    { let tmp_1978 = keys[4]; keys[4] = keys[5]; keys[5] = tmp_1978;let tmp_1979 = values[4]; values[4] = values[5]; values[5] = tmp_1979; }
    }
    // cmp_swap(6,7)
    if keys[6] > keys[7] || (keys[6] == keys[7] && values[6] > values[7]) {
    // swap(6,7) 
    { let tmp_1980 = keys[6]; keys[6] = keys[7]; keys[7] = tmp_1980;let tmp_1981 = values[6]; values[6] = values[7]; values[7] = tmp_1981; }
    }
    // cmp_swap(8,9)
    if keys[8] > keys[9] || (keys[8] == keys[9] && values[8] > values[9]) {
    // swap(8,9) 
    { let tmp_1982 = keys[8]; keys[8] = keys[9]; keys[9] = tmp_1982;let tmp_1983 = values[8]; values[8] = values[9]; values[9] = tmp_1983; }
    }
    // cmp_swap(10,11)
    if keys[10] > keys[11] || (keys[10] == keys[11] && values[10] > values[11]) {
    // swap(10,11) 
    { let tmp_1984 = keys[10]; keys[10] = keys[11]; keys[11] = tmp_1984;let tmp_1985 = values[10]; values[10] = values[11]; values[11] = tmp_1985; }
    }
    // cmp_swap(12,13)
    if keys[12] > keys[13] || (keys[12] == keys[13] && values[12] > values[13]) {
    // swap(12,13) 
    { let tmp_1986 = keys[12]; keys[12] = keys[13]; keys[13] = tmp_1986;let tmp_1987 = values[12]; values[12] = values[13]; values[13] = tmp_1987; }
    }
    // cmp_swap(14,15)
    if keys[14] > keys[15] || (keys[14] == keys[15] && values[14] > values[15]) {
    // swap(14,15) 
    { let tmp_1988 = keys[14]; keys[14] = keys[15]; keys[15] = tmp_1988;let tmp_1989 = values[14]; values[14] = values[15]; values[15] = tmp_1989; }
    }
