...
fn segsort_hybrid_sg16_n1024_m256_striped(
    ...
    // exch_intxn(tmask:63,swbit:5,wpt:4)
    {
        // _exch_workgroup([(0, 3), (1, 2), (2, 1), (3, 0)],63,5)
        {
            ...
            smem_vals[tid_g * WPT + 3u] = values[3];
            workgroupBarrier();
            let tmp_248 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_249 = seg_base + (local_tid ^ 63u);
            let tmp_250 = smem_keys[tmp_249 * WPT + 3u];
            let tmp_251 = smem_vals[tmp_249 * WPT + 3u];
            let tmp_252 = keys[0] < tmp_250 || (keys[0] == tmp_250 && values[0] < tmp_251);
            if tmp_248 == tmp_252 { keys[0] = tmp_250; values[0] = tmp_251; }
            let tmp_253 = smem_keys[tmp_249 * WPT + 2u];
            let tmp_254 = smem_vals[tmp_249 * WPT + 2u];
            let tmp_255 = keys[1] < tmp_253 || (keys[1] == tmp_253 && values[1] < tmp_254);
            if tmp_248 == tmp_255 { keys[1] = tmp_253; values[1] = tmp_254; }
            let tmp_256 = smem_keys[tmp_249 * WPT + 1u];
            let tmp_257 = smem_vals[tmp_249 * WPT + 1u];
            let tmp_258 = keys[2] < tmp_256 || (keys[2] == tmp_256 && values[2] < tmp_257);
            if tmp_248 == tmp_258 { keys[2] = tmp_256; values[2] = tmp_257; }
            let tmp_259 = smem_keys[tmp_249 * WPT + 0u];
            let tmp_260 = smem_vals[tmp_249 * WPT + 0u];
            let tmp_261 = keys[3] < tmp_259 || (keys[3] == tmp_259 && values[3] < tmp_260);
            if tmp_248 == tmp_261 { keys[3] = tmp_259; values[3] = tmp_260; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:16,swbit:4,wpt:4)
    {
        // _exch_workgroup([(0, 0), (1, 1), (2, 2), (3, 3)],16,4)
        {
            ...
            smem_vals[tid_g * WPT + 3u] = values[3];
            workgroupBarrier();
            let tmp_262 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_263 = seg_base + (local_tid ^ 16u);
            let tmp_264 = smem_keys[tmp_263 * WPT + 0u];
            let tmp_265 = smem_vals[tmp_263 * WPT + 0u];
            let tmp_266 = keys[0] < tmp_264 || (keys[0] == tmp_264 && values[0] < tmp_265);
            if tmp_262 == tmp_266 { keys[0] = tmp_264; values[0] = tmp_265; }
            let tmp_267 = smem_keys[tmp_263 * WPT + 1u];
            let tmp_268 = smem_vals[tmp_263 * WPT + 1u];
            let tmp_269 = keys[1] < tmp_267 || (keys[1] == tmp_267 && values[1] < tmp_268);
            if tmp_262 == tmp_269 { keys[1] = tmp_267; values[1] = tmp_268; }
            let tmp_270 = smem_keys[tmp_263 * WPT + 2u];
            let tmp_271 = smem_vals[tmp_263 * WPT + 2u];
            let tmp_272 = keys[2] < tmp_270 || (keys[2] == tmp_270 && values[2] < tmp_271);
            if tmp_262 == tmp_272 { keys[2] = tmp_270; values[2] = tmp_271; }
            let tmp_273 = smem_keys[tmp_263 * WPT + 3u];
            let tmp_274 = smem_vals[tmp_263 * WPT + 3u];
    ...
    // exch_local(2,4)
    {
        ...
        if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
            // swap(0,2)
            {
                let tmp_328 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_328;
                let tmp_329 = values[0]; values[0] = values[2]; values[2] = tmp_329;
            }
        }
        // cmp_swap(1,3)
        if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
            // swap(1,3)
            {
                let tmp_330 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_330;
                let tmp_331 = values[1]; values[1] = values[3]; values[3] = tmp_331;
            }
        }
    }
    ...
    // exch_local(1,4)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_332 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_332;
                let tmp_333 = values[0]; values[0] = values[1]; values[1] = tmp_333;
            }
        }
        // cmp_swap(2,3)
        if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
            // swap(2,3)
            {
                let tmp_334 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_334;
                let tmp_335 = values[2]; values[2] = values[3]; values[3] = tmp_335;
            }
        }
    }
    ...
    // exch_intxn(tmask:127,swbit:6,wpt:4)
    {
        // _exch_workgroup([(0, 3), (1, 2), (2, 1), (3, 0)],127,6)
        {
            ...
            smem_vals[tid_g * WPT + 3u] = values[3];
            workgroupBarrier();
            let tmp_336 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_337 = seg_base + (local_tid ^ 127u);
            let tmp_338 = smem_keys[tmp_337 * WPT + 3u];
            let tmp_339 = smem_vals[tmp_337 * WPT + 3u];
            let tmp_340 = keys[0] < tmp_338 || (keys[0] == tmp_338 && values[0] < tmp_339);
            if tmp_336 == tmp_340 { keys[0] = tmp_338; values[0] = tmp_339; }
            let tmp_341 = smem_keys[tmp_337 * WPT + 2u];
            let tmp_342 = smem_vals[tmp_337 * WPT + 2u];
            let tmp_343 = keys[1] < tmp_341 || (keys[1] == tmp_341 && values[1] < tmp_342);
            if tmp_336 == tmp_343 { keys[1] = tmp_341; values[1] = tmp_342; }
            let tmp_344 = smem_keys[tmp_337 * WPT + 1u];
            let tmp_345 = smem_vals[tmp_337 * WPT + 1u];
            let tmp_346 = keys[2] < tmp_344 || (keys[2] == tmp_344 && values[2] < tmp_345);
            if tmp_336 == tmp_346 { keys[2] = tmp_344; values[2] = tmp_345; }
            let tmp_347 = smem_keys[tmp_337 * WPT + 0u];
            let tmp_348 = smem_vals[tmp_337 * WPT + 0u];
            let tmp_349 = keys[3] < tmp_347 || (keys[3] == tmp_347 && values[3] < tmp_348);
            if tmp_336 == tmp_349 { keys[3] = tmp_347; values[3] = tmp_348; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:32,swbit:5,wpt:4)
    {
        // _exch_workgroup([(0, 0), (1, 1), (2, 2), (3, 3)],32,5)
        {
            ...
            smem_vals[tid_g * WPT + 3u] = values[3];
            workgroupBarrier();
            let tmp_350 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_351 = seg_base + (local_tid ^ 32u);
            let tmp_352 = smem_keys[tmp_351 * WPT + 0u];
            let tmp_353 = smem_vals[tmp_351 * WPT + 0u];
            let tmp_354 = keys[0] < tmp_352 || (keys[0] == tmp_352 && values[0] < tmp_353);
            if tmp_350 == tmp_354 { keys[0] = tmp_352; values[0] = tmp_353; }
            let tmp_355 = smem_keys[tmp_351 * WPT + 1u];
            let tmp_356 = smem_vals[tmp_351 * WPT + 1u];
            let tmp_357 = keys[1] < tmp_355 || (keys[1] == tmp_355 && values[1] < tmp_356);
            if tmp_350 == tmp_357 { keys[1] = tmp_355; values[1] = tmp_356; }
            let tmp_358 = smem_keys[tmp_351 * WPT + 2u];
            let tmp_359 = smem_vals[tmp_351 * WPT + 2u];
            let tmp_360 = keys[2] < tmp_358 || (keys[2] == tmp_358 && values[2] < tmp_359);
            if tmp_350 == tmp_360 { keys[2] = tmp_358; values[2] = tmp_359; }
            let tmp_361 = smem_keys[tmp_351 * WPT + 3u];
            let tmp_362 = smem_vals[tmp_351 * WPT + 3u];
            let tmp_363 = keys[3] < tmp_361 || (keys[3] == tmp_361 && values[3] < tmp_362);
            if tmp_350 == tmp_363 { keys[3] = tmp_361; values[3] = tmp_362; }
            workgroupBarrier();
        }
    }
    ...
    // exch_paral(tmask:16,swbit:4,wpt:4)
    {
        // _exch_workgroup([(0, 0), (1, 1), (2, 2), (3, 3)],16,4)
        {
            ...
            smem_vals[tid_g * WPT + 3u] = values[3];
            workgroupBarrier();
            let tmp_364 = extractBits(local_tid, 4u, 1u) != 0u;
            let tmp_365 = seg_base + (local_tid ^ 16u);
            let tmp_366 = smem_keys[tmp_365 * WPT + 0u];
            let tmp_367 = smem_vals[tmp_365 * WPT + 0u];
            let tmp_368 = keys[0] < tmp_366 || (keys[0] == tmp_366 && values[0] < tmp_367);
            if tmp_364 == tmp_368 { keys[0] = tmp_366; values[0] = tmp_367; }
            let tmp_369 = smem_keys[tmp_365 * WPT + 1u];
            let tmp_370 = smem_vals[tmp_365 * WPT + 1u];
            let tmp_371 = keys[1] < tmp_369 || (keys[1] == tmp_369 && values[1] < tmp_370);
            if tmp_364 == tmp_371 { keys[1] = tmp_369; values[1] = tmp_370; }
            let tmp_372 = smem_keys[tmp_365 * WPT + 2u];
            let tmp_373 = smem_vals[tmp_365 * WPT + 2u];
            let tmp_374 = keys[2] < tmp_372 || (keys[2] == tmp_372 && values[2] < tmp_373);
            if tmp_364 == tmp_374 { keys[2] = tmp_372; values[2] = tmp_373; }
            let tmp_375 = smem_keys[tmp_365 * WPT + 3u];
            let tmp_376 = smem_vals[tmp_365 * WPT + 3u];
            let tmp_377 = keys[3] < tmp_375 || (keys[3] == tmp_375 && values[3] < tmp_376);
            if tmp_364 == tmp_377 { keys[3] = tmp_375; values[3] = tmp_376; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(2,4)
    {
        ...
        if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
            // swap(0,2)
            {
                let tmp_430 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_430;
                let tmp_431 = values[0]; values[0] = values[2]; values[2] = tmp_431;
            }
        }
        // cmp_swap(1,3)
        if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
            // swap(1,3)
            {
                let tmp_432 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_432;
                let tmp_433 = values[1]; values[1] = values[3]; values[3] = tmp_433;
            }
        }
    }
    ...
    // exch_local(1,4)
    {
        ...
        if keys[0] > keys[1] || (keys[0] == keys[1] && values[0] > values[1]) {
            // swap(0,1)
            {
                let tmp_434 = keys[0]; keys[0] = keys[1]; keys[1] = tmp_434;
                let tmp_435 = values[0]; values[0] = values[1]; values[1] = tmp_435;
            }
        }
        // cmp_swap(2,3)
        if keys[2] > keys[3] || (keys[2] == keys[3] && values[2] > values[3]) {
            // swap(2,3)
            {
                let tmp_436 = keys[2]; keys[2] = keys[3]; keys[3] = tmp_436;
                let tmp_437 = values[2]; values[2] = values[3]; values[3] = tmp_437;
            }
        }
    }
    ...
    // exch_intxn(tmask:255,swbit:7,wpt:4)
    {
        // _exch_workgroup([(0, 3), (1, 2), (2, 1), (3, 0)],255,7)
        {
            ...
            smem_vals[tid_g * WPT + 3u] = values[3];
            workgroupBarrier();
            let tmp_438 = extractBits(local_tid, 7u, 1u) != 0u;
            let tmp_439 = seg_base + (local_tid ^ 255u);
            let tmp_440 = smem_keys[tmp_439 * WPT + 3u];
            let tmp_441 = smem_vals[tmp_439 * WPT + 3u];
            let tmp_442 = keys[0] < tmp_440 || (keys[0] == tmp_440 && values[0] < tmp_441);
            if tmp_438 == tmp_442 { keys[0] = tmp_440; values[0] = tmp_441; }
            let tmp_443 = smem_keys[tmp_439 * WPT + 2u];
            let tmp_444 = smem_vals[tmp_439 * WPT + 2u];
            let tmp_445 = keys[1] < tmp_443 || (keys[1] == tmp_443 && values[1] < tmp_444);
            if tmp_438 == tmp_445 { keys[1] = tmp_443; values[1] = tmp_444; }
            let tmp_446 = smem_keys[tmp_439 * WPT + 1u];
            let tmp_447 = smem_vals[tmp_439 * WPT + 1u];
            let tmp_448 = keys[2] < tmp_446 || (keys[2] == tmp_446 && values[2] < tmp_447);
            if tmp_438 == tmp_448 { keys[2] = tmp_446; values[2] = tmp_447; }
            let tmp_449 = smem_keys[tmp_439 * WPT + 0u];
            let tmp_450 = smem_vals[tmp_439 * WPT + 0u];
    ...
    // exch_paral(tmask:64,swbit:6,wpt:4)
    {
        // _exch_workgroup([(0, 0), (1, 1), (2, 2), (3, 3)],64,6)
        {
            ...
            smem_vals[tid_g * WPT + 3u] = values[3];
            workgroupBarrier();
            let tmp_452 = extractBits(local_tid, 6u, 1u) != 0u;
            let tmp_453 = seg_base + (local_tid ^ 64u);
            let tmp_454 = smem_keys[tmp_453 * WPT + 0u];
            let tmp_455 = smem_vals[tmp_453 * WPT + 0u];
            let tmp_456 = keys[0] < tmp_454 || (keys[0] == tmp_454 && values[0] < tmp_455);
            if tmp_452 == tmp_456 { keys[0] = tmp_454; values[0] = tmp_455; }
            let tmp_457 = smem_keys[tmp_453 * WPT + 1u];
            let tmp_458 = smem_vals[tmp_453 * WPT + 1u];
            let tmp_459 = keys[1] < tmp_457 || (keys[1] == tmp_457 && values[1] < tmp_458);
            if tmp_452 == tmp_459 { keys[1] = tmp_457; values[1] = tmp_458; }
            let tmp_460 = smem_keys[tmp_453 * WPT + 2u];
            let tmp_461 = smem_vals[tmp_453 * WPT + 2u];
            let tmp_462 = keys[2] < tmp_460 || (keys[2] == tmp_460 && values[2] < tmp_461);
            if tmp_452 == tmp_462 { keys[2] = tmp_460; values[2] = tmp_461; }
            let tmp_463 = smem_keys[tmp_453 * WPT + 3u];
            let tmp_464 = smem_vals[tmp_453 * WPT + 3u];
            let tmp_465 = keys[3] < tmp_463 || (keys[3] == tmp_463 && values[3] < tmp_464);
    ...
    // exch_paral(tmask:32,swbit:5,wpt:4)
    {
        // _exch_workgroup([(0, 0), (1, 1), (2, 2), (3, 3)],32,5)
        {
            ...
            smem_vals[tid_g * WPT + 3u] = values[3];
            workgroupBarrier();
            let tmp_466 = extractBits(local_tid, 5u, 1u) != 0u;
            let tmp_467 = seg_base + (local_tid ^ 32u);
            let tmp_468 = smem_keys[tmp_467 * WPT + 0u];
            let tmp_469 = smem_vals[tmp_467 * WPT + 0u];
            let tmp_470 = keys[0] < tmp_468 || (keys[0] == tmp_468 && values[0] < tmp_469);
            if tmp_466 == tmp_470 { keys[0] = tmp_468; values[0] = tmp_469; }
            let tmp_471 = smem_keys[tmp_467 * WPT + 1u];
            let tmp_472 = smem_vals[tmp_467 * WPT + 1u];
            let tmp_473 = keys[1] < tmp_471 || (keys[1] == tmp_471 && values[1] < tmp_472);
            if tmp_466 == tmp_473 { keys[1] = tmp_471; values[1] = tmp_472; }
            let tmp_474 = smem_keys[tmp_467 * WPT + 2u];
            let tmp_475 = smem_vals[tmp_467 * WPT + 2u];
            let tmp_476 = keys[2] < tmp_474 || (keys[2] == tmp_474 && values[2] < tmp_475);
            if tmp_466 == tmp_476 { keys[2] = tmp_474; values[2] = tmp_475; }
            let tmp_477 = smem_keys[tmp_467 * WPT + 3u];
            let tmp_478 = smem_vals[tmp_467 * WPT + 3u];
            let tmp_479 = keys[3] < tmp_477 || (keys[3] == tmp_477 && values[3] < tmp_478);
            if tmp_466 == tmp_479 { keys[3] = tmp_477; values[3] = tmp_478; }
            workgroupBarrier();
        }
    }
    ...
    // exch_local(2,4)
    {
        ...
        if keys[0] > keys[2] || (keys[0] == keys[2] && values[0] > values[2]) {
            // swap(0,2)
            {
                let tmp_546 = keys[0]; keys[0] = keys[2]; keys[2] = tmp_546;
                let tmp_547 = values[0]; values[0] = values[2]; values[2] = tmp_547;
            }
        }
        // cmp_swap(1,3)
        if keys[1] > keys[3] || (keys[1] == keys[3] && values[1] > values[3]) {
            // swap(1,3)
            {
                let tmp_548 = keys[1]; keys[1] = keys[3]; keys[3] = tmp_548;
                let tmp_549 = values[1]; values[1] = values[3]; values[3] = tmp_549;
            }
        }
    }
