...
const M: u32 = 128u;
const WPT: u32 = 2u;
const SG: u32 = 32u;      // one CuteSort run spans SG lanes; RUN = SG*WPT = 64
...
fn segsort_cutemerge_sg32_smem16k_n256_m128_striped(
    ...
    {  // CuteSort wide run 0: 2 slot(s) x 32 lanes -> sorted run of 64
